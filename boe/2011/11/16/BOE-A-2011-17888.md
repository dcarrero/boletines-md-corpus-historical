...
pagina_final: 117983
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-17888"
url_pdf: "https://www.boe.es/boe/dias/2011/11/16/pdfs/BOE-A-2011-17888.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-17888"
url_eli: "https://www.boe.es/eli/es/o/2011/11/08/eha3067"
fetched_at: "2026-05-10T05:30:33Z"
...
Regla 24. Conservación de los registroscontables.
...
Anexo I. Modelos de la documentación que configura el Resumen de la Cuenta de la Administración General del Estado.

Anexo II. Modelos de la documentación que configura los Informes agregados de las operaciones realizadas en el ámbito de cada Departamento ministerial.
...
## [precepto]Regla 1. Ámbito de aplicación.
...
## [precepto]Regla 2. Aplicación del Plan General de Contabilidad Pública.
...
## [precepto]Regla 3. Oficinas contables.
...
## [precepto]Regla 4. Ejercicio contable.

El ejercicio contable coincidirá con el año natural.

## [precepto]Regla 5. Destinatarios de la información contable.
...
## [precepto]Regla 9. Modelo contable.
...
## [precepto]Regla 10. Configuración informática del Sistema.
...
## [precepto]Regla 11. Soporte de los registros contables.
...
## [precepto]Regla 12. En relación con la contabilidad de la Administración General del Estado.
...
## [precepto]Regla 13. En relación con el soporte informático del SIC.
...
## [precepto]Regla 14. De la Central Contable.
...
## [precepto]Regla 15. De las Oficinas de Contabilidad de las Intervenciones Delegadas en los Ministerios y Subdirección General de Contabilidad del Ministerio de Defensa.
...
## [precepto]Regla 16. De las Oficinas de Contabilidad de las Intervenciones de las Delegaciones de Economía y Hacienda.
...
## [precepto]Regla 17. De la Oficina de Contabilidad de la Intervención Delegada en la Dirección General del Tesoro y Política Financiera.
...
## [precepto]Regla 18. Justificación.
...
## [precepto]Regla 19. Medios de justificación.
...
## [precepto]Regla 20. Soporte de las anotaciones contables.
...
## [precepto]Regla 21. Autorización.
...
## [precepto]Regla 22. Toma de razón.
...
## [precepto]Regla 23. Archivo y conservación de los justificantes de las operaciones y de los soportes de las anotaciones contables.
...
## [precepto]Regla 24. Conservación de los registros contables.
...
## [precepto]Regla 25. Tipos de información.
...
## [precepto]Regla 26. Garantía de la información contable.
...
## [precepto]Regla 29. Especialidades en el Estado de cambios en el patrimonio neto.
...
## [precepto]Regla 30. Especialidades en el Estado de flujos de efectivo.
...
## [precepto]Regla 31. Especialidades en el Estado de liquidación del Presupuesto.
...
## [precepto]Regla 32. Especialidades en la Memoria.
...
## [precepto]Regla 33. Delimitación.
...
## [precepto]Regla 34. Nivel de la información.
...
## [precepto]Regla 35. Soporte de la información.
...
## [precepto]Regla 36. Información para publicar en el «Boletín Oficial del Estado».
...
## [precepto]Regla 37. Información para el Congreso de los Diputados y el Senado.
...
## [precepto]Regla 38. Información estadística.
...
## [precepto]Regla 39. Formación de la Cuenta de la Administración General del Estado.
...
## [precepto]Regla 40. Rendición de cuentas.
...
## [precepto]Regla 41. Tramitación de la Cuenta de la Administración General del Estado al Tribunal de Cuentas.
...
## [precepto]Regla 42. Conservación de la Cuenta de la Administración General del Estado.
...
## [precepto]Regla 43. Publicación del Resumen de la Cuenta de la Administración General del Estado.
...
| SUPERPROYECTO | DESCRIPCIÓN | INVERSIÓN 
 TOTAL | EJERCICIO 
 DE INICIO | EJERCICIO DE 
 FINALIZACIÓN | INVERSIÓN 
 REALIZADA AL 
 INICIO 
 EJERCICIO | INVERSIÓN 
 REALIZADA EN EL 
 EJERCICIO | INVERSIÓN A 
 REALIZAR EN 
 ANUALIDADES 
 PENDIENTES |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| EJERCICIO DE 
 ...
 DESCRIPCIÓN | CRÉDITO 
 ANTICIPADO | CRÉDITOS 
 CANCELADOS | OBLIGACIONES 
 RECONOCIDAS A 1 DE ENERO | OBLIGACIONES 
 RECONOCIDAS 
 EN EL EJERCICIO | OBLIGACIONES 
 CANCELADAS A 1 DE ENERO | OBLIGACIONES 
 CANCELADAS EN 
 EL EJERCICIO |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |
...
| CAPÍTULO | OBLIGACIONES RECONOCIDAS 
 HASTA 31 DE DICIEMBRE. | PROPUESTAS DE PAGO 
 EXPEDIDAS HASTA 31 DE 
 DICIEMBRE | OBLIGACIONES PENDIENTES 
 DE PROPONER EL PAGO A 31 
 DE DICIEMBRE |
| --- | --- | --- | --- |
|  |  |  |  |
| TOTAL |  |  |  |
...
| SECCIÓN | PROPUESTAS DE PAGO 
 RECIBIDAS NETAS HASTA 31 DE 
 DICIEMBRE | PAGOS | PROPUESTAS PENDIENTES DE 
...
| EJERCICIO/SECCIÓN/ 
 ...
 PENDIENTES DE 
 PROPONER EL PAGO A 
 1 DE ENERO | RECTIFICACIONES DEL 
 SALDO ENTRANTE Y 
 ANULACIONES | PROPUESTAS DE 
 PAGO EXPEDIDAS | OBLIGACIONES 
 PENDIENTES DE 
 PROPONER EL PAGO A 
 31 DE DICIEMBRE |
| --- | --- | --- | --- | --- |
...
| EJERCICIO/SECCIÓN/ 
 ...
 PENDIENTES DE 
 PAGO A 1 DE 
 ENERO | RECTIFICACIONES 
 DEL SALDO 
 ENTRANTE Y 
 ANULACIONES | PROPUESTAS 
 RECIBIDAS NETAS | PAGOS | PROPUESTAS 
 PENDIENTES DE 
 PAGO A 31 DE 
 DICIEMBRE |
| --- | --- | --- | --- | --- | --- |
...
| CAPÍTULOS | PENDIENTES DE 
 ...
 DEVOLUCIONES 
 RECONOCIDAS | PRESCRIPCIONES | DEVOLUCIONES 
 PAGADAS | DEVOLUCIONES 
 PENDIENTES DE 
 PAGO A 31 DE 
 DICIEMBRE |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| DENOMINACIÓN DE LA INVERSIÓN | VALOR DE LA 
 INVERSIÓN AL 
 INICIO DEL 
 EJERCICIO | VARIACIONES EN 
 AUMENTO | VARIACIONES EN 
 DISMINUCIÓN | VALOR DE LA 
 INVERSIÓN AL FINAL 
 DEL EJERCICIO | DESEMBOLSOS 
 PENDIENTES AL 
 FINAL DEL 
 EJERCICIO | INTERESES 
 DEVENGADOS Y 
...
| DENOMINACIÓN DE LA INVERSIÓN | VALOR DE LOS 
 CRÉDITOS AL INICIO DEL EJERCICIO | VARIACIONES EN 
 AUMENTO | VARIACIONES EN 
 DISMINUCIÓN | VALOR DE LOS 
 CRÉDITOS AL FINAL 
 DEL EJERCICIO | INTERESES 
 DEVENGADOS Y NO 
 VENCIDOS AL FINAL DEL 
 EJERCICIO | DETERIORO DE VALOR 
 AL FINAL DEL 
 EJERCICIO |
| --- | --- | --- | --- | --- | --- | --- |
...
III. Información sobre la Deuda del Estado

Ejercicio ...............

|  | DEUDA AL 1 DE 
 ENERO | CREACIONES | INTERESES 
 DEVENGADOS | INTERESES 
 CANCELADOS | DIFERENCIAS 
 DE CAMBIO | DISMINUCIONES | DEUDA A 31 DE DICIEMBRE |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| COSTE 
 AMORTIZADO ó 
 VALOR 
...
| ENTIDAD 
 AVALADA | DEUDA 
 AVALADA | VTO. | PENDIENTE 
 A 1 ENERO | CONCEDIDOS | CANCELADOS | PENDIENTE 
 A 31 
 DICIEMBRE | PROVISIÓN | EJECUCIONES | REINTEGROS DE EJECUCIONES |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
