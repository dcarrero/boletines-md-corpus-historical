---
identificador: "BOE-A-2011-20552"
titulo: "Resolución de 15 de diciembre de 2011, de la Universidad Jaume I, por la que se convocan pruebas selectivas para el ingreso en la Escala Técnica Media de Informática."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 146193
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-20552"
url_pdf: "https://www.boe.es/boe/dias/2011/12/30/pdfs/BOE-A-2011-20552.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-20552"
url_eli: ""
fetched_at: "2026-05-10T08:03:40Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 15 de diciembre de 2011, de la Universidad Jaume I, por la que se convocan pruebas selectivas para el ingreso en la Escala Técnica Media de Informática.
...
Este Rectorado, en uso de las competencias que le vienen atribuidas por la legislación vigente, acuerda convocar pruebas selectivas por el sistema de oposición para ingreso en la escala técnica media de Informática, de la Universitat Jaume I, con sujeción a las siguientes

Bases de la convocatoria

1. Normas generales

1.1 Se convocan pruebas selectivas para cubrir un puesto de trabajo de la escala técnica media de Informática (Analista-Programador/a), adscrito a la Servicio de Informática de la Universitat Jaume I.

1.2 Al presente proceso selectivo le será de aplicación la Ley orgánica 6/2001, de 21 de diciembre, de Universidades, modificada por la Ley orgánica 4/2007; la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público; la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana; el Decreto 33/1999, de 9 de marzo, del Gobierno valenciano, por el que se aprueba el reglamento de selección, provisión de puestos de trabajo y carrera administrativa del personal comprendido en el ámbito de aplicación de la Ley de Función Pública Valenciana; los Estatutos de la Universitat Jaume I y lo dispuesto en la presente convocatoria.
...
2.1.3 Estar en posesión del título de diplomatura, Ingeniería técnica, Arquitectura técnica, grado o equivalente. En el caso de titulaciones obtenidas al extranjero hay que estar en posesión de la credencial que acredite la homologación de éstas o la credencial de reconocimiento para el ejercicio de profesiones consideradas reguladas en virtud del Real Decreto 1837/2008, de 8 de noviembre.

2.1.4 Acreditación de los conocimientos de los idiomas oficiales de la Universitat Jaume I.

En el caso del español, deberá estar en posesión de alguno de los documentos relacionados en el anexo IV o superar la prueba específica que se realizará a los aspirantes que no posean nacionalidad española, e irá destinada a comprobar que posean un nivel adecuado de comprensión y expresión oral y escrita en esta lengua. El contenido de la prueba de acreditación de conocimientos de español, siguiendo el anexo III del Real Decreto 1137/2002, de 31 de octubre (BOE núm. 268, de 8 de noviembre), por el que se establecen diplomas acreditativos de conocimiento de español como Lengua extranjera, contendrá una parte oral y una escrita.
...
Los aspirantes deberán cumplimentar el apartado Datos de la convocatoria de su solicitud: Código 13464.
...
3.4 Las solicitudes serán facilitadas gratuitamente en Servicio de Recursos Humanos sito en la segunda planta del edificio Rectorado y Servicios Centrales, Campus del Riu Sec de la Universitat Jaume I. Este modelo de solicitud también se podrá obtener desde la siguiente dirección de internet:<http://www.uji.es/serveis/rec-hum/docs/proves.pdf>

3.5 Los derechos de examen serán de 18,26 euros y se ingresarán en la cuenta corriente núm. 3104549646 –«Universitat Jaume I de Castelló. Derechos de examen»– en Bancaja, entidad 2077, sucursal 0580 de la calle Caballeros, 2, haciendo constar en el ingreso «Pruebas selectivas para ingreso en la escala técnica media de Informática de la Universitat Jaume I».
...
En esta prueba se valorará el rigor analítico, la sistemática y la claridad de ideas en vistas a la elaboración de una solución razonada.
...
5.4 Caso de realizarse el ejercicio en varias sesiones, el orden de intervención de los aspirantes comenzará por la letra «V», siguiendo el orden alfabético de apellidos conforme a la Resolución de 27 de septiembre de 2010, de la Consellería de Justicia y Administraciones Públicas («DOCV» número 6376, de 14 de octubre de 2010).
...
Castelló de la Plana, 15 de diciembre de 2011.–El Rector, Vicent Climent Jordà.
...
5. El Estatuto Básico del Empleado Público. La Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana.
...
1. Redes TCP/IP. Concepto y utilidades.

2. El servicio web: Servidor Apache.

3. El servicio de correo electrónico (Postfix, Cyrus-imapd).

4. El servicio DNS. Servidor named.

5. El servicio directorio LDAP. Servidor OpenLDAP.

6. El servicio de mensajería instantánea por medio de XMPP. Servidor OpenFire. Integración con otros sistemas de MI.

7. Autenticación en la web.

8. Conceptos sobre seguridad perimetral: Cortafuegos, servidores VPN, técnicas criptográficas.

9. Tipos de virus y técnicas de transmisión. Detección y eliminación de virus en la intranet.

10. Aplicaciones en la WEB. Programación en PHP, Python y Perl. Técnicas de prevención frente a vulnerabilidades en el código.

11. Programación C.

12. Protocolos de comunicación entre aplicaciones: XMLRPC, SOAP y REST.

13. Bases de datos: MySQL.

14. Herramientas de enseñanza virtual: Moodle y Mahara. Integración de la autenticación (plug-ins y Moodle network), administración y optimización de estas aplicaciones.

15. Auditoría informática. Metodologías, técnicas y herramientas. En particular metodologías ágiles de desarrollo de software, como Scrum y Kanban. Normas y estándares.

16. La legislación de protección de datos de carácter personal: La Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal; Real Decreto 1720/2007, de 21 de diciembre, por el que se aprueba el Reglamento de desarrollo de la Ley Orgánica 15/1999, de 13 de diciembre, de protección de datos de carácter personal; la Directiva 95/46/CE; Ley 11/2007, de 22 de junio, de acceso electrónico de los ciudadanos a los Servicios Públicos; Ley 34/2002, de 11 de julio, de servicios de la sociedad de la información y de comercio electrónico. La Agencia de Protección de Datos.
...
e. Diploma Superior de Español como Lengua Extranjera (DELE) de nivel B2, según el Real Decreto 1137/2002, de 31 de octubre, modificado por el Real Decreto 264/2008, de 22 de febrero de 2008.

f. Graduado escolar.

2. Acreditación de conocimientos del nivel C1 (suficiencia) de valenciano

a. Certificado de nivel C1 (suficiencia), expedido por la Universitat Jaume I o equivalente segín el acuerdo publicado en la siguiente dirección electrónica <http://www.uji.es/serveis/slt/cursos/taula.html>
...
e. Certificado de haber superado la prueba de valenciano de nivel C1 (suficiencia) en otras convocatorias para la provisión de puestos de trabajo de la Universitat Jaume I.
