...
pagina_inicial: 7903
pagina_final: 7917
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1351"
url_pdf: "https://www.boe.es/boe/dias/2011/01/25/pdfs/BOE-A-2011-1351.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1351"
url_eli: ""
fetched_at: "2026-05-09T14:26:27Z"
...
Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el artículo 75 de la Ley Orgánica 6/2001 de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público; la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector Administración especial, Técnico Superior de Apoyo a la Investigación (PF 1778), de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:
...
Las funciones están relacionadas con las instalaciones y equipamiento disponible en el laboratorio.

Desarrollo y mantenimiento de programas para la medida automatizada de antenas (control del sistema de posicionamiento y de la instrumentación de RF), y de dispositivos de radiofrecuencia y microondas.

Diseño, simulación, prototipado, comprobación del diseño, funcionamiento y medida de antenas y dispositivos de radiofrecuencia y microondas.

Diseño y realización de piezas industriales para la sujeción y prototipado de antenas, y dispositivos de radiofrecuencia y microondas.

Manejo especializado de paquetes informáticos de CAD/CAM y simuladores electromagnéticos.
...
19. Lenguajes de programación para el control de instrumentación.

20. Librerías VISA, COM/DCOM y comandos SCPI.

21. Sistemas de medida de antenas.

22. Configuraciones de los ejes en una cámara anecoica.

23. Posicionadores y controladores de posicionadores para medida de antenas.

24. Alineamiento de ejes de los posicionadores para la medida de antenas.

25. Técnicas de diseño de cámaras anecoicas para medida de antenas.

26. Procedimientos de test de cámaras anecoicas para medida de antenas.

27. Mantenimiento y calibración de instrumentación.

28. Errores en las medidas con analizadores de redes.

29. Elementos y métodos de calibración para analizadores de redes.

30. Métodos de calibración para la medida de antenas.

31. Errores y corrección de errores en la medida de antenas.

32. Métodos para la medida de la ganancia de antenas en campo próximo.

33. Sondas en la medida de antenas. Corrección de sonda.

34. Transformación de campo próximo a campo lejano. Métodos y problemática existente.

35. Reconstrucción de corrientes para el análisis de antenas.

36. Procedimientos normalizados para la medida de los parámetros característicos de una antena.

37. Mantenimiento de conectadores y transiciones.

38. Diseño CAD/CAM de circuitos de microondas y antenas.

39. Procesos de mecanizado con máquinas de control numérico

40. Lenguaje de programación de control númerico.

41. Programación manual y asistida de máquinas de control numérico.

42. Herramientas y utillajes de mecanizado.

43. Mecanizado de alta velocidad.

44. Sondas de palpado.

45. Procesos de mecanizado no convencional.

46. Fresadoras y microfresadoras. Utilización y mantenimiento.

47. Medición de dimensiones y posicionamiento. Calibres y micrómetros.

48. Verificación de redondez y de la rugosidad superficial por contacto.

49. Programas de simulación electromagnética.

50. Diseño y fabricación de dispositivos de RF y microondas.

51. Metales y aleaciones para fabricación de circuitos de RF y microondas, y antenas.

52. Sustratos dieléctricos.

53. El lenguaje HTML/XHTML.

54. El lenguaje XML

55. El lenguaje PHP

56. El lenguaje javascript.

57. El lenguaje SQL.

58. Sistemas operativos Linux.

59. Directorio Activo, Administración de Dominios, Gestión de usuarios y grupos en entornos MS-Windows.

60. Sistemas de documentación, su implantación y mantenimiento.
