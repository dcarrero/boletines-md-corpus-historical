...
pagina_inicial: 7918
pagina_final: 7932
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1352"
url_pdf: "https://www.boe.es/boe/dias/2011/01/25/pdfs/BOE-A-2011-1352.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1352"
url_eli: ""
fetched_at: "2026-05-09T14:26:28Z"
...
Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el artículo 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector Administración especial, Técnico Superior de Apoyo a la Investigación (PF1779), de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:
...
Código de Puesto: PF1779: Denominación del Puesto: Técnico Superior de Apoyo a la Investigación.
...
Manejo y desarrollo de los algoritmos utilizados en distintas aplicaciones (control activo de sonido y vibraciones, creación de entornos virtuales, análisis multirate, adquisición y procesado de señales de comunicaciones digitales, etc.) a fin de apoyar las tareas de implementación de los algoritmos requeridos en tiempo real mediante DSP o PC.

Realización de labores de apoyo en campañas de medidas requeridas en los distintos proyectos de investigación que lleva a cabo el Instituto de Investigación en el área del procesado digital de sonido y comunicaciones.

Realización y diseño de tests de jurado para la evaluación psicoacústica de medidas de sonido.

Mantenimiento de la página web del grupo de tratamiento de audio y comunicaciones.
...
19. Procesado digital de señal. Sistemas lineales, filtrado, transformadas.

20. Procesado digital de sonido. Procesado de Audio. Características de las señales de voz y musicales. Análisis y representación.

21. Fundamentos de acústica de sala. Reverberación. Métodos de medida de respuesta de salas. Materiales de acondicionamiento acústico.

22. Sistemas de control activo de sonido: estructuras de control, algoritmos adaptativos.

23. Sonido espacial: propiedades, sistemas de reproducción multicanal.

24. Psicoacústica: Percepción del sonido. Parámetros objetivos y subjetivos de la Psicoacústica. Test de pares y medida de calidad del sonido. Análisis de regresión.

25. Sistemas MIMO (Multiple Input-Multiple Output) para sistemas de audio.

26. Sistema de reproducción sonora Wave-Field Synthesis: síntesis, implementación con arrays, problemas.

27. Sistemas de compensación de los efectos de la sala en sistemas de audio.

28. Separación de fuentes sonoras: modelos y algoritmos.

29. Programación en paralelo con GPU mediante jacket para aplicaciones de audio.

30. Programación en paralelo multicore para aplicaciones de audio.

31. Fundamentos y utilización de un analizador de audio de alta precisión.

32. Fundamentos, utilización y mantenimiento de un sonómetro.

33. Fundamentos y utilización de un transductor láser para medida de vibraciones.

34. Fundamentos y utilización de una mesa de mezclas.

35. Fundamentos, utilización y mantenimiento de micrófonos de precisión de campo libre, binaurales y de diferentes diagramas de radiación.

36. Fundamentos, utilización y mantenimiento de un simulador de cabeza y torso humano.

37. Fundamentos, utilización y mantenimiento de distintos altavoces autoamplificados, altavoces controlados remotamente y altavoces en array.

38. Fundamentos, utilización y mantenimiento de un calibrador de nivel sonoro.

39. Fundamentos y utilización de tarjetas de adquisición de señales, en particular de audio multicanal y DSP.

40. Fundamentos y utilización de sistema de posicionamiento X-Y y circular.

41. Conectores e interfaces de audio.

42. Software acústico Adobe Audition: funcionamiento y funciones.

43. Software acústico Steinberg Nuendo: funcionamiento y funciones.

44. Software Sound Quality de Brüel & Kjaer: funcionamiento y funciones.

45. Software de simulación acústica de recintos, en particular Ease: funcionamiento y funciones.

46. Software de procesado estadístico Statgraphics: funcionamiento y funciones.

47. Administración de sistemas operativos, en particular: Windows Server 2003 y Windows Server 2008.

48. Administración de Redes y discos.

49. Diseño de bases de datos.

50. El lenguaje Matlab.

51. El lenguaje C/C++.

52. El lenguaje Delphi.

53. El lenguaje JavaScript.

54. El lenguaje SQL y PL/SQL.

55. Manual de seguridad para operaciones con riesgo de exposición a radiofrecuencias. Accesible de esta dirección: http://www.sprl.upv.es/msradiofrecuendias1.htm
