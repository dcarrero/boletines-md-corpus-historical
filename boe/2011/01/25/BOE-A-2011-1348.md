---
identificador: "BOE-A-2011-1348"
titulo: "Resolución de 10 de enero de 2011, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación, por el sistema de concurso oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 7858
pagina_final: 7872
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1348"
url_pdf: "https://www.boe.es/boe/dias/2011/01/25/pdfs/BOE-A-2011-1348.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1348"
url_eli: ""
fetched_at: "2026-05-09T14:26:23Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 10 de enero de 2011, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación, por el sistema de concurso oposición.

Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el artículo 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público; la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector Administración especial, Técnico Superior de Apoyo a la Investigación (PF 1770), de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:
...
Valencia, 10 de enero de 2011.–El Rector, Juan Juliá Igual.

## ANEXO I

Código de Puesto: PF1770.
...
Diseño de los experimentos necesarios para la validación de dispositivos de radiofrecuencia y microondas. Caracterización y medida en la banda de radiofrecuencia y microondas de dispositivos y prototipos. Presentación de resultados e informes a los investigadores responsables.

Realización, implementación y depurado de circuitos de RF y microondas.

Realización de ensayos para la certificación de compatibilidad electromagnética de productos, en colaboración con otros grupos de investigación del Instituto.

Se responsabilizará del laboratorio de mecanizado de precisión (taller mecánico del instituto) para la realización de circuitos y estructuras de radiofrecuencia y microondas. Desarrollará procedimientos de automatización para el mecanizado de piezas, utilizando los medios disponibles (fresadora de control numérico) valiéndose de las herramientas informáticas adecuadas.

Colaborar en el desarrollo y mantenimiento del sitio Web del instituto.
...
14. El entorno de trabajo de Windows. Conexión a la red UPVNET. La Internet. Navegación. Búsquedas de información. La página web de la Universidad Politécnicad de Valencia. La Intranet. El correo electrónico. Webmail.
...
19. El espectro electromagnético. Bandas de frecuencia, uso y aplicaciones.

20. Líneas de transmisión a frecuencia de radio y microondas. Tipos y principales características.

21. Análisis de circuitos de radiofrecuencia y microondas. Parámetros de dispersión.

22. Cavidades resonantes de alta frecuencia y microondas.

23. Redes de acoplamiento de energía en circuitos de alta frecuencia. Alimentación de estructuras resonantes.

24. Filtros de radiofrecuencia y microondas.

25. Antenas. Tipos y características.

26. Antenas para aplicaciones de comunicación inalámbrica.

27. Diseño de circuitos impresos de alta frecuencia y microondas. Circuitos planares (microstrip).

28. Redes de separación de señal en líneas de transmisión. Acopladores direccionales.

29. Dispositivos de radiofrecuencia y microondas: amplificadores, aisladores, circuladores, híbridos, divisores, etc.

30. Receptores de señales de radiofrecuencia y microondas.

31. Generadores de señales de radiofrecuencia y microondas.

32. Interacción entre ondas electromagnéticas y materia. Propiedades dieléctricas.

33. Medida de propiedades dieléctricas de materiales a altas frecuencias.

34. Medida de propiedades magnéticas de materiales a altas frecuencias.

35. Medida de la conductividad eléctrica a altas frecuencias.

36. Conectores de microondas, tipos y características.

37. Analizadores vectoriales de redes. Conceptos, arquitectura y manejo.

38. Calibración de analizadores de redes.

39. Analizadores de espectros. Conceptos, arquitectura y manejo.

40. Analizador de onda estacionaria. Concepto, arquitectura y manejo.

41. Generación de calor con microondas.

42. El Horno Microondas.

43. Sistemas de microondas de alta potencia. Elementos y subsistemas.

44. Generación de microondas de alta potencia. Tipos de generadores y características.

45. El magnetrón.

46. Caracterización de dispositivos microondas en alta potencia. Medidas de potencia incidente, reflejada, transmitida y disipada.

47. Adaptación de impedancia para dispositivos microondas de alta potencia.

48. Sintonización en cavidades resonantes de alta potencia.

49. Aplicadores industriales de microondas.

50. Medida de la distribución del campo eléctrico en aplicadores de microondas.

51. Termometría infrarroja. Conceptos generales y técnicas de medida.

52. Termometría por fibra óptica. Conceptos generales y técnicas de medida.

53. Ondas electromagnéticas y salud. Límites de seguridad. SAR.

54. Medidas de emisiones radioeléctricas en la banda RF y microondas en cumplimiento de los estándares de seguridad.

55. Apantallamiento EMI. Conceptos y técnicas.

56. Compatibilidad electromagnética. Marcado CE.

57. Programación en entorno LabView.

58. Control remoto de instrumentación de medida.

59. Programación en entorno Matlab.

60. Técnicas de control automático de procesos (PID, lógica difusa, etc.).

61. Diseño de sólidos 3D en Solidworks.

62. Diseño de sólidos 3D en AutoCAD.

63. Generación de código ISO para control numérico (CNC) utilizando SolidCAM.

64. Ergonomía de oficinas. Plan de oficinas. Accesible desde: http://www.sprl.upv.es/pdf/Plandeoficinas.pdf

65. El proceso de implantación del Sistema de Gestión Ambiental en la Universidad Politécnica de Valencia.

66. Gestión de los residuos no peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable.
