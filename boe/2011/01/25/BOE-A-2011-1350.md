...
pagina_inicial: 7888
pagina_final: 7902
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1350"
url_pdf: "https://www.boe.es/boe/dias/2011/01/25/pdfs/BOE-A-2011-1350.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1350"
url_eli: ""
fetched_at: "2026-05-09T14:26:25Z"
...
Este Rectorado, de conformidad con lo dispuesto en el art. 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público; la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector Administración especial, Técnico Superior de Apoyo a la Investigación (PF 1776), de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:
...
3.4 Los derechos de examen serán de 27,09 euros, que se ingresarán en la cuenta corriente número 2077 0724 68 3100033835 –tasas–, de la Caja de Ahorros de Valencia (Bancaja) en la urbana 724, sita en la Universidad Politécnica de Valencia, Camino de Vera s/n.º, CP 46071, Valencia.
...
Código de Puesto: PF1776. Denominación del Puesto: Técnico Superior de Apoyo a la Investigación.
...
Diseño y desarrollo de equipos electrónicos específicos para sistemas de inyección y encendido en MCIA (Motores de Combustión Interna Alternativos).

Diseño y construcción de sistemas de control automatizado para salas de ensayo de motores de combustión interna alternativos e implementación de aplicaciones informáticas de control y de adquisición de datos.

Diseño y desarrollo de acondicionadores electrónicos para sensores utilizados en bancos de prueba de sistemas propulsivos.

Instalación y puesta en marcha y optimización de equipos electrónicos de control y de medida para la evaluación experimental de vehículos y/o sistemas propulsivos.

Calibración de instrumentos de medida y mantenimiento general de equipos eléctricos y electrónicos.
...
14. El entorno de trabajo de Windows. Conexión a la red UPVNET. La Internet. Navegación. Búsquedas de información. La página Web de la Universidda Politécnica de Valencia. La Intranet. El correo electrónico. Webmail.
...
19. Fundamentos de electrónica analógica, digital y de potencia.

20. Microcontroladores y dispositivos lógicos programables. Estructura interna y programación. Familias PIC de Microchip, familias FPGA de Altera o Xilinx.

21. Fundamentos de equipos electrónicos de medida y generación de señales orientados a laboratorios de ensayo de Motores de Combustión Interna Alternativos (MCIA).

22. Fundamentos de equipos y procesos de calibración de sensores y equipos de medida utilizados para la caracterización de los procesos termofluidodinámicos de MCIA.

23. Equipos electrónicos: herramientas para diseño y fabricación de circuitos impresos (Orcad 9.0 o superior), diseño digital de alta velocidad, compatibilidad electromagnética.

24. Concepción y diseño de sistemas de adquisición y tratamiento de datos de alta velocidad para ensayos de motores de combustión interna alternativos. Hardware, protocolos de comunicación para transmisión de datos, programación en lenguaje visual LabView.

25. Instrumentación electrónica: sensores para medida de magnitudes eléctricas, sensores para medida de magnitudes físicas, termometría. Acondicionamiento electrónico.

26. Control de máquinas asíncronas empleadas como dinamómetros en bancos de ensayo de sistemas propulsivos.

27. Reglamento electrotécnico de baja tensión en vigencia.

28. Concepción de instalaciones experimentales para el ensayo sobre banco de motores de combustión interna alternativos.

29. Fundamentos de sistemas de control de temperatura de los fluidos que operan en los motores de combustión interna alternativos.

30. Fundamentos del subsistema de control de inyección de combustible en motores de combustión interna alternativos diésel. Software y hardware de gestión electrónica de los sistemas de inyección.

31. Gestión electrónica del sistema de sobrealimentación de motores de combustión interna alternativo.

32. Gestión electrónica de motor de combustión interna alternativo.

33. Analizadores de emisiones gaseosas de motores de combustión interna alternativos.

34. Sistemas de calibración de sensores empleados para medir parámetros de mecánicas de sistemas propulsivos.

35. Bancos dinámicos para sistemas propulsivos.

36. Gestión electrónica de bancos de ensayo de turbomáquinas.

37. Sistemas de calibración de instrumentos de medida de parámetros termodinámicos.

38. Sistemas de control electrónico de túneles de viento subsónico.

39. Sistema de encendido electrónico de motores MEP.

40. Técnicas ópticas aplicadas al estudio fluidodinámico de sistemas propulsivos.

41. Sistema de control de bancos de ensayo de vehículos de transporte por carretera.

42. Manual de seguridad y salud para operaciones en talleres mecánicos y de motores térmicos. Accesible en esta dirección electrónica: http://www.sprl.upv.es/msmecanico1.htm.
