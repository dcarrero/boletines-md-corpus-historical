---
identificador: "BOE-A-2011-1344"
titulo: "Resolución de 30 de diciembre de 2010, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación, por el sistema de concurso oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 7804
pagina_final: 7818
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1344"
url_pdf: "https://www.boe.es/boe/dias/2011/01/25/pdfs/BOE-A-2011-1344.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1344"
url_eli: ""
fetched_at: "2026-05-09T14:26:20Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 30 de diciembre de 2010, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación, por el sistema de concurso oposición.
...
| Puntuación = | ( | (n.º aciertos) – (n.º fallos/3) 
(n.º preguntas) | ) | x 30 |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |
...
Mantenimiento de la red de datos del instituto y planificación de actuaciones relacionadas con la red, verificación, informe de fallos, solución de problemas, etc., así como el acceso a la misma por parte de los usuarios.

Ampliación y mejora del CPD del instituto: Adquisición y puesta en producción de nuevo equipamiento que mejore las prestaciones del CPD del instituto, y que aporte un valor añadido al mantenimiento por parte de los grupos. Desarrollo de acciones preventivas de fallos y de optimización energética y funcional de los recursos.

Mantenimiento y gestión de la infraestructura Grid: planificación de nuevos despliegues GRID (de ámbito local y global) genéricos, actualizando middlewares y desarrollando nuevos servicios.

Mantenimiento de la Autoridad Certificadora y de la RA de la UPV en la pkIRISGrid.

Aplicación de tecnologías Cloud Computing. Apoyo a su uso, y despliegue de infraestructuras Cloud privadas.
...
13. Ley Orgánica 1/2004, de 28 diciembre, de Medidas de Protección Integral contra la Violencia de Género. Título Preliminar.–Objeto de la Ley. Título I.–Capítulo I: En el ámbito educativo. Capítulo II: En el ámbito de la publicidad y de los medios de comunicación. Título II.–Capítulo I: Derecho a la información, a la asistencia social integral y a la asistencia jurídica gratuita. Capítulo III: Derechos de las funcionarias públicas. Titulo III.–Artículo 30. Titulo V.–Capítulo IV: Medidas judiciales de protección y de seguridad de las victimas.
...
19. Redes de Área Local. Modelo de referencia ISO. Protocolos estándares IEEE 802. Familia de Protocolos basados en Ethernet.

20. La familia de protocolos TCP/IP. Sistema de direccionamiento. Servicio de Nombres.

21. Administración de sistemas Linux en distribuciones más usuales (Fedora, Ubuntu). Ficheros de instalación y configuración. Clustering. Gestión del arranque. Configuración y compilación del kernel. Runlevels y servicios. Sistemas de paquetes. Autenticación. Configuración y políticas de seguridad. Scripts en bash.

22. Servidores FTP, Web y SVN. Herramientas, uso, configuración.

23. Clusters y supercomputadores. Conceptos, arquitecturas, instalación y aplicaciones. Integración con sistemas Grid.

24. Sistemas de ficheros distribuidos en entornos cluster.

25. Arquitectura Grid. Filosofía Grid. Conceptos de la computación en Grid, y aplicaciones.

26. Sistemas de indexación de recursos en el Grid. Index Service, MDS, Sistemas basados en P2P.

27. Sistemas de ejecución de trabajos en el Grid.

28. Workflows en el Grid.

29. Sistemas de gestión de datos en el Grid.

30. Instalación, mantenimiento y manejo de middlewares Grid (de ámbito global y de ámbito local).

31. Open Grid Service Architecture. Open Grid Forum.

32. Computación paralela en Grid.

33. Sistemas de gestión de recursos locales. Integración con sistemas grid.

34. Instalación, mantenimiento y manejo de sistemas de recursos locales.

35. Metaplanificadores, conceptos, funcionamiento.

36. Sistemas de monitorización de infraestructuras Grid.

37. Esquemas de seguridad basados en certificados X.509. Entidades Certificadoras. OpenRA, OpenCA.

38. Gestión de Organizaciones Virtuales.

39. Desktop Grids. Conceptos, aplicaciones y middlewares.

40. Gestión de infraestructuras Grid.

41. Servicios Grid. Conceptos, estructura, relaciones con los servicios tradicionales, evolución.

42. Las Iniciativas de Grid Nacionales y la Iniciativa Europea de Grid.

43. eCiencia y eInfraestructuras. Conceptos, métodos e iniciativas.

44. Sistemas de virtualización. Conceptos, aplicaciones, aplicación en el Grid.

45. Estándares en Virtualización.

46. Cloud Computing. Conceptos, arquitectura, aplicaciones. Relación con Grid.

47. Adopción, Retos y Aplicabilidad de tecnologías Cloud.

48. Migración de Instancias en Cloud Computing. Conceptos. Métodos.

49. Almacenamiento en Cloud.

50. Contextualización de imágenes virtuales en cloud. Adaptación a subredes, adaptación al host. Repositorios de imágenes virtuales.

51. Programación en entornos Cloud.

52. Nubes públicas, privadas e híbridas. Conceptos, elementos constructivos. Tecnologías asociadas.

53. Elasticidad en entornos Cloud. OpenNebula,

54. Cloud Computing para Infrastructure as a Service. Conceptos. Tecnologías. Arquitectura. Aplicaciones.

55. Cloud Computing y Platform as a Service. Conceptos. Tecnologías. Arquitecturas. Aplicaciones.

56. Software as a Service en entornos Cloud. Conceptos. Tecnologías. Arquitecturas.

57. Estructura de Amazon WS. Gestión de imágenes, despliegue de instancias. S3 y EC2.

58. Microsoft Azure cloud. Arquitectura y conceptos. Web role y worker role. Puesta en marcha de instancias.

59. Green computing. Optimización de recursos hardware, contención automática del consumo, monitorización.

60. Ergonomía en oficinas. Plan de oficinas. Accesible desde esta dirección electrónica: http://www.sprl.upv.es/pdf/Plandeoficinas.pdf.
