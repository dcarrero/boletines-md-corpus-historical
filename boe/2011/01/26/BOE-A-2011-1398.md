---
identificador: "BOE-A-2011-1398"
titulo: "Resolución de 12 de enero de 2011, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación, por el sistema de concurso oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 8090
pagina_final: 8103
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1398"
url_pdf: "https://www.boe.es/boe/dias/2011/01/26/pdfs/BOE-A-2011-1398.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1398"
url_eli: ""
fetched_at: "2026-05-09T14:29:35Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 12 de enero de 2011, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación, por el sistema de concurso oposición.

Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el art. 75 de la Ley Orgánica 6/2001 de 21 de diciembre, de Universidades así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector Administración especial, Técnico Superior de Apoyo a la Investigación (PF 1782), de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:
...
Valencia, 12 de enero de 2011.–El Rector, Juan Juliá Igual.

## ANEXO I

Código de puesto: PF1782.
...
Funciones específicas.–Las funciones están relacionadas con las instalaciones y equipamiento disponible en el laboratorio de efectos de descarga de RF y microondas:

Instalación, operación y mantenimiento de la sala limpia, sistemas de vacío e instrumentación de radiofrecuencia disponibles en el iTEAM.

Puesta a punto y coordinación de una instalación de medida de efectos de potencia (multipactor, corona e intermodulación pasiva) en dispositivos, circuitos y sistemas de radiofrecuencia.

Supervisión, planificación, desarrollo y procesado de resultados de los ensayos y medidas de los efectos de ruptura (multipactor y corona) y PIM en la sala limpia del iTEAM.

Diseño y verificación experimental de prototipos de dispositivos, circuitos y sistemas de radiofrecuencia y microondas.

Gestión para la adquisición/compra de material fungible y equipamiento del laboratorio/sala limpia. Mantenimiento del inventario. Relación con proveedores.
...
19. Análisis y Diseño CAD de circuitos, dispositivos y sistemas de radiofrecuencia.

20. Verificación Experimental de circuitos, dispositivos y sistemas de radiofrecuencia.

21. Caracterización on-wafer de dispositivos de microondas en estación de puntas.

22. Técnicas de medida para caracterización de RF-MEMS.

23. Multipactor: fundamentos teóricos y métodos de medida.

24. Corona: fundamentos teóricos y métodos de medida.

25. Intermodulación Pasiva (PIM): fundamentos teóricos y métodos de medida.

26. Elaboración de procedimientos de medida de fenómenos de descarga (multipactor y corona) e Intermodulación Pasiva en circuitos y dispositivos de radiofrecuencia causados por la alta potencia.

27. Elaboración de informes de ensayos.

28. Salas limpias para verificar prototipos de vuelo (aplicaciones espaciales) de circuitos y dispositivos de radiofrecuencia.

29. Sistemas de vacío. Principios, fundamentos y aplicaciones.

30. Principios básicos de radiación.

31. Fuentes radiactivas: operación y mantenimiento.

32. Instalación radiactiva única.

33. Analizador de redes vectorial.

34. Elementos y métodos de calibración para medidas con analizadores de redes.

35. Analizador de espectros.

36. Medidores y sensores de potencia.

37. Osciloscopios.

38. Generadores de RF.

39. Amplificadores de potencia.

40. Estación de puntas.

41. Técnicas de calibración para medidas en estación de puntas.

42. Cables y conectores para radiofrecuencia y microondas.

43. Circuitería pasiva de microondas.

44. Lenguajes de programación para control de instrumentación.

45. Programa de Simulación Electromagnética Ansoft HFSS.

46. Programa de Simulación Electromagnética CST Microwave Studio.

47. Programa de Simulación Electromagnética Ansoft Designer.

48. Programa de Simulación Electromagnética FEST3D.

49. Programa de Simulación Electromagnética Microwave Office.

50. Programa de Simulación Electromagnética Mician.

51. Lenguaje de Programación de alto nivel FORTRAN.

52. Lenguaje de Programación de alto nivel C++

53. Lenguaje de Programación de alto nivel MATLAB.

54. Bases de datos. Openoffice.org Base.

55. Procesado de textos. Openoffice.org Writer.

56. Hojas de cálculo. Openoffice.org Calc

57. Dibujo de diagramas. Openoffice.org Draw.

58. Presentaciones. Openoffice.org Impress.

59. Edición de textos en LaTeX.

60. Sistemas operativos Linux en sus distribuciones más usuales (RedHat, SuSE, Ubuntu...).

61. Sistemas de documentación, su implantación y mantenimiento.

62. Manual de seguridad para operaciones con riesgo de exposición a radiofrecuencias. Accesible en esta dirección: http://www.sprl.upv.es/msradiofrecuendias1.htm

63. El proceso de implantación del Sistema de Gestión Ambiental en la Universidad Politécnica de Valencia.

64. Gestión de los residuos no peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable.
