...
pagina_final: 10306
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1768"
url_pdf: "https://www.boe.es/boe/dias/2011/01/31/pdfs/BOE-A-2011-1768.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1768"
url_eli: ""
fetched_at: "2026-05-09T14:46:32Z"
...
Con el fin de atender las necesidades de personal en esta administración pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el art. 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector de administración especial, técnico superior de apoyo a la investigación, de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:
...
2.1 Para ser admitido a estas pruebas selectivas los aspirantes deberán reunir los requisitos siguientes:
...
## ANEXO I. Código de puesto: PF1813. Denominación del puesto: técnico superior de apoyo a la investigación. Unidad: Comisión de I+D+i. Localidad: Valencia. Catalogación del puesto: grupo A, subgrupo A1, 22 E040. Titulación: licenciatura, título de Ingeniería, de Arquitectura, grado o titulación equivalente
...
Administración, gestión, desarrollo y evaluación de plataformas de sistemas multiagente.

Administración de sistemas operativos y de servidores de web, correo electrónico y bases de satos.

Instalación de software e implementación de protocolos de seguridad.

Desarrollo de herramientas para la especificación y validación de diferentes técnicas de tecnologías del acuerdo (normas, argumentación, confianza).

Desarrollo de aplicaciones para la generación de informes de gestión del grupo de investigación.
...
19. Tecnología de agentes.

20. Modelos y arquitecturas de agente.

21. Sistemas multiagente.

22. Comunicación entre agentes.

23. Plataformas de sistemas multiagente: FIPA y JADE.

24. Negociación y confianza en sistemas multiagentes.

25. Modelos de coordinación, colaboración y cooperación en sistemas multiagente.

26. Instituticiones electrónicas.

27. Organizaciones virtuales.

28. Inteligencia artificial: representación del conocimiento.

29. Inteligencia artificial: resolución de problemas.

30. Inteligencia artificial: algoritmos de búsqueda.

31. Inteligencia artificial: juegos.

32. Inteligencia artificial: planificación.

33. Base de datos MySQL 5.0. Instalación.

34. Administración de Base de datos MySQL 5.0. Replicación. Optimización.

35. Base de datos SQL Server 2008. Instalación.

36. Administración de la base de datos SQL Server 2008. Replicación. Optimización.

37. SQL Server 2008. Analysis Services. Reporting Services.

38. Programación en PHP 5.0. Sintaxis básica. Tipos, variables y constantes. Expresiones. Estructuras de control. Funciones. Clases y objetos.

39. Programación en C++. Sintaxis básica. Tipos, variables y constantes. Expresiones. Estructuras de control. Funciones. Clases y objetos.

40. El lenguaje de programación Java: JSE5.

41. Desarrollo de aplicaciones Java.

42. Arquitectura de Java EE v.5:.Servlets, Applets, EJB, JSP y JSF.

43. Acceso a base de datos en JAVA: JDBC e Hibernate.

44. Entornos integrados de desarrollo (IDE) para Java: Eclipse v3.2.

45. Gestión de proyectos Java: Maven.

46. Seguridad en redes telemáticas, correo y servicios de internet.

47. Políticas y administración de la seguridad. Aspectos organizativos. Privacidad. Clasificación de amenazas. Administración. Dominios. Claves.

48. Programación orientada a servicios.

49. Especificación de servicios de Software.

50. Arquitecturas orientadas a servicios. Ciclo de vida de las arquitecturas orientadas a servicios. Workflows.

51. Descubrimiento de servicios.

52. Adaptación de arquitecturas orientadas a servicios.

53. Plan de oficinas. Guía del usuario: http://www.sprl.upv.es/pdf/Plandeoficinas.pdf.

54. El proceso de implantación del sistema de gestión ambiental en la Universidad Politécnica de Valencia.

55. Gestión de los residuos no peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable.
