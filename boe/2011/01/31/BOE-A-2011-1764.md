...
pagina_final: 10247
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1764"
url_pdf: "https://www.boe.es/boe/dias/2011/01/31/pdfs/BOE-A-2011-1764.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1764"
url_eli: ""
fetched_at: "2026-05-09T14:46:28Z"
...
5.2.1 Primer ejercicio.–Constará de dos partes:

Primera parte: Se realizará por escrito y versará sobre los conocimientos que se especifican en el anexo I como bloque general de la presente convocatoria.
...
6.1 El primer ejercicio se puntuará de 0 a 30 puntos.

La primera parte, tipo test, tendrá una validez del 20%. Cada pregunta contestada erróneamente tendrá una penalización de un tercio sobre las correctas y las contestaciones en blanco no puntuarán.

La fórmula de corrección será la siguiente:

| *Puntuación =* | ( | *(n.º aciertos) – (n.º fallos /*3*)* | ) | *x*6 |
| --- | --- | --- | --- | --- |
| *(n.º preguntas)* |  |  |  |  |

La segunda parte, preguntas cortas o tipo test, tendrá una validez del 80 %.

Será necesario obtener un mínimo de 15 puntos para superar este ejercicio.
...
## ANEXO I. Código de Puesto: PF1803. Denominación del Puesto: Técnico Superior de Apoyo a la Investigación. Unidad: Comisión de I+D+i. Localidad: Valencia. Catalogación del Puesto: Grupo A, Subgrupo A1, 22 E040. Titulación: Licenciatura, título de Ingeniería, de Arquitectura, grado o titulación equivalente
...
Realizar el mantenimiento de equipos informáticos aplicados a técnicas estadísticas y de análisis de la señal.

Manejo para el tratamiento del análisis de imagen y simulación y control de procesos.
...
10. Riesgos de origen químico. Instrucciones operativas relacionadas con el riesgo químico. Esta información se encuentra accesible en la siguiente dirección: http://www.sprl.upv.es

11. Organización preventiva en los departamentos. Esta información se encuentra accesible en la siguiente dirección: http://www.sprl.upv.es

12. Los equipos de trabajo. Adquisición. Aparatos de diseño y fabricación propios. Esta información se encuentra accesible en la siguiente dirección: http://www.sprl.upv.es

13. El proceso de implantación del Sistema de Gestión Ambiental en la Universidad Politécnica de Valencia. Esta información se encuentra accesible en la siguiente dirección: http://www.upv.es/medioambiente

14. Gestión de los residuos no peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable. Esta información se encuentra accesible en la siguiente dirección: http://www.upv.es/medioambiente

15. Gestión de los residuos peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable. Esta información se encuentra accesible en la siguiente dirección: http://www.upv.es/medioambiente.

16. Aguas residuales. Problemática específica de la Universidad Politécnica de Valencia. Normativa aplicable. Análisis y caracterización de las aguas residuales. Características físicas, químicas y biológicas. Esta información se encuentra accesible en la siguiente dirección: http://www.upv.es/medioambiente.

17. El plan estratégico de la Universidad Politécnica de Valencia.

18. Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal.

19. Ley Orgánica 3/07, 22 marzo, para la igualdad efectiva de mujeres y hombres: Titulo Preliminar.–Objeto y ámbito de la Ley. Titulo I.–El principio de igualdad y la tutela contra la discriminación. Titulo II.–Capítulo I: Principios Generales. Titulo IV.–Capítulo I: Igualdad de trato y de oportunidades en el ámbito laboral. Capítulo II.–Igualdad y Conciliación. Capítulo III: Los planes de igualdad de las empresas y otras medidas de promoción de la igualdad. Titulo V.–Capítulo I: Criterios de actuación de las Administraciones Públicas.

20. Ley Orgánica 1/04, de 28 diciembre, de Medidas de Protección Integral contra la Violencia de Género. Titulo Preliminar.–Objeto de la Ley. Titulo I.–Capítulo I: En el ámbito educativo. Capítulo II: En el ámbito de la publicidad y de los medios de comunicación. Titulo II.–Capítulo I: Derecho a la información, a la asistencia social integral y a la asistencia jurídica gratuita. Capítulo III: Derechos de las funcionarias públicas. Titulo III.–Artículo 30. Titulo V.–Capítulo IV: Medidas judiciales de protección y de seguridad de las victimas.

21. El entorno de trabajo de Windows. Conexión a la red UPVNET. La Internet. Navegación. Búsquedas de información. La página web de la UPV. La Intranet. El correo electrónico. Webmail.

22. La seguridad en los equipos informáticos personales. Las reglas básicas de la navegación y correo seguros. Antivirus y cortafuegos.

23. Generación de documentos básicos con Word. Edición e impresión. Formatos. Ortografía y gramática. Diseño de páginas. Tablas. Estilos. Imágenes y gráficos.

24. Cálculos elementales en Excel. Generación, edición e impresión de hojas. Operaciones básicas. Funciones. Gráficos. Generación y edición de diapositivas y presentaciones con Powerpoint.

25. La investigación en la Universidad Politécnica de Valencia. Estructura, Centros y Programas de I+D+i.

Bloque específico:

Bloque I: Métodos estadísticos y análisis de señal.

26. Teoría de procesos aleatorios. Probabilidad y variables aleatorias. Procesos aleatorios. Ergodicidad. Entropía.

27. Procesos estocásticos discretos. Funciones de distribución y de densidad de probabilidad. Procesos estocásticos discretos estacionarios y procesos ergódicos.

28. Densidad espectral de frecuencia (PSD).

29. Muestreo y procesado discreto de señales continuas.

30. La transformada discreta de Fourier

31. Filtros digitales. Aplicaciones. Ventajas e Inconvenientes. Filtros FIR. Filtros IIR. Implementación de un filtro digital. Filtros adaptativos.

32. Análisis espectral. Tipos y tecnologías de analizadores espectrales. Tipos de señales.

33. Análisis espectral de señales deterministas. Ventanas de análisis. Resolución en frecuencia. Uso de la transformada de Fourier. Muestreo en frecuencia.

34. Análisis espectral no paramétrico. Sesgo y varianza. El periodograma. Autocorrelación. Métodos no paramétricos.

35. Análisis tiempo-frecuencia.

36. Modelos paramétricos de procesos aleatorios. Modelos AR, MA y ARMA.

37. Propiedades de los procesos autorregresivos y propiedades del espectro.

38. Estimación de la frecuencia basada en el análisis de los autovalores.

39. Estimación espectral multicanal.

Bloque II: Análisis y tratamiento de imágenes.

40. La imagen. Análisis y procesado de imagen. Información contenida en la imagen. Morfometría y estereología.

41. La imagen digital. El píxel. Digitalización de la imagen. Profundidad. Resolución. El histograma de nivel de gris. Escalado de nivel de gris. Digitalización del color real.

42. Procedimiento general de trabajo en análisis de imagen asistido por computadora.

43. Medidas de análisis de imagen. Parámetros morfométricos. Parámetros densitométricos. Parámetros de campo. Parámetros de objeto.

44. Procesado de imágenes. Operaciones básicas. Métodos de modificación del histograma de gris. Operaciones aritméticas.

45. Procesado de imágenes. Filtros matriciales. Filtros de suavizado. Filtros de enfatizado.

46. Detección de bordes.

47. Segmentación. Técnicas de segmentación.

48. El tratamiento de imagen en aplicaciones médicas.

Bloque III: Simulación y control de procesos.

49. Simulación de procesos de flujo multifase gas-líquido. Los reactores de burbujeo. Tipos de regímenes de flujo y características. Fundamentos y parámetros hidrodinámicos. Aplicaciones industriales.

50. Técnicas de medida de los parámetros hidrodinámicos de un proceso multifase gas-líquido. Medida de la velocidad del gas y del líquido. Medida de la fracción de huecos.

51. Códigos termohidráulicos para la simulación de un reactor nuclear. RELAP-5.

52. Códigos termohidráulicos para la simulación de un reactor nuclear. COBRA-TF.

53. Fundamentos de la dinámica de fluidos computacional (CFD). Mapa conceptual de un proyecto con códigos de CFD. Aplicaciones de los códigos de CFD.

54. Descripción de los códigos de CFD en el mercado actual. El código ANSYS® CFX-V10.0. Descripción del código.

55. Descripción y significado de las ecuaciones que gobiernan la dinámica de fluidos. Modelos de flujo. Modelos de turbulencia.

56. Métodos numéricos para la dinámica de fluidos computacional. Técnicas de discretización numérica. Diferencias finitas y volúmenes finitos.

57. Tipos y características de mallas de un código de CFD. El mallado y sus transformaciones.

58. Técnicas de resolución numérica de problemas de flujo. Algoritmos de resolución acoplada de presión-velocidad de los códigos CFD. El algoritmo SIMPLE y el algoritmo SIMPLER.
