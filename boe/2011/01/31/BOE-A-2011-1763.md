...
pagina_final: 10232
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-1763"
url_pdf: "https://www.boe.es/boe/dias/2011/01/31/pdfs/BOE-A-2011-1763.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-1763"
url_eli: ""
fetched_at: "2026-05-09T14:46:27Z"
...
## ANEXO I. Código de puesto: PF 1797. Denominación del Puesto: Técnico Superior de Apoyo a la Investigación. Unidad: Comisión de I+D+i. Localidad: Valencia. Catalogación del puesto: Grupo A, Subgrupo A1, 22 E040. Titulación: Licenciatura, título de Ingeniería, de Arquitectura, grado o titulación equivalente
...
Diseño, instalación, desarrollo y explotación de soluciones de computación distribuida orientadas a la Bioinformática, así como la administración y desarrollo de prestaciones de servicios web.

Programación de pequeños programas (scripts) para la resolución de problemas bioinformáticos.
...
19. Bioinformática. Definición. Desarrollo histórico. Principales campos.

20. Biología molecular. Conceptos básicos. Código genético. Dogma central.

21. Técnicas fundamentales en biología molecular. Digestión con enzimas de restricción. Clonación. Reacción PCR. Hibridación de sondas.

22. Método Sanger de Secuenciación. Extracción y preparacion del DNA. Reacción de PCR Lectura de los cromatogramas.

23. Métodos de ultrasecuenciación. Tecnologías de ultrasecuenciación. Aplicaciones.

24. Ensamblaje y mapeo de secuencias. Ensamblaje de DNA genómico. Ensamblaje de DNA. Mapeo contra genoma de referencia.

25. Análisis de secuencias. Tipos de análisis. Suites de programas. Portales web.

26. Anotación de secuencias. Anotación estructural. Anotación funcional.

27. Recuperación de secuencias. Búsqueda en bases de datos. Información asociada a las secuencias.

28. Comparación de secuencias. Alineamiento de secuencias. Alineamientos múltiples.

29. Filogenia molecular. Arboles filogenéticos. Reloj molecular.

30. Estructura tridimensional de proteínas. Conceptos básicos. Métodos experimentales de determinación.

31. Bases de datos de estructura de proteínas. El Protein Data Bank. Clasificación de estructuras: CATH, SCOP.

32. Predicción bioinformática de la estructura de proteínas. Conceptos básicos.Requerimientos.

33. Modelado por homología. Conceptos básicos. Principales programas utilizados.Servidores web.

34. Reconocimiento de plegamiento. Conceptos básicos. Threading. Principales programas utilizados. Servidores web.

35. Genómica. Conceptos básicos. Microarrays. Ultrasecuenciación. Principales programas y bases de datos.

36. Proteómica. Conceptos básicos. Separación e identificación de proteínas. Principales programas y bases de datos.

37. Metabolómica. Conceptos básicos. Identificación de metabolitos. Perfil metabólico. Principales programas y bases de datos.

38. Biología de sistemas. Conceptos básicos. Librería de funciones SBML. Principales programas y bases de datos.

39. Bases de datos. Principales bases de datos en Biología. Sistemas de acceso. Interconexión de bases de datos.

40. Ontologias. Conceptos básicos. Clasificaciones ontológicas. Gene Ontology.

41. Infraestructura de hardware. Entorno físico. Infraestructura eléctrica. Sistemas de alimentación ininterrumpida.

42. Seguridad de los datos. Sistemas orientados a almacenamiento y servicio de datos. Armarios de discos. Redundancia.

43. Supercomputación. Sistemas orientados a computación. Superordenadores. Clústers de ordenadores.

44. Computación distribuida. Sistemas de gestión de colas. Políticas de asignación de nodos de computación. Computación paralela.

45. Sistema operativo Linux en bioinformática. Conceptos básicos. Ventajas e inconvenientes. Principales distribuciones.

46. Administración de Linux. Instalación. Sistema de ficheros Linux. Sistema de usuarios y permisos.

47. Instalación de programas en Linux. Espacio de usuario. Librerías y dependencias.

48. Conceptos básicos de programación. Tipos de lenguajes de programación. Variables. Estructuras de control del flujo.

49. Programación avanzada. Librerías y funciones. Programación orientada a objetos. Entornos de desarrollo integrado.

50. Expresiones regulares. Manejo de cadenas de texto. Expresiones regulares en Bioinformática.

51. Programación en bioinformática. Principales lenguajes. Librerías de funciones orientadas a Bioinformática.

52. Protección de datos. Seguridad en la Red: cortafuegos y encriptación. Control de los registros del sistema. Copias de seguridad.

53. Servidores de bioinformática. Sistema de grupos y usuarios: distribución de recursos. Arquitectura cliente-servidor y acceso remoto. Software instalado. Servidores LAMP. Servidores de escritorio.

54. Servidores de bases de datos. Sistemas de alta disponibilidad. Bases de datos relacionales. Sistemas gestores de bases de datos. Lenguaje de consulta SQL.

55. Servidores WEB. Conceptos básicos. El servidor web Apache: instalación y administración. Virtualización de servidores.

56. Servicios WEB. Conceptos básicos. Servicios web en Bioinformática. Protocolos y registros.

57. Desarrollo de paginas WEB. Lenguaje HTML. Frameworks de desarrollo web.

58. Páginas WEB dinámicas. Conceptos básicos. Formularios. Interacción con bases de datos.

59. Riesgos de origen químico.

60. Manual de Seguridad para operaciones en laboratorios de biotecnología y de tipo biológico.
