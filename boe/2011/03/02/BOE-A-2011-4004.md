---
identificador: "BOE-A-2011-4004"
titulo: "Resolución de 15 de febrero de 2011, de la Universidad de A Coruña, por la que se convocan pruebas selectivas para la provisión de plaza de Técnico Superior en Biología Molecular."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 23924
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-4004"
url_pdf: "https://www.boe.es/boe/dias/2011/03/02/pdfs/BOE-A-2011-4004.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-4004"
url_eli: ""
fetched_at: "2026-05-09T16:39:10Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 15 de febrero de 2011, de la Universidad de A Coruña, por la que se convocan pruebas selectivas para la provisión de plaza de Técnico Superior en Biología Molecular.

Debido a la necesaria provisión de una plaza vacante de Técnico Superior en Biología Molecular de la vigente relación de puestos de trabajo del personal laboral de administración y servicios, este Rectorado en el uso de las competencias que se le atribuyen en el artículo 20 de la Ley Orgánica de Universidades, así como en los Estatutos de esta Universidad resuelve:

Primero.–Convocar pruebas selectivas para cubrir una plaza de Técnico Superior en Biología Molecular (grupo I), por el turno libre.

Conforme a lo dispuesto en el artículo 22 del III Convenio Colectivo de PAS laboral de la UDC, al finalizar las pruebas selectivas se constituirán listas de espera para cubrir con carácter temporal los puestos de trabajo que puedan surgir hasta el próximo proceso selectivo. Para estos efectos las personas aspirantes deberán presentar la solicitud debidamente cubierta, indicando todos los datos que se requieren en el impreso que figura cómo anexo III, y especificando sus opciones de preferencia en cuanto a la localidad y/o al tipo de contrato.
...
La presentación de las solicitudes se hará en el Registro General de la Universidad de A Coruña (edificio de la Rectorado, calle de la Maestranza, n.º 9, CP A Coruña), en los registros auxiliares (Casa del Lagar, Campus de Elviña, A Coruña y edificio de Usos Administrativos en el Campus de Esteiro, Ferrol), o en las restantes formas previstas en el artículo 38.4.º de la Ley 30/1992, del 26 de noviembre, de régimen jurídico de las administraciones públicas y del procedimiento administrativo común («BOE» del 27 de noviembre), modificada por la Ley 4/1999, del 13 de enero («BOE» del 14).
...
a) Ser español o nacional de un estado miembro de la Unión Europea o nacional de aquellos estados a los que, en virtud de tratados internacionales suscribir por la Unión Europea y ratificados por España, les sea de aplicación a libre circulación de trabajadores en los términos en que esta está definida en el Tratado Constitutivo de la Comunidad Europea. También podrán participar el/la cónyuge, descendientes y descendientes del/de la cónyuge, de los/as españoles y de los/as nacionales de otros estados miembros de la Unión Europea, si no estuviesen separados/as de derecho, menores de veintiún años o mayores de esta edad que vivan a sus expensas. Este último beneficio será igualmente de aplicación en los tratados internacionales suscritos por la Unión Europea y ratificados por España.
...
3.2. Si en el desarrollo del proceso selectivo se le presentaran dudas al tribunal con respeto a la capacidad de las personas aspirantes con alguna discapacidad para el desempeño de las actividades que habitualmente desarrollan los trabajadores de la categoría de técnico superior en biología molecular, podrá solicitar el correspondiente dictamen del órgano competente de la Comunidad Autónoma.
...
Las personas aspirantes excluidas dispondrán de un plazo de diez días, que contará a partir de la publicación de la referida resolución, para corregir el defecto que motivara la exclusión. Una vez transcurrido el dicho plazo el rector dictará la resolución en que se declarará aprobada la relación definitiva de personas admitidas y excluidas, que será publicada en el tablón de anuncios del Rectorado de la Universidad, en el Vicerrectorado del Campus de Ferrol y en la página web de la Universidad de A Coruña.
...
Se constituirán una lista de espera, de acuerdo con lo dispuesto en el anexo V del III Convenio colectivo del personal laboral de la Universidad de A Coruña, con las personas aspirantes que no consiguieran la puntuación final suficiente para su inclusión en la relación definitiva de aprobados. En el listado se incluirán las personas que superaran todos los ejercicios de la oposición. Caso de existir fase de concurso, se sumará la puntuación obtenida en esa fase.
...
11.2. Una vez que la persona aspirante, supere las pruebas selectivas, y realice debidamente los trámites de presentación de documentos, será contratada cómo técnico superior en biología molecular.
...
De acuerdo con lo dispuesto en la disposición transitoria cuarta del III Convenio Colectivo del PAS Laboral de la UDC, de manera excepcional y al tratarse este del primero proceso selectivo para técnico superior en biología molecular tras la publicación de la RPT de 2005, se valorará cómo sigue:
...
De 30 a 49 horas: 2 puntos/curso.
...
2. Macromoléculas biológicas. Estructura y función de los ácidos nucleicos. Componentes fundamentales.

3. Métodos de extracción de ADN procedente de diversos organismos y tipos de muestras. Obtención y preparación preliminar de muestras. Tratamientos adicionales o complementarios. Conservación de muestras.

4. Métodos de extracción de ARN. Precauciones, preparación y condiciones de conservación de las muestras. Problemas habituales y posibles soluciones.

5. Electroforesis de ácidos nucleicos. Fundamento. Tipos. Electroforesis en gel de agarosa. Estimación de la concentración de ADN. Recuperación de ADN de geles de agarosa.

6. Cuantificación de ácidos nucleicos y proteínas mediante espectrofotometría. Utilización de la absorbancia y el coeficiente de extinción para el cálculo de concentraciones. Conversión de unidades.

7. Secuenciación de ADN. Fundamentos teóricos. Metodología básica. Estrategias para la secuenciación de ADN. Manejo y tipos de secuenciadores automáticos.

8. Fundamento de un secuenciador automático basado en electroforesis capilar. Diseño de experimentos.

9. Métodos para la preparación de muestras de ADN para la secuenciación. Preparación de muestras de cadena simple, de cadena doble y de productos de PCR.

10. Requisitos de las muestras y los oligonucleótidos para secuenciación. Purificación de reacciones de secuenciación.

11. Resultados de la secuenciación automática de ADN. Análisis y evaluación de datos de secuencia. Posibles errores y soluciones.

12. Análisis del tamaño de fragmentos de ADN. Fundamento, metodología y aplicaciones. Preparación de muestras.

13. Resultados del análisis de fragmentos de ADN. Análisis y evaluación de datos de fragmentos. Posibles errores y soluciones.

14. Mantenimiento y medidas de seguridad en el manejo de un analizador genético basado en electroforesis capilar.

15. Calibración espacial y espectral de los analizadores genéticos. Creación de matrices.

16. Marcadores moleculares. Ventajas e inconvenientes. Tipos de marcadores moleculares: características y clasificación. Aplicaciones.

17. Marcadores microsatélites: características, clasificación y aplicaciones. Análisis genético mediante el uso de microsatélites. Ventajas e inconvenientes.

18. Estudio de polimorfismos de ADN en medicina forense.

19. ADN mitocondrial: ventajas e inconvenientes en el análisis forense.

20. Análisis genético mediante RFLPs, RAPDs y AFLPs. Fundamento. Ventajas e inconvenientes. Aplicaciones.

21. Análisis genético mediante SNPs. Fundamento. Ventajas e inconvenientes. Aplicaciones. Técnicas de genotipado de SNPs.

22. Bioanalizador genético. Sistema automatizado de electroforesis. Fundamentos. Preparación de reactivos y chips.

23. Operaciones de análisis de un bioanalizador genético. Manejo, precauciones y mantenimiento. Aplicaciones de un bioanalizador genético. Problemas.

Módulo II:

24. PCR: la técnica de la reacción encadenada de la polimerasa. Fundamento, componentes e inhibidores.

25. Optimización de ensayos de PCR. Contaminación. Precauciones. Tipos de termocicladores. Mantenimiento de equipos de PCR.

26. Tipos de técnicas de PCR. Fundamento y aplicaciones.

27. PCR a partir de ARN. Metodología. Transcriptasas inversas.

28. PCR en tiempo real (I): Fundamento, componentes e inhibidores. Diseño y optimización de experimentos. Instrumentación.

29. PCR en tiempo real (II): Estrategias de cuantificación. Aplicaciones.

30. Requisitos del diseño de oligonucleótidos y sondas en ensayos de PCR cuantitativa. Tipos de químicas de marcaje.

31. Análisis e interpretación de resultados de PCR en tiempo real. Posibles errores y soluciones.

32. Microarrays de ADN (I): definición y clasificación de microarrays. Diseño de microarrays. Tipos de sondas y sistemas de marcaje.

33. Microarrays de ADN (II): tipos de superficie y sistemas de impresión. Aplicaciones de los microarrays de ADN.

34. Análisis de imágenes y generación de resultados procedentes de microarrays de ADN. Posibles errores y soluciones.

35. Mantenimiento y medidas de seguridad en el manejo la equipación de microarrays de ADN: sistema de impresión, estación de hibridación y escáner.

36. Riesgos y medidas de prevención en los laboratorios. Clasificación de sustancias químicas. Etiquetado. Fichas de datos de seguridad.

37. Buenas prácticas de laboratorio. Laboratorio de secuenciación de ADN.

38. Sistema de calidad en los laboratorios analíticos: Norme la ISO 17025:2005. Aspectos de gestión. Aspectos técnicos.

39. Validación de métodos analíticos. Ensayos de validación. Cálculos de incertidumbres. Cálculos de límites de detección y cuantificación.

40. Control de calidad del método. Cartas de control. Recuperaciones. Materiales de referencia.
