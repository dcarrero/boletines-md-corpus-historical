...
pagina_final: 27416
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-4475"
url_pdf: "https://www.boe.es/boe/dias/2011/03/11/pdfs/BOE-A-2011-4475.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-4475"
url_eli: "https://www.boe.es/eli/es/res/2011/02/22/(4)"
fetched_at: "2026-05-09T17:08:48Z"
...
## [precepto]Quinto. Remisión de los documentos contables a la oficina de contabilidad.
...
## [precepto]Sexto. Ordenación y pago a favor del Cajero de pagos al exterior.
...
## [precepto]Séptimo. Actuaciones del Cajero de pagos al exterior.
...
## [precepto]Octavo. Contabilización de las diferencias de cambio y de las comisiones cargadas por el Banco de España.
...
## [precepto]Noveno. Reintegros por sobrantes de pagos «a justificar» provenientes del exterior a favor del Tesoro Público.
...
## [precepto]Décimo. Justificación de los pagos.
...
| A1 
 72-18 | Número de Propuesta | Blancos. |
| A1 
 419-32 | Proponente Nif | NIF del organismo que efectúa el Pago. Su formato es ES000 + NIF. |
| N7 
...
| A5 
 81-85 | Código de Centro Gestor | Código asignado por la Dirección General del Tesoro y Política Financiera que identificará elCentro Gestor del fichero de pagos en divisas. |
| N8 
 86-93 | Fecha de referencia | Su formato será: DDMMAAAA |
| N5 
...
| A2 
 189-190 | Código País Beneficiario | Código del País del Beneficiario. |  |
| A1 
...
| A33 
 262-294 | Banco del beneficiario. 
 Código doméstico | Campo opcional. Será el código de identificación del banco en su sistema doméstico de compensación. Se admitirán los siguientes valores en función del país del banco del beneficiario: |  |
...
| GB | 6 dígitos 
 ...
 SC seguido de 6 dígitos |  |  |
| A11 
 295-305 | Banco del beneficiario. 
 Código BIC/SWIFT | BIC/SWIFT en vigor. Hay que grabar dicho código, excepto cuando el banco del beneficiario haya comunicado que no dispone de él. |  |
| A35 
...
| A2 
 411-412 | Código País Banco Beneficiario | Código del País del Banco del Beneficiario. |  |
| A34 
 ...
 - Código de país: código de dos letras especificado en la norma ISO 3166 del país en eque se encuentra el banco/sucursal que utiliza el IBAN. En España, será siempre ES. 
 ...
 Ejemplo: ES07 0012 0345 03 0000067890. |  |
| A1 
...
| A33 
 518-550 | Banco Intermediario del beneficiario. 
 Código doméstico | Campo opcional. Será el código de identificación del banco en su sistema doméstico de compensación. Se admitirán los siguientes valores en función del país del banco delbeneficiario: |  |
|  | **Código del país** | **Valores admitidos** |  |
| US | 9 dígitos 
 //FW seguido de 9 dígitos 
 FW seguido de 9 dígitos |  |  |
...
| GB | 6 dígitos 
 ...
 SC seguido de 6 dígitos |  |  |
| A11 
 551-561 | Banco Intermediario del beneficiario. 
 Código BIC/SWIFT | Campo opcional. Cuando tenga contenido deberá ser un BIC/SWIFT en vigor. |  |
| A35 
...
| A2 
 667-668 | Código País Banco Intermediario Beneficiario | Campo Opcional Código del País del Banco Intermediario del Beneficiario. |  |
| A34 
...
| N13,2 
 ...
 Se comprobará la coherencia entre el número de decimales distintos de cero de este campo yl a moneda, ya que no todas las monedas permiten el empleo de decimales: en la mayoría se aceptan hasta dos, pero en algunas no se acepta ninguno. Ejemplo: no se admitiría que un importe en yenes japoneses (moneda 392) presentara alguna cifra decimal distinta de cero. 
...
| N7 
 748-754 | Clave de autenticación | Se determina según lo establecido en las normas que se acuerden entre la Intervención General de la Administración del Estado y la Dirección General del Tesoro y Política Financiera. |  |
| N5 
...
| A1 
 ...
 - N : En caso contrario. |
| A14 
 761-774 | NIF | Su formato es ES000 + NIF |
