---
identificador: "BOE-A-2011-10734"
titulo: "Resolución de 9 de junio de 2011, de la Secretaría de Estado de Cambio Climático, sobre la evaluación de impacto ambiental del proyecto Base contra incendios helipuerto de Rabanal del Camino, León."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 64887
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-10734"
url_pdf: "https://www.boe.es/boe/dias/2011/06/20/pdfs/BOE-A-2011-10734.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-10734"
url_eli: ""
fetched_at: "2026-05-09T22:36:45Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 9 de junio de 2011, de la Secretaría de Estado de Cambio Climático, sobre la evaluación de impacto ambiental del proyecto Base contra incendios helipuerto de Rabanal del Camino, León.
...
Senda de vuelo: rumbo 80 y 290º.
...
Mantener la ubicación del helipuerto. El promotor opina que el emplazamiento actual del helipuerto es excelente para operar en lucha contra incendios al estar cerca del lugar de importancia comunitaria (LIC) Montes Aquilanos, Sierra del Teleno y a la zona de especial protección para las aves (ZEPA) Montes Aquilanos, y a los monumentos naturales Lago de Truchillas y La Baña y Las Médulas, espacios todos ellos que se pretende proteger. Por este motivo, se escoge esta segunda opción.

Localización del proyecto. El helipuerto se emplaza en el término municipal Santa Colomba de Somoza (provincia de León, Castilla y León), próximo a la entidad local menor de Rabanal del Camino. Tiene las coordenadas geográficas (WGS-84), UTM (DATUM ED 50 30T) y cota siguientes:

| Latitud | Longitud | X | Y | Z (m) |
| --- | --- | --- | --- | --- |
| 42º 28’ 51’’ N | 06º 16’ 19’’ W | 231.062 | 4.708.354 | 1.015 |
...
| Ayuntamiento de Santa Colomba de Somoza (León). | – |
...
Características del proyecto. Como se ha indicado anteriormente, la actuación no implica la realización de obras de ningún tipo, puesto que el helipuerto se encuentra construido y en funcionamiento desde el año 2007, como indica el promotor. Se trata de un helipuerto dedicado a la lucha contra incendios forestales en exclusiva.

Ubicación del proyecto. El helipuerto se ubica en el término municipal de Santa Colomba de Somoza, en la provincia de León (Castilla y León). Está situado a menos de 1 km al este del núcleo de población.

El proyecto no se sitúa sobre ningún espacio de la Red Natura 2000, encontrándose el lugar de importancia comunitaria (LIC) y la zona de especial protección para las aves (ZEPA) más próximos a aproximadamente 10 km de distancia (LIC ES4130117 Montes Aquilanos y Sierra del Teleno y ZEPA ES4130022 Montes Aquilanos).

El helipuerto no coincide espacialmente con ningún área importante para las aves (IBA), situándose, la más cercana (IBA n.° 10 Montes Aquilanos), a unos 10 km.

Además, según indica la Dirección General del Medio Natural, el helipuerto no se emplaza sobre ningún espacio incluido en el Plan de Espacios Naturales Protegidos de Castilla y León.

Por otra parte, debido a que la base ya está construida desde hace años, su superficie de ubicación se encuentra desprovista de vegetación. Cabe destacar que el helipuerto se ubica en terrenos pertenecientes al monte de utilidad pública (MUP) n.º 28 denominado Los Carrozales perteneciente a la entidad local menor de Rabanal del Camino.
...
Por otra parte, las aguas residuales se recogen en una fosa séptica, que se vaciará periódicamente cuyo traslado deberá ser gestionado por una empresa autorizada.
...
Teniendo en cuenta todo ello, y a propuesta de la Dirección General de Calidad y Evaluación Ambiental, resuelve de acuerdo con la evaluación de impacto ambiental practicada según la sección 2.ª del capítulo II, artículos 16 y 17, y el análisis realizado con los criterios del anexo III del texto refundido de la Ley de Evaluación de Impacto Ambiental de proyectos, aprobado por Real Decreto Legislativo 1/2008, no es previsible que el proyecto base contra incendios helipuerto de Rabanal del Camino (León), cumpliendo los requisitos ambientales que se desprenden de la presente resolución, vaya a producir impactos adversos significativos, por lo que no se considera necesaria la tramitación prevista en la sección 1.ª de dicha Ley.
