---
identificador: "BOE-A-2011-11081"
titulo: "Resolución de 6 de junio de 2011, de la Secretaría de Estado de Cambio Climático, sobre la evaluación de impacto ambiental del proyecto Base contra incendios helipuerto de Camposagrado, León."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 68588
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-11081"
url_pdf: "https://www.boe.es/boe/dias/2011/06/27/pdfs/BOE-A-2011-11081.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-11081"
url_eli: ""
fetched_at: "2026-05-09T22:53:39Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 6 de junio de 2011, de la Secretaría de Estado de Cambio Climático, sobre la evaluación de impacto ambiental del proyecto Base contra incendios helipuerto de Camposagrado, León.
...
Un área de aproximación final y de despegue (FATO). Su superficie no está definida. Se trata de un área de 3.500 m^2^ sobre hierba.
...
Abastecimiento de energía eléctrica mediante red.
...
Abastecimiento de agua mediante sondeo en el interior de la parcela.

Para las aguas residuales, se dispone de una fosa séptica, que se vacía periódicamente.
...
Localización del proyecto. El helipuerto se emplaza en el término municipal de Cuadros, en la provincia de León, perteneciente a la Comunidad Autónoma de Castilla y León. Tiene las coordenadas geográficas (WGS-84), UTM (DATUM ED 50 30T) y cota siguientes:

| Latitud | Longitud | X | Y | Z |
| --- | --- | --- | --- | --- |
| 42º 43’ 55’’ N | 05º 43’ 35’’ W | 276.806 | 4.734.653 | 1.130 |
...
Características del proyecto. Como se ha indicado anteriormente, la actuación no implica la realización de obras de ningún tipo, puesto que el aeródromo se encuentra construido y en funcionamiento desde hace más de 15 años, como indica el promotor. Se trata de un helipuerto de dimensiones moderadas y dedicado a la lucha contra incendios forestales en exclusiva.

Ubicación del proyecto. El helipuerto se ubica en el término municipal de Cuadros, en la provincia castellanoleonesa de León. Está situada en una zona despoblada, próximo a la entidad local menor de Camposagrado. La base se encuentra a unos 23 kilómetros al noroeste de la ciudad de León, por la carretera CL-623 dirección Caboalles.

El proyecto no se sitúa sobre ningún espacio de la Red Natura 2000, ni coincide espacialmente con ningún Área Importante para las Aves (IBA). Además, según indica la Dirección General del Medio Natural, el aeródromo no se emplaza sobre ningún espacio incluido en el Plan de Espacios Naturales Protegidos de Castilla y León.

Por otra parte, debido a que la base ya está construida desde hace años, su superficie de ubicación se encuentra desprovista de vegetación. Cabe reseñar que el helipuerto se ubica parcialmente en terrenos pertenecientes al MUP nº 112-D denominado Monte de Rioseco.

La fauna del entorno del aeródromo no es reseñable.

Se ha constatado que existe una restricción publicada en el Boletín de Información Aeronáutica (AIP) sobre la operación de helicópteros cercana a la zona señalada. Es la correspondiente al Campo de Tiro y maniobras de El Ferral, así como al polvorín de Cuadros.
...
Durante la explotación de la base, el impacto más destacable se debe a los vertidos accidentales procedentes de aeronaves y vehículos, así como a la producción de residuos. La empresa operadora de las aeronaves actúa como responsable gestora de los residuos. Por otra parte, los residuos sólidos producidos por la actividad serán gestionados por el ayuntamiento de Cuadros.
...
Por otra parte, las aguas residuales se recogen en una fosa séptica, debiendo ser tratadas por gestor autorizado.
...
Atmósfera. Calidad física y calidad química del aire. Durante la explotación, el movimiento de aeronaves genera una elevación de los niveles de presión sonora en el entorno del aeródromo. Sin embargo, el promotor considera que se trata de una afección irrelevante dada la poca frecuencia de las operaciones de despegue y aterrizaje (se calcula una media de 175 vuelos al año, diurnos y concentrados en la época estival –de mediados de junio a mediados de octubre–, y, en menor medida, en la época de peligro medio de incendios –entre mediados de febrero y mediados de abril–).

Es necesario señalar además que dada la ubicación de la base en una zona despoblada, los niveles de ruido se mantendrán en el rango de valores mínimos. Además, mediante un establecimiento adecuado de las trayectorias, de forma que sean compatibles con los vientos dominantes y con las restricciones operativas, se minimizará el potencial impacto sobre el entorno. Se prevé además la realización de un seguimiento de que los pilotos utilicen las trayectorias señaladas y establecidas.
...
Patrimonio cultural. No se espera afección derivada de la actuación sobre el patrimonio cultural, puesto que, además de que no va a remover el terreno, no se ha inventariado ningún elemento arqueológico o etnológico en el entorno de la actuación.
