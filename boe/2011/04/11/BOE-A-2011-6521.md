---
identificador: "BOE-A-2011-6521"
titulo: "Orden CUL/871/2011, de 24 de marzo, por la que se convocan subvenciones, en régimen de concurrencia competitiva, para el fomento de la traducción y edición entre lenguas oficiales españolas de obras de autores españoles, correspondientes al año 2011."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 37451
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-6521"
url_pdf: "https://www.boe.es/boe/dias/2011/04/11/pdfs/BOE-A-2011-6521.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-6521"
url_eli: ""
fetched_at: "2026-05-09T18:54:18Z"
parser_version: "boletines-md/0.1"
---

# Orden CUL/871/2011, de 24 de marzo, por la que se convocan subvenciones, en régimen de concurrencia competitiva, para el fomento de la traducción y edición entre lenguas oficiales españolas de obras de autores españoles, correspondientes al año 2011.

Según establece el artículo 14 del Real Decreto 1313/2010, de 20 de octubre, por el que se reestructuran lo departamentos ministeriales, corresponde al Ministerio de Cultura la preparación y ejecución de la política de promoción, protección y difusión del patrimonio histórico español, de los museos estatales y de las artes, del libro, la lectura y la creación literaria. En este sentido, el artículo 6 del Real Decreto 1132/2008, de 4 de julio, por el que se desarrolla la estructura orgánica básica de ese Ministerio, atribuye a la Dirección General del Libro, Archivos y Bibliotecas, entre otras funciones, la de promoción y difusión nacional e internacional de las letras españolas, así como la de creación, dotación y fomento de bibliotecas de titularidad estatal.
...
Primero. *Objeto y finalidad.*–Mediante la presente orden, se convocan para el año 2011, subvenciones, en régimen de concurrencia competitiva, a proyectos de edición de libros, de autores españoles, a traducir entre lenguas oficiales, con independencia del soporte en que se editen, de proyección nacional e internacional, que contribuyan al enriquecimiento del patrimonio bibliográfico español.

La finalidad de estas subvenciones es ampliar los fondos de las bibliotecas públicas de España y además fomentar y favorecer la comunicación y cohesión cultural entre las Comunidades Autónomas mediante la traducción entre lenguas oficiales de las obras más relevantes y la creación de un fondo bibliográfico común en todas las bibliotecas públicas.
...
2. Sobre el precio del ejemplar se aplicará el descuento máximo establecido en el artículo 11.1b) de la Ley 10/2007, de 22 de junio, de la Lectura, del Libro y de las Biblio-tecas.

Tercero. *Imputación presupuestaria.–*El importe de las subvenciones convocadas a favor de empresas será, como máximo, de 50.000 euros, con cargo a la aplicación presupuestaria 24.04.776, del programa 334B «Promoción del libro y publicaciones culturales» del presupuesto de gastos del Ministerio de Cultura para el año 2011.
...
1. Cada empresa deberá presentar una sola solicitud que contendrá uno o varios proyectos editoriales distintos. El número máximo de proyectos a presentar será del 50% de la producción editorial de la empresa en 2010 y, en todo caso, nunca podrá ser superior a 10. Los proyectos que se presenten por encima de ambos límites serán automáticamente desestimados.
...
a) Las obras que consistan en la traducción de una obra que todavía no haya sido publicada en el momento de la publicación de esta convocatoria.

b) Las obras que hayan sido presentadas consecutivamente en las dos convocatorias anteriores.

c) Los libros que vayan a ser publicados por administraciones públicas o entidades del sector público estatal, aun cuando sean editados por encargo a través de editoriales de carácter privado.

d) Los libros que vayan a ser editados por entidades sin ánimo de lucro, incluso en el caso de coedición con editoriales privadas.

e) Los libros de texto para enseñanza, las obras en fascículos, los editados por sus autores, los libros de bibliófilo y aquellos con edición limitada y numerada, los catálogos de exposiciones y los libros no venales.

f) Las reimpresiones.

g) Los anuarios, publicaciones periódicas y separatas o números monográficos de estas.

h) Los volúmenes sueltos que formen parte de una obra completa que no se comercialicen por separado.

i) Las obras que hayan sido publicadas con anterioridad al 1 de enero del año correspondiente a la convocatoria, o que tengan catalogado el número de ISBN en el ejercicio anterior.

j) Las obras que propongan un pago al traductor de castellano, gallego, catalán o valenciano del que se derive de una tarifa inferior a 35€ por 1.000 palabras para libros contemporáneos sencillos o menor a 50€ por 1.000 palabras para obras clásicas o difíciles. Igualmente no se aceptarán las propuestas de obras cuando el pago al traductor de euskera se derive de una tarifa inferior a 45€ por 1.000 palabras para libros contemporáneos sencillos o menor a 64€ por 1.000 palabras para obras clásicas o difíciles.
...
Original o copia compulsada del documento que acredite que la editorial ha adquirido los derechos para traducir y editar la obra.

Original o copia compulsada del contrato de traducción.

Un ejemplar de la obra original que se va a traducir.

Y, además, en el caso de que la obra ya haya sido traducida y editada, un ejemplar de muestra.
...
El importe de cada subvención dependerá del número de solicitudes seleccionadas y de la cuantía que para estas subvenciones se establece en el apartado tercero. Más concretamente, la ayuda individual que recibe cada proyecto será resultado de multiplicar el número de ejemplares que se propone adquirir en concepto de subvención por el precio de venta al público una vez aplicado el descuento previsto en el apartado segundo.2.
...
1. Una vez aceptada la propuesta de resolución, en el plazo de quince días, el titular de la Dirección General resolverá el procedimiento, por delegación de la Ministra, de conformidad con lo establecido en el apartado segundo.3.C) de la Orden CUL/2165/2009, de 14 de julio, de delegación de competencias del Ministerio de Cultura.

Esta orden será motivada, debiendo quedar, en todo caso, acreditados los fundamentos de la resolución que se adopte, de conformidad con lo establecido en el artículo 25.2 de la LGS.

Dicha orden, además de contener el solicitante o relación de solicitantes para los que se concede la subvención, hará constar, de manera expresa, la desestimación del resto de las solicitudes y en ella figurará el importe de la subvención y el número de ejemplares equivalentes.
...
3. Toda alteración de las condiciones tenidas en cuenta para la concesión de las subvenciones y la obtención concurrente de subvenciones, ayudas, ingresos o recursos para la misma finalidad, podrá dar lugar a la modificación de la orden de concesión, en los términos establecidos en su normativa reguladora, de acuerdo con lo previsto en el articulo 19.4 de la Ley 38/2003, de 17 de noviembre.
...
Esta orden pondrá fin a la vía administrativa, pudiendo interponerse contra la misma recurso de reposición en el plazo de un mes a contar desde su publicación, ante el mismo órgano que lo ha dictado, de acuerdo con lo dispuesto en los artículos 116 y 117 de la LRJPAC.
...
Posteriormente, conforme a las instrucciones dictadas a tal efecto por la Dirección General del Libro, Archivos y Bibliotecas, la editorial procederá a la entrega del número de ejemplares financiados de la obra, así como:

Una breve memoria de actuación que contenga una descripción del proyecto editorial (a título de ejemplo, se puede hacer una referencia sucinta al contenido y al público objetivo, incluir una biografía y bibliografía, etc.).

Una relación clasificada de los gastos e inversiones, con identificación del acreedor y del documento, su importe, fecha de emisión y, en su caso, fecha del pago, indicando las desviaciones acaecidas respecto del presupuesto indicado en la solicitud.

En este sentido, se señala que, de acuerdo con el artículo 31 LGS serán gastos subvencionables aquellos que de manera indubitada respondan a la naturaleza de la actividad subvencionada, resulten estrictamente necesarios y se realicen en el plazo establecido en el apartado anterior. A título orientativo, se considerarán subvencionables para la edición y traducción de la obra los gastos de derechos autor, traducción, diseño, preparación y marcaje, fotografía, dibujos, composición, papel, fotomecánica, impresión, encuadernación y plastificado.

Un detalle de otros ingresos o subvenciones que hayan financiado la actividad con indicación de su importe y procedencia.
...
2. Mediante Orden la resolución del procedimiento también se publicará en el Boletín Oficial del Estado.
...
Madrid, 24 de marzo de 2011.–La Ministra de Cultura, P.D. (Orden CUL/2165/2009, de 14 de julio), el Director General del Libro, Archivos y Bibliotecas, Rogelio Blanco Martínez.
