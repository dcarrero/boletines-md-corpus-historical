---
identificador: "BOE-A-2011-6130"
titulo: "Orden DEF/765/2011, de 23 de marzo, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala de Analistas y Operadores de Laboratorio del Instituto Nacional de Técnica Aeroespacial \"Esteban Terradas\", mediante el sistema de concurso-oposición, en el marco del proceso de consolidación del empleo temporal, en el ámbito del Ministerio de Defensa y sus organismos autónomos."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 34940
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-6130"
url_pdf: "https://www.boe.es/boe/dias/2011/04/05/pdfs/BOE-A-2011-6130.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-6130"
url_eli: ""
fetched_at: "2026-05-09T18:36:04Z"
parser_version: "boletines-md/0.1"
---

# Orden DEF/765/2011, de 23 de marzo, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala de Analistas y Operadores de Laboratorio del Instituto Nacional de Técnica Aeroespacial "Esteban Terradas", mediante el sistema de concurso-oposición, en el marco del proceso de consolidación del empleo temporal, en el ámbito del Ministerio de Defensa y sus organismos autónomos.
...
Este Ministerio, en uso de las competencias que le están atribuidas en el artículo 13 de la Ley 6/1997, de 14 de abril, de Organización y Funcionamiento de la Administración General del Estado, previo informe de la Dirección General de la Función Pública, acuerda convocar pruebas selectivas para ingreso en la Escala de Analistas y Operadores de Laboratorio del Instituto de Técnica Aeroespacial «Esteban Terradas», en el marco del proceso de consolidación del empleo temporal en el ámbito del Ministerio de Defensa y sus Organismos Autónomos.
...
Se convoca proceso selectivo para cubrir dos plazas de la Escala de Analistas y Operadores de Laboratorio del Instituto de Técnica Aeroespacial «Esteban Terradas», código 5321, por el sistema general de acceso libre.
...
1.1. El Tribunal calificador de este proceso selectivo es el que figura como anexo IV a esta convocatoria.
...
1.3. A efectos de comunicaciones y demás incidencias, el Tribunal tendrá su sede en el Instituto Nacional de Técnica Aeroespacial «Esteban Terradas», carretera de Torrejón a Ajalvir, km 4, 28850 Torrejón de Ardoz (Madrid), teléfono 91 5201311 ó 91 5201243, dirección de correo electrónico marinent@inta.es.
...
| --- | --- | --- | --- |
| Torrejón de Ardoz (Madrid). | 1 | Geomicrobiología de ambientes extremos. | 1 |
| Torrejón de Ardoz (Madrid). | 2 | Tecnologías de la información. | 1 |
...
La valoración de los servicios prestados como mérito en la fase de concurso únicamente se realizará si el aspirante tiene la condición de funcionario interino de la Escala de Analistas y Operadores de Laboratorio del Instituto de Técnica Aeroespacial «Esteban Terradas» en el Ministerio de Defensa y sus Organismos Autónomos, o la ha tenido en los últimos tres años, a la fecha de la finalización del plazo de presentación de solicitudes.
...
La condición de funcionario interino de la Escala de Analistas y Operadores de Laboratorio del Instituto de Técnica Aeroespacial «Esteban Terradas» del aspirante, a la fecha de finalización del plazo de presentación de solicitudes, o durante los tres años inmediatamente anteriores a esta misma fecha, siempre referido al ámbito señalado en la letra A) del apartado 2.
...
Programa 1. Geomicrobiología de ambientes extremos.

Tema 1. Microorganismos extremófilos: clasificación y características.

Tema 2. Geomicrobiología de ambientes extremos. Ambientes extremos de interés astrobiológico. Río Tinto.

Tema 3. Intervención de los microorganismos en los procesos geológicos.

Tema 4. Técnicas de análisis en geomicrobiología.

Tema 5. Técnicas microscópicas: Microscopía óptica y confocal. Preparación de muestras. Aplicaciones específicas al estudio en geomicrobiología.

Tema 6. Técnicas microscópicas: Microscopía electrónica de transmisión y barrido. Preparación de muestras. Aplicaciones específicas al estudio geomicrobiológico.

Tema 7. Cultivos de microorganismos. Técnicas de aislamiento y propagación de cultivos. Cultivo de microorganismos extremófilos.

Tema 8. Cuantificación y control del crecimiento microbiano. Cultivos anaeróbios. Cámaras de anaerobiosis. Manipulación de muestras anaerobias.

Tema 9. Colecciones de microorganismos. Métodos de identificación. Importancia de las colecciones de microorganismos. Mantenimiento de una colección de microorganismos extremófilos. Gestión y control. Micotecas.

Tema 10. Biomineralización y bioacumulación intracelular. Procesos de biomineralización en bacterias. Producción bacteriana de carbonatos (cálcico, manganeso y otros). Precipitación bacteriana de fosfatos.

Tema 11. Estructura bacteriana y mecanismos de biosorción en bacterias. Problemas de biosorción como solución a problemas medioambientales. Metales pesados.

Tema 12. Técnicas instrumentales en geomicrobiología.

Tema 13. Técnicas moleculares y ecología microbiana aplicada a la geomicrobiología.

Tema 14. Diseño y desarrollo de campañas de exploración geomicrobiológica. Equipamiento de un laboratorio astrobiológico móvil.

Tema 15. Normas de seguridad y prevención de riesgos. Riesgos específicos de exposición a agentes biológicos. Normas y buenas prácticas de trabajo en el laboratorio.

Programa 2. Tecnologías de la información.

Tema 1. Modelo conceptual de datos. Entidades, atributos y relaciones. Reglas de modelización. Diagrama de flujo de datos. Reglas de construcción. Descomposición en niveles. Flujogramas.

Tema 2. Diseño de bases de datos. Diseño lógico y físico El modelo lógico relacional. Normalización. Diseño de interfaz de usuario. Principios de diseño de interfaces. Presentación de la información y asistencia al usuario.
...
Tema 4. Lenguajes de interrogación de bases de datos. Estándar SQL.

Tema 5. Lenguajes de programación. Características, elementos y funciones básicas de Java, C, y C++.

Tema 6. Modelo simplificado de un sistema de comunicación. Elementos y funciones. Técnicas de conmutación (circuitos, paquetes y mensajes).

Tema 7. Arquitecturas de comunicación: Modelo OSI y TCP/IP. Comparación OSI vs TCP/IP.

Tema 8. Transmisión de datos: Medios de transmisión (Par trenzado, cable coaxial, fibra óptica y transmisión inalámbrica). Clasificación de señales, de datos y de las transmisiones (Simples, Half-Duplex y Full-Duplex). Dificultades de la transmisión (atenuación, ruido y distorsión de retardo).

Tema 9. Protocolos de interconexión de redes: Protocolo Internet (IP). IPv4. ICMP (Protocolo control de Internet).

Tema 10. Clasificación de redes. Redes de Área Local (LAN). Aplicaciones de redes LAN. Topologías y medios de transmisión (Bus, árbol, estrella y anillo). Interconexión de LANs (Repetidores, Concentradores, Hubs, Puentes y Switches).

Tema 11. Seguridad de la información: Requisitos. Cifrado simétrico (esquema, algoritmos y distribución de claves). Cifrado de clave pública (esquema, algoritmo, gestión de claves y firma digital).

Tema 12. Seguridad de sistemas de comunicaciones: Sistemas de cortafuegos. Sistemas de detección de intrusos. Redes Privadas Virtuales (VPN).

Tema 13. Interconexión de sistemas de las tecnologías de la información y comunicaciones que manejan información nacional clasificada en la administración: Sistemas de protección de perímetro (tipos, arquitectura y administración) e Interconexiones autorizadas.

Tema 14. Plan de adecuación del Esquema Nacional de Seguridad establecido por el Centro Criptológico Nacional.

Tema 15. Dispositivos biométricos dentro del marco de referencia establecido por el Centro Criptológico Nacional: Huella dactilar e Iris.
...
Doña Carolina de la Puerta Martín, funcionaria de la Escala de Científicos Superiores del INTA.

Don Francisco Llorente Simón, funcionario de la Escala de Titulados Técnicos Especializados del INTA.

Doña M.ª Pilar Martínez de Llera, funcionaria de la Escala de Científicos Superiores del INTA.

Tribunal suplente:

Presidente: Don Santiago López González, funcionario de la Escala de Científicos Superiores del INTA.

Secretaria: Doña Cristina Cerezo Morales, funcionaria de la Escala de Titulados Técnicos Especializados del INTA.

Vocales:

Don Carlos Ángel de León Santamaría, funcionario de la Escala de Titulados Técnicos Especializados del INTA.

Don Manuel Matilla Escribano, funcionario de la Escala de Titulados Técnicos Especializados del INTA.

Doña Cristina Mateos de Torres, funcionaria de la Escala Administrativa de OO.AA.
...
En el recuadro 15, «Cuerpo o Escala», se consignará «Escala de Analistas y Operadores de Laboratorio del INTA», y en el recuadro correspondiente a código que figura a su lado «5321».
...
En el recuadro 17, «Forma de acceso», los aspirantes que estén prestando servicios como funcionarios interinos de la Escala de Analistas y Operadores de Laboratorio del INTA en el Ministerio de Defensa consignarán necesariamente la letra «A». El resto de los aspirantes consignarán la letra «B».
