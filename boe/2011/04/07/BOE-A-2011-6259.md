---
identificador: "BOE-A-2011-6259"
titulo: "Orden TAP/806/2011, de 18 de marzo, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Técnica de Gestión de Organismos Autónomos mediante el sistema de concurso-oposición, en el marco del proceso de consolidación del empleo temporal, en el ámbito del Ministerio de Sanidad, Política Social e Igualdad y sus organismos autónomos."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 36397
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-6259"
url_pdf: "https://www.boe.es/boe/dias/2011/04/07/pdfs/BOE-A-2011-6259.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-6259"
url_eli: ""
fetched_at: "2026-05-09T18:43:11Z"
parser_version: "boletines-md/0.1"
---

# Orden TAP/806/2011, de 18 de marzo, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Técnica de Gestión de Organismos Autónomos mediante el sistema de concurso-oposición, en el marco del proceso de consolidación del empleo temporal, en el ámbito del Ministerio de Sanidad, Política Social e Igualdad y sus organismos autónomos.
...
Se convoca proceso selectivo para cubrir dos plazas de la Escala Técnica de Gestión de Organismos Autónomos Código 6000 por el sistema general de acceso libre.
...
6.3 A efectos de comunicaciones y demás incidencias, el Tribunal tendrá su sede en el Instituto Nacional del Consumo, calle Príncipe de Vergara, número 54, teléfonos 918 22 45 17 dirección de correo electrónico elena.sanchez@consumo-inc.es
...
| Localidad | Número de programa | Número plazas |
| --- | --- | --- |
| Madrid. | Consejo de la Juventud de España. | 1 |

Área Consumo

| Localidad | Número de programa | Número plazas |
| --- | --- | --- |
| Madrid. . . . . . . . . . . . . . . | Centro de Investigación y Control de Calidad. | 1 |
...
La valoración de los servicios prestados como mérito en la fase de concurso únicamente se realizará si el aspirante tiene la condición de funcionario interino de la Escala Técnica de Gestión de Organismos Autónomos en el Ministerio de Sanidad, Política Social e Igualdad y sus organismos autónomos, o la ha tenido en los últimos tres años, a la fecha de la finalización del plazo de presentación de solicitudes.
...
Los funcionarios interinos a que se refiere la letra A) del apartado 2 en caso de solicitar puntuación en la fase de concurso, deberán presentar certificación expedida por la Subdirección General de Recursos Humanos del Ministerio de Sanidad, Política Social e Igualdad o por la Secretaría General del Organismo Autónomo correspondiente.
...
Tema 2. Estadística aplicada a laboratorios. Tipos de errores. Análisis de resultados. Test estadístico. Análisis de la varianza.

Tema 3. Errores en análisis instrumental. Regresión y correlación. Recta de regresión. Error de la pendiente y ordenada en el origen de la recta de regresión.

Tema 4. Calibración en el análisis químico. Curvas de calibrado. Patrón interno. Patrón externo. Método de las adiciones estándar.

Tema 5. Sistemas de calidad. Normas de calidad aplicables a laboratorios. La Norma UNE/EN/ISO 17025. Entidades de acreditación.

Tema 6. Aseguramiento de la de calidad en laboratorios. Trazabilidad de las medidas. Ejercicios de intercomparación.

Tema 7. Validación de métodos analíticos. Criterios y parámetros de validación. Tipos y cálculo de las incertidumbres de las medidas.

Tema 8. Análisis sensorial. Paneles de cata. Atributos reglamentados.

Tema 9. Técnicas de preparación de muestras. Representatividad. Homogeneidad.

Tema 10. Mineralización por vía seca y vía húmeda. Precipitaciones. Otras técnicas preparativas. Fundamentos, instrumental y aplicaciones.

Tema 11. Sistemas de extracción: principios generales. Extracción con soxhlet, con microondas, con fluidos supercríticos. Destilación.

Tema 12. Análisis gravimétrico y volumétrico. Errores. Calibración de equipos y material.

Tema 13. Separaciones cromatográficas. Consideraciones generales. Principios fundamentales de los equilibrios cromatográficos. Tipos de cromatografías.Parámetros cromatográficos. Resolución, eficacia, selectividad.

Tema 14. Cromatografía en fase gaseosa. Principios y parámetros fundamentales. Componentes básicos del sistema cromatográfico. Métodos de calibración.

Tema 15. Cromatografía de líquidos de alta resolución. Mecanismos básicos de separación y parámetros fundamentales. Mantenimiento y verificación del sistema cromatográfico.

Tema 16. Cromatografía iónica, características diferenciales, mecanismos de separación, columnas, detectores.

Tema 17. Espectrometría de absorción molecular ultravioleta y visible. Fundamentos. Componentes básicos de los equipos. Metodología para el análisis cuantitativo. Calibración de equipos.

Tema 18. Espectrometría de Fluorescencia molecular. Fosforescencia. Quimiluminiscencia. Fundamentos. Componentes básicos de los equipos. Metodología para el análisis cuantitativo. Calibración.

Tema 19. Espectrometría de Infrarrojo. Fundamentos. Componentes básicos de los equipos. Metodología para el análisis cuantitativo. Calibración.

Tema 20. Espectrometría de emisión de Plasma. Fundamentos. Componentes básicos de los equipos. Metodología para el análisis cuantitativo. Calibración.

Tema 21. Espectrometría de absorción atómica de llama. Fundamentos. Componentes básicos de los equipos. Metodología para el análisis cuantitativo. Calibración.

Tema 22. Análisis microbiológico. Preparación de muestras y medios de cultivo. Métodos de análisis.

Tema 23. Criterios microbiológicos aplicables a los productos alimenticios.

Tema 24. Tecnología del gen. Regulación de la transcripción. Reacción en cadena de la polimerasa. Organismos modificados genéticamente en la producción alimentaria. Identificación y cuantificación.

Tema 25. Inmunoquímica. Antígenos y anticuerpos. Especificidad. Haptenos. Técnicas de detección por inmunoquímica.

Tema 26. Técnicas analíticas de electroforesis. Fundamentos. Componentes básicos del equipo. El análisis cualitativo y cuantitativo.

Tema 27. Técnicas automáticas de análisis. Tipos y fundamentos. Análisis por Inyección de flujo.

Tema 28. Hidratos de carbono. Clasificación y fuentes alimentarias. Funciones y metabolismo.

Tema 29. Lípidos. Clasificación y fuentes alimentarias. Funciones y metabolismo.

Tema 30. Proteínas. Clasificación y fuentes alimentarias. Funciones y metabolismo.

Tema 31. Vitaminas. Clasificación y fuentes alimentarias. Funciones y metabolismo. Ingestas recomendadas.

Tema 32. Minerales de interés nutricional. Clasificación y fuentes alimentarias. Funciones e Ingestas recomendadas.

Tema 33. Irradiación de los alimentos: aplicaciones, limitaciones y técnicas de detección.

Tema 34. Técnicas alternativas de conservación de alimentos.

Tema 35. Aditivos alimentarios. Definición. Regulación. Edulcorantes y colorantes.

Tema 36. Aditivos alimentarios distintos de los edulcorantes y colorantes.

Tema 37. Contaminantes bióticos de los alimentos.

Tema 38. Contaminantes abióticos de los alimentos. Metales, otras sustancias.

Tema 39. Miel. Tipos. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 40. Frutos secos y frutas desecadas. Valor nutricional. Tipos. Regulación. Parámetros a controlar. Métodos de análisis.

Tema 41. Productos de confitería. Tipos. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 42. Salsas de mesa. Tipos. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 43. Cereales y legumbres en la alimentación humana. Tipos. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 44. Alimentos estimulantes: café, té, cacao y derivados. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 45. Vinos. Tipos. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 46. Cervezas. Tipos. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 47. Bebidas espirituosas. Tipos. Parámetros a controlar. Técnicas de análisis.

Tema 48. Bebidas analcohólicas: zumos, néctares, bebidas refrescantes. Parámetros a controlar. Técnicas de análisis.

Tema 49. Aceites vegetales. Tipos. Composición. Procesos de obtención. Técnicas de identificación.

Tema 50. Grasas comestibles. Tipos. Regulación. Técnicas de identificación.

Tema 51. Leche. Componentes fundamentales.

Tema 52. Leche y productos lácteos. Tipos. Regulación. Factores de calidad. Técnicas de identificación.

Tema 53. Carne y productos cárnicos crudos y crudos curados. Tipos. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 54. Productos cárnicos tratados por el calor. Tipos. Regulación. Parámetros a controlar. Técnicas de análisis.

Tema 55. Conservas vegetales, cárnicas y de pescados.

Tema 56. Harinas y derivados. Pastas, masas, masas fermentadas.

Tema 57. Aguas de consumo público y aguas envasadas.

Tema 58. Especias y condimentos. Productos de herboristería. Factores de calidad. Técnicas de identificación.

Tema 59. Alimentos infantiles. Tipos. Parámetros a controlar. Técnicas de análisis.

Tema 60. Nuevos alimentos y nuevos ingredientes. Alimentos funcionales. Complementos alimenticios.
...
Secretaria: Elena Sánchez Díaz. E. Superior Técnicos de la Administración de la S.S.

Vocales:

Carlos Asenjo Velasco. E. Técnica de Gestión de OO.AA.
...
Presidente: Juan Francisco Babío Díaz. E. Técnica de Gestión de OO.AA., especialidad de Sanidad y Consumo.

Secretaria: Regina Fernández Duran. E. Técnica de Gestión de OO.AA.

Vocales:

Guadalupe Berzosa Trillo. E. Técnica de Gestión de OO.AA.

Ángel Blázquez de los Riscos. E. Técnica de Gestión de OO.AA.
...
En el recuadro 16, «Especialidad, área o asignatura», se consignará el área de la parte Temas específicos del anexo III por la que opta.

En el recuadro 17, «Forma de acceso», los aspirantes que estén prestando servicios como funcionarios interinos de la Escala Técnica de Gestión de Organismos Autónomos en el Ministerio de Sanidad, Política Social e Igualdad consignarán necesariamente la letra «A». El resto de los aspirantes consignarán la letra «B».
