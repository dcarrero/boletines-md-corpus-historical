...
pagina_final: 87107
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2011-13169"
url_pdf: "https://www.boe.es/boe/dias/2011/07/30/pdfs/BOE-A-2011-13169.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2011-13169"
url_eli: "https://www.boe.es/eli/es/res/2011/07/19/(3)"
fetched_at: "2026-05-10T00:47:03Z"
...
[encabezado]NORMA TÉCNICA DE INTEROPERABILIDAD DE DOCUMENTO ELECTRÓNICO
...
Anexo III. Información básica de la firma de documentos electrónicos. [fin indice]
...
[precepto]III. Componentes del documento electrónico.
...
[precepto]IV. Firma del documento electrónico.
...
[precepto]V. Metadatos del documento electrónico.
...
[precepto]VI. Formato de documentos electrónicos.
...
[precepto]VII. Intercambio de documentos electrónicos.
...
[precepto]VIII. Acceso a documentos electrónicos.
...
## [encabezado]ANEXO I. Metadatos mínimos obligatorios del documento electrónico
...
| Identificador | Identificador normalizado del documento. | 1 | Cadena de caracteres | ES_ <Órgano>_<AAAA>_<ID específico>^2^ 
 Ejemplo: ES E00010207 2010 MPR000000000000000000000010207 |
...
| Estado de elaboración | Indica la naturaleza del documento. Si es copia, este metadato indica también si se ha realizado una digitalización o conversión de formato en el proceso de generación. | 1 | Cadena de caracteres | – Original (Ley 11/2007 Ad. 30). 
...
|  |  |  |  | – Otros incautados. |
|  |  |  |  | Otros. |
| Tipo de firma | Indica el tipo de firma que avala el documento.
 En caso de firma con certificado, indica el formato de la firma. | 1:N | Cadena de caracteres | – CSV 
...
| Identificador de documento origen | Identificador normalizado del documento origen al que corresponde la copia. | 1 | Cadena de caracteres | Si el documento origen es un documento electrónico: 
 ES_<Órgano>_<AAAA>_<ID específico> 
 Ejemplo: ES–E00010207–2010 MPR000000000000000000000010207 |
...
## [encabezado]ANEXO II. Esquemas XML para intercambio de documentos electrónicos
...
[imagen]
 ...
 Metadato del documento electrónico.
 
 
 
 
 Firma basada en certificados
 
 
 Validez de la firma.
 
 
 Según reglas de validación de firma descritas en la Norma Técnica de Interoperabilidad de Política de firma y certificados de la Administración.
 
 
 
 
 Información del firmante(s) del documento (persona física, jurídica o sello de órgano).
