---
identificador: "BOE-A-2015-10137"
titulo: "Resolución de 7 de septiembre de 2015, de la Secretaría de Estado de Medio Ambiente, por la que se formula declaración ambiental estratégica conjunta de los planes Hidrológico y de Gestión del Riesgo de Inundación de la Demarcación Hidrográfica del Júcar para el periodo 2016-2021."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 83570
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2015-10137"
url_pdf: "https://www.boe.es/boe/dias/2015/09/21/pdfs/BOE-A-2015-10137.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2015-10137"
url_eli: ""
fetched_at: "2026-04-27T01:29:02Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 7 de septiembre de 2015, de la Secretaría de Estado de Medio Ambiente, por la que se formula declaración ambiental estratégica conjunta de los planes Hidrológico y de Gestión del Riesgo de Inundación de la Demarcación Hidrográfica del Júcar para el periodo 2016-2021.
...
Así ocurre en el caso de los planes Hidrológico y de Gestión del Riesgo de Inundación de la Demarcación Hidrográfica del Júcar, cuya evaluación ambiental estratégica, por procedimiento ordinario, se ha realizado según lo que establecen los artículos 17 a 25 de la Ley de Evaluación Ambiental.
...
Medidas contempladas: Los planes Hidrológico y de Gestión del Riesgo de Inundación incorporan sendos programas de medidas que integran las diversas actuaciones que cada uno de ellos requiere. En total, se contemplan 16 tipos de actuaciones que se desglosan en 52 subtipos, según se muestra en la tabla n.º 1.
...
| 01.11 | Reducción de la contaminación por vertidos de aguas de achique de mina. |  |  |
...
El presupuesto previsto conjunto total para ambos planes es de 2.297,35 millones de euros, cifra a la que se añaden 17,34 millones en concepto de otras inversiones requeridas por diversos usos ligados al agua que debieran progresar en paralelo, aunque no son medidas estrictas de los planes. No obstante, para el período de programación 2016-2021, ciclo de planificación al que apunta esta revisión antes de su siguiente actualización, el importe previsto total es de 1.304,83 millones de euros que se distribuye según se indica en la tabla n.º 2, según los grandes grupos de problemas que las medidas pretenden resolver. Las cifras que se indican para horizontes futuros tienen mero carácter informativo.
...
| --- | --- | --- | --- | --- | --- |
| Medidas Directiva Marco del Agua | 297 | 1.107,58 | 730,87 | – | 1.838,45 |
| Medidas Gestión del Riesgo de Inundación | 95 | 74,50 | – | – | 74,50 |
| Medidas de gobernanza y mejora del conocimiento | 128 | 43,62 | 30,91 | – | 74,53 |
| Inversiones para mejorar la oferta de recursos | 15 | 78,64 | 231,23 | – | 309,88 |
| Total planes | 535 | 1.304,34 | 993,01 | – | 2.297,35 |
| Inversiones requeridas por diversos usos ligados al agua | 9 | 0,49 | 16,85 | – | 17,34 |
| Total | 544 | 1.304,83 | 1.009,85 | – | 2.314,69 |
...
Ámbito: El ámbito geográfico es común a ambos planes, habiendo quedado establecido en el Real Decreto 125/2007, de 2 de febrero, por el que se fija el ámbito territorial de las demarcaciones hidrográficas. Este ámbito territorial, para el caso de la Demarcación Hidrográfica del Júcar, cubre una superficie de 44.871 km^2^, incluyendo aguas costeras y de transición, y comprende el territorio de las Comunidades Autónomas que se muestran en la tabla n.º 3.

Tabla n.º 3. Comunidades Autónomas que conforman el ámbito geográfico de la Demarcación Hidrográfica del Júcar:
...
| --- | --- | --- |
| Comunidad Valenciana | 49,42% | 90,76 % |
| Castilla-La Mancha | 37,65% | 20,26 % |
| Aragón | 12,57% | 11,26 % |
| Cataluña | 0,21% | 0,27 % |
| Región de Murcia | 0,15% | 0,57 % |
...
| 07 | Otras medidas: medidas ligadas a impactos (los dos subtipos previstos 07.01 y 07.02) |  |
...
(Nota: Previsto para la construcción de depuradoras, es decir, dentro del tipo de medidas 7).
...
(Nota: Previsto para los tipos de medidas 7).
...
g) Implantar medidas de gestión de la demanda que incrementen la eficiencia: En el mismo sentido que lo expresado en el apartado anterior, la planificación hidrológica no debe asumir incrementos del recurso disponible para dotar sistemas o unidades de demanda que no hayan alcanzado una determinada eficiencia en el uso del agua. Por ello, el Plan adopta medidas de eficiencia, en especial para el regadío que da lugar a la mayor parte del uso consuntivo en esta demarcación.

(Nota: Previsto para los tipos de medidas 12 y 19).

h) Eliminar o adaptar barreras transversales para mitigar los efectos de las presas y azudes sobre la ictiofauna y el transporte de sedimentos: La continuidad longitudinal de los ríos es un valor natural que debe ser conservado o, donde se haya perdido, recuperado. Por ello, y de conformidad con lo dispuesto en el artículo 126 bis del Reglamento del Dominio Público Hidráulico, este Plan hidrológico incorpora medidas para mejorar la continuidad fluvial.

(Nota: Previsto para el tipo de medida 4 como reducción de impactos del tipo de medidas 14).
...
| Trámite | Fecha |
| --- | --- |
| Entrada del documento inicial estratégico | 17/04/2014 |
| Inicio de consultas previas | 06/05/2014 |
...
En esta fase de información pública se recibieron 142 escritos con propuestas, observaciones o sugerencias, cuyo análisis por el promotor ha permitido identificar y materializar diversas oportunidades de mejora que aparecerán incorporadas en los documentos finales.

Los documentos Informe sobre las propuestas, observaciones y sugerencias a la propuesta de proyecto de revisión del Plan Hidrológico del ciclo de planificación hidrológica: 2015-2021 y Proyecto de plan de gestión del riesgo de inundación. Anejo 3. Resumen de los procesos de consulta pública y resultados describen las aportaciones realizadas, observaciones y sugerencias formuladas y cómo se han tomado en consideración. Están disponibles en Internet, tal y como ya se ha citado en el punto 3 de esta Declaración Ambiental Estratégica.
...
Sobre la definición de las masas de agua: La siguiente revisión del Plan, correspondiente al ciclo 2021-2027, incluirá una revisión de la identificación y caracterización de las masas de agua, tanto de agua superficial como subterránea. Esta revisión se basará en el análisis de la información recabada en los últimos años sobre diversos aspectos como son los resultados de los programas de control y seguimiento del plan, la identificación de las presiones, la actualización del registro de zonas protegidas, etc.

Asimismo, se realizará un análisis del carácter hidrológico de las masas de agua superficiales, diferenciándose si son permanentes, temporales, intermitentes y efímeros, tal como establece la Instrucción de Planificación Hidrológica. Además, en aquellas masas de agua superficiales que no presentan agua en los muestreos se diferenciará si es debido a causas naturales o antrópicas.
...
Sobre la determinación del estado de las masas de agua: El Plan Hidrológico del Júcar debe disminuir significativamente el número de masas que presentan como desconocido el estado ecológico y el estado químico.

Además, debe tenerse en cuenta que, en la determinación del estado de las masas de agua, el Plan debe considerar los resultados de la intercalibración, los nuevos estándares para las substancias prioritarias y los elementos de calidad biológicos, químicos, físico-químicos e hidromorfológicos que impone la nueva Directiva 2013/39/EU y que refleja el Proyecto de Real Decreto por el que se establecen los criterios de seguimiento y evaluación del estado de las aguas superficiales y las normas de calidad ambiental.

Asimismo, el Plan deberá incluir, al menos, indicadores hidromorfológicos que informen sobre el régimen hidrológico y, en sus siguientes revisiones, se completará con otros indicadores hidromorfológicos relativos a la continuidad fluvial. Para el caso de las aguas costeras y marinas, en el siguiente ciclo de planificación (2021-2027), la definición de nuevos indicadores hidromorfológicos se realizará de manera coordinada con los trabajos que se realicen para la actualización de la Estrategia marina de la Demarcación marina Levantino-balear, derivados del análisis de presiones hidromorfológicas en el medio costero y marino.

El Plan deberá completar los valores límite de cambio de clase del estado en las masas de agua muy modificadas para alcanzar el buen potencial ecológico.
...
Sobre el régimen de caudales ecológicos: En cuanto a los caudales ecológicos, el Plan define caudales mínimos en 185 de las 304 masas de agua tipo río. Éstos se han extrapolado a partir de los obtenidos por simulación de hábitat en 31 puntos de control estratégicos que suponen un 10% del total de las masas de agua tipo río. Este porcentaje deberá aumentarse durante este segundo ciclo de planificación (2016-2021).

Respecto a los distintos componentes del régimen de caudales ecológicos, el Plan debe exigir el cumplimiento de los caudales máximos y tasas de cambio, al menos en puntos significativos de la demarcación donde su determinación haya sido posible. Estas determinaciones deberán sin embargo completarse durante este segundo ciclo de planificación (2016-2021).

A falta de disposición general que lo regule, el control de estos caudales ecológicos debe realizarse por parte del Organismo de cuenca, pudiendo localizarse en una serie de estaciones de aforo específicas y en las principales infraestructuras. Su cumplimiento debe exigirse a todos los titulares de concesiones a escala diaria.

Sobre los objetivos ambientales: Para las masas de agua, tanto superficiales como subterráneas, en las que el cumplimiento de los objetivos ambientales requiera la utilización de las excepciones que la DMA prevé como prórrogas en el plazo de cumplimiento de los objetivos ambientales (artículo 4.4) o como definición de objetivos ambientales menos rigurosos (artículo 4.5), el Plan debe justificar adecuadamente su aplicación. Al respecto, debe señalarse que la insuficiencia presupuestaria no justifica por sí sola la aplicación de estas excepciones que debe basarse en los supuestos que indica la DMA y que, en todo caso, debe garantizarse que no haya nuevos deterioros del estado de la masa agua afectada.
...
Sobre el déficit hídrico en la demarcación y las referencias al Plan Hidrológico Nacional: El Plan considera que en los sistemas Júcar y Vinalopó-Alacantí no es posible atender con sus recursos disponibles todos los derechos de agua existentes, las redotaciones y los posibles futuros crecimientos de demanda con las adecuadas garantías y cumplir con el régimen de caudales ecológicos, estimándose un déficit hídrico de 265 hm^3^/año, que el Plan desglosa por sistemas de explotación.

El Plan remite la solución para este déficit al futuro Plan Hidrológico Nacional. En todo caso, durante el segundo ciclo de planificación, es decir antes de 2021, deberá procederse a la reevaluación del déficit, considerándose:

i. La evolución de los recursos disponibles y de los usos y derechos del agua.

ii. Los nuevos escenarios climáticos que sean aportados por la Oficina Española de Cambio Climático.
...
12. En el caso de operaciones de depuración y saneamiento, se priorizarán las medidas requeridas por la Directiva 91/271, sobre tratamiento de aguas residuales urbanas, que se encuentran señaladas en los procedimientos sancionadores incoados ante el Tribunal de Justicia de la Unión Europea y las que se han considerado no conformes por el Reino de España en el cuestionario remitido a la Comisión Europea.
...
En la siguiente revisión del Plan de gestión del riesgo de inundación, el establecimiento de medidas estructurales requerirá un análisis previo de coste-beneficio que las justifiquen.
...
Por otra parte, las actuaciones que afecten a espacios catalogados con alguna figura de protección, tales como Red Natura 2000 terrestre y marina (LIC, ZEC y ZEPA), lista de Humedales de Importancia Internacional (lista RAMSAR) recogidas en Ley 42/2007, de 13 de diciembre, del Patrimonio Natural y la Biodiversidad, deberán someterse a una evaluación específica que se realizará de acuerdo con la legislación básica estatal y la adicional de las Comunidades Autónomas donde se localicen, sin comprometer los objetivos de conservación de estos lugares.
...
Por la relevancia de sus valores medioambientales, la preservación de La Albufera de Valencia y de sus ecosistemas asociados precisa de un tratamiento singular, con un alcance y un nivel de detalle que debe ir más allá de lo que el Plan prevé, de forma general, para otras masas de agua.

Para ello, el Plan, a través del Plan Especial de la Albufera, contemplará la aplicación de medidas encaminadas a una gestión integral de La Albufera de Valencia que aseguren la compatibilidad de los usos del agua con el estricto cumplimiento de los objetivos ambientales, tanto en lo que se refiere a la DMA como a la Directiva 92/43/CEE (conocida como Directiva Hábitats). Las Administraciones públicas, en el ámbito de sus competencias, definirán un programa de medidas que contribuya a alcanzar en buen potencial ecológico. Asimismo, se hará un seguimiento de los efectos de las medidas implantadas que permitirá, si fuera necesario, modificar el objetivo ambiental definido.

Sobre el seguimiento de los usos del agua: En la siguiente revisión del Plan, es decir antes de 2021, se continuará avanzando en el conocimiento de los usos del agua. Para ello, se mejorará la identificación de las zonas de regadío en todo el ámbito de la demarcación, empleándose técnicas como la teledetección y se intensificará el control de las extracciones mediante la instalación de los correspondientes dispositivos.

Sobre el conocimiento de las masas de agua subterráneas: Debido a su repercusión en el régimen concesional, en la siguiente revisión del Plan, es decir antes de 2021, en aquellas masas de agua subterráneas donde existe incertidumbre sobre la evaluación del estado cuantitativo, se mejorará su caracterización hidrogeológica, la evaluación del recurso disponible y la estimación de las extracciones existentes. A falta de datos procedentes de las redes de control o si éstos presentan cierta incertidumbre, estos análisis se apoyarán en técnicas de modelación matemática.
...
Sobre el seguimiento ambiental y del estado de las masas de agua: El órgano sustantivo deberá realizar un seguimiento periódico de los principales efectos que la aplicación de ambos planes produce en el medio ambiente para, lo que pondrá en práctica medidas de seguimiento ambiental acordes con los principios de sostenibilidad y los objetivos ambientales e indicadores que se han propuesto durante la evaluación ambiental de los Planes, tal y como se indica en el capítulo 4 y en el Anejo II del Documento de Alcance, que fueron posteriormente concretados en el Estudio Ambiental Estratégico.

Deberá ampliarse el porcentaje de masas de agua monitorizadas en el ciclo 2015-2021, de tal forma que se asegure que son capaces de informar sobre la eficacia de la aplicación de los programas de medidas y, en especial, sobre su influencia en el cumplimiento de los objetivos ambientales.

Concretamente, los siguientes programas de seguimiento:

1. Programa de control de vigilancia de las aguas superficiales.

2. Programa de control operativo de las aguas superficiales.

3. Programa de control de zonas protegidas de las aguas superficiales.

4. Programa de control químico de vigilancia de las aguas subterráneas.

5. Programa de control químico operativo de las aguas subterráneas.

6. Programa de control del estado cuantitativo de las aguas subterráneas.

7. Programa de control de zonas protegidas de las aguas subterráneas.

Que incluyen el seguimiento de los caudales circulantes por las masas de agua superficiales continentales, a través de la Red Oficial de Estaciones de Aforos (ROEA) y Sistema Automático de Información Hidrológica (SAIH), y que deberán fundamentalmente orientarse a:
