...
pagina_final: 88634
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2015-10440"
url_pdf: "https://www.boe.es/boe/dias/2015/09/30/pdfs/BOE-A-2015-10440.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2015-10440"
url_eli: "https://www.boe.es/eli/es/l/2015/09/29/38"
fetched_at: "2026-04-27T01:52:16Z"
...
Anexo III. Contenido mínimo de la declaración sobre la red prevista en el artículo 32.[fin indice]
...
Incremento de tráfico repercutible a cada sujeto pasivo (I~EF~): se distribuirá el incremento global de tráfico respecto del tráfico de referencia a los distintos sujetos pasivos en función de la proporción de tráfico de los mismos en el ejercicio. Si T~EF~ es el tráfico realizado por una empresa ferroviaria, el incremento de tráfico repercutible a dicho sujeto pasivo será: I~EF~ = (T-Tref) × T~EF~ / T.

Cuantía objeto de bonificación de cada sujeto pasivo (CB~EF~): será resultado de aplicar a la cuantía de canon abonada por el sujeto pasivo durante el ejercicio correspondiente por las modalidades A y B, el coeficiente de proporcionalidad del incremento de tráfico repercutible al sujeto pasivo respecto del tráfico del mismo.

Por tanto: CB~EF~ = C~EF~ × I~EF~ / T~EF.~

Bonificación correspondiente a cada sujeto pasivo (B~EF~): se determinará aplicando el porcentaje de bonificación global a la cuantía objeto de bonificación de cada sujeto pasivo, es decir, B~EF~ = B × CB~EF.~
...
Canon~D~ = (C ~base~ + C ~equipamiento~) × T × K (formula d.1)

[imagen]

Donde:

C ~base~ = (Longitud de la vía × C~vía~) + (Longitud de catenaria × C~catenaria~) + (n.º desvíos × C~desvío~)
...
Canon~D~ = (C~base~ + C~equipamiento~) × T × K
...
Canon~E~ = (C~base~ + C~equipamiento~) × T × K

Donde:

| C~base~ = (Longitud de la vía × C~vía~) + (Longitud de catenaria × C~catenaria~) + (n.º desvíos × C~desvío~) + (Longitud de playa × C~playa~) |
| --- |

Componente base

| C ~Playa Tipo I (hormigón/adoquín)~ | Euros/ml-año |
| --- | --- |
| C ~Playa Tipo II (aglomerado)~ | Euros/ml-año |
| C ~Playa Tipo III (zahorras)~ | Euros/ml-año |
