...
pagina_final: 36141
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2015-4520"
url_pdf: "https://www.boe.es/boe/dias/2015/04/25/pdfs/BOE-A-2015-4520.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2015-4520"
url_eli: "https://www.boe.es/eli/es/rd/2015/04/24/319"
fetched_at: "2026-04-26T19:23:02Z"
...
| Litros entregados | Identificador Nº contrato 1^1^ | TIPO PRECIO^2^ |
| --- | --- | --- |
|  |  |  |
| Litros entregados | Identificador Nº contrato 2 | TIPO PRECIO |
|  |  |  |

| MEDIA MATERIA GRASA^3^
 (% con dos decimales) | MEDIA PROTEÍNA^4^
 (%con dos decimales) | IMPORTE TOTAL ABONADO^5^
 (€ con dos decimales) |
| --- | --- | --- |
|  |  |  |
...
| Litros entregados (A) | Identificador Nº contrato 1^6^ | TIPO PRECIO^7^ |
| --- | --- | --- |
|  |  |  |
| Litros entregados | Identificador Nº contrato 2 | TIPO PRECIO |
|  |  |  |

| Valor medio mensual del grado^8^ (% con dos decimales) | Importe total abonado^9^ (B)
 (€ con dos decimales) | Importe medio (€/L)^10^ (B/A)
 (€ con dos decimales) | Euros/hectogrado^11^
 (€ con dos decimales) |
| --- | --- | --- | --- |
|  |  |  |  |
...
| Litros entregados (A) | Identificador Nº contrato 1^1^ | TIPO PRECIO^2^ |
| --- | --- | --- |
|  |  |  |
| Litros entregados | Identificador Nº contrato 2 | TIPO PRECIO |
|  |  |  |

| Valor medio mensual del grado^3^ (% con dos decimales) | Importe total abonado^4^ (B)
 (€ con dos decimales) | Importe medio (€/L^5^ (B/A)
 (€ con dos decimales) | Euros/hectogrado^6^
 (€ con dos decimales) |
| --- | --- | --- | --- |
|  |  |  |  |
