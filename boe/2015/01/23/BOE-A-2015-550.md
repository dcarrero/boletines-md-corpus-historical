...
pagina_inicial: 4882
pagina_final: 4891
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2015-550"
url_pdf: "https://www.boe.es/boe/dias/2015/01/23/pdfs/BOE-A-2015-550.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2015-550"
url_eli: ""
fetched_at: "2026-04-26T14:58:16Z"
...
Por un grado personal 24: Dos puntos.

Por un grado personal 22 o 23: 1,5 puntos.

Por un grado personal 20 o 21: Un punto.

Por un grado personal inferior al 20: 0,5 puntos.

1.2 Valoración del trabajo desarrollado: Atendiendo a las características de los puestos desempeñados, en relación con las propias de la plaza convocada, se adjudicarán hasta seis puntos, distribuidos valorando la experiencia en el desempeño de puestos de trabajo pertenecientes a un área funcional o sectorial similar al de la plaza convocada, el grado de similitud de los puestos de trabajo ocupados por los concursantes con el de la plaza convocada, el tiempo de desempeño de dichos puestos y las aptitudes o rendimientos acreditados.
...
Para acceder a la segunda fase deberá obtenerse una puntuación mínima de ocho puntos.
...
2.1 Experiencia en gestión y mantenimiento de colecciones bibliográficas.

2.2 Conocimientos y experiencia en catalogación de monografías y publicaciones seriadas en cualquier soporte (papel, discos ópticos —CD-Rom o DVD— y en línea).

2.3 Experiencia en la atención a usuarios, búsquedas en bases de datos especializadas y en catálogos web españoles y extranjeros.

2.4 Conocimiento de servicios de información jurídica.

2.5 Idiomas, en especial alemán, inglés y francés.

2.6 Otros méritos: publicaciones relacionadas con las actividades propias de la plaza convocada, participación en eventos profesionales y similares.

Los concursantes podrán presentar, junto con su instancia para participar en el presente concurso, una memoria en la que, en relación con las funciones del Tribunal Constitucional, se formulen las consideraciones que se estimen pertinentes sobre las tareas y cometidos que a su juicio sean propios del contenido del puesto al que concursan. Esta memoria se valorará, en esta fase de méritos específicos, hasta un máximo de dos puntos.

La puntuación mínima que debe obtenerse en la segunda fase, para ser tenido en cuenta en la valoración final del concurso, será de seis puntos.
...
Denominación del puesto de trabajo: Técnico de Biblioteca (Servicio de Biblioteca y Documentación). Subgrupos A2 y C1 de las Administraciones Públicas (Art. 76, Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público). Número de puestos: Uno. Localidad: Madrid. Formación específica: Biblioteca y Documentación. Complemento de destino*: 23.660,04 euros anuales. Complemento específico: puesto sin complemento específico asignado.

Funciones más importantes: Bajo la autoridad del Letrado jefe del Servicio, el puesto de trabajo tiene asignados, en los términos que resultan adecuados a su nivel de responsabilidad, los cometidos siguientes: colaborar con los Bibliotecarios-Documentalistas en la gestión y mantenimiento de la colección bibliográfica; participar en el proceso técnico de los fondos bibliográficos y documentales en cualquier soporte, así como en el mantenimiento del catálogo bibliográfico y de autoridades; apoyar al servicio de atención e información a los lectores.
