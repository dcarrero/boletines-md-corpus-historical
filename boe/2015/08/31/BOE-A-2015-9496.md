...
pagina_final: 77477
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2015-9496"
url_pdf: "https://www.boe.es/boe/dias/2015/08/31/pdfs/BOE-A-2015-9496.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2015-9496"
url_eli: ""
fetched_at: "2026-04-27T00:51:29Z"
parser_version: "boletines-md/0.1"
---

# Orden AAA/1760/2015, de 28 de agosto, por la que se definen los bienes y los rendimientos asegurables, las condiciones técnicas mínimas de cultivo, el ámbito de aplicación, los periodos de garantía, las fechas de suscripción y los precios unitarios del seguro con coberturas crecientes para explotaciones de frutos secos, comprendido en el Plan de Seguros Agrarios Combinados para el ejercicio 2015.
...
1.ª Parcela SIGPAC: Superficie contínua del terreno identificada alfanuméricamente como tal y representada gráficamente en el registro del Sistema de Información Geográfica de Parcelas Agrícolas SIGPAC.

2.ª Recinto SIGPAC: Superficie contínua de terreno dentro de una parcela SIGPAC con un uso agrícola único de los definidos en el SIGPAC.
...
3.1 Solicitudes recibidas antes del inicio de suscripción del seguro.
...
La resolución de estas solicitudes tendrá validez para el Plan 2015 y siguientes o hasta la elaboración de una nueva base de datos.

3.2 Solicitudes recibidas durante el periodo de suscripción del seguro.

Para ello se deberá:

Formalizar la declaración de seguro a nombre del titular con el rendimiento asignado, que figura en la base de datos del Ministerio de Agricultura, Alimentación y Medio Ambiente.
...
3.3 Solicitudes recibidas después del final de suscripción del seguro.

Se debe cursar la solicitud a AGROSEGURO, en su domicilio social, C/ Gobelas, 23, 28023 Madrid, en el impreso establecido al efecto, y en el que se deberán consignar el nombre o la razón social del solicitante, su NIF o CIF, su domicilio, el código postal y el teléfono.

La resolución de estas solicitudes tendrá validez para el Plan 2016 y siguientes o hasta la elaboración de una nueva base de datos.
...
5.1 Revisiones de oficio de la base de datos por el Ministerio de Agricultura, Alimentación y Medio Ambiente.
...
5.2.1 Solicitudes recibidas antes del inicio de suscripción del seguro.

AGROSEGURO remitirá a ENESA la propuesta de revisión en un plazo de 50 días desde el inicio del período de suscripción.

La resolución de la solicitud, se comunicará por el Ministerio de Agricultura, Alimentación y Medio Ambiente a AGROSEGURO, en un plazo no superior a 70 días contados a partir del inicio del período de suscripción.

AGROSEGURO comunicará por escrito al asegurado el resultado de la revisión efectuada.

5.2.2 Solicitudes recibidas durante el periodo de suscripción del seguro.

AGROSEGURO remitirá a ENESA la propuesta de revisión en un plazo de 50 días desde el final de período de suscripción.

La resolución de la solicitud, se comunicará por el Ministerio de Agricultura, Alimentación y Medio Ambiente a AGROSEGURO, en un plazo no superior a 70 días contados a partir de la finalización del período de suscripción.
...
5.2.3 Solicitudes recibidas después del final de suscripción del seguro.

Las solicitudes se resolverán agrupándolas según fechas de recepción:

a) Solicitudes recibidas hasta el 30 de abril:

AGROSEGURO remitirá a ENESA la propuesta de revisión en un plazo de 50 días desde el 30 de abril.

La resolución de la solicitud, se comunicará por el Ministerio de Agricultura, Alimentación y Medio Ambiente a AGROSEGURO, en un plazo no superior a 70 días contados a partir del 30 de abril.

AGROSEGURO comunicará por escrito al asegurado el resultado de la revisión efectuada.

b) Solicitudes desde el 1 de mayo hasta el inicio del periodo de suscripción del Plan siguiente:
...
La resolución de la solicitud, se comunicará por el Ministerio de Agricultura, Alimentación y Medio Ambiente a AGROSEGURO, en un plazo no superior a 70 días contados a partir del inicio del período de suscripción del Plan siguiente.
...
a) Inicio de garantías: Las garantías se inician con la toma de efecto de la declaración de seguro complementario y nunca antes de que el cultivo alcance el estado fenológico «fruto de 20 mm.»
...
Teniendo en cuenta los periodos de garantía anteriormente indicados y lo establecido en el Plan de Seguros Agrarios combinados para el ejercicio 2015, el periodo de suscripción será el siguiente:

1. Seguro principal:

a) Módulos 1 y 2 para almendro.

Inicio de la suscripción: 1 de septiembre de 2015.

Finalización del periodo de suscripción: 30 de noviembre de 2015.

b) Módulos 1 y 2 para el resto de cultivos.

Inicio de la suscripción: 1 de marzo de 2016.

Finalización del periodo de suscripción: 15 de mayo de 2016.

c) Módulo P.

Inicio de suscripción: 1 de marzo de 2016 para todos los cultivos.

Finalización del periodo de suscripción: 15 de mayo de 2016 para todos los cultivos.

2. Seguro complementario:

Inicio de la suscripción: 1 de marzo de 2016.

Finalización de la suscripción: 15 de mayo de 2016.
...
(1) Los daños en plantación a consecuencia del riesgo de sequía están cubiertos únicamente para el cultivo de almendro en las parcelas de aquellos asegurados que hayan contratado este seguro el plan anterior en los Módulos 1 o 2 y vuelvan a estar aseguradas en los Módulos 1 o 2 por el mismo asegurado en el presente plan.
...
a) Datos procedentes del aseguramiento en el seguro de rendimientos de almendro en las cosechas 2004 a 2011 y del seguro combinado de almendro de las cosechas 2004 a la cosecha 2011.

b) Datos procedentes del aseguramiento en la tarifa general combinada en las cosechas 2004 a 2007.

c) Datos procedentes del aseguramiento en el seguro con coberturas crecientes para explotaciones de frutos secos, para el cultivo del almendro, de las cosechas 2012 y 2013.
...
a) Las que en la serie de cosechas 2009 a 2013, han asegurado al menos tres de ellas en el seguro combinado de almendro o en el Módulo P para dicho cultivo, del seguro con coberturas crecientes para explotaciones de frutos secos.

b) Las que en la serie de cosechas 2009 a 2013, han asegurado al menos una de ellas en el seguro de rendimientos de almendro o en los módulos 1 o 2 del seguro con coberturas crecientes para explotaciones de frutos secos.

3. Cálculo de los rendimientos máximos asegurables.

3.1 Cálculo del rendimiento medio.

El cálculo del rendimiento medio, para las explotaciones incluidas de forma expresa en la Base de Datos de almendro, se ha obtenido mediante media aritmética de los rendimientos obtenidos en las cosechas aseguradas en la serie comprendida entre las cosechas 2004 a 2013, ambas incluidas. En el caso de que en la serie anterior se hayan contratado menos de tres cosechas, el rendimiento medio asignado será el que figuraba para esas explotaciones en la Base de Datos del Plan de Seguros Agrarios Combinados para el ejercicio 2012.

Los rendimientos así calculados, han sido objeto de corrección cuando el nivel de riesgo de la explotación supera el 21 por ciento o cuando entre las cosechas 2004 a 2013 solamente se dispone de dos años de aseguramiento y además en ambas cosechas ha existido indemnización por resto de riesgos.
...
| Campo Níjar y Bajo Andarax. | Almería, Carboneras, Níjar, Viator. |  |
...
| Producción. | Almendro. | Pedrisco. | Fruto 20 mm. | 31 de octubre de 2016. |
| Riesgos excepcionales. |  |  |  |  |
| Resto de adversidades climáticas (1). | 1 de noviembre de 2015. |  |  |  |
| Avellano. | Pedrisco. | 1 de mayo de 2016. | 15 de agosto de 2016. |  |
| Riesgos Excepcionales. | Incendio. | 1 de mayo de 2016. | 15 de octubre de 2016. |  |
| Fauna silvestre. |  |  |  |  |
| Inundación-Lluvia torrencial. |  |  |  |  |
| Lluvia persistente. | 1 de julio de 2016. | 15 de octubre de 2016. |  |  |
| Viento huracanado. | 1 de julio de 2016. | 15 de agosto de 2016. |  |  |
| Resto de adversidades climáticas. | 1 de julio de 2016. | 15 de agosto de 2016. |  |  |
| Algarrobo, Nogal y Pistacho. | Pedrisco.
 Riesgos excepcionales.
 Resto de adversidades climáticas. | 15 de mayo de 2016. | 15 de noviembre de 2016. |  |
...
| Especie | Variedad | Precio mínimo
 ...
 €/100kg |
| --- | --- | --- | --- |
| Avellano. | Negreta. | 104 | 156 |
| Resto de variedades. | 95 | 144 |  |
| Variedades de cultivo ecológico. | 120 | 180 |  |
| Algarrobo. | Todas las variedades. | 16 | 25 |
| Variedades de cultivo ecológico. | 20 | 30 |  |
| Almendro (con cáscara). | Marcona, Desmayo Largueta. | 85 | 130 |
| Resto de variedades. | 73 | 110 |  |
| Variedades de cultivo ecológico. | 112 | 170 |  |
| Nogal (nueces con cáscara). | Todas las variedades. | 155 | 230 |
| Variedades de cultivo ecológico. | 165 | 250 |  |
| Pistacho (con cáscara). | Todas las variedades. | 180 | 270 |
| Variedades de cultivo ecológico. | 195 | 295 |  |
...
| Especie | Variedad | Precio mínimo
 ...
 (€/ud.) |
| --- | --- | --- | --- |
| Pistacho | Todas las variedades | 6 | 10 |
