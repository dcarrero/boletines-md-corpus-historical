...
pagina_final: 33896
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2016-4870"
url_pdf: "https://www.boe.es/boe/dias/2016/05/21/pdfs/BOE-A-2016-4870.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2016-4870"
url_eli: ""
fetched_at: "2026-04-23T16:24:26Z"
parser_version: "boletines-md/0.1"
---

# Resolución 452/38064/2016, de 17 de mayo, de la Subsecretaría, por la que se convocan procesos de selección para el ingreso en los centros docentes militares de formación, mediante las formas de ingreso directo y promoción, sin exigencia de titulación universitaria previa, para la incorporación como militar de carrera a la Escala de Oficiales del Cuerpo Militar de Sanidad, especialidad fundamental Medicina.
...
| Oficiales y Suboficiales (3)
 ...
 de Carrera
 (c) |  |  |  |  |  |
| Escala de Oficiales del Cuerpo Militar de Sanidad (Medicina) | Con | 060 | 2 | 1 | 1 | 0 | 4 |
| Sin | 23 | 1 | 1 | 1 | 26 |  |  |
| Total…………….……………………………………….......... | 25 | 2 | 2 | 1 | 30 |  |  |
...
Cuando se aporte la PAU solo será válida la nota de la PAU obtenida en convocatoria ordinaria (primera convocatoria) del año 2016 o en convocatorias, ordinarias o extraordinarias, de años anteriores.
...
1.1.1 Solicitud de admisión a los procesos de selección para la incorporación como militar de carrera a la Escala de Oficiales del Cuerpo Militar de Sanidad, especialidad fundamental Medicina, sin exigencia de titulación universitaria previa. Apéndice 1.
...
Se deberá indicar, marcando con una «X», en la casilla que corresponda del apartado C «Forma de ingreso», cual es forma de ingreso por la que opta. En el caso de optar a plazas para varias formas de ingreso (ingreso directo, promoción cambio de escala o promoción cambio de cuerpo), deberá manifestar su preferencia en la casilla que corresponda con un número ordinal (1º, 2º).

Se deberá indicar, marcando con una «X» en la casilla correspondiente del apartado D «Oferta de plazas a las que se presenta», la oferta de plazas por las que opta: «SIN créditos superados de la titulación de Medicina» o «CON créditos superados». En el caso de que opte a las dos ofertas de plazas, deberá manifestar su preferencia en cada casilla con un número ordinal (1.º, 2.º). Las opciones de ingreso manifestadas solo podrán ser modificadas o anuladas por el interesado y exclusivamente dentro del plazo de presentación de las mismas. Para ello, solicitará al Director General de Reclutamiento y Enseñanza Militar la correspondiente anulación o realizará otra solicitud que anulará la anterior. Asimismo, quien no cumplimente ninguna opción de ingreso será excluido del proceso de selección.
...
– Certificación relativa a la condición de demandante de empleo, que puede haberse obtenido por medios telemáticos, si el aspirante autorizó a ello en el el apartado G de la solicitud. No obstante, el resto de los requisitos señalados deberán ser certificados por la oficina del Servicio Público de Empleo correspondiente.
...
1.4 Presentación hasta el día 15 de julio, para poder participar en el proceso de selección sin créditos superados:
...
En el caso de alumnos procedentes de sistemas educativos de otros países, se presentará original o copia compulsada de la credencial de convalidación de la prueba de acceso del país origen con la prueba de acceso a la universidad española, no aceptando procedimientos pendientes de resolución.
...
1.5 Presentación hasta el día 22 de julio, para poder participar en el proceso de selección con créditos superados: Créditos superados de la titulación de Medicina.
...
Los aspirantes deberán finalizar las pruebas y superar las marcas de las pruebas físicas recogidas en el apéndice 10. Cuando para el ingreso se requiera tener créditos superados, las pruebas a realizar y marcas a superar por el aspirante en el proceso de selección serán las siguientes:

1.º Cuando se tengan superados entre 120 y 179 ECTS o, en su caso, entre 160 y 249 créditos de la titulación de licenciado en Medicina, serán las que figuran para superar segundo curso de la enseñanza de formación.

2.º Cuando se tengan superados entre 180 y 239 ECTS o, en su caso, entre 250 y 339 créditos de la titulación de licenciado en Medicina, serán las que figuran para superar tercer curso de la enseñanza de formación.

3.º Cuando se tengan superados más de 240 ECTS o, en su caso, más de 340 créditos de la titulación de licenciado en Medicina, serán las que figuran para superar cuarto curso de la enseñanza de formación.
...
«A» es el número de preguntas acertadas.

«E» es el número de errores,

«n» es el número de opciones presentadas como solución.

«P» es la puntuación obtenida en el correspondiente ejercicio; no contabilizando las respuestas en blanco como errores.
...
1. La calificación final y posterior ordenación de los aspirantes del proceso de selección, se efectuará conforme a la aplicación de las siguientes formulas:
...
Los militares profesionales que tengan que presentarse en fecha posterior al día 1 de septiembre de 2016, continuarán en su misma situación militar y destino hasta la fecha que le indique la Subdirección General de Enseñanza Militar.
...
El plan de estudios de los alumnos que accedan a las plazas ofertadas según la disposición adicional cuarta del Real Decreto 35/2010, de 15 de enero, y la disposición transitoria tercera de la Orden DEF/689/2012, de 30 de marzo (acceso con créditos superados), se aprobará una vez efectuado el reconocimiento de créditos por la comisión de docencia, y se distribuirá entre un mínimo de tres (3) cursos académicos, y un máximo de cinco (5), en función de los ECTS reconocidos.
