...
pagina_final: 91405
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2016-12487"
url_pdf: "https://www.boe.es/boe/dias/2016/12/30/pdfs/BOE-A-2016-12487.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2016-12487"
url_eli: "https://www.boe.es/eli/es/res/2016/12/28/(2)"
fetched_at: "2026-04-24T08:13:33Z"
...
a) Consumidores con peaje de acceso 2.0 A y 2.1 A y equipos de medida de un solo período (Perfil tipo P^a^).
...
[imagen] = Perfil Inicial, de la categoría de clientes «i», para el mes «m», día «d» y hora «h», que representa el peso relativo de la hora en el año.

[imagen]Suma de los coeficientes del Perfil Inicial de la categoría de clientes «i» en las 24 horas de un día.

[imagen]; Peso de la hora «h» del día «d» del mes «m», en el total del día «d» del mes «m».

[imagen]; Peso del mes «m», en el año en el Perfil Inicial.

[imagen] = Demanda del Sistema en la hora «h» del día «d» del mes «m».

[imagen]= Demanda de Referencia en la hora «h» del día «d» del mes «m».

[imagen], [imagen], [imagen] = Coeficientes específicos para cada categoría de clientes «i».

[imagen], [imagen], [imagen] y [imagen], tienen el mismo significado que los anteriores pero referidos a los Perfiles Finales, en lugar de a los Perfiles Iniciales.

[imagen], [imagen] y [imagen] tomarán en 2017 los valores recogidos en el anexo II de la presente Resolución.
...
[imagen]= Medida incremental obtenida del contador del cliente «c», entre el día «t» del mes «j» y el día «T» del mes «J» correspondiente al bloque horario «p».

[imagen]= Medida horaria calculada del cliente «c» con perfil «i», en la hora «h» del día «d» mes del «m» correspondiente al bloque horario «p» registrado por el equipo de medida.

[imagen] = número de días del mes «m»
