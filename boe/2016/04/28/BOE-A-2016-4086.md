---
identificador: "BOE-A-2016-4086"
titulo: "Orden AAA/614/2016, de 19 de abril, por la que se definen las explotaciones y animales asegurables, las condiciones técnicas mínimas de explotación y manejo, el ámbito de aplicación, el periodo de garantía, el periodo de suscripción y el valor unitario de los animales en relación con el seguro de explotación de ganado porcino, comprendido en el trigésimo séptimo Plan de Seguros Agrarios Combinados."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 28558
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2016-4086"
url_pdf: "https://www.boe.es/boe/dias/2016/04/28/pdfs/BOE-A-2016-4086.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2016-4086"
url_eli: ""
fetched_at: "2026-04-23T14:50:18Z"
parser_version: "boletines-md/0.1"
---

# Orden AAA/614/2016, de 19 de abril, por la que se definen las explotaciones y animales asegurables, las condiciones técnicas mínimas de explotación y manejo, el ámbito de aplicación, el periodo de garantía, el periodo de suscripción y el valor unitario de los animales en relación con el seguro de explotación de ganado porcino, comprendido en el trigésimo séptimo Plan de Seguros Agrarios Combinados.
...
Para la garantía adicional de enfermedad de Aujeszky, las explotaciones deberán estar calificadas como A4 (oficialmente indemnes).
...
1. Las condiciones técnicas mínimas de explotación, comunes a todos los regímenes de ganado porcino intensivo, que deben reunir las instalaciones de las explotaciones de ganado porcino serán las establecidas en los artículos 4, 5, 6 y 7 del Real Decreto 324/2000, de 3 de marzo, por el que se establecen normas básicas de ordenación de las explotaciones porcinas. Además, a efectos del seguro, deberán:
...
3.º Sistemas de hidrólisis, en explotaciones cuyo material hidrolizado será retirado por la empresa o empresas gestoras autorizadas para el Sistema de Seguros Agrarios por la autoridad competente de su comunidad autónoma. Las explotaciones deben contar con la autorización pertinente.

m) Todos los vehículos de retirada contarán con un sistema automático de pesaje en kilogramos; por tanto, en todos los servicios que realicen deberán registrar fehacientemente el peso de los animales recogidos.
...
6. En caso de deficiencia en el cumplimiento de las condiciones técnicas mínimas de explotación y manejo, el asegurador podrá reducir la indemnización en proporción a la importancia de los daños derivados de la misma y el grado de culpa del asegurado.
...
Teniendo en cuenta lo establecido en el Trigésimo séptimo Plan de Seguros Agrarios Combinados, el período de suscripción del seguro de explotación de ganado porcino se iniciará el 1 de junio de 2016 y finalizará el día 31 de mayo de 2017.
...
Valor limite de los animales a efectos de indemnización (expresado en porcentajes sobre el valor unitario, en euros por animal o en euros por animal y semana, según se indique)

Grupo de razas selecto o puro

| Régimen | Centros de inseminación | Ciclo cerrado o mixto |  |
| --- | --- | --- | --- |
| Tipo de animal | Reproductor selecto macho | Reproductor | Animales de cebo y recría intensiva |
...
| Limpieza y desinfección. Límite máximo en porcentaje sobre valor unitario | 8% | 8% | 8% |

Grupo de razas de cerdo blanco

| Régimen | Producción de lechones | Ciclo cerrado o mixto | Cebo/ recría intensivo | Transición de lechones |  |
| --- | --- | --- | --- | --- | --- |
| Tipo de animal | Reproductores | Reproductores | Animales de cebo y recría intensiva | Animales de cebo y recría intensiva | Animales de transición |
...
| Limpieza y desinfección. Limite máximo en porcentaje sobre valor unitario. | 8% | 8% | 8% | 8% | 8% |

Grupo de razas raza Ibérica y machos de raza Duroc y raza celta

| Régimen | Producción de lechones | Ciclo cerrado o mixto | Cebo/ recría intensivo | cebo extensivo |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| Tipo de animal | Reproductor | Reproductor | Animales de cebo y recría intensiva | Cebo extensivo | Animales de cebo y recría intensiva | Animales de cebo extensivo |
...
| Limpieza y desinfección. Limite máximo en porcentaje sobre valor unitario. | 8% | 8% | 8% | 8% | 8% | 8% |

## ANEXO IX. Garantía adicional de decomiso en matadero

Solo para animales de cebo extensivo

(Expresado en porcentaje sobre el valor unitario)

| % Valor Unitario de animal / canal decomisada totalmente |
| --- |
| 90 % |
