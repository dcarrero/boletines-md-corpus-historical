---
identificador: "BOE-A-2012-7229"
titulo: "Resolución de 16 de mayo de 2012, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 39296
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2012-7229"
url_pdf: "https://www.boe.es/boe/dias/2012/05/31/pdfs/BOE-A-2012-7229.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2012-7229"
url_eli: ""
fetched_at: "2026-05-07T15:33:35Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 16 de mayo de 2012, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación.

Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el art. 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público y la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector de administración especial, técnico superior de apoyo a la investigación de la Universitat Politècnica de València (Código: 2012/P/FC/C/11), con arreglo a las siguientes bases:
...
Valencia, 16 de mayo de 2012.–El Rector, Juan Juliá Igual.

ANEXO I

Código de puesto: PF1817.

Unidad: Comisión I+D+i.
...
De acuerdo con el Real Decreto 1021/2005, de 10 de octubre, sobre protección de los animales utilizados para experimentación y otros fines científicos y el Decreto 13/2007, de 26 de enero, de Protección de animales utilizados para experimentación y otros fines científicos en la Comunidad Valenciana, se deberá acreditar la competencia de formación necesaria establecida en los mismos para llevar a cabo las funciones contenidas en esta convocatoria.

Para quienes hayan superado las pruebas selectivas y no pudieran acreditar esta formación, la Universidad establecerá el periodo máximo en el que se deberá acreditar la misma.
...
▪ Síntesis y caracterización de análogos estructurales de contaminantes orgánicos.

▪ Supervisión y manejo de animales de experimentación.

▪ Desarrollo y aplicación de anticuerpos (monoclonales y recombinantes), inmunoensayos y biosensores para contaminantes orgánicos.

▪ Participación en la difusión de resultados de las investigaciones en memorias, libros y artículos científicos en castellano e inglés.
...
19. Las moléculas orgánicas: Estructura, nomenclatura y propiedades.

20. Los grupos funcionales de las moléculas orgánicas: Síntesis y reactividad.

21. Síntesis orgánica: Planificación y estrategias; grupos protectores de grupos funcionales; purificación de productos de síntesis orgánica.

22. Espectroscopía ultravioleta-visible: Aplicación a la caracterización de compuestos orgánicos.

23. Espectroscopía de resonancia magnética nuclear: Aplicación a la caracterización de compuestos orgánicos.

24. Espectroscopía infrarroja: Aplicación a la caracterización de compuestos orgánicos.

25. Espectrometría de masas: Aplicación a la identificación de compuestos orgánicos.

26. El sistema inmunitario: biología y regulación.

27. Anticuerpos: Estructura molecular; clases y subclases de inmunoglobulinas; bases genéticas de su diversidad.

28. Antígenos: estructura y tipos. Antígenos proteicos y haptenos. Preparación y caracterización de conjugados hapténicos.

29. Las interacciones antígeno-anticuerpo: naturaleza y características. Epítopos y parátopos.

30. Inmunización: Antígenos e inmunogenicidad; metodología y seguimiento; aspectos éticos y reglamentación.

31. Anticuerpos policlonales: producción, purificación y caracterización.

32. Cultivo de células animales: Tipos celulares, condiciones y material de cultivo, medios y suplementos, control de la contaminación.

33. Tecnología de hibridomas: Tipos de mielomas; técnicas de fusión, clonación y selección; mantenimiento y criopreservación.

34. Anticuerpos monoclonales: Producción, purificación y caracterización.

35. Tecnología del ADN recombinante: aislamiento, purificación y cuantificación de ácidos nucleicos; enzimas modificadores del ADN; reacción en cadena de la polimerasa (PCR).

36. Clonación de genes en procariotas; expresión y purificación de proteínas recombinantes.

37. Construcción y rastreo de genotecas de anticuerpos recombinantes.

38. Expresión, purificación y caracterización de anticuerpos recombinantes.

39. Ingeniería de anticuerpos recombinantes: técnicas de mutagénesis; técnicas de selección de anticuerpos con propiedades analíticas modificadas; proteínas de fusión con anticuerpos recombinantes.

40. Bioseguridad y legislación en laboratorios que manipulan organismos modificados genéticamente.

41. Inmunoensayos: Fundamentos, clasificación y características.

42. Soportes sólidos utilizados en inmunoensayos. Inmovilización de inmunorreactivos.

43. Sistemas de detección utilizados en los inmunoensayos. Preparación y caracterización de inmunorreactivos marcados.

44. Diseño y optimización de inmunoensayos. Procesamiento e interpretación de resultados.

45. Adaptación de los inmunoensayos a la matriz de ensayo: Preparación de la muestra, efectos matriz, parámetros analíticos.

46. Evaluación y validación de inmunoensayos.

47. Biosensores: concepto y fundamentos, características generales; clasificaciones.

48. Receptores de reconocimiento molecular: tipos, preparación y características; inmovilización en distintos soportes.

49. Transductores electroquímicos: electrodos potenciométricos y amperométricos; el transistor de efecto de campo.

50. Transductores ópticos: optrodos; onda evanescente; resonancia del plasmón de superficie.

51. Transductores piezoeléctricos: microbalanza de cuarzo. Onda acústica superficial.

52. Biosensores enzimáticos: Aspectos teóricos y prácticos; tipos y características.

53. Biosensores inmunológicos: Aspectos teóricos y prácticos; tipos y características.

54. Análisis de contaminantes orgánicos en muestras agroalimentarias: Técnicas de muestreo; preparación y purificación de muestras.

55. Cromatografía de gases: Aplicación al análisis de contaminantes.

56. Cromatografía en fase líquida: Aplicación al análisis de contaminantes.

57. Desarrollo y validación de técnicas inmunoanalíticas/biosensores para contaminantes orgánicos.

58. Procesamiento de datos analíticos: curvas de calibración; análisis estadístico.

59. La calidad en los laboratorios de química analítica.

60. Riesgos Biológico: Recomendaciones generales y protecciones colectivas e individuales. Puede consultarse en: http://www.sprl.upv.es/D7_5_b.htm.

61. Manual de seguridad para operaciones en laboratorios de biotecnología y de tipo biológico: Puede consultarse en: http://www.sprl.upv.es/msbiotecnologia.htm.

62. El proceso de implantación del Sistema de Gestión Ambiental en la Universitat Politècnica de València. Esta información se encuentra accesible en la siguiente dirección: http://www.upv.es/medioambiente.

63. Gestión de los residuos no peligrosos en la Universitat Politècnica de València. Normativa aplicable. Esta información se encuentra accesible en la siguiente dirección: http://www.upv.es/medioambiente.

64. Gestión de los residuos peligrosos en la Universitat Politècnica de València. Normativa aplicable. Esta información se encuentra accesible en la siguiente dirección: http://www.upv.es/medioambiente.
