...
pagina_final: 37765
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2012-6896"
url_pdf: "https://www.boe.es/boe/dias/2012/05/25/pdfs/BOE-A-2012-6896.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2012-6896"
url_eli: ""
fetched_at: "2026-05-07T15:12:48Z"
...
## ANEXO I. Código de Puesto: PF1789. Denominación del Puesto: Técnico Superior de Apoyo a la Investigación. Unidad: Comisión de I+D+I. Localidad: Valencia. Catalogación del Puesto: Grupo A, Subgrupo A1, 22 E040. Titulación: Ingeniero en Informática.
...
● Análisis, desarrollo, mantenimiento e implantación de proyectos y demostradores informáticos del Instituto.

● Mantenimiento y gestión de contenidos de difusión del Instituto en la web y demás material multimedia.

● Coordinación con el ASIC para la implantación de estándares, gestión de recursos y mantenimiento de imagen corporativa de la UPV en el Instituto.

● Análisis y gestión de la seguridad informática, de los datos y de los sistemas de autenticación del Instituto.

● Atención, organización y coordinación de los servicios informáticos del Instituto, incluidos los de escáner 3D y de desarrollo de software así como otros que pudieran implantarse.
...
19. Arquitectura de computadores. Base tecnológica. Componentes. Funcionalidades. Capacidades.

20. Tecnologías actuales de equipos y sistemas informáticos. Procesadores. Memorias. Tarjetas gráficas. Dispositivos USB.

21. Cableado de red. Tipos y parámetros significativos. Normalización UNE-EN 50173.

22. Redes de área local. Protocolos estándares IEEE 802. Familia de protocolos basados en Ethernet.

23. La familia de protocolos TCP/IP. Arquitectura. Capas. Interfaces. Sistemas de direccionamiento. Servicio de nombres. Métodos de configuración. Encaminamiento.

24. Principales protocolos TCP/IP: ARP, ICMP, UDP, TCP, DNS, TELNET, FTP, HTTP, SMTP, DHCP.

25. Redes inalámbricas. Sistemas basados en IEEE 802.11. Seguridad. Protocolos 802.1x.

26. Administración y gestión del almacenamiento: disco local, SAN, NAS (NFS, SMB) y DAS. Familias SCSI y SATA. RAID. Gestión de volúmenes. Sistemas de archivos. Gestión de librerías de programas y medios magnéticos.

27. Sistemas operativos MS-Windows. Instalación y administración. Protección del sistema. Sistemas de validación. Sistemas de almacenamiento. Tolerancia a fallos. Recuperación del sistema.

28. Despliegue y automatización de instalaciones en entorno MS-Windows. Arquitectura y funcionalidades.

29. Directorio Activo de Windows. Administración. Estructura lógica y física, esquema, replicación. Integración con DNS. Administración de dominios. Gestión de usuarios y grupos.

30. GNU/Linux. Instalación y administración. Protección del sistema. Sistemas de validación y autentificación. Creación de repositorios para la distribución y la actualización. Herramientas para la gestión de paquetes. Seguridad local en GNU/Linux.

31. Servicios de Cluster y alta disponibilidad. Instalación y configuración en entornos MS-Windows y Unix.

32. Virtualización y consolidación de servidores: Sistemas VMware ESXi.

33. Servidores Web: Apache Web Server y Microsoft Internet Information Server. Instalación y configuración Seguridad. Certificados SSL.

34. Lenguajes para scripting. Javascript. PHP. Características y funcionalidades.

35. Diseño y desarrollo Web: HTML 4.01, XHTML 1.0.

36. Programación XML v1.1. Documentos válidos y documentos bien formados. Esquemas XML y DTD’s. Parseadores de XML: DOM y SAX.

37. Certificación digital. Autoridades de certificación. DNI electrónico.

38. Formatos de almacenamiento de documentos PDF. Sistemas basados en Adobe Acrobat. Aplicaciones de la arquitectura de certificación a los documentos PDF.

39. Acceso a bases de datos: vinculación de tablas y vistas. Utilización de bases de datos ofimáticas.

40. Gestión de proyectos informáticos. Planificación. Métricas. Seguimiento y documentación.

41. La arquitectura J2EE. Características de funcionamiento. Elementos constitutivos. Productos y herramientas.

42. Aplicaciones de gestión informática de proyectos software: Jira, Trac y Confluence.

43. Aplicaciones informáticas de administración de contenidos: Alfresco.

44. Gestión de documentos utilizando Alfresco. Gestión de contenido web. Versionado. Permisos y grupos. Flujos de Trabajo. Integración.

45. Sistemas de Escáner 3D. Sistemas «contactless». Reconstrucción y creación de mallado. Aplicaciones.

46. Sistemas de creación de aplicaciones informáticas de robótica. Microsoft Robotics Developer Studio.

47. Seguridad física y lógica de los sistemas de información. Riesgos, amenazas y vulnerabilidades. Medidas de protección y aseguramientos. Sistemas Antivirus. Auditorías de seguridad.

48. Planificación y control de las TIC. ITIL («IT Infrastructure Library»)

49. Sistemas de atención al usuario de servicios de informática. Normativa ISO 20000: especificaciones; procesos de provisión de servicios; procesos de resolución de problemas e incidencias.

50. Explotación de sistemas informáticos. Distribución del almacenamiento. Gestión de copias de seguridad. Mantenimiento preventivo.

51. Sistemas de identificación y autenticación por radiofrecuencia. Sistemas RFID. Arquitectura y funcionalidades.

52. Reglamento de medidas de seguridad (994/1999 de 11 de junio). Ley de Servicios de la Sociedad de Información y comercio electrónico (34/2002 de 11 de julio)..
