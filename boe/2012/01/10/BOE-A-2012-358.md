---
identificador: "BOE-A-2012-358"
titulo: "Resolución de 30 de noviembre de 2011, de la Universidad de Granada, por la que se convoca oposición libre para cubrir plaza de personal laboral de Técnico Especialista de Laboratorio (grupo III)."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 1382
pagina_final: 1391
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2012-358"
url_pdf: "https://www.boe.es/boe/dias/2012/01/10/pdfs/BOE-A-2012-358.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2012-358"
url_eli: ""
fetched_at: "2026-05-07T08:14:12Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 30 de noviembre de 2011, de la Universidad de Granada, por la que se convoca oposición libre para cubrir plaza de personal laboral de Técnico Especialista de Laboratorio (grupo III).
...
1.5 Tras la publicación de la relación con la persona seleccionada, se podrá elaborar una lista de sustituciones, en la que figurarán relacionadas por orden de puntuación, aquellas personas que habiendo superado la oposición, obtuvieron una nota inferior a la del último de las personas seleccionadas

1.6 El primer ejercicio no se iniciará antes del día 1 de junio de 2012. La fecha, hora y lugar de celebración del primer ejercicio se fijará en la Resolución del Rectorado en que se aprueben las listas de personal admitido y excluido.
...
2.1 Para ser admitida/o al proceso selectivo, las personas aspirantes deberán reunir los siguientes requisitos:
...
4.1 Expirado el plazo de presentación de instancias, el Rector de la Universidad de Granada dictará Resolución en el plazo máximo de un mes, que se publicará en el «Boletín Oficial de la Junta de Andalucía», conteniendo la composición del Tribunal Calificador así como los lugares donde se exponen las listas de personal admitido y excluido, con indicación de las causas de exclusión. En la lista deberán constar, en todo caso, los apellidos, nombre y número de documento nacional de identidad o pasaporte, en su caso.
...
En todo caso, al objeto de evitar errores y, en el supuesto de producirse, posibilitar su subsanación en tiempo y forma, las personas aspirantes comprobarán fehacientemente no sólo que no figuran en la relación de excluidos, sino que sus datos identificativos constan en la relación de personas admitidas.
...
4.4 De conformidad con lo establecido en el artículo 12 de la Ley 8/1989, de 13 de abril, de Tasas y Precios Públicos, procederá la devolución de los precios públicos cuando no se realice su hecho imponible por causas no imputables al sujeto pasivo. Por tanto, no procederá devolución alguna de los derechos de examen en los supuestos de exclusión de las pruebas selectivas por causa imputable a la persona interesada por lo que el supuesto de exclusión por no cumplir los requisitos o no aportar los documentos exigidos en las convocatorias, no dará lugar a la devolución de los derechos de examen.
...
7.3 Finalizado el proceso selectivo, el Tribunal hará pública las relaciones definitivas de personas que han superado el mismo, por el cupo general y el de discapacitados (si lo hubiera), por orden de puntuación, en las que constarán las calificaciones de cada uno de los ejercicios de la fase de oposición, así como la calificación final obtenida. De acuerdo con lo regulado en el artículo 4.2 del Decreto 93/2006, de 9 de mayo: «En el supuesto de que alguna de las personas aspirantes con discapacidad que se haya presentado por el turno de reserva superase los ejercicios correspondientes pero no obtuviera plaza, y su puntuación fuera superior a la obtenida por otros aspirantes del turno libre, será incluido por su orden de puntuación en el sistema de acceso general».
...
8.1 En el plazo de veinte días naturales a contar desde la publicación en el Rectorado de la Universidad de las relaciones de personas aprobadas a que se refiere la base anterior, las que figuren en las mismas, deberán presentar en el Servicio de Personal de Administración y Servicios de esta Universidad, los siguientes documentos:
...
1. Instalación, configuración y administración de Linux (Fedora 11, Ubuntu 9.04, OpenSuSE 11.1 y superiores) y Windows (XP y superiores).

2. Instalación, configuración y administración de Apache (2.2 y siguientes).

3. Instalación, configuración y administración de MySQL (3.x, 4.x, 5.x y siguientes).

4. Instalación, configuración y administración de PHP (5.x y siguientes).

5. Instalación, configuración y administración de servidores de impresión usando CUPS (2.x y siguientes).

6. Instalación, configuración y administración de impresoras con cualquier tipo de conectividad (usb, red, wifi, etc).

7. Instalación, configuración y administración de sistemas de copia de respaldo en sistemas operativos Linux y Windows.

8. Instalación, configuración y mantenimiento de PCs a nivel físico.

9. Instalación, configuración y mantenimiento de hardware de comunicación (routers, switches, etc). Cableado de red.

10. Instalación, configuración y administración de software de docencia (ETSIIT, Bellas Artes, Empresariales y Arquitectura).

11. Instalación, configuración y administración de servidores y clusters de altas prestaciones.

12. Instalación, configuración y administración de servidores de repositorios.

13. Instalación, configuración y administración del software para dispositivos de interacción.

14. Mantenimiento de la seguridad que evite acceso y usos no autorizados en sistemas Linux (Fedora11, Ubuntu 9.04, OpenSuSE 11.1 y superiores) y Windows (XP y superiores). Instalación, configuración y administración de cortafuegos.

15. Instalación, configuración y administración de Samba (3.x y superiores).

16. Prevención de Riesgos Laborales en el Departamento.

17. Artículos del 15 AL 70 del IV Convenio Colectivo del Personal Laboral de las Universidades Públicas de Andalucía, aprobado por Resolución de 10 de febrero de 2004, de la Dirección General de Trabajo y Seguridad Social («BOJA» n.º 36 de 23 de febrero de 2004).

18. Ley Orgánica 3/2007, de 22 de marzo, para la igualdad efectiva de mujeres y hombres (título V, capítulos I, II y III)

19. Acuerdo de fecha 18 de mayo de 2007, del Complemento de Productividad para la Mejora y Calidad de los Servicios que presta el PAS de las Universidades Públicas de Andalucía (CPMCS).
