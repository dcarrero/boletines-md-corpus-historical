---
identificador: "BOE-A-2012-14493"
titulo: "Resolución de 29 de octubre de 2012, de la Universidad de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A2, por el turno libre, sector de administración especial, Escala Técnica Media de Prevención (perfil: seguridad en el trabajo)."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 81814
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2012-14493"
url_pdf: "https://www.boe.es/boe/dias/2012/11/26/pdfs/BOE-A-2012-14493.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2012-14493"
url_eli: ""
fetched_at: "2026-05-08T00:12:52Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 29 de octubre de 2012, de la Universidad de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A2, por el turno libre, sector de administración especial, Escala Técnica Media de Prevención (perfil: seguridad en el trabajo).

Este Rectorado, haciendo uso de las competencias que le atribuye el artículo 20, en relación con el 2.2 de la Ley Orgánica 6/2001, de 21 de diciembre de Universidades, modificada por la Ley 4/2007, de 12 de abril, la Ley 7/2007 de 12 de abril del Estatuto Básico del Empleado Público y de acuerdo con lo que establece el artículo 190 de los Estatutos de la Universitat de València, acuerda convocar pruebas selectivas de acceso al grupo A, subgrupo A2, por el turno libre, sector de administración especial, escala técnica media de prevención (perfil: seguridad en el trabajo) de la Universidad de Valencia, de conformidad con las siguientes:
...
3.2 Independientemente de la opción elegida para cumplimentar la solicitud, se presentará por triplicado: una copia para la entidad bancaria, una para la Universidad de Valencia y una para la persona interesada. Las solicitudes estarán dirigidas al Rectorado de la Universidad de Valencia.
...
a) El registro de entrada de la Universidad de Valencia (avenida de Blasco Ibáñez, 13, 46010 Valencia), que se encuentra abierto al público de lunes a viernes (horario: de 9 a 14 h y de 16 a 18 h).
...
c) Si se realiza el pago de los derechos de examen en la oficina del Banco Santander Central Hispano «Oficina Universitaria» situada en la avenida de Blasco Ibáñez, 21 –Facultad de Psicología, Aulario I de la Universitat de València– le sellarán los tres ejemplares de la solicitud en el momento de abonar las tasas, y con este acto, se considerará presentada la solicitud.
...
7.1 Las personas que superen las pruebas selectivas tendrán que acreditar el conocimiento de valenciano a nivel medio (C1), con certificados, diplomas o títulos expedidos por la Junta Qualificadora de Coneixements del Valencià de la Generalitat Valenciana o por el Servei de Política Lingüística de la Universitat de València, o bien el certificado de homologación emitido por este Servicio.

7.2 Las personas que no cumplan el requisito anterior se comprometerán a realizar los cursos de formación y perfeccionamiento que se organicen para este efecto para adquirir, en el plazo de una año desde la toma de posesión (o en el tiempo que permita la programación del Servei de Política Lingüística) el nivel medio de conocimiento de la lengua.

## Octava. Presentación de documentos.

8.1 En el plazo de 20 días hábiles, contados desde el día siguiente de la publicación en el *Diari Oficial de la Comunitat Valenciana* *(DOCV)* de la lista con las personas aprobadas, éstas deberán presentar en el Servei de Recursos Humans (PAS) de esta Universitat la documentación siguiente:
...
8.1.3 Fotocopia cotejada del título acreditativo de técnico/a superior de prevención de riesgos laborales, especialidad seguridad en el trabajo, exigido en esta convocatoria.
...
8.1.5 Certificado médico acreditativo de poseer la capacidad física y psíquica necesaria para el ejercicio de las funciones de los puestos de trabajo convocados. A tal efecto, los reconocimientos se realizarán a través de los servicios médicos concertados de la Universitat de València.

8.1.6 Las personas aprobadas que tengan alguna discapacidad tendrán que aportar un certificado del órgano competente de la comunidad autónoma sobre la capacidad para llevar a cabo las tareas que correspondan a los puestos de trabajo objeto de esta convocatoria.
...
Una vez transcurrido el plazo de presentación de la documentación especificada en la base octava de esta convocatoria, y habiéndose verificado el cumplimiento de los requisitos exigidos, el rector dictará una resolución que se publicará en el Diari Oficial de la Comunitat Valenciana (DOCV), mediante la cual las personas que hayan superado las pruebas selectivas serán nombradas funcionarias de carrera.
...
Los recursos contenciosos administrativos que se interpongan contra esta resolución serán anunciados en el Diari Oficial de la Comunitat Valenciana (DOCV), a los efectos de emplazamiento a las posibles personas interesadas.
...
Segunda parte: realización de una entrevista basada en la memoria que tendrá que presentar el/la opositor/a sobre el funcionamiento de un servicio relacionado con el área funcional a la cual se refieren las plazas convocadas por la Universitat de València.
...
Tema 5. La Evaluación de Riesgos Laborales como herramienta básica de la planificación de la actividad preventiva. Aplicación en la Universitat de València.
...
Tema 8. Protección individual. Equipos de Protección Individual (EPI). Concepto y Clasificación. Normativa de aplicación. Comercialización, selección y uso. Implantación del uso de los equipos de protección individual.

Tema 9. Coordinación de actividades empresariales en la Universitat de València.

Tema 10. Lugares de trabajo (I). Espacio de trabajo. Orden y limpieza en los centros de trabajo. Vías de evacuación. Nivel de iluminación. Temperatura.

Tema 11. Lugares de trabajo (II). Condiciones ambientales. Iluminación. Ambiente térmico. Ruido: confort y disconfort. Calidad de aire interior.

Tema 12. Condiciones de trabajo y salud. Terminología básica. El riesgo profesional. Daños derivados del trabajo. Los accidentes de trabajo y las enfermedades profesionales. Prevención y Protección.
...
Tema 15. Medicina del trabajo. Concepto. Vigilancia y control de la salud de los trabajadores. Recursos humanos y materiales. Funciones. Confidencialidad.

Tema 16. Seguridad y Ergonomía en las Bibliotecas.

Tema 17. Prevención de riesgos en Seguridad Vial Laboral (I). Conceptos básicos y marco normativo. Causas de los accidentes de tráfico: factores de riesgo.

Tema 18. Prevención de riesgos en Seguridad Vial Laboral (II). El conductor. La vía y su entorno. El vehículo.

Tema 19. Señalización (I). Conceptos y requisitos de la señalización de seguridad. El Real Decreto 485/1997, de 14 de abril, sobre señalización de seguridad y salud en el trabajo.

Tema 20. Señalización (II). Señalización y evacuación. Tipos de señalización. Colores de seguridad. Iluminación de seguridad. Señalización de los medios de protección. Señales en forma de panel.

Tema 21. Diseño de puestos de trabajo equipados con Pantallas de Visualización de Datos. Principios generales. Aspectos relativos a la posición de las pantallas. Disposiciones mínimas de seguridad y salud en el trabajo.

Tema 22. Uso de herramientas manuales. Ergonomía. Riesgos y medidas preventivas.

Tema 23. Manipulación manual de cargas. Normativa de aplicación. Esfuerzos. Manutención mecánica y manual. Posturas de trabajo.

Tema 24 Seguridad y salud en los trabajos de jardinería: Riesgos laborables derivados de trabajos en jardinería con maquinaria y herramientas.

Tema 25. Prevención de Riesgos Laborales aplicada en los laboratorios de docencia e investigación.

Tema 26. Primeros auxilios. Concepto. Normas de actuación ante una emergencia. Reanimación cardiopulmonar. Actuaciones ante situaciones específicas.

Tema 27. El análisis estadístico de accidentes en la empresa: Concepto y objetivos. Principales índices y parámetros. La notificación de los accidentes de trabajo y enfermedades profesionales. Obligaciones establecidas en la Ley General de la Seguridad Social y su normativa de desarrollo y en la Ley de Prevención de Riesgos Laborales.

Tema 28. Investigación de accidentes de trabajo. Objetivos de la investigación de los accidentes de trabajo. Propuestas preventivas emanadas de la investigación de un accidente. Metodología de la investigación de accidentes.

Tema 29. Trabajos en altura. Medios auxiliares. Medidas de prevención y protección. Trabajos verticales.

Tema 30. Prevención y protección contra incendios: Conceptos básicos sobre causas y propagación de los incendios. Principios generales de prevención y protección. Productos inflamables y explosivos y su almacenamiento.

Tema 31. Medidas de emergencia. Normativa de aplicación: Protección Civil y Norma Básica de Autoprotección. Principios del Código Técnico de la Edificación, documento básico de Seguridad en caso de Incendio.

Tema 32. Accesibilidad en la edificación. Soluciones de accesibilidad para edificios públicos. Evacuación de personas con discapacidad.

Tema 33. Los planes de autoprotección. Concepto y objeto. Contenido. Regulación de los planes de autoprotección según su actividad sectorial. Compatibilidad de la normativa de autoprotección con la legislación específica.

Tema 34. Elaboración e implantación de los planes de autoprotección en centros públicos docentes y de investigación. Fases. Procedimiento. Documentación. La tramitación administrativa del plan de autoprotección en el ámbito local y autonómico.

Tema 35. Explosiones: Concepto de explosión y de atmósfera explosiva. Polvos inflamables y combustibles. Límites y valores de referencia. Emplazamientos peligrosos. Clasificación y características de las áreas en las que pueden formarse atmósferas explosivas. Medidas de protección frente a atmósferas explosivas. Aparatos y sistemas de protección para uso en atmósferas potencialmente explosivas. Normativa de aplicación en trabajos en atmósferas explosivas.

Tema 36. Utilización de equipos de trabajo: El Real Decreto 1215/1997, de 18 de julio, sobre utilización por los trabajadores de los equipos de trabajo. Guía técnica. Análisis y evaluación de riesgos. Procedimientos de adecuación y puesta en conformidad.

Tema 37. Riesgos eléctricos. Efectos nocivos de la electricidad. Factores que influyen en el efecto eléctrico. Tipos de contactos eléctricos. Protección contra contactos eléctricos. Su fiabilidad. Normativa legal para la protección frente al riesgo eléctrico. Trabajos con presencia de riesgo eléctrico.

Tema 38. Máquinas. Principales riesgos. Principios básicos de seguridad en máquinas. Normativa de aplicación. Certificación de máquinas. Procedimientos de certificación de conformidad. La declaración CE de conformidad. Organismos de control notificados.

Tema 39. Espacios confinados: Concepto de espacio confinado. Peligros asociados a un espacio confinado. Actuación ante un espacio confinado. El permiso de trabajo. Contenido del permiso de trabajo. Procedimientos de emergencia y rescate. Entrenamiento y deberes del equipo de trabajo en el espacio confinado. Cancelación del permiso de trabajo.

Tema 40. Seguridad y salud en las obras de construcción. Normativa de aplicación. El estudio y los planes de seguridad y salud en el trabajo. El Coordinador de Seguridad, la dirección facultativa y la propiedad. Disposiciones mínimas de seguridad y salud en las obras de construcción.
...
Solicitud de admisión a las pruebas selectivas de acceso al grupo A, subgrupo A2, de administración especial, turno libre, escala técnica media de prevención (perfil: seguridad en el trabajo) de esta Universitat.
...
Datos que ha de recoger la solicitud de admisión a las pruebas selectivas de acceso al grupo A, subgrupo A2, turno libre, de administración especial, escala técnica media de prevención (perfil: seguridad en el trabajo).
