...
pagina_final: 87303
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2012-15499"
url_pdf: "https://www.boe.es/boe/dias/2012/12/24/pdfs/BOE-A-2012-15499.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2012-15499"
url_eli: "https://www.boe.es/eli/es/o/2012/12/20/ecc2741"
fetched_at: "2026-05-08T01:41:27Z"
...
*L**~pot~*= POB*∙*PART~pot~*∙*(1– *NAWRU)**∙**H**~pot~* [2]
...
Ingresos Cíclicos en el año t: IC~t~ = Σ T~it~ ε~i~ GAP~t~ [1]

Donde T~it~ representa el porcentaje de peso en el PIB nominal de cada uno de los ingresos impositivos (i) del año t; ε~i~ es la elasticidad de cada tipo de impuesto respecto a la brecha de producción; y GAP~t~ es la brecha de producción o *output gap* del año t en porcentaje del PIB potencial, que indica la fase cíclica en la que se encuentra la economía.

De igual modo, el componente cíclico de los gastos viene dado por:

Gastos Cíclicos en el año t: GC~t~ = Σ G~jt~ ε~j~ GAP~t~ [2]

Donde G~it~ representa cada uno de los gastos corrientes primarios (j) del año t en porcentaje del PIB; ε~i~ es la elasticidad respecto a la brecha de producción de cada tipo de gasto corriente primario; y GAP~t~ es la brecha de producción del año t en porcentaje del PIB potencial.

El saldo cíclico se obtendrá por diferencia entre ingresos y gastos cíclicos:

Saldo cíclico en el año t: BC~t~ = IC~t~ – GC~t~ = (Σ T~it~ ε~i~ - Σ G~jt~ε~i~) GAP~t~ [3]
...
Sensibilidad η = (Σ T~it~ ε~i~ - Σ G~jt~ ε~j~) [5]
