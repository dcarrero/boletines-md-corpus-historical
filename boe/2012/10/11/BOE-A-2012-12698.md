---
identificador: "BOE-A-2012-12698"
titulo: "Resolución de 1 de octubre de 2012, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso al grupo C, subgrupo C1, sector administración especial, operador, en el campus de la localidad de Gandia, por el sistema de concurso oposición libre."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 72817
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2012-12698"
url_pdf: "https://www.boe.es/boe/dias/2012/10/11/pdfs/BOE-A-2012-12698.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2012-12698"
url_eli: ""
fetched_at: "2026-05-07T21:51:32Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 1 de octubre de 2012, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso al grupo C, subgrupo C1, sector administración especial, operador, en el campus de la localidad de Gandia, por el sistema de concurso oposición libre.

Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado, de conformidad con lo dispuesto en el artículo 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, y la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo C, subgrupo C1, sector de administración especial, operador de la Universitat Politècnica de València, con arreglo a las siguientes bases:

1. Objeto de la convocatoria

1.1 La presente convocatoria tiene por objeto la selección de personal para cubrir una plaza vacante del grupo C, subgrupo C1, sector de administración especial, operador de la Universitat Politècnica de València, por el turno que a continuación se indica:
...
3.4 Los derechos de examen serán de 15,20 euros, que se ingresarán en la cuenta corriente número ES15 2038 6543 92 6000022653 (tasas, de Bankia).
...
3.5.3 Tendrán una bonificación del 50% del pago de los derechos de examen a pruebas selectivas, los miembros de familias numerosas de categoría general, debiendo acompañar a la solicitud certificado acreditativo de tal condición, siendo en este caso los derechos de examen 7,60 euros.
...
5.2.2 Segundo ejercicio: consistirá en resolver por escrito, durante un tiempo mínimo de dos horas y máximo de cuatro, que determinará el tribunal, un examen de supuestos prácticos propuesto por el tribunal de las funciones y del programa que figura en el bloque específico de la presente convocatoria.
...
7.1 Los ejercicios tendrán lugar en la ciudad de Gandia.

El primer ejercicio se realizará en el lugar, fecha y hora que se establezca en la resolución por la que se aprueba y publica en el «DOCV», la lista definitiva de admitidos y excluidos de las pruebas objeto de esta convocatoria, con una antelación no inferior a 15 días hábiles, fecha y hora que coincidirá con la realización del primer ejercicio de la convocatoria de pruebas selectivas de acceso al grupo C, subgrupo C1, sector administración especial, operador, por el sistema de concurso-oposición que se realizará en el campus de la localidad de Valencia.
...
Valencia, 1 de octubre de 2012.–El Rector, Juan Juliá Igual.
...
Jornada: Turno de tardes y una mañana.
...
18. Conceptos informáticos básicos. Hardware/Software. Arquitectura. Sistema Operativo. Lenguajes. Programas.

19. Elementos de los equipos informáticos. Interfaces. Controladoras. Periféricos. El ordenador personal. Estaciones de trabajo.

20. Cableado de red. Normalización. Procedimientos de instalación y verificación.

21. Comunicaciones y redes de área local y extensa. Dispositivos. Protocolos Ethernet.

22. Protocolos TCP/IP. Sistema de direccionamiento. Configuración y verificación de equipos.

23. Redes inalámbricas. Sistemas basados en IEEE 802.11.

24. Redes Privadas Virtuales. Conceptos generales. Configuración.

25. Sistemas Operativos: definición y conceptos generales. Estructura. Tipos de sistemas operativos.

26. Instalación y configuración de estaciones de trabajo en entorno MS-Windows (XP y Windows7) Apple Mac (Snow Leopard y Lion) y Linux (en distribuciones RedHat, SuSE, Ubuntu). Gestión de periféricos. Uso de recursos compartidos.

27. Configuración de dispositivos móviles. Conexión a la WiFi. Acceso a través del proveedor de telefonía. Sincronización con los servicios de correo, calendario, agenda y tareas. Dispositivos Android, iPad/iPhone y Windows Mobile.

28. Instalación y configuración de servidores en entorno MS-Windows 20xx. Directorio Activo. Servicios. Gestión de periféricos. Colas de impresión. Copias de seguridad.

29. Replicación de instalaciones y configuraciones. Herramienta Ghost.

30. Servicios de información en Internet. Servicios Web y de correo electrónico.

31. Servicios de valor añadido de las redes IP y equipos en entornos docentes: aspectos fundamentales de las aplicaciones de telefonía, video, videoproyección y videoconferencia.

32. Sistemas de atención al usuario de servicios de informática. Normativa ISO 20000: especificaciones; procesos de resolución de problemas e incidencias.

33. Seguridad en Sistemas Informáticos: mecanismos de infección y ataque. Antivirus. Firewalls de usuario. Mecanismos de copia y recuperación de datos. Norma UNE 71502.

34. Documentos electrónicos. Política de firma electrónica y certificados de la Administración. Instalación y configuración de certificados y dispositivos.

35. Ley 11/2007, de 22 de junio, de acceso electrónico de los ciudadanos a los servicios públicos: Título preliminar.–Del ámbito de aplicación y los principios generales; Título primero.–Derechos de los ciudadanos a relacionarse con las Administraciones Públicas por medios electrónicos; Título segundo.–Régimen jurídico de la administración electrónica.

36. La Organización Preventiva de un Servicio.

37. Diferentes figuras del Organigrama Preventivo (seguridad y salud) de un Servicio: las figuras N1; N2; N3; N4 y N5.

38. Manipulación manual de cargas.

39. La Ergonomía en tareas administrativas.

40. El proceso de implantación del Sistema de Gestión Ambiental en la Universitat Politècnica de València.

41. Gestión de los residuos no peligrosos en la Universitat Politècnica de València. Normativa aplicable.

42. Gestión de residuos peligrosos en la Universitat Politècnica de València: monitores informáticos, sistemas de alimentación ininterrumpida y otros. Normativa aplicable.
