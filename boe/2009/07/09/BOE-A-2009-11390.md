---
identificador: "BOE-A-2009-11390"
titulo: "Resolución de 23 de junio de 2009, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo C, Subgrupo C1, sector administración especial, Especialista Técnico Montaje Equipos Audiovisuales, por el sistema de concurso oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 57462
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-11390"
url_pdf: "https://www.boe.es/boe/dias/2009/07/09/pdfs/BOE-A-2009-11390.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-11390"
url_eli: ""
fetched_at: "2026-05-19T17:25:54Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 23 de junio de 2009, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo C, Subgrupo C1, sector administración especial, Especialista Técnico Montaje Equipos Audiovisuales, por el sistema de concurso oposición.

Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el art. 75 de la Ley Orgánica 6/2001 de 21 de diciembre, de Universidades así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, el Texto Refundido de la Ley de la Función Pública Valenciana y Decreto 33/1999, de 9 de marzo del Gobierno Valenciano, acuerda convocar pruebas de acceso al grupo C, subgrupo C1, sector Administración especial, especialista técnico montaje de equipos audiovisuales de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:

1. Objeto de la Convocatoria.

1.1 La presente convocatoria tiene por objeto la selección de personal para cubrir una plaza vacante del grupo C, subgrupo C1, sector Administración especial, especialista técnico montaje de equipos audiovisuales de la Universidad Politécnica de Valencia, por el turno que a continuación se indica, y hasta un máximo de un 10% adicional, de conformidad con lo dispuesto en los artículos 61.8 y 70 de la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público:
...
| Código de Puesto: PF1726 | Denominación del Puesto: Especialista Técnico montaje de Equipos Audiovisuales |
| --- | --- |
...
Gestión de averías y mantenimiento de equipos audiovisuales de la radiotelevisión.

Control y supervisión de los equipos móviles de la radiotelevisión.

Confección de cables de audio y vídeo.

Reconfiguración y ajuste de estudios y equipos de radio y televisión.

Reconfiguración de las estaciones de edición de vídeo sobre PC.

Reconfiguración de las estaciones de edición de audio sobre PC.

Reconfiguración del sistema de continuidad de la radio sobre PC.

Gestión de los servidores informáticos y los usuarios de la radiotelevisión.

Gestión de las aplicaciones informáticas específicas de la radio televisión.

Mantenimiento y actualización ordenadores de la radiotelevisión.

Mantenimiento y actualización de las estaciones de edición de audio y vídeo.

Mantenimiento y actualización del sistema de continuidad de la radio.

Mantenimiento de los sistemas de emisión por Internet.

Gestión de los sistemas de copia legal.
...
12. Gestión de residuos no peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable.
...
16. El entorno de trabajo de Windows. Conexión a la red UPVNET. La Internet. Navegación. Búsquedas de información. La página web de la UPV. La Intranet. El correo electrónico. web mail.
...
20. La señal de vídeo compuesto. Análisis frecuencial. Análisis temporal. Parámetros generales en PAL y NTSC.

21. Señales de vídeo analógicas en componentes.

22. Formatos de grabación de vídeo analógico. VHS, SVHS, Umatic, Betacam SP

23. Digitalización de la imagen de vídeo. Parámetros. Relación de aspecto, formatos de píxel.

24. Estrategias de reducción de información para la codificación digital del vídeo. Espacios de color.

25. Algoritmos de compresión digital de vídeo. Formatos de compresión de vídeo digital.

26. Formatos de archivo utilizados para el vídeo digital en Windows y Mac. Consideraciones a tener en cuenta en la mezcla de formatos de ficheros de vídeo digital.

27. Sistemas de grabación de vídeo digital para camascopios.

28. Buses digitales utilizados para la transmisión de vídeo.

29. El estándar MPEG2. Estándares para DVD y Blu-Ray

30. La gestión de vídeo en Windows. Directshow y Video for Windows

31. Postproducción digital de vídeo y audio. Generalidades.

32. Aplicaciones de tratamiento de vídeo y audio. Vegas Vídeo Pro, Adobe Premiere, Soundforge.

33. Camascopios: lentes, tratamiento del color, ajustes, sistemas ENG

34. Realización en plató. Generalidades.

35. Mezcladores, Tituladoras, cámaras de estudio y otros equipos de realización en plató.

36. Iluminación. Generalidades. Equipos de Iluminación en plató

37. Codificación de vídeo para Internet. Windows Media Video, Flash, H.264

38. Generalidades sobre audio. Impedancias, Unidades de medida, cableado y conexionado.

39. Características de los Micrófonos. Técnicas de captación sonora.

40. Sistemas para la grabación y edición de audio. Formatos de grabación de la señal de audio.

41. Funcionamiento y aplicaciones de mesa de mezclas de audio.

42. Funcionamiento de los equipos de procesado de la señal de audio. Procesadores de espectro, procesadores de dinámica, procesado temporal y multiefectos.

43. Transmisión de datos. Generalidades. Conceptos previos: comunicación, información y transmisión. Elementos de un sistema de TD. Conceptos generales sobre TD: velocidad de modulación, baudio, velocidad de transferencia de datos, transferencia serie/paralelo, sincronismo, transferencia síncrona/asíncrona. Soportes físicos de comunicaciones. Conmutación de circuitos, mensajes, paquetes.

44. Redes de Área Local. Concepto y usos. Topologías.

45. Internet. Estructura y funcionamiento. Organización. Modos de acceso. Aplicaciones.

46. Servidores WWW. Generalidades. Gestión. Acceso a Bases de Datos.

47. Sistemas de cableado. Tipos de cable. Normativas. Parámetros de diseño. Adaptación de señales multimedia a los distintos cables.

48. Sistemas operativos de la familia Windows. Instalación y mantenimiento. Gestión de servidores de ficheros e impresoras

49. Legislación multimedia. Derechos de autor y propiedad intelectual.

50. Manipulación manual de cargas.

51. Manual Preventivo para empresas externas contratadas desde los centros de coste.
...
Se valorará hasta un máximo de 4 puntos, siempre que se acredite estar en posesión del pertinente certificado u homologación expedido por el Gabinete de Normalización Lingüística de la Universidad Politécnica de Valencia o la Junta Qualificadora de Coneixements del Valencià, con arreglo a la escala que a continuación se indica, valorándose en caso de estar en posesión de dos o más niveles, únicamente el de mayor nivel:
