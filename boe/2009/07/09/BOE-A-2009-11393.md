---
identificador: "BOE-A-2009-11393"
titulo: "Resolución de 24 de junio de 2009, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Realizador de Radio, por el sistema de concurso oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 57510
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-11393"
url_pdf: "https://www.boe.es/boe/dias/2009/07/09/pdfs/BOE-A-2009-11393.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-11393"
url_eli: ""
fetched_at: "2026-05-19T17:25:57Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 24 de junio de 2009, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Realizador de Radio, por el sistema de concurso oposición.
...
Este Rectorado de conformidad con lo dispuesto en el art. 75 de la Ley Orgánica 6/2001 de 21 de diciembre, de Universidades así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, el Texto Refundido de la Ley de la Función Pública Valenciana y Decreto 33/1999, de 9 de marzo del Gobierno Valenciano, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector Administración especial, realizador de radio de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:

1. Objeto de la Convocatoria

1.1 La presente convocatoria tiene por objeto la selección de personal para cubrir 1 plaza vacante del grupo A, subgrupo A1, sector Administración especial, realizador de radio de la Universidad Politécnica de Valencia, por el turno que a continuación se indica, y hasta un máximo de un 10% adicional, de conformidad con lo dispuesto en los artículos 61.8 y 70 de la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público:
...
3.4 Los derechos de examen serán de 26,80 €, que se ingresarán en la cuenta corriente número 2077 0724 68 3100033835 –Tasas–, de la Caja de Ahorros de Valencia (Bancaja) en la urbana 724, sita en la Universidad Politécnica de Valencia, Camino de Vera s/n.º, CP 46071, Valencia.
...
Certificado de nivel medio de la Junta Qualificadora de Coneixements del Valencià.

Certificado de nivel medio de Conocimientos de Valenciano expedido u homologado por el Gabinete de Normalización Lingüística de la Universidad Politécnica de Valencia.
...
Valencia, 24 de junio de 2009.–El Rector, Juan Juliá Igual.

### ANEXO I

| Código de Puesto: PF1720. | Denominación del Puesto: Realizador de Radio |
| --- | --- |
| Unidad: Área de Comunicación. | Centro de destino: Unidad de Producción |
| Localidad: Valencia |  |
| Catalogación del Puesto: A1 22 E040. | Titulación: Licenciado en Ciencias de la Información o Licenciado en Comunicación Audiovisual |

Funciones del Puesto:

Coordinación de las tareas técnicas de la radio.

Coordinación de la parrilla de emisión.

Coordinación de los estudios de la radio.

Realización de programas en autocontrol.

Planificación mantenimiento sistemas de audio de la radio.

Supervisión de la emisión.

Manejo de la mesa de mezclas y sistemas de audio de la emisora para la producción de programas desde diversas cabinas.

Grabación de programas en un sistema informático de tratamiento de audio.

Conversión de formatos digitales de audio.

Edición de audio digital.

Gestión del programa de sistema digital de continuidad de audio.

Configuración de equipos de audio.

Control y ajuste de los niveles de la emisión por Internet.
...
3. La Ley Orgánica de Universidades.

4. Los Estatutos de la Universidad Politécnica de Valencia: Régimen Jurídico (Titulo Preliminar: Capítulos I y II). Estructura de la Universidad (Titulo Primero). Del Gobierno de la Universidad (Titulo Segundo).
...
10. Manual de derechos y obligaciones del personal de la Universidad Politécnica de Valencia en materia de seguridad y salud en el trabajo.

11. El plan estratégico de la Universidad Politécnica de Valencia.

12. El proceso de implantación del Sistema de Gestión Ambiental en la Universidad Politécnica de Valencia.

13. Gestión de los residuos no peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable.

14. Ley Orgánica 1/04, 28 de diciembre, de Medidas de Protección Integral contra la Violencia de Género: Título Preliminar.–Objeto de la Ley; Título I.–Capítulo I.–En el ámbito educativo. Capítulo II.–En el ámbito de la publicidad y de los medios de comunicación. Título II.–Capítulo I.–Derecho a la información, a la asistencia social integral y a la asistencia jurídica gratuita. Capítulo III.–Derechos de las funcionarias públicas. Título III: Artículo 30; Título V.–Capítulo IV.–Medidas judiciales de protección y de seguridad de las víctimas.
...
20. Generalidades sobre audio. Impedancias, Unidades de medida, cableado y conexionado.

21. Características de los Micrófonos.

22. Técnicas de captación sonora.

23. Radiodifusión de audio digital (DAB). Generalidades.

24. Sistemas para la grabación y edición de audio.

25. Formatos de grabación de la señal de audio.

26. Funcionamiento y aplicaciones de mesa de mezclas de audio.

27. Sistemas de incorporación de llamadas a la radio.

28. Manejo de mesa de mezclas y fuentes de audio para la emisión y grabación de programas de radio.

29. Funcionamiento de los equipos de procesado de la señal de audio. Procesadores de espectro.

30. Funcionamiento de los equipos de procesado de la señal de audio. Procesadores de dinámica.

31. Funcionamiento de los equipos de procesado de la señal de audio. Procesado temporal y multiefectos.

32. Aplicaciones de los procesadores de la señal de audio.

33. Manejo del software de grabación y edición de audio Sound Forge.

34. Elementos del lenguaje radiofónico.

35. Montaje radiofónico. Planificación sonora y construcción del espacio radiofónico.

36. El medio radiofónico. Preparación de programas, coordinación de emisiones, confección de parrillas.

37. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. Generalidades.

38. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. El navegador.

39. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. El módulo de grabación.

40. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. El módulo de programación.

41. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. El módulo de emisión.

42. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. La ventana de carga.

43. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. La agenda de tareas.

44. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. La base de datos musical.

45. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. El módulo de gestión del sistema.

46. Sistemas digitales de continuidad y grabación para radio. Software de gestión de radio VIVA NT. Creación y uso de plantillas.

47. Configuración sistema de radio bajo demanda y por streaming.

48. Legislación multimedia. Derechos de autor y propiedad intelectual.

49. Guía de coordinación preventiva dirigida a centros de coste.

50. Manual Preventivo para empresas contratadas desde centros de coste.
