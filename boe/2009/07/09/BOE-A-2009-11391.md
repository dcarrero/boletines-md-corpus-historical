---
identificador: "BOE-A-2009-11391"
titulo: "Resolución de 23 de junio de 2009, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo C, Subgrupo C1, sector administración especial, Especialista Técnico de Imagen y Sonido, por el sistema de concurso oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 57479
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-11391"
url_pdf: "https://www.boe.es/boe/dias/2009/07/09/pdfs/BOE-A-2009-11391.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-11391"
url_eli: ""
fetched_at: "2026-05-19T17:25:55Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 23 de junio de 2009, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo C, Subgrupo C1, sector administración especial, Especialista Técnico de Imagen y Sonido, por el sistema de concurso oposición.

Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado, de conformidad con lo dispuesto en el art. 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, el Texto Refundido de la Ley de la Función Pública Valenciana y Decreto 33/1999, de 9 de marzo, del Gobierno Valenciano, acuerda convocar pruebas de acceso al grupo C, subgrupo C1, sector Administración especial, especialista técnico de imagen y sonido de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:

1. Objeto de la Convocatoria

1.1 La presente convocatoria tiene por objeto la selección de personal para cubrir 4 plazas vacantes del grupo C, subgrupo C1, sector Administración especial, especialista técnico de imagen y sonido de la Universidad Politécnica de Valencia, por el turno que a continuación se indica y hasta un máximo de un 10% adicional, de conformidad con lo dispuesto en los artículos 61.8 y 70 de la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público:

Turno libre: 1.

Turno promoción interna: 3.
...
3.4 Los derechos de examen serán de 14,89 euros, que se ingresarán en la cuenta corriente número 2077 0724 68 3100033835 –Tasas–, de la Caja de Ahorros de Valencia (Bancaja) en la urbana 724, sita en la Universidad Politécnica de Valencia, Camino de Vera s/n.º, CP 46071, Valencia.
...
5.2.2 Segundo ejercicio, común para el turno de promoción interna y turno de acceso libre. Consistirá en una prueba/ejercicio práctico sobre el temario especificado en el anexo I bloque de conocimientos específicos de la presente convocatoria, y funciones a desarrollar en el puesto de trabajo.
...
Valencia, 23 de Junio de 2009.–El Rector, Juan Juliá Igual.

### ANEXO I

| Denominación del Puesto: Especialista Técnico de Imagen y Sonido. |  |
| --- | --- |
| Unidad: Área de Comunicación. | Centro de destino: Unidad de Producción. |
| Localidad: Valencia. |  |
| Catalogación del Puesto: C1 19 E023 | Titulación: BUP, Bachiller Superior, Formación Profesional de Segundo Grado, o hayan superado la prueba de acceso para mayores de 25 años a la Universidad, o titulación equivalente. |

Funciones del puesto:

Preparar el material y los recursos técnicos a utilizar, verificando su estado, con el fin de garantizar que estarán en condiciones para la grabación.

Poner a punto los equipos técnicos, mediante su conexión y ajuste, para realizar la grabación y el montaje.

Grabación de eventos con cámara ENG y micros.

Operación de cámaras de estudio.

Realización de programas en plató y salones de actos de la Universidad.

Determinar las necesidades técnicas de la sonorización, analizando los condicionantes técnicos, para confirmar y concretar la viabilidad del proyecto.

Postproducción de audio y vídeo al corte.

Postproducción de audio y vídeo analógico y digital con estación no lineal.

Configuración de equipos audiovisuales.

Retransmisión de eventos.

Supervisar las calidades técnicas de las señales de audio y vídeo en los diversos procesos de producción, postproducción y emisión de las señales en radio y televisión.
...
11. El proceso de implantación del Sistema de Gestión Ambiental en la Universidad Politécnica de Valencia.

12. Gestión de los residuos no peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable.

13. Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal.

14. Ley Orgánica 1/2004, de 28 de diciembre, de Medidas de Protección Integral contra la Violencia de Género: Título Preliminar, Objeto de la Ley. Título I, Capítulo I: En el ámbito educativo; Capítulo II: En el ámbito de la publicidad y de los medios de comunicación. Título II, Capítulo I: Derecho a la información, a la asistencia social integral y a la asistencia jurídica gratuita; Capítulo III: Derechos de las funcionarias públicas. Título III: Artículo 30. Título V, Capítulo IV: Medidas judiciales de protección y de seguridad de las víctimas.
...
1. La señal de vídeo compuesto. La señal de vídeo compuesto. Análisis frecuencial. Análisis temporal. Parámetros generales en PAL. Parámetros generales en NTSC.

2. Señales de vídeo analógicas en componentes.

3. Formatos de grabación de vídeo analógico. VHS, SVHS, Umatic, Betacam SP

4. Televisión Digital Terrestre. Aspectos Generales. Difusión de la TDT. Multiplexación de la señal. Prestación de servicios adicionales.

5. Digitalización de la imagen de vídeo. Parámetros. Relación de aspecto, formatos de píxel.

6. Estrategias de reducción de información para la codificación digital del vídeo. Espacios de color.

7. Algoritmos de compresión digital de vídeo. Formatos de compresión de vídeo digital. Formatos de archivo utilizados para el vídeo digital en Windows y Mac. Consideraciones a tener en cuenta en la mezcla de formatos de ficheros de vídeo digital.

8. Sistemas de grabación de vídeo digital para camascopios.

9. Buses digitales utilizados para la transmisión de vídeo.

10. El estándar MPEG2.

11. Estándares para DVD y Blu-Ray.

12. La gestión de vídeo en Windows. Directshow y Video for Windows.

13. Postproducción digital de vídeo y audio. Generalidades.

14. Aplicaciones de tratamiento de vídeo. Vegas Vídeo Pro, Adobe Premiere, Adobe After Effects.

15. Aplicaciones de tratamiento de audio. Soundforge, Protools.

16. Sistemas de audio y vídeo. Generalidades. Fuentes de señal de audio y vídeo. Normalización. Grabación de señales de audio y vídeo. Gestión de sistemas complejos.

17. Camascopios: lentes, tratamiento del color, ajustes, sistemas ENG.

18. Realización en plató. Generalidades.

19. Equipos de realización en plató: Mezcladores y tituladoras.

20. Equipos de plató: cámaras de estudio y otros.

21. Iluminación. Generalidades. Equipos de Iluminación en plató.

22. Codificación de vídeo para Internet. Windows Media Video, Flash, H.264.

23. Generalidades sobre audio. Impedancias, Unidades de medida, cableado y conexionado.

24. Características de los Micrófonos. Técnicas de captación sonora.

25. Sistemas para la grabación y edición de audio. Formatos de grabación de la señal de audio.

26. Funcionamiento y aplicaciones de mesa de mezclas de audio. Manejo de mesa de mezclas y fuentes de audio para la emisión y grabación de programas de televisión.

27. Funcionamiento de los equipos de procesado de la señal de audio. Procesadores de espectro, procesadores de dinámica, procesado temporal y multiefectos.

28. Aplicaciones de los procesadores de la señal de audio.

29. Legislación multimedia. Derechos de autor y propiedad intelectual.

30. Manipulación manual de cargas.

31. Manual Preventivo para empresas externas contratadas desde los centros de coste.
...
Se valorará por cada año de prestación de servicios o parte proporcional, no computándose a estos efectos de trabajo desarrollado las fracciones inferiores a un mes, en puestos de trabajo del grupo C, subgrupo C2, administración especial, de acuerdo con el nivel de complemento de destino asignado a los mismos, de acuerdo con la siguiente escala:
...
|  | Puntos |
| --- | --- |
| Haber superado el 3.º Curso de Idioma Comunitario de la Escuela Oficial de Idiomas | 0,75 |
| Haber superado el 5.º Curso de Idioma Comunitario de la Escuela Oficial de Idiomas | 1,50 |
