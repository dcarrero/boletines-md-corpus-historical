...
pagina_final: 62861
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-12206"
url_pdf: "https://www.boe.es/boe/dias/2009/07/23/pdfs/BOE-A-2009-12206.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-12206"
url_eli: "https://www.boe.es/eli/es/rd/2009/07/03/1082"
fetched_at: "2026-05-19T18:16:28Z"
...
b. Caprinos (cabra montés, sarrio/rebeco/gamuza). | Sarna sarcóptica. | Inspección clínica: Sin signos clínicos visibles. | Inmovilización preventiva y estudio epidemiológico. 
...
| Enfermedad Hemorrágica del Ciervo (sólo para cérvidos). | ELISA o RT-PCR negativo. | No se podrá realizar el movimiento. 
...
| Tuberculosis (no para el caso de ovinos). | Prueba de intradermoreacción a la tuberculina. 
...
Las pruebas mencionadas podrán sustituirse, en los animales abatidos en cacerías, por el resultado, debidamente documentado, de la inspección pos- mortem realizada por un veterinario oficial, habilitado o autorizado. | No se podrá realizar el movimiento. |  |
| Brucelosis. | Rosa de Bengala negativo. | Inmovilización preventiva y estudio epidemiológico. 
Sólo se autorizará el movimiento tras haber realizado una evaluación del riesgo previa y se hayan adoptado medidas específicas para reducir el citado riesgo. |  |
...
| Peste porcina clásica. | ELISA negativo. | No se podrá realizar el movimiento. 
...
| Peste porcina africana. | ELISA negativo. | No se podrá realizar el movimiento. 
...
| Enfermedad vesicular porcina. | ELISA negativo. | No se podrá realizar el movimiento. 
...
| Enfermedad de Aujeszky. | ELISA negativo. | Inmovilización preventiva y estudio epidemiológico. 
...
| Lagomorfos silvestres: Conejo y liebre. | Sarna sarcóptica. | Inspección clínica: Sin signos clínicos visibles. | Inmovilización preventiva y estudio epidemiológico. 
Sólo se autorizará el movimiento tras haber realizado una evaluación del riesgo previa y se hayan adoptado medidas específicas para reducir el citado riesgo. |
| Enfermedad hemorrágica vírica. | Inspección clínica: Sin signos clínicos visibles. | Inmovilización preventiva y estudio epidemiológico. 
Sólo se autorizará el movimiento tras haber realizado una evaluación del riesgo previa y se hayan adoptado medidas específicas para reducir el citado riesgo. |  |
| Mixomatosis. | Inspección clínica: Sin signos clínicos visibles. | Inmovilización preventiva y estudio epidemiológico. 
Sólo se autorizará el movimiento tras haber realizado una evaluación del riesgo previa y se hayan adoptado medidas específicas para reducir el citado riesgo. |  |
| Enfermedades producidas por hongos. Tiña (Trichophyton mentagrophytes). | Inspección clínica: Sin signos clínicos visibles. | Inmovilización preventiva y estudio epidemiológico. 
Sólo se autorizará el movimiento tras haber realizado una evaluación del riesgo previa y se hayan adoptado medidas específicas para reducir el citado riesgo. |  |
| Tularemia (sólo para el caso de liebre). | ELISA negativo. 
Las pruebas mencionadas podrán sustituirse, en los animales abatidos en cacerías, por el resultado, debidamente documentado, de la inspección post mortem realizada por un veterinario oficial, habilitado o autorizado. | Inmovilización preventiva y estudio epidemiológico. 
Sólo se autorizará el movimiento tras haber realizado una evaluación del riesgo previa y se hayan adoptado medidas específicas para reducir el citado riesgo. |  |
| Aves silvestres: Galliformes, columbiformes y anseriformes (patos y gansos). | Enfermedad de Newcastle. | RT-PCR de heces negativa. | No se podrá realizar el movimiento. 
...
| Influenza aviar. | RT-PCR de heces negativa. | No se podrá realizar el movimiento. 
...
| Salmonella enteritidis y Salmonella typhimurium. | Ausencia en muestras fecales. | Inmovilización preventiva y estudio epidemiológico. 
Sólo se autorizará el movimiento tras haber realizado una evaluación del riesgo previa y se hayan adoptado medidas específicas para reducir el citado riesgo. |  |
| Peces. | Septicemia hemorrágica vírica. 
Necrosis Hematopoyética infecciosa. 
Anemia infecciosa del salmón. | Procedentes de zonas o explotaciones declaradas libres. 
...
ELISA. | Inmovilización preventiva y estudio epidemiológico. 
Sólo se autorizará el movimiento tras haber realizado una evaluación del riesgo previa y se hayan adoptado medidas específicas para reducir el citado riesgo. 
