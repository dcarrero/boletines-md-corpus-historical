---
identificador: "BOE-A-2009-13799"
titulo: "Resolución de 30 de julio de 2009, de la Universidad Nacional de Educación a Distancia, por la que se convoca concurso oposición libre para acceder a plazas de personal laboral, grupo II-B."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
2.1.5 Titulación: Estar en posesión de un Título de Diplomado Universitario. En el caso de titulaciones obtenidas en el extranjero deberá estarse en posesión de la documentación que acredite su homologación en España.
...
3.3 Los derechos de examen serán de 21,11 € y se ingresarán en la cuenta de la Universidad Nacional de Educación a Distancia número 0049-0001-54-2211438387, del Banco Santander Central Hispano, realizando el ingreso en concepto de abono de derechos de examen de las pruebas selectivas del concurso-oposición libre para acceder a cuatro plazas vacantes de Programador, Grupo II-B, en el Centro de Servicios Informáticos.
...
c) Fotocopia compulsada del Título de Diplomado Universitario. En el caso de titulaciones obtenidas en el extranjero, documentación que acredite su homologación en España.

d) El aspirante incluido en la base 2.1.1.b) que no resida en España, deberá presentar fotocopia compulsada del resguardo de haber solicitado la tarjeta de residencia comunitaria. De no haber solicitado este documento deberá presentar los documentos expedidos por las autoridades competentes que acrediten el vinculo de parentesco y una declaración jurada o promesa del español o nacional de la Unión Europea o del Estado al que sea de aplicación la libre circulación de trabajadores con el que existe este vínculo, de que no está separado de derecho de su cónyuge y, en su caso, del hecho de que el candidato vive a sus expensas o está a su cargo.
...
La formalización del contrato supondrá la toma de posesión de su puesto por el trabajador. El personal de nuevo ingreso de acuerdo con el artículo 22 del Convenio Colectivo del Personal Laboral de la UNED, estará sometido a un período de prueba en el que no se computará el tiempo de incapacidad temporal y cuya duración será de tres meses.
...
9.2 Contra la presente Resolución, que agota la vía administrativa, se podrá interponer recurso potestativo de reposición, ante el Sr. Rector Magnífico de esta Universidad, en el plazo de un mes a contar desde el día siguiente a su publicación o recurso contencioso-administrativo ante la Sala de lo Contencioso-Administrativo del Tribunal Superior de Justicia de Madrid, en el plazo de dos meses a contar desde el día siguiente a su publicación.
...
Contestación de un cuestionario tipo test de 80 preguntas con respuestas alternativas, de las cuales sólo una será correcta, basado en el contenido del temario que figura en el Anexo III.

El tiempo máximo para la realización de este primer ejercicio será de 70 minutos.

Para superar este ejercicio será necesario obtener un resultado de un 60% de respuestas netas acertadas y la penalización será de 0,25 por pregunta mal contestada.

Segundo ejercicio:

Consistirá en la realización de un ejercicio, con tres supuestos teórico-prácticos a elegir por el opositor de entre varios propuestos por el Tribunal, que versará sobre el contenido de la parte específica del programa que figura en el Anexo III de esta convocatoria.
...
Presidente: D. Jordi Montserrat Garrocho, Gerente.

Vocales: D. Bernardo Granda Lostau, Director Departamento Gestión Administrativa CSI; D. Manuel Ortiz de la Guía, Analista de Sistemas; D. Juan Francisco Chamorro Pérez, Ordenanza; D.ª Esther Gómez Ruiz, Diplomado Universitario CINDITEC.

Secretaria: D.ª Mercedes Hernández Morales, Jefe Servicio Informática y Comunicaciones.

#### Suplentes

Presidente: Por delegación del Sr. Gerente, D. Alejandro de Mora Losana Careno, Director del Centro de Servicios Informáticos.

Vocales: D. Víctor Díaz-Toledo Gimeno, Programador; D. Juan Carlos Sánchez Cepeda, Programador; D. Ángel Iglesias Tejedor, Ordenanza; D. Enrique Obregón Heredero, Diplomado Universitario Departamento CC. y Tec. Físico-Químicas.

Secretaria: D.ª M.ª Carmen Gómez González, Jefe Servicio Implantación Procesos Académicos.
...
7. Ley Orgánica de protección de datos de carácter personal. Disposiciones generales. Principios de protección de datos. La protección de datos en la UNED.
...
1. Oracle: el modelo entidad/relación. El lenguaje SQL. Uso del SQL en PL/SQL. Programación PL/SQL. ODBC. JDBC. Utilización del pool de conexiones. Optimización de la utilización de Oracle: herramientas y normas.

2. Objetos de esquemas Oracle. Creación y gestión. Procesos en Oracle. Ficheros de control. Tablespaces, Redo Logs. Nociones del Grid Control de Oracle. Informes.

3. Middleware Oracle. Oracle Portal: arquitectura, fucionamiento. OAS, OC4J. Contenedores, proveedores, optimización. OID. SSO de Oracle. WebCenter.

4. Metodología de aplicaciones. Ciclo de desarrollo. Ciclo espiral. Diseño orientado a objeto. UML. CMMI. Herramientas de análisis, gestión de configuración, gestión de versiones, planes de prueba.

5. Lenguajes de etiquetas: HTML, DHTML, XHTML, CSS.

6. Arquitectura SOA: Webservices, XML, BPM, BPEL. Herramientas de Workflow.

7. ASP y JAVA: Estructura de componentes ASP y COM. Subprocesos y contextos. Secuencias de comandos. COM+. Creación de componentes ADO. Java. J2EE. EJB. JDKsy entornos integrados IDE. Portlets, Servlets, applets. Frameworks.

8. Lenguajes de script: VBScript y JavaScript.

9. Administración electrónica. Ley 11/2007 y componentes (registro, identificación, notificaciones, sello electrónico, sede electrónica, …). Ley de firma electrónica (59/2003). Criptografía: claves simétricas y asimétricas, RSA, PKI. DNI electrónico. Interoperabilidad entre administraciones. Ley de protección de datos 15/1999. Certificados electrónicos X509. Autoridades de certificación en España. Certificación electrónica. Autoridades. Notarios Electrónicos. TTP. Tecnologías para compartir y repartir claves.

10. Servidores web: IIS y Apache. Configurar y administrar servidores web y ftp. Monitorización y optimización. Archivos de configuración. Directivas de apache.

11. SO Windows 2003 server. Windows XP y Vista.

12. S.O. Linux (Red Hat)., UNIX.

13. Sistemas de almacenamiento físico. NAS y SAN.

14. Redes TCP/IP.

15. Arquitectura de redes. Protocolos de red. Ethernet, Frame Relay, ATM. Modelo OSI. ftp, POP3, IMAP, SSH. SSL,. Hardware de comunicaciones: Routers, Switches, Hubs. VoIP. SIP.

16. Seguridad en redes. HTTP y HTTPS. SSH. Confidencialidad, autenticación, Integridad, no repudio. VLAN. Seguridad en redes inalámbricas (Bluetooth, RFID,GSM, GPRS, UMTS, WLAN: WiFi, WMAN: Wi-Max). Cortafuegos.

17. Calidad en los sistemas de información. Metodologías. ISO 27000. ISO 9000. Modelo CMM (SEI) y CMMI. Metodología ITIL. Metodologías de pruebas (pruebas de stress, pruebas de integración, documentos de prueba). Ciclos de desarrollo (modelo espiral de Boehm). Políticas de salvaguarda/recuperación de la información. Análisis de riesgos. Utilización de herramientas de apoyo al ciclo del software: gestión de configuración, gestión de versiones, entornos CASE, gestión de incidencias.
...
Solicitud de participación en la Bolsa de Trabajo para cubrir puestos con carácter provisional como Programador, Grupo II-B, en el Centro de Servicios Informáticos, conforme a los acuerdos establecidos en la Universidad
