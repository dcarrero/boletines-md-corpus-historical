---
identificador: "BOE-A-2009-7938"
titulo: "Resolución de 7 de abril de 2009, del Consejo Insular de Mallorca (Illes Balears), referente a la declaración de bien de interés cultural a favor de Ses Olleries, Santa Eugénia."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
jurisdiccion: "local"
...
pagina_final: 40848
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-7938"
url_pdf: "https://www.boe.es/boe/dias/2009/05/12/pdfs/BOE-A-2009-7938.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-7938"
url_eli: ""
fetched_at: "2026-05-19T13:59:36Z"
...
I. Declarar Bien de Interés Cultural, con categoría de conjunto histórico, Ses Olleries, en el término municipal de Santa Eugènia, la descripción y la delimitación del cual figuran en el informe técnico de fecha 10 de abril de 2007, que se adjunta y forma parte integrante del presente acuerdo.
...
[Se publica como anexo un extracto del informe técnico de fecha 10 de abril de 2007. El informe íntegro al que hace referencia el apartado I del acuerdo de declaración, consta en el expediente administrativo núm. 153/07. Este expediente se podrá consultar en las dependencias del Servei de Patrimoni Històric (Plaça de l’Hospital, 4. 07012- Palma) por aquellos interesados en el procedimiento y que acrediten esta condición, de acuerdo con lo que dispone el art. 31 y ss. de la Ley 30/1992, de 26 de noviembre, de régimen jurídico de las administraciones públicas y del procedimiento administrativo común, modificada por la Ley 4/1999, de 13 de enero.]

I. Memoria descriptiva

La aldea de Ses Olleries, en el término de Santa Eugenia, debe su topónimo al gran número de obradores de alfareros especializados en la fabricación de ollas, tazas y otros recipientes y cacharros de cocina que había hasta el siglo XVII y XVIII, en que muchos de ellos se trasladaron al núcleo de Pòrtol, introduciendo allí esta actividad.

El núcleo de Ses Olleries se encuentra en el municipio de Santa Eugenia, en el declive meridional del Puig de Son Seguí, que tiene la cota más alta del término (320 m) y que, junto con el Puig de Santa Eugenia (245 m), conforman el espacio más montañoso del término, aunque con contornos muy suaves.

A diferencia de otros núcleos rurales de pequeñas dimensiones, presenta una disposición alargada siguiendo el trazado del camino que une la villa de Santa Eugenia con la carretera Palma-Sineu.

La trama urbana se estructura a partir de la calle principal, que atraviesa todo el núcleo, con las construcciones dispersas, a excepción de un área donde se presentan más próximos un mayor número de viviendas, aunque no llegan a estar agrupadas. El resto de calles, perpendiculares a la calle principal, rectas y no muy anchas, conducen a las viviendas situadas en la parte más elevada del núcleo. Cada casa conserva en su entorno espacios exteriores.
...
El abandono progresivo que se da a partir de la segunda mitad del siglo XX ha hecho que la aldea no se haya visto muy modificada por construcciones ajenas a la tipología tradicional, mostrándose como un conjunto arquitectónico representativo de la arquitectura rural mallorquina.

El tejido residencial, está formado por una sesentena de casas. Se trata de edificaciones de una o dos crujías, de planta baja y piso, de gran austeridad formal y constructiva, con escasa presencia de elementos decorativos. Del conjunto edilicio destaca Cas Penós, su Cova, son Mora, can Prim, can Planiol, son Pericàs, son Rigo, son Ponç, Can Freixura, Can Palou, Can Rom, Can Cotà, ses Rotes Velles, can Vidal, son Garrit. Entre ellos se conservan algunos hornos de alfareros.
...
Esta delimitación, tal como se muestra al anexo gráfico, incorpora todo el conjunto edificatorio original e histórico de Ses Olleries y los espacios exteriores más inmediatos.

La superficie incluida dentro de este conjunto histórico es de 72.841 m2.
...
3. Por ello, corregimos el criterio anterior con el análisis de visuales que hemos llevado a cabo. En el caso de Ses Olleries, y hablando de las visuales desde el núcleo hacia fuera y desde fuera hacia el núcleo se puede definir que:

a) visuales desde el núcleo hacia el exterior: desde el núcleo, tal como ya se ha dicho antes, nunca se pierde de vista la relación con el entorno natural que lo rodea, por un lado del núcleo se tienen claras visuales hacia la montaña que tiene por encima, y por el otro lado, hacia el norte, se tienen las visuales muy extensas hacia el este y el sureste, sobre la extensa llanura con los campos de cultivo.

b) visuales desde el exterior del núcleo hacia el núcleo: Puesto que Sess Olleries se sitúa a una vertiente orientada a sureste, las visuales desde la zona más alta de ses Olleries, desde algunas de las viviendas situadas en la cota más elevada, son sobre el núcleo y sobre la llanura descrita en el punto exterior. Desde la carretera de Palma a Sineu se tiene alguna visual sobre al núcleo, pero como éste tiene una cierta condición de disperso y está tan integrado en el entorno, es difícil de apreciar.
...
La superficie incluida dentro de éste entorno de protección es de 391.393 m2.
...
Se tienen que mantener también aquellos lugares y aspectos que resulten destacados en relación con la actividad relacionada con el barro que singularizó este lugar durante una época y le dio nombre.
...
A la hora de concluir sobre los aspectos que hacen de Ses Olleries uno de los núcleos con valores históricos i paisajísticos más destacados de la isla, y por tanto merecedores de una especial protección, cabe remarcar los siguientes:
...
2. Las transformaciones que han ido configurando el actual núcleo de Ses Olleries no han comportado ninguna ruptura con la adaptación de su trazado urbano a las características topográficas, presentando una trama urbana orgánica, integrada en su entorno.

3. A la vez que se ha mantenido la estructura urbana, Ses Olleries continúa formando un conjunto edilicio coherente con muestras de una arquitectura adaptada en el territorio, constituyendo un importante ejemplo de la arquitectura de la zona, donde se combinan valores arquitectónicos y etnológicos. La conservación de buena parte de su tejido edilicio hace que haya restos susceptibles de ser estudiado con metodología arqueológica y por lo tanto, y de acuerdo con el arte. 6.6 de la Ley 12/1998, también tiene que tener la consideración de zona arqueológica.

4. Ses Olleries es un ejemplo resultante de una ocupación del territorio comedida y repuesta a lo largo del tiempo, respondiendo a la coherencia y racionalidad de las necesidades constructivas en relación a los medios que se disponía en su momento y de una cultura sobre «la construcción del lugar». En este caso, están presentes los valores del núcleo que ha sabido resolver adecuadamente el diálogo entre el lugar donde se ubica, con respecto a sus valores de territorio y paisaje, y el asentamiento del conjunto edificado.
