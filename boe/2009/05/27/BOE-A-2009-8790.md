---
identificador: "BOE-A-2009-8790"
titulo: "Resolución de 19 de mayo de 2009, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A2, sector administración especial, Técnico Medio, por el sistema de concurso oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 44176
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-8790"
url_pdf: "https://www.boe.es/boe/dias/2009/05/27/pdfs/BOE-A-2009-8790.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-8790"
url_eli: ""
fetched_at: "2026-05-19T14:52:54Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 19 de mayo de 2009, de la Universidad Politécnica de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A2, sector administración especial, Técnico Medio, por el sistema de concurso oposición.

Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el artículo 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, el texto refundido de la Ley de la Función Pública Valenciana, y Decreto 33/1999, de 9 de marzo, del Gobierno Valenciano, acuerda convocar pruebas de acceso al Grupo A, Subgrupo A2, sector administración especial, Técnico Medio, de la Universidad Politécnica de Valencia, con arreglo a las siguientes bases:

1. Objeto de la convocatoria

1.1 La presente convocatoria tiene por objeto la selección de personal para cubrir una plaza vacante del Grupo A, Subgrupo A2, sector administración especial, Técnico Medio, de la Universidad Politécnica de Valencia, por el turno que a continuación se indica, y hasta un máximo de un 10% adicional, de conformidad con lo dispuesto en los artículos 61.8 y 70 de la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público:
...
3.4 Los derechos de examen serán de 17,89 euros, que se ingresarán en la cuenta corriente número 2077 0724 68 3100033835 –tasas–, de la Caja de Ahorros de Valencia (Bancaja), en la urbana 724, sita en la Universidad Politécnica de Valencia, camino de Vera, s/n, CP 46071, Valencia.
...
Valencia, 19 de mayo de 2009.–El Rector, Juan Juliá Igual.

### ANEXO I

| Código de puesto: PF1681 | Denominación del puesto: Técnico Medio. |
| --- | --- |
| Unidad: Área de Sistemas de Información y de las Comunicaciones. | Centro de destino: Centro de Atención al Asuario. |
| Localidad: Valencia. |  |
| Catalogación del puesto: A2 20 E026. | Titulación: Diplomado, Ingeniero Técnico, Arquitecto Técnico, o equivalente. |

Funciones del puesto:

Coordinar y supervisar el trabajo del personal asignado a su unidad de inferior categoría.

Soporte a los usuarios en el uso adecuado de herramientas informáticas de apoyo a la docencia. Establecimiento de recomendaciones de uso, mejores prácticas y resolución de incidencias.

Apoyo a los usuarios en la adecuada generación de contenidos, evaluación y comunicación eficaz para la formación semipresencial y no presencial.

Creación de herramientas de ayuda, autoformación, materiales formativos y documentación de herramientas informáticas de apoyo a la docencia y de otros tipos de aplicaciones informáticas universitarias.

Diseño, desarrollo y ejecución de acciones formativas sobre aplicaciones informáticas de apoyo a la docencia y otro tipo de aplicaciones informáticas universitarias.

Asesoría al resto del personal del ASIC en la correcta definición y para la creación de materiales formativos, de ayuda y de autoformación en los servicios y aplicaciones informáticas ofrecidas por esta área.

Organización, comunicación y seguimiento de planes y programas orientados a la implantación de tecnologías de la información y las comunicaciones en la docencia universitaria.
...
11. Ley Orgánica 3/07, de 22 de marzo, para la igualdad efectiva de mujeres y hombres.
...
17. El Espacio Europeo de Educación Superior: Guías docentes.

18. Los Planes de estudios. El perfil académico-profesional, las competencias, los créditos ECTS.

19. Las guías docentes de las asignaturas. Esquema general, programación detallada de las unidades didácticas.

20. El papel de las Tecnologías de la Información y las Comunicaciones (TIC) en el marco europeo de educación superior.

21. Técnicas pedagógicas para el buen uso de las TIC en la docencia. Las TIC como medios y recursos didácticos.

22. La innovación educativa en el Plan Estratégico de la Universidad Politécnica de Valencia (UPV) 2007-2014.

23. Plan Docencia en Red en la UPV.

24. Diseño y desarrollo de cursos y contenidos en línea.

25. Características generales de las plataformas tecnológicas de soporte a la educación superior presencial y a distancia.

26. Administración de plataformas de Campus Virtual. Administración de sitios en Sakai. Gestión de usuarios en Sakai.

27. Herramientas de autor. Gestores de contenido. Implementación en Sakai: Melete y Recursos.

28. Métodos de evaluación a través una plataforma tecnológica. Implementación en Sakai: Samigo, Tareas y Calificaciones.

29. Herramientas de organización a través de una plataforma tecnológica. Gestión de herramientas de organización en Sakai: Calendario y Anuncios.

30. Comunicación a través de una plataforma tecnológica. Gestión de herramientas de comunicación en Sakai: Espacio Compartido, Chat, Foros y Mensajería Interna.

31. Objetos de aprendizaje: Definición y clasificación. Concepto, características, ventajas y tipos.

32. Construcción de objetos de aprendizaje.

33. Módulos de aprendizaje. Concepto de módulo. Tipos de objeto de aprendizaje contenidos en los módulos.

34. Implementación práctica de módulos de aprendizaje.

35. Criterios de elaboración y evaluación de la calidad en materiales docentes.

36. Tecnologías multimedia para la docencia virtual.

37. Tecnologías de laboratorios virtuales para la docencia.

38. El repositorio de objetos de aprendizaje. Implementación de un repositorio de objetos de aprendizaje. Implementación en la UPV: Riunet.

39. El proyecto Open Courseware.

40. Formación en tecnología educativa dentro de la universidad. Aplicación y puesta en práctica en la UPV.

41. Formación del profesorado universitario en el uso de las TIC para la docencia.

42. Atención al usuario en tecnología educativa y uso de plataformas de campus virtual. Gestión de incidencias. Herramientas de gestión de incidencias. Integración en un centro de atención a usuarios.

43. El proceso de implantación del Sistema de Gestión Ambiental en la Universidad Politécnica de Valencia.

44. Gestión de los residuos no peligrosos en la Universidad Politécnica de Valencia. Normativa aplicable.

45. Derechos y Obligaciones del personal de la Universidad Politécnica de Valencia en materia de Seguridad y Salud en el trabajo.

46. Organización Preventiva en los Servicios.

Enlaces de interés:

http://www.upv.es; ttp://www.sprl.upv.es; http://www.upv.es/medioambiente.
...
| --- | --- |
| Haber superado el 3.er curso de Idioma Comunitario de la Escuela Oficial de Idiomas. | 0,75 puntos |
