---
identificador: "BOE-A-2009-5884"
titulo: "Resolución de 9 de marzo de 2009, de la Universidad Jaume I, por la que se convocan pruebas selectivas para el ingreso en la Escala Técnica Básica de Gestión de Instalaciones, mediante el sistema de oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 33350
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-5884"
url_pdf: "https://www.boe.es/boe/dias/2009/04/08/pdfs/BOE-A-2009-5884.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-5884"
url_eli: ""
fetched_at: "2026-05-19T12:07:44Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 9 de marzo de 2009, de la Universidad Jaume I, por la que se convocan pruebas selectivas para el ingreso en la Escala Técnica Básica de Gestión de Instalaciones, mediante el sistema de oposición.

Con el fin de atender las necesidades de personal en esta administración pública encargada del servicio público de la educación superior, este Rectorado, en uso de las competencias que le vienen atribuidas por la legislación vigente, acuerda convocar pruebas selectivas por el sistema de oposición para ingreso en la escala técnica básica de gestión de instalaciones de la Universitat Jaume I, con sujeción a las siguientes

Bases de la convocatoria

### 1. Normas generales

1.1 Se convocan pruebas selectivas para cubrir un puesto de trabajo de la escala técnica básica de gestión de instalaciones, de la Universitat Jaume I, adscrito al Servicio de Informática de la Universitat Jaume I.

1.2 Al presente proceso selectivo le será de aplicación la Ley orgánica 6/2001 de 21 de diciembre de universidades, modificada por la Ley orgánica 4/2007; el Estatuto Básico del Empleado Público; el Texto refundido de la ley de la función pública valenciana; el Decreto 33/1999, de 9 de marzo, del Gobierno valenciano, por el que se aprueba el reglamento de selección, provisión de puestos de trabajo y carrera administrativa del personal comprendido en el ámbito de aplicación de la Ley de función pública valenciana; los Estatutos de la Universitat Jaume I y lo dispuesto en la presente convocatoria.
...
Los aspirantes deberán cumplimentar el apartado Datos de la convocatoria de su solicitud: Código12130.
...
3.4 Las solicitudes serán facilitadas gratuitamente en la Conserjería del Edificio Rectorado y Servicios Centrales, Campus del Riu Sec de la Universitat Jaume I. Este modelo de solicitud también se podrá obtener desde la siguiente dirección de internet:

3.5 Los derechos de examen serán de 14,89 euros y se ingresarán en la cuenta corriente núm. 3104549646 -»Universitat Jaume I de Castelló. Derechos de examen»- en Bancaja, entidad 2077, sucursal 0580 de la c/ Caballeros, 2, haciendo constar en el ingreso «Pruebas selectivas para ingreso en la escala técnica básica de gestión de instalaciones de la Universitat Jaume I».
...
Consistirá en la realización de una prueba práctica, relacionada con la escala correspondiente.
...
5.4 Caso de realizarse el ejercicio en varias sesiones, el orden de intervención de los aspirantes comenzará por la letra «Z», siguiendo el orden alfabético de apellidos conforme a la Resolución de 23 de abril de 2008, de la Conselleria de Justicia y Administraciones Públicas (DOCV número 5755, de 5 de mayo de 2008).
...
e) Los aspirantes discapacitados, deberán presentar certificación de la Conselleria de Trabajo y Asuntos Sociales u órganos competentes de otras Administraciones Públicas, que acredite discapacidad igual o superior al 33%, así como su capacidad para desempeñar las funciones que correspondan a las vacantes ofertadas.
...
Castellón de la Plana, 9 de marzo de 2009.–El Rector, Francisco Toledo Lobo.
...
1. La Constitución española de 1978: estructura. Derechos y deberes fundamentales: de los españoles y extranjeros, derechos y libertades, de las garantías de las libertades y derechos fundamentales.

Las Cortes Generales: las Cámaras y elaboración de leyes.

El Gobierno: relaciones entre el Gobierno y las Cortes Generales.

El Tribunal Constitucional. La reforma de la Constitución.

2. El Estatuto de Autonomía de la Comunitat Valenciana: su estructura. Les Corts Valencianes. El president de la Generalitat Valenciana. El Gobierno valenciano.
...
6. La Ley de Prevención de Riesgos Laborales: derechos y obligaciones, consulta y participación de los trabajadores.

Temario específico

1. Cableado estructurado: Definición. Normativas. Tipos de cable. Certificación de instalaciones.

2. Sistemas de cableado para la transmisión de voz: Tipos de cable. Conectores, regletas y repartidores.

3. Fibra óptica: Características. Tipos de cables de fibra óptica. Conectores.

4. Centrales telefónicas (PBX): Conceptos generales. Tipos de terminales. Configuración. Servicios programables. Estándares de señalización entre centrales: SS7, Q.SIG.

5. Voz sobre IP: Conceptos básicos. Arquitectura de redes VoIP. Protocolo SIP.

6. Equipos de fuerza para conmutación y transmisión: Conceptos básicos. Equipos convertidores.

7. Sistemas de control de presencia: Conceptos básicos. Componentes. Tipos de tecnología. Estrategias.

8. Sistemas de control de acceso: Conceptos. Componentes. Tipos de tecnología para llaves y cerraduras. Amaestramiento, plan de cierre y gestión de listas.

9. RFID Mifare: Especificaciones de la tecnología. Personalización para distintas aplicaciones.

10. Sistemas de gestión de edificios: Inmótica.

11. Adquisición de datos, control y supervisión: Pasarelas serie/Ethernet, pasarelas/enrutadores. Contadores/medidores de consumo. Buses de comunicación. Protocolos de comunicación: Modbus, OPC, DDE. Software SCADA.

12. Fundamentos sobre electrotecnia: Conocimientos generales. Interpretación de esquemas eléctricos. Equipos de medida.

13. Conceptos sobre redes de ordenadores. Redes Ethernet. Protocolo TCP/IP.
...
a) Certificado nivel medio de conocimientos de valenciano expedido por la Universitat Jaume I o equivalente según el acuerdo publicado en la siguiente dirección electrónica
