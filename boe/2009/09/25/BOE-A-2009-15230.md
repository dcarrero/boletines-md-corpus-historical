---
identificador: "BOE-A-2009-15230"
...
pagina_final: 80986
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-15230"
url_pdf: "https://www.boe.es/boe/dias/2009/09/25/pdfs/BOE-A-2009-15230.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-15230"
url_eli: ""
fetched_at: "2026-05-19T21:13:44Z"
...
## ANEXO. Convenio entre la Comunidad Autónoma de Galicia y el Ministerio de Trabajo e Inmigración (INSS) por el que se acuerda ejecutar para el año 2009 un programa específico que tiene por objeto el estudio del comportamiento de los procesos de incapacidad temporal (IT) derivados de ciertas patologías y el desarrollo de determinadas estrategias para mejorar la gestión de ésta prestación
...
Y de otra parte, Dª Maria del Pilar Farjas Abadía, Consejera de Sanidad en nombre y representación de la Comunidad de Galicia.
...
Este Convenio es plenamente compatible en su contenido y desarrollo con el también firmado por las dos Administraciones, el pasado 8 de enero, denominado: «Convenio de colaboración entre el Ministerio de Trabajo e Inmigración (INSS) y la Comunidad Autónoma de Galicia para el control de la Incapacidad Temporal durante el periodo 2009-2012».
...
Primera. El presente Convenio tiene por objeto establecer la colaboración entre el INSS y la Comunidad de Galicia para el desarrollo del Programa Específico, que se acompaña como parte integrante del Convenio. Con él, se pone en marcha un programa de estudio sobre el comportamiento de los procesos de IT derivados de ciertas patologías a fin de fijar los adecuados controles sobre la prestación. Asimismo se pretende establecer el seguimiento de ciertos procesos derivados de patología psiquiátrica por Áreas de Inspección, dotarse de un sistema informático con un adecuado desarrollo a fin de obtener explotaciones que aumenten el conocimiento sobre el comportamiento de la IT y finalmente establecer para los Inspectores Médicos del INSS la capacidad de acceso a la base de datos informatizada de las historias clínicas en la Comunidad Autónoma.

Segunda. La Comunidad de Galicia, a través de la Consejería de Sanidad y de su Servicio Público de Salud, se compromete a:
...
Efectuar un seguimiento singularizado de cada uno de los procesos de IT que se generen por patología psiquiátrica de determinados diagnósticos conforme se relacionan en el apartado 2 del programa.

Llevar a cabo las actividades necesarias, encaminadas a desarrollar su sistema informático, en orden a obtener la información precisa sobre la prescripción de procesos de IT por los médicos de Atención Primaria de la Comunidad.
...
Y en prueba de conformidad, firman el presente Convenio en duplicado ejemplar, quedándose uno en poder de cada parte, en el lugar y fecha arriba indicados. Por el Ministerio de Trabajo e Inmigración.–El Secretario de Estado de la Seguridad Social, Octavio J. Granado Martínez, el Director General del I.N.S.S., Fidel Ferreras Alonso.– Por la Comunidad Autónoma de Galicia, La Consejera de Sanidad, María del Pilar Farjas Abadía.

PROGRAMA ESPECÍFICO

Estudio del comportamiento de los procesos de incapacidad temporal (IT) derivados de ciertas patologías y desarrollo de determinadas estrategias para mejorar la gestión de esta prestación en la Comunidad Autónoma de Galicia

Este Programa plantea aprovechar la experiencia de los estudios realizados entre el Instituto Nacional de la Seguridad Social (INSS) y la Comunidad Autónoma de Galicia a través de la Consejería de Sanidad y el Servicio Público de Salud.

De la experiencia acumulada por el desarrollo de los Convenios de colaboración para el control de la Incapacidad Temporal, firmados por el INSS y esta Comunidad Autónoma, en los años anteriores, viene a destacarse la importancia de analizar el comportamiento de los procesos de IT en determinadas patologías o problemas de salud, que son responsables de un porcentaje elevado del conjunto de procesos de IT en esa Comunidad.
...
El programa establece cuatro objetivos: el primero, se refiere al estudio y control de procesos de IT por patologías; el segundo, establece un seguimiento pormenorizado de ciertos procesos de IT derivados de patología psiquiátrica; el tercero, se ocupa del desarrollo y mejora de la aplicación informática INTEM y el cuarto, establece para los Inspectores Médicos del INSS, la capacidad de acceso a la base de datos informatizada de las historias clínicas en la Comunidad Autónoma
...
2. Estudio y control de los procesos de IT derivados de patología psiquiátrica por Áreas de Inspección.–Mediante este objetivo se establece un protocolo específico de tratamiento y control de los siguientes diagnósticos.

| Código | Descripción del diagnóstico |
| --- | --- |
| 300 | TRASTORNOS NEUROTICOS. |
| 302 | TRASTORNO DE ANSIEDAD GENERALIZADO. |
| 308 | REACCIÓN AGUDA AL STRESS. |
| 309 | REACCIÓN DE ADAPTACIÓN. |
| 311 | TRASTORNO DEPRESIVO. |
| 313 | TRASTORNOS DE ANSIEDAD. |

Se pretende conocer el comportamiento de los procesos de IT derivados de unos determinados trastornos psiquiátricos (Anexo I) en las diferentes áreas sanitarias de la Comunidad, y conseguir, mediante el establecimiento de un sistema adecuado de controles, un ajuste de las duraciones medias de estos procesos y una reducción en los días de IT en aras de la racionalización de la prestación.
...
3. Implantación y desarrollo del programa informático INTEM.–Este objetivo, pretende modificar y desarrollar el programa de gestión INTEM con la finalidad de mejorar su funcionalidad.

Se configura un perfil de prescripción que incluye los siguientes datos: incidencia, prevalencia, tasa global de absentismo, duración media y diez diagnósticos más frecuentes. Además se elabora un nuevo perfil que permitirá realizar comparaciones de cada CIAS con su centro de salud y con el Área Sanitaria.

La consecución de este objetivo, exige la elaboración de un plan de actividades secuenciales que habrá de especificar la Comunidad, estableciendo un calendario de ejecución de las mismas. Dicho plan de actividades y la ponderación que éstas tengan entre sí será objeto de consenso en la Comisión Mixta Central de seguimiento.

Ponderación en el programa: este objetivo tienen, en el total del crédito asignado, un peso del 30%.

4. Acceso de Inspectores Médicos del INSS a la base de datos informatizada de historias clínicas.–Con este objetivo, ambas administraciones firmantes se comprometen a desarrollar las actividades necesarias a fin de alcanzar, para los Inspectores Médicos del INSS en la Comunidad, la capacidad de acceder informáticamente a las historias clínicas correspondientes a los procesos de incapacidades laborales que se gestionen en su territorio.

La consecución de este objetivo, exige la elaboración de un plan de actividades secuenciales que habrá de especificar la Comunidad, estableciendo un calendario de ejecución de las mismas. Dicho plan de actividades y la ponderación que éstas tengan entre sí será objeto de consenso en la Comisión Mixta Central de seguimiento.

Ponderación en el programa: este objetivo tienen, en el total del crédito asignado, un peso del 20%.

5. Comunicación entre el Servicio Público de Salud y el INSS.–La Comisión Mixta establecerá unos cauces específicos de comunicación entre el INSS y el Servicio Público de Salud, mediante los cuales fluya cuanta información, datos y documentos se consideren oportunos para el eficaz desarrollo de las experiencias que se ponen en marcha.
...
Para la ejecución del Programa se pondrá a disposición del Servicio de Público de Salud, mediante un anticipo a cuenta, los fondos necesarios para poner en marcha el citado Programa. En fechas posteriores, coincidiendo con las etapas marcadas, se irán efectuando liquidaciones ajustadas a los objetivos alcanzados en cada una de ellas.

Anticipos y liquidaciones

Al inicio del Programa, el Servicio de Público de Salud recibe un anticipo del 25% del crédito. Esta cantidad se mantendrá anticipada a lo largo de la ejecución del Convenio y sólo será objeto de liquidación al final del mismo.
