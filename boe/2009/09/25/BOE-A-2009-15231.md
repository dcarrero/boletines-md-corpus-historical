---
identificador: "BOE-A-2009-15231"
...
pagina_final: 80993
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2009-15231"
url_pdf: "https://www.boe.es/boe/dias/2009/09/25/pdfs/BOE-A-2009-15231.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2009-15231"
url_eli: ""
fetched_at: "2026-05-19T21:13:45Z"
...
## ANEXO. Convenio entre la Comunidad Autónoma de la Rioja y el Ministerio de Trabajo e Inmigración (INSS) por el que se acuerda ejecutar para el año 2009 un programa específico que tiene por objeto el estudio del comportamiento de los procesos de incapacidad temporal (IT) derivados de ciertas patologías y el desarrollo de determinadas estrategias para mejorar la Gestión de esta prestación
...
Y, de otra parte, D. José Ignacio Nieto García, Consejero de Salud, en nombre y representación de la Comunidad Autónoma de La Rioja, nombrado para este cargo por Decreto de la Presidencia 13/2007, de 2 de julio («BOR» de 3 de julio), actuando en ejercicio de las facultades que legalmente tiene atribuidas.
...
Primera.–El presente Convenio tiene por objeto establecer la colaboración entre el INSS y la Comunidad Autónoma de La Rioja para el desarrollo del Programa Específico, que se acompaña como parte integrante del Convenio. Con él se pone en marcha un programa de estudio sobre el comportamiento de los procesos de IT derivados de ciertas patologías a fin de fijar los adecuados controles sobre la prestación. Asimismo se pretende establecer el acceso de los Inspectores Médicos del INSS a la base de datos informatizada de las historias clínicas y dotarse de un sistema informático con un adecuado desarrollo a fin de obtener explotaciones que aumenten el conocimiento sobre el comportamiento de la IT en la Comunidad Autónoma.

Segunda.–La Comunidad de La Rioja, a través de la Consejería de Salud y de su Servicio Público de Salud, se compromete a:
...
Llevar a cabo las actividades necesarias, encaminadas a desarrollar su sistema informático, en orden a obtener la información precisa sobre la concordancia que se produce entre los procesos de IT y los asegurados.
...
Y, en prueba de conformidad, firman el presente Convenio en duplicado ejemplar, quedándose uno en poder de cada parte, en el lugar y fecha arriba indicados. Por el Ministerio de Trabajo e Inmigración.–El Secretario de Estado de la Seguridad Social, Octavio J. Granado Martínez; el Director General del INSS, Fidel Ferreras Alonso.–Por la Comunidad Autónoma de La Rioja, el Consejero de Salud, José Ignacio Prieto García.

Programa Específico

Estudio del comportamiento de los procesos de incapacidad temporal (IT) derivados de ciertas patologías y desarrollo de determinadas estrategias para mejorar la gestión de esta prestación en la Comunidad Autónoma de La Rioja

Este Programa plantea aprovechar la experiencia de los estudios realizados entre el Instituto Nacional de la Seguridad Social (INSS) y la Comunidad Autónoma de La Rioja a través de la Consejería de Salud y el Servicio Público de Salud.
...
El programa establece tres objetivos: El primero, se refiere al estudio y control de procesos de IT por patologías; el segundo, establece para los Inspectores Médicos del INSS, la capacidad de acceso a la base de datos informatizada de las historias clínicas en la Comunidad Autónoma y el tercero, se ocupa del desarrollo y mejora de la aplicación informática SAGITARIO, con la incorporación de un módulo de especial control de la IT.
...
Anticipos y liquidaciones.–Al inicio del Programa, el Servicio de Público de Salud recibe un anticipo del 25 % del crédito. Esta cantidad se mantendrá anticipada a lo largo de la ejecución del Convenio y sólo será objeto de liquidación al final del mismo.
