---
identificador: "BOE-A-2018-9691"
titulo: "Resolución de 2 de julio de 2018, de la Universidad Internacional Menéndez Pelayo, por la que se publica el Convenio con Paramotion Films, SRL."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 69290
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2018-9691"
url_pdf: "https://www.boe.es/boe/dias/2018/07/11/pdfs/BOE-A-2018-9691.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2018-9691"
url_eli: ""
fetched_at: "2026-04-19T10:51:10Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 2 de julio de 2018, de la Universidad Internacional Menéndez Pelayo, por la que se publica el Convenio con Paramotion Films, SRL.

La Universidad Internacional Menéndez Pelayo y Paramotion FILMS, S. R. L., han suscrito, con fecha 14 de junio de 2018, un Convenio para la realización de prácticas académicas externas curriculares o extracurriculares y proyectos de fin de Máster por parte de los alumnos de Cursos de Postgrado de esta Universidad, por lo que conforme a lo previsto en el artículo 48.8 de la Ley 40/2015, de 1 de octubre, del Régimen Jurídico del Sector Público, una vez inscrito en el Registro Electrónico estatal de Órganos e Instrumentos de Cooperación del sector público estatal, procede la publicación en el «Boletín Oficial del Estado» de dicho convenio, que figura como anexo a esta resolución.

Madrid, 2 de julio de 2018.–El Rector de la Universidad Internacional Menéndez Pelayo, Emilio Lora-Tamayo D´Ocon.

## ANEXO. Convenio entre la Universidad Internacional Menéndez Pelayo (UIMP) y Paramotion Films SRL para la realización de prácticas académicas externas por parte de estudiantes de postgrado de la UIMP
...
Y, de otra parte, don José Luis Farias Gómez, representante legal de Paramotion Films SRL (entidad con NIF. B76659002 y domicilio social Batalla del Salado, 3, esc B, 6.º B, 28045 Madrid. España) en su condición de Administrador Solidario y haciendo uso de los poderes otorgados mediante escritura notarial, Escritura Pública otorgada por el Notario de Madrid don Alejandro Miguel Velasco Gómez, con el nº 2007/850 de su protocolo, en fecha 13 de Marzo de 2007, poderes que declara no le han sido revocados, ni disminuidos.
...
II. Que Paramotion Films SRL es una productora audiovisual.

Que Paramotion Films SRL tiene interés en colaborar con al UIMP estableciendo un convenio que establezca el marco permanente que permita la incorporación temporal de estudiantes de los Programas de Postgrado de la UIMP con el objeto de que puedan realizar sus prácticas académicas externas curriculares o extracurriculares y Trabajos de Fin de Máster.
...
El objeto del presente convenio es regular la relación entre la UIMP y Paramotion Films SRL con el fin de que los alumnos de los Programas de Postgrado de la UIMP, puedan realizar en Paramotion Films SRL sus prácticas académicas externas curriculares o extracurriculares y proyectos de fin de Máster, en las condiciones que se establecen en las cláusulas siguientes, que se completarán en sucesivos anexos para cada uno de los alumnos y periodos de prácticas.
...
Las prácticas que los alumnos realicen en Paramotion Films SRL podrán ser dediferentes modalidades:
...
▪ No mantengan ninguna relación contractual con Paramotion Films SRL, salvo autorización especial de la UIMP.
...
II. En el caso de que al término de los estudios el estudiante se incorporase a la plantilla de Paramotion Films SRL el tiempo de las prácticas no se computará a efectos de antigüedad ni eximirá del periodo de prueba salvo que en el correspondiente convenio colectivo aplicable estuviese expresamente estipulado algo distinto.
...
II. Los horarios de realización de las prácticas se establecerán de acuerdo con las características de las mismas y las disponibilidades de Paramotion Films SRL En todo caso se procurará que sean compatibles con la actividad académica, formativa y de representación y participación desarrollada por el estudiante en la UIMP.
...
El Tutor de Paramotion Films SRL deberá ser una persona vinculada a la entidad con experiencia profesional y los conocimientos necesarios para realizar una tutela efectiva.
...
Con la finalidad de mantener actualizado en todo momento el registro de alumnos participantes en el presente convenio, Paramotion Films SRL comunicará por escrito a la UIMP cualquier incidencia o modificación en las fechas de inicio o cese, horario u otras circunstancias que se produzca en cada práctica que se realice en la empresa en relación con lo acordado en su Anexo correspondiente.

## Octava. Derechos y deberes de los estudiantes.

Durante el periodo de prácticas cada alumno estará sujeto a las normas generales de trabajo propias de Paramotion Films SRL, especialmente en lo referido al cumplimiento del horario, régimen de permisos, identificación, normas de seguridad y de prevención de riesgos laborales, etc., para lo que recibirán la adecuada información. Asimismo los alumnos mostrarán en todo momento una actitud respetuosa hacia la política de Paramotion Films SRL

Los estudiantes estarán obligados a guardar confidencialidad en relación con la información interna de Paramotion Films SRL y guardar secreto profesional sobre sus actividades, durante su estancia y finalizada ésta.
...
– El Tutor de Paramotion Films SRL realizará y enviará al Tutor académico de la UIMP y a la UIMP un Informe final según modelo que se adjunta como ANEXO II, en el que se recogerá el número de horas realizadas por el estudiante y se valorarán diversas capacidades y actitudes en relación con las competencias genéricas y específicas previstas en el proyecto formativo.
...
– El Tutor académico de la UIMP, a la vista del informe del Tutor de Paramotion Films SRL y de la Memoria final presentada por el estudiante, evaluará las prácticas cumplimentando el correspondiente Informe de valoración.
...
En concepto de bolsa o ayuda al estudio, de Paramotion Films SRL podrá, si lo considera oportuno, conceder a cada alumno participante en el programa una cantidad mensual que dependerá del curso académico del alumno, de su dedicación horaria y del tiempo de duración de la práctica. El importe, si lo hubiera, se recogerá en el Anexo de formalización de la práctica.

## Undécima. Gastos de gestión del programa de prácticas por la UIMP.

La UIMP renuncia a percibir de Paramotion Films SRL cantidad alguna en concepto de gastos vinculados a la gestión de los programas de prácticas cualquiera que sea la modalidad de éstas.

## Duodécima. Finalización anticipada de las prácticas.

I. La UIMP se reserva la facultad de dar por finalizada una práctica por incumplimiento por parte de Paramotion Films SRL de alguno de los compromisos adquiridos en este convenio y sus anexos.

Asimismo la UIMP podrá solicitar la finalización de un periodo de prácticas en caso de que su Tutor académico valore que las actividades que se están desarrollando no corresponden con lo pactado en el proyecto formativo y por tanto no son útiles para el desarrollo de las capacidades y competencias curriculares del alumno, sin que este hecho haya podido ser solucionado a través de la oportuna coordinación y comunicación con el Tutor designado por Paramotion Films SRL para dicha práctica. La UIMP deberá notificar este hecho a Paramotion Films SRL, quien podrá reorganizar las tareas del alumno o dar por finalizada la práctica en el plazo de 10 días desde la recepción de la notificación.

II. Paramotion Films SRL podrá, por su parte, dar por finalizada, para un determinado alumno o grupo de alumnos, la participación en el Programa por incumplimiento de las cláusulas establecidas en el presente convenio yen sus Anexos, o vulneración de las normas que, en relación con la realización de las actividades programadas, estén, en cada caso, vigentes (faltas de puntualidad o de asistencia, incorrecto comportamiento, manifiesta falta de adecuación entre las tareas a realizar y la formación y aptitudes del alumno, actitud negativa o inapropiada del alumno, falta del deber de confidencialidad, etc.), sin que estos problemas hayan podido ser solucionados a través de la oportuna coordinación y comunicación con el Tutor designado por la UIMP. En este caso bastará la comunicación escrita y motivada al alumno, al tutor de la UIMP y a la UIMP para el cese de la relación de prácticas de dicho alumno.
...
La UIMP se compromete a considerar a Paramotion Films SRL como Entidad Colaboradora de sus programas de prácticas, y a difundirlo así en la Memoria oficial anual del organismo y en cuantos medios considere conveniente.
...
Y en prueba de conformidad, firman el presente Convenio, en duplicado ejemplar, en el lugar y fecha arriba indicados.–Emilio Lora-Tamayo D´Ocon, Rector de la Universidad Internacional Menéndez Pelayo.–José Luis Farias Gómez, Administrador solidario de Paramotion Films SRL.
...
## ANEXO II. Modelo del informe final a cumplimentar por el tutor de Paramotion Films SRL
