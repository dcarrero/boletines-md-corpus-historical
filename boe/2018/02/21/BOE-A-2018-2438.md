...
pagina_final: 20107
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2018-2438"
url_pdf: "https://www.boe.es/boe/dias/2018/02/21/pdfs/BOE-A-2018-2438.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2018-2438"
url_eli: ""
fetched_at: "2026-04-19T00:57:07Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 8 de febrero de 2018, de la Secretaría de Estado de Función Pública, por la que se publica el Convenio entre la Secretaría General de Administración Digital y la Sociedad Estatal de Participaciones Industriales, para la utilización de la "Gestión Integrada de Servicios de Registro" como aplicación integral de registro.

El Secretario General de Administración Digital y D. Bartolomé Lora Toro y D.ª María Jesús Álvarez González, en representación de la Sociedad Estatal de Participaciones Industriales, han suscrito, con fecha 24 de enero de 2018, un Convenio para la utilización de la «Gestión Integrada de Servicios de Registro» (GEISER) como aplicación integral de registro.
...
## ANEJO. Convenio entre la Administración General del Estado (Secretaria General de Administración Digital) y la Sociedad Estatal de Participaciones Industriales (SEPI) para la utilización de la «Gestión Integrada de Servicios de Registro» (GEISER) como aplicación integral de registro
...
De otra parte, don Bartolomé Lora Toro, con NIF 51.340.133-Q y doña María Jesús Álvarez González, con NIF nº 42.966.727-J actuando en nombre y representación de la Sociedad Estatal de Participaciones Industriales (SEPI), Entidad de Derecho Público, CIF Q-2820015-B, con domicilio oficial en Madrid, c/ Velázquez, 134.

Ostentan dicha representación en virtud de escritura de poder, otorgada ante el Notario de Madrid don Ramón María Luis Sánchez González, el día 11 de octubre de 2017, con el número 2.786 de su protocolo y escritura de poder, otorgada ante el Notario de Madrid don José Madridejos Fernández el día 3 de agosto de 2012, con el número 1.619 de su protocolo, respectivamente, que declaran vigentes.
...
1. Para la SGAD, la puesta a disposición de SEPI de la aplicación informática denominada «GEISER», como solución tecnológica para la gestión de los libros de registro de entrada y salida de dicho organismo, así como para la interconexión electrónica de su registro con el Sistema de Interconexión de Registros y el Registro Electrónico.

2. Para SEPI el uso de la aplicación citada, con sus propios recursos, para contribuir a la racionalización del uso de las tecnologías de la información y las comunicaciones en las Administraciones y, adaptar sus sistemas de información a los requisitos mínimos exigidos por la SGAD para el uso de la citada plataforma que figuran en el manual de usuario proporcionado por la SGAD.

3. La SGAD, y SEPI se prestarán el soporte necesario para la solución de las incidencias técnicas, de carácter informático, de la aplicación, en los términos recogidos en la cláusula quinta de este Convenio.

## Segunda. Especificaciones de la aplicación.

1. La conexión de los usuarios de SEPI a la aplicación «GEISER» se hará a través de la Red SARA, gestionada por la SGAD, que adoptará las medidas de seguridad que garanticen la confidencialidad del tránsito de la información intercambiada.

2. La aplicación distinguirá entre el grupo de usuarios de SEPI y el de usuarios de la SGAD y otros organismos.
...
a) Adscribir al proyecto los medios humanos y técnicos necesarios para la adecuada adaptación e implantación inicial de la citada aplicación en SEPI.

b) Proporcionar, antes de la puesta en producción de la aplicación, material para la autoformación específica del personal de SEPI encargado de dar soporte funcional e informático a la misma.

c) Proponer una lista de indicadores de seguimiento a los efectos de obtener la información necesaria durante la puesta a disposición de la aplicación «GEISER» en relación a la prestación del servicio por la SGAD, a SEPI.

2. SEPI se compromete a:

a) Utilizar la aplicación GEISER para la gestión de su registro oficial de entrada/salida en sus oficinas de registro y unidades tramitadoras. En este sentido y, conforme a la experiencia registrada en el ejercicio inmediatamente anterior a la firma de este Convenio, SEPI estima una previsión de uso de 2.700 asientos registrales.
...
1. La SGAD, realizará las labores de adaptación para la implantación inicial de la aplicación en SEPI.

a) Configuración técnica de los parámetros de GEISER relacionados con la conexión a SIR de las oficinas de SEPI.

b) Configuración en GEISER de las unidades de SEPI no contenidas en el Directorio Común DIR3.

c) Configuración en GEISER de los gestores de los accesos a los distintos ámbitos de SEPI configurados en la aplicación.
...
2. Por otra parte, la documentación electrónica contenida en la aplicación GEISER correspondiente a los registros de SEPI estará disponible en la aplicación por un periodo máximo de 1 año desde su entrada en el sistema.
...
Por su parte, SEPI contribuirá al mantenimiento anual de la sostenibilidad funcional y técnica de la aplicación GEISER con una contraprestación económica que se determina en base al uso del servicio. El cálculo de la contribución económica se realizará conforme a los criterios establecidos en el anexo I de este Convenio.

En particular, SEPI ha estimado, para el primer año de vigencia del Convenio, que el uso de la aplicación en 2.700 asientos registrales, según lo que certifica en el anexo II de este Convenio, por lo que el alcance de la contraprestación económica es de 0 Euros.
...
Anualmente, con dos meses de antelación respecto a la fecha de la firma inicial del convenio, SEPI, comunicará a la SGAD la estimación para el ejerció anual siguiente.
...
En caso de resolución, ambas partes deberán adoptar, de acuerdo con lo previsto en el artículo 52.3 de la Ley 40/2015, de 1 de octubre, las medidas necesarias para asegurar, en todo caso, el mantenimiento del servicio público electrónico a los ciudadanos prestado por SEPI con las aplicaciones proporcionadas por la SGAD.
...
En prueba de conformidad, y para que conste a los efectos oportunos, las partes firman el presente Convenio.–Por la Secretaría General de Administración Digital, Domingo Molina Moscoso.–Por SEPI, el Vicepresidente, Bartolomé Lora Toro y la Directora de Administración y Gestión Financiera, M.ª Jesús Álvarez González.
...
Doña María Jesús Álvarez González, como directora económico-financiera de SEPI, declara que durante el ejercicio 2016 el número de asientos registrales de entrada y salida que fueron realizados conjuntamente en las oficinas de registro que se incorporarán a la aplicación GEISER en las condiciones del presente convenio/acuerdo, asciende a un total de 2.647 asientos registrales.

Para el periodo anual inicial de vigencia del Convenio, se estima un total de 2.700 asientos registrales.
...
Fdo: M.ª Jesús Álvarez González.
