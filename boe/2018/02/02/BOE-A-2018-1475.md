---
identificador: "BOE-A-2018-1475"
titulo: "Resolución de 25 de enero de 2018, de la Subsecretaría, por la que se publica el Convenio entre la Secretaría General de Administración Digital y la Agencia de Información y Control Alimentarios, para la utilización de la \"Gestión Integrada de Servicios de Registro\" (GEISER) como aplicación integral de registro."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 13285
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2018-1475"
url_pdf: "https://www.boe.es/boe/dias/2018/02/02/pdfs/BOE-A-2018-1475.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2018-1475"
url_eli: ""
fetched_at: "2026-04-18T23:20:10Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 25 de enero de 2018, de la Subsecretaría, por la que se publica el Convenio entre la Secretaría General de Administración Digital y la Agencia de Información y Control Alimentarios, para la utilización de la "Gestión Integrada de Servicios de Registro" (GEISER) como aplicación integral de registro.

El Secretario General de Administración Digital y el Director de la Agencia de Información y Control Alimentarios han suscrito, con fecha 4 de enero de 2018, un Convenio para la utilización de la «Gestión Integrada de Servicios de Registro» (GEISER) como aplicación integral de registro.
...
## ANEJO. Convenio entre la Administración General del Estado (Secretaria General de Administración Digital) y la Agencia de Información y Control Alimentarios (AICA) para la utilización de la «Gestión Integrada de Servicios de Registro» (GEISER) como aplicación integral de registro
...
De otra parte, José Miguel Herrero Velasco, Director de la Agencia de Información y Control Alimentarios actuando en nombre y representación de este organismo, nombrado para este cargo por Orden AAA/502/2015 publicada en el «BOE» núm. 71, de 24 de marzo de 2015, y facultado expresamente para este acto en virtud de lo dispuesto en el artículo 5.i) del estatuto de la Agencia de Información y control Alimentarios, aprobado por el Real Decreto 227/2014, de 4 de abril.
...
1. Para la SGAD, la puesta a disposición de AICA de la aplicación informática denominada «GEISER», como solución tecnológica para la gestión de los libros de registro de entrada y salida de dicho organismo, así como para la interconexión electrónica de su registro con el Sistema de Interconexión de Registros y el Registro Electrónico.

2. Para AICA el uso de la aplicación citada, con sus propios recursos, para contribuir a la racionalización del uso de las tecnologías de la información y las comunicaciones en las Administraciones y, adaptar sus sistemas de información a los requisitos mínimos exigidos por la SGAD para el uso de la citada plataforma que figuran en el manual de usuario proporcionado por la SGAD.

3. La SGAD, y AICA se prestarán el soporte necesario para la solución de las incidencias técnicas, de carácter informático, de la aplicación, en los términos recogidos en la cláusula quinta de este Convenio.

## Segunda. Especificaciones de la aplicación.

1. La conexión de los usuarios de AICA a la aplicación «GEISER» se hará a través de la Red SARA, gestionada por la SGAD, que adoptará las medidas de seguridad que garanticen la confidencialidad del tránsito de la información intercambiada.

2. La aplicación distinguirá entre el grupo de usuarios de AICA y el de usuarios de la SGAD y otros organismos.
...
a) Adscribir al proyecto los medios humanos y técnicos necesarios para la adecuada adaptación e implantación inicial de la citada aplicación en AICA.

b) Proporcionar, antes de la puesta en producción de la aplicación, material para la autoformación específica del personal de AICA encargado de dar soporte funcional e informático a la misma.

c) Proponer una lista de indicadores de seguimiento a los efectos de obtener la información necesaria durante la puesta a disposición de la aplicación «GEISER» en relación a la prestación del servicio por la SGAD, a AICA.

2. AICA se compromete a:

a) Utilizar la aplicación GEISER para la gestión de su registro oficial de entrada/salida en sus oficinas de registro y unidades tramitadoras. En este sentido y, conforme a la experiencia registrada en el ejercicio inmediatamente anterior a la firma de este Convenio, AICA estima una previsión de uso de 16.000 asientos registrales.
...
1. La SGAD, realizará las labores de adaptación para la implantación inicial de la aplicación en AICA.

a) Configuración técnica de los parámetros de GEISER relacionados con la conexión a SIR de las oficinas de AICA.

b) Configuración en GEISER de las unidades de AICA no contenidas en el Directorio Común DIR3.

c) Configuración en GEISER de los gestores de los accesos a los distintos ámbitos de AICA configurados en la aplicación.
...
a) Corresponderá a AICA dar soporte a la solución de las mismas, siempre y cuando su causa se encuentre dentro de su propia red de comunicaciones, equipos, sistemas operativos o navegadores.

b) Corresponderá a AICA atender y dar un primer nivel de soporte a las incidencias que se produzcan en relación con el uso y funcionamiento de la aplicación. La SGAD no atenderá directamente a los usuarios de AICA.

c) Las incidencias fuera del ámbito de actuación de AICA serán comunicadas por su unidad de informática a la unidad designada por la SGAD, quien proporcionará el soporte solicitado.

1.2 Incidencias evolutivas: Que serán aquellas que se produzcan a partir de la implantación inicial de la aplicación en AICA y, en concreto, toda petición de modificación o alteración sugerida o solicitada por parte de este, de naturaleza distinta a las incidencias correctivas establecidas en el apartado anterior.

Estas incidencias deberán ser analizadas conjuntamente por la unidad designada por la SGAD y por la unidad designada por AICA, siendo competencia de la SGAD asegurar, en concordancia con los requisitos y necesidades del resto de organismos usuarios de la aplicación, que en todo caso la aplicación evoluciona de acuerdo con una única línea de desarrollo que permita su extensión a otros Organismos o Entidades de la Administración General del Estado.

2. Por otra parte, la documentación electrónica contenida en la aplicación GEISER correspondiente a los registros de AICA estará disponible en la aplicación por un periodo máximo de 1 año desde su entrada en el sistema.
...
Por su parte, AICA contribuirá al mantenimiento anual de la sostenibilidad funcional y técnica de la aplicación GEISER con una contraprestación económica que se determina en base al uso del servicio. El cálculo de la contribución económica se realizará conforme a los criterios establecidos en el anexo I de este Convenio.

En particular AICA ha estimado, para el primer año de vigencia del Convenio, que el uso de la aplicación en 16.000 asientos registrales, según lo que certifica en el anexo II de este Convenio, por lo que el alcance de la contraprestación económica es de 0 euros.
...
El Convenio será administrado por una Comisión de Seguimiento, formada por dos representantes de la SGAD, nombrados por su Secretario General, de los cuales uno que asumirá la Presidencia y tendrá voto de calidad en caso de empate en las votaciones y, dos representantes de AICA, nombrados por su Director.
...
En caso de resolución, ambas partes deberán adoptar, de acuerdo con lo previsto en el artículo 52.3 de la Ley 40/2015, de 1 de octubre, las medidas necesarias para asegurar, en todo caso, el mantenimiento del servicio público electrónico a los ciudadanos prestado por AICA con las aplicaciones proporcionadas por la SGAD.
...
En prueba de conformidad, y para que conste a los efectos oportunos, las partes firman el presente Convenio.–El Secretario General de Administración Digital, Domingo Molina Moscoso.–El Director de la Agencia de Información y Control Alimentarios, José Miguel Herrero Velasco.
...
Don Carlos Domínguez Collado, como Secretario General de AICA, declara que durante el ejercicio 2016 el número de asientos registrales de entrada y salida que fueron realizados conjuntamente en las oficinas de registro que se incorporarán a la aplicación GEISER en las condiciones del presente convenio/acuerdo, asciende a un total de 15.162 asientos registrales.

Para el periodo anual inicial de vigencia del Convenio, se estima un total de 16.000 asientos registrales.

Asimismo, de conformidad con lo dispuesto en el apartado 5 de la Ley 40/2015, de 1 de octubre, declara tener capacidad para financiar durante cada anualidad de vigencia del convenio, los compromisos financieros asumidos.–Carlos Domínguez Collado.
