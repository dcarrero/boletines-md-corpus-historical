...
pagina_final: 46964
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2018-5890"
url_pdf: "https://www.boe.es/boe/dias/2018/05/01/pdfs/BOE-A-2018-5890.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2018-5890"
url_eli: "https://www.boe.es/eli/es/rd/2018/04/27/235"
fetched_at: "2026-04-19T06:10:45Z"
...
e) Valor de referencia: nivel medio de las emisiones de gases de efecto invernadero por unidad de energía derivadas de los combustibles fósiles utilizados en la Unión Europea en 2010, cuyo valor es de 94,1 g de CO~2~ eq/MJ.
...
e~l~ = Las emisiones anualizadas de gases de efecto invernadero procedentes de las modificaciones en las reservas de carbono causadas por el cambio de uso de la tierra [expresadas como masa equivalente (gramos) de CO~2~ por unidad de energía producida por biocarburantes o biolíquidos (megajulios)]. “Las tierras de cultivo” (**) y las tierras usadas para “cultivos vivaces” (***) se considerarán un único uso de la tierra.

(*) Al dividir el peso molecular del CO~2~ (44,010 g/mol) por el peso atómico del carbono (12,011 g/mol) se obtiene un cociente de 3,664.
...
e~B~ = Prima de 29 g CO~2~ eq/MJ para el biocarburante o biolíquido cuya biomasa se obtiene de tierras degradadas restauradas según las condiciones establecidas en el punto 8.
...
Emisiones estimadas provisionales de las materias primas de biocarburantes y biolíquidos, resultantes del cambio indirecto del uso de la tierra (g CO~2~ eq/MJ). (1)
...
La intensidad de las emisiones de gases de efecto invernadero de los combustibles y de la energía suministrados se expresa en gramos equivalentes de dióxido de carbono por megajulio de combustible (g CO~2~ eq/MJ).

1. Los gases de efecto invernadero que se tendrán en cuenta para calcular la intensidad de las emisiones de gases de efecto invernadero de los combustibles son el dióxido de carbono (CO~2~), el óxido nitroso (N~2~O) y el metano (CH~4~). A efectos del cálculo de la equivalencia en CO~2~, las emisiones de esos gases se asocian a los valores de emisión siguientes:
...
a) GEIi~n~ = Intensidad de gases de efecto invernadero de un sujeto obligado a la remisión de información.
...
d) MJ~x~= Energía total suministrada del combustible x, expresada en megajulios. Se calcula como sigue:
...
f) «GEIi~x~» es la intensidad de las emisiones de gases de efecto invernadero del combustible o energía x, expresada en gramos de CO~2~ eq/MJ. Los sujetos obligados calcularán la intensidad de las emisiones de gases de efecto invernadero de cada combustible o energía de la manera siguiente:
...
| Fuente de materias primas y procesos | Tipo de combustible comercializado | Intensidad de las emisiones de GEI durante el ciclo de vida (g CO~2~ eq/MJ) | Intensidad ponderada de GEI durante el ciclo de vida (g CO~2~ eq/MJ) |
| --- | --- | --- | --- |
...
Los sujetos obligados a remitir información, en tanto en cuanto no estén regulados los valores anteriormente citados, podrán establecer valores de intensidad de las emisiones de gases de efecto invernadero (g CO~2~ eq/MJ) por unidad de electricidad a partir de los datos comunicados a la Comisión Europea con arreglo a los siguientes actos:
