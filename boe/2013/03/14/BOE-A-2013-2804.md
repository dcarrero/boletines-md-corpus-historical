...
pagina_final: 20817
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2013-2804"
url_pdf: "https://www.boe.es/boe/dias/2013/03/14/pdfs/BOE-A-2013-2804.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2013-2804"
url_eli: ""
fetched_at: "2026-05-04T11:57:32Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 1 de marzo de 2013, del Instituto de Astrofísica de Canarias, por la que se publica la convocatoria de becas de verano para la formación en desarrollo tecnológico dirigidas a recién licenciados y a estudiantes universitarios de titulaciones superiores, que estén cursando los últimos cursos de la carrera.
...
1. La presente Resolución tiene por objeto convocar, en régimen de publicidad, objetividad y concurrencia competitiva, 6 ayudas para la formación de recién licenciados (curso 2011-2012 o posterior) y estudiantes de los últimos cursos universitarios de titulaciones superiores de ciclo largo y de grado. Su finalidad es la de formar a dichos estudiantes o recién licenciados en el desarrollo tecnológico asociado a la investigación astrofísica.
...
i) Declaración de cumplir los requisitos del apartado 1) del punto cuarto o, en el supuesto de estar percibiendo algún tipo de remuneración o ayuda económica, el compromiso de renunciar a la misma en el caso de concesión de la beca, según modelo que figura como anexo III.
...
a) Nota media del expediente académico del candidato, teniendo especialmente en cuenta las asignaturas más relevantes para el proyecto de la beca solicitada así como el número de convocatorias. Hasta 85 puntos.

Forma de acreditación: Fotocopia del certificado/expediente académico, con las precisiones señaladas en el apartado 3e) de la base séptima.
...
Los candidatos seleccionados se incorporarán el 1 de julio de 2013, fecha que figurará en la comunicación individual que se les remitirá. Por causas debidamente justificadas esta fecha podrá ampliarse hasta el 8 de julio, siempre y cuando el Coordinador de Instrumentación emita informe favorable a dicho retraso en la incorporación.
...
b) Igualmente y en las condiciones previstas en el art. 35 de la Ley General de Subvenciones, Ley 38/2003, de 17 de noviembre, el IAC podrá proceder a la retención del pago.
...
La Laguna, 1 de marzo de 2013.–El Director del Instituto de Astrofísica de Canarias, Francisco Sánchez Martínez.
...
Los proyectos disponibles para la formación en desarrollo tecnológico en 2013 son:

| Proyecto | Título | Proyecto instrumental asociado | Especialidad |
| --- | --- | --- | --- |
| A | Desarrollo software de simuladores de controladores de subsistemas mecánicos. | Espectrógrafo Multiobjeto Infrarrojo para el telescopio GTC (EMIR). | Ingeniería Informática (Linux, Python, C++, RS-232). |
| B | Montaje, integración y verificación de un prototipo de montura óptica. | Espectrógrafo Echelle para el telescopio VLT (ESPRESSO). | Ingeniería Mecánica (Diseño, Creo Elements/Pro, Montaje, Verificación). |
| C | Montaje, integración y verificación del criostato y de la estructura fría del instrumento EMIR. | Espectrógrafo Multiobjeto Infrarrojo para el telescopio GTC (EMIR). | IIngeniería Mecánica (Montaje, Verificación, Vacío, Criogenia). |
| D | Montaje, integración y verificación de prototipos de enlaces térmicos y de receptor en el criostato de pruebas del instrumento de 30GHz. | Q U I Joint Tenerife Cosmic Microwave Background experiment (QUIJOTE-CMB). | Ingeniería Mecánica (Modelado 3D, Creo Elements/Pro, Verificación, Criogenia). |
| E | Pruebas criogénicas para prototipos de mecanismos de HARMONI. | Espectrógrafo visible e IR de campo integral para el telescopio E-ELT (HARMONI). | Ingeniería Mecánica (Modelado 3D, Creo Elements/Pro, Verificación, Criogenia). |
| F | Optimización y control de la funcionalidad criogénica de EMIR. | Espectrógrafo Multiobjeto Infrarrojo para el telescopio GTC (EMIR). | Ingeniería Mecánica (Vacío matlab, Diseño, Creo Elements/Pro, labview). |

## ANEXO V. Composición de la Comisión de Evaluación

• Elvio Hernández Suárez, Ingeniero del Departamento de Mecánica.

• Vicente Sánchez de la Rosa, Jefe del Departamento de Mecánica.

• Pablo Redondo Caicoya, Ingeniero del Departamento de Mecánica.

• Heidy Moreno Arce, Ingeniera del Departamento de Software.

• Pablo López Ramos, Ingeniero del Departamento de Software.
