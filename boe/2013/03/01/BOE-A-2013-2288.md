---
identificador: "BOE-A-2013-2288"
titulo: "Resolución de 18 de febrero de 2013, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación, por el sistema de concurso-oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 16692
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2013-2288"
url_pdf: "https://www.boe.es/boe/dias/2013/03/01/pdfs/BOE-A-2013-2288.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2013-2288"
url_eli: ""
fetched_at: "2026-05-04T11:15:07Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 18 de febrero de 2013, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, sector administración especial, Técnico Superior de Apoyo a la Investigación, por el sistema de concurso-oposición.

Con el fin de atender las necesidades de personal en esta Administración Pública encargada del servicio público de la educación superior, este Rectorado de conformidad con lo dispuesto en el artículo 75 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, así como la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, y la Ley 10/2010, de 9 de julio, de la Generalitat, de Ordenación y Gestión de la Función Pública Valenciana, acuerda convocar pruebas de acceso al grupo A, subgrupo A1, sector de administración especial, técnico superior de apoyo a la investigación de la Universitat Politècnica de València, con arreglo a las siguientes bases:

1. Objeto de la convocatoria

1.1 La presente convocatoria tiene por objeto la selección de personal para cubrir una plaza vacante del grupo A, subgrupo A1, sector de administración especial, técnico superior de apoyo a la investigación de la Universitat Politècnica de València, por el turno que a continuación se indica.
...
Valencia, 18 de febrero de 2013.–El Rector, Juan Juliá Igual.

ANEXO I

| Código de puesto: PF1811 | Denominación del puesto: Técnico superior de apoyo a la investigación. |
| --- | --- |
...
● Dirección y gestión de proyectos (incluido el apoyo a la solicitud de proyectos).
...
19. Modelos dinámicos de la transmisión de enfermedades infecciosas.

20. Modelos de compartimentos en epidemiología.

21. Fundamentos de la epidemiología de virus.

22. Fundamentos de la patogenia.

23. Modelos de evolución demográfica. Predicción y series temporales. El caso de la Comunidad Valenciana.

24. Modelos continuos de población.

25. Modelos discretos de población.

26. Estructura de las redes aleatorias.

27. Modelos de red en epidemiología.

28. Modelos matemáticos de las neuronas. El modelo de integración y disparo.

29. Principios básicos de neurofisiología: neuronas excitatorias e inhibitorias, transmisión sináptica, neurotransmisores.

30. Fisiología, reconocimiento de patrones y modelos analíticos del electroencefalograma.

31. Modelos de ecuaciones diferenciales en biología: dispersión de poblaciones, quimiotaxis, formación de patrones.

32. Métodos estadísticos para la simulación de modelos matemáticos.

33. Matemáticas Financieras.

34. Modelos Económicos.

35. Valoración de Opciones y Futuros.

36. Optimización clásica.

37. Métodos heurísticos de optimización.

38. Optimización multidisciplinar.

39. Investigación Operativa.

40. Fundamentos del lenguaje Fortran: Tipos de datos, estructuras de control, ficheros, subrutinas y módulos, matrices.

41. Redacción de documentación técnica en inglés. El estilo científico.

42. Generación de documentos científicos en Latex. Bibliotecas. Estilos. Generación de ecuaciones, tablas, y gráficas.

43. Mathematica. Funciones. Gráficos. Aplicaciones simples y avanzadas.

44. Programación en Mathematica: Manipulación de Listas, Patrones y Reglas de Transformación.

45. Introducción a MATLAB. Vectores, matrices, gráficos.

46. Programación en MATLAB. Scripts, funciones. Interfaces gráficas de usuario.

47. Redes bayesianas.

48. Máquinas de vectores soporte.

49. Algoritmos de clustering.

50. Manejo de SPSS.

51. Análisis estadístico y minería de datos con el lenguaje R.

52. Gestión con el sistema operativo Linux. Instalación y administración básica.

53. Sistema operativo MS-Windows. Instalación y administración básica.

54. Gestión de una red de usuarios con el sistema operativo Linux.

55. Lenguaje de programación C++.

56. Sistemas básicos de computación paralela para el desarrollo de Modelos Matemáticos.

57. Administración, Gestión y Coordinación de proyectos de I+D+i: seguimiento y control del gasto, colaboración en la preparación de justificaciones, etc.

58. Elaboración de informes, memorias anuales y otro tipo de documentación, relacionadas con la actividad investigadora.

59. El Sistema Público de I+D+i en el Sistema Nacional de Innovación.

60. El espacio europeo de investigación y sus instrumentos. El Programa Marco.

61. La innovación. Tipos de innovación. Los poderes públicos y la innovación. Innovación y emprendedores.

62. La innovación en: los países emergentes, los países desarrollados. El caso particular de España. Políticas de ciencia y tecnología.

63. Indicadores de ciencia y tecnología. Directrices internacionales. El manual de Oslo. Presente y futuro de los estudios de innovación. Nuevos planteamientos metodológicos. Utilización de la información contable-financiera. Aspectos cualitativos de la innovación y principales resultados. El futuro de los estudios de innovación.

64. NTP 602: El diseño ergonómico del puesto de trabajo con pantallas de visualización: el equipo de trabajo.

65. NTP 139: El trabajo con pantallas de visualización.
...
http://www.insht.es/InshtWeb/Contenidos/Documentacion/FichasTecnicas/NTP/Ficheros/601a700/ntp_602.pdf

http://www.insht.es/InshtWeb/Contenidos/Documentacion/FichasTecnicas/NTP/Ficheros/101a200/ntp_139.pdf
