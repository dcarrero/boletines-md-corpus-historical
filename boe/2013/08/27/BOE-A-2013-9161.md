---
identificador: "BOE-A-2013-9161"
titulo: "Resolución de 1 de agosto de 2013, de la Secretaría de Estado de Medio Ambiente, sobre la evaluación de impacto ambiental del proyecto Aeródromo de Alhama de Almería, base contra incendios de Andalucía."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 62960
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2013-9161"
url_pdf: "https://www.boe.es/boe/dias/2013/08/27/pdfs/BOE-A-2013-9161.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2013-9161"
url_eli: ""
fetched_at: "2026-05-04T20:32:01Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 1 de agosto de 2013, de la Secretaría de Estado de Medio Ambiente, sobre la evaluación de impacto ambiental del proyecto Aeródromo de Alhama de Almería, base contra incendios de Andalucía.
...
El proyecto Aeródromo de Alhama de Almería, base contra incendios de Andalucía (CEDEFO) se encuentra encuadrado en el apartado d del Grupo 7, del referido anexo II.
...
El objeto del proyecto es obtener la autorización de un helipuerto de uso restringido, perteneciente al Centro de Defensa Forestal (CEDEFO) de la Junta de Andalucía, existente en el término municipal de Alhama de Almería (provincia de Almería), para operaciones de prevención y extinción de incendios forestales.
...
Se trata de un helipuerto de superficie de 900 m^2^ de extensión, situado en las inmediaciones de la población de Huéchar, pedanía del municipio de Alhama de Almería, en la provincia de Almería (Andalucía).
...
| Ayuntamiento de Gádor (Almería). | – |
| Ayuntamiento de Alhabia (Almería). | – |
| Ayuntamiento de Alicún (Almería). | – |
| Ayuntamiento de Santa Fe de Mondújar (Almería). | – |
| Ayuntamiento de Terque (Almería). | – |
| WWF España | – |
...
El helipuerto dispone de un área de aproximación final y de despegue (FATO) de forma circular de 25 metros de diámetro.

El área de contacto y de elevación inicial (TLOF) es circular de 20 m de diámetro, de las mismas características físicas de la FATO y a su mismo nivel, a dos aguas con pendiente inferior al 1%, con señal de TLOF orientada en dirección 45º-225º y 240º-60º. El área de seguridad que circunscribe a la FATO se encuentra a su mismo nivel, con pendiente hacia el exterior para facilitar el drenaje del agua de lluvia.
...
Los movimientos previstos se reducen a operaciones relacionadas con la prevención y extinción de incendios forestales y, con datos históricos, se sabe que alcanzan aproximadamente la cifra de 107,43 operaciones/año, en una media de 163,4 días de posicionamiento en el año, lo que supone una operación de aterrizaje y despegue cada 1,52 días. Se incluyen aquí tanto las misiones de incendio como las de adiestramiento y otras.

Las aeronaves a utilizar serán helicópteros de diversa tipología, siendo fundamentalmente operado por modelos Agusta A-119.

Ubicación del proyecto: El helipuerto se emplaza en el término municipal de Alhama de Almería, a 3 km hacia el este de su núcleo urbano, en la comarca del Valle de Andarax, en la provincia de Almería (Andalucía). La instalación coincide con las coordenadas geográficas siguientes:

| Latitud | Longitud | Elevación (m) |
| --- | --- | --- |
| 36º 57’ 34» N | 02º 32’ 23» W | 400 |

Las direcciones de los rumbos de aproximación y ascenso en el despegue son 45º-225º.
...
Sin embargo, el emplazamiento se sitúa a 1,2 km del LIC (ES6110006) Ramblas de Gérgal, Tabernas y Sur de Sierra Alhamilla, en dirección norte, y a 2,2 km en dirección suroeste del LIC (ES6110008) Sierras de Gádor y Enix. Asimismo, a 5 km al noroeste se encuentra el límite más próximo con el Parque Natural del Sierra Nevada, en sus estribaciones más orientales, catalogado como ZEPA (ES6140004) Sierra Nevada.
...
De todo lo expuesto, se deduce que la ejecución del proyecto Aeródromo de Alhama de Alhama de Almería, base contra incendios de Andalucía (CEDEFO) no producirá en términos generales efectos ambientales significativos.

Teniendo en cuenta todo ello, y a propuesta de la Dirección General de Calidad y Evaluación Ambiental y Medio Natural, este Ministerio resuelve de acuerdo con la evaluación de impacto ambiental practicada según la sección 2.ª del capítulo II, artículos 16 y 17, y el análisis realizado con los criterios del anexo III del texto refundido de la Ley de Evaluación de Impacto Ambiental de proyectos, no es previsible que el proyecto Aeródromo de Alhama de Almería, base contra incendios de Andalucía (CEDEFO), cumpliendo los requisitos ambientales que se desprenden de la presente resolución, vaya a producir impactos adversos significativos, por lo que no se considera necesaria la tramitación prevista en la sección 1.ª del capítulo II de dicha Ley.
