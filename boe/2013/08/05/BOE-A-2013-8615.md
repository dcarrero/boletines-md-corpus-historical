---
identificador: "BOE-A-2013-8615"
titulo: "Resolución de 23 de julio de 2013, de la Universidad de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, por el turno libre, sector de administración especial, Escala Técnica Superior de Investigación (perfil bioinformática)."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 57081
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2013-8615"
url_pdf: "https://www.boe.es/boe/dias/2013/08/05/pdfs/BOE-A-2013-8615.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2013-8615"
url_eli: ""
fetched_at: "2026-05-04T19:46:21Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 23 de julio de 2013, de la Universidad de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, por el turno libre, sector de administración especial, Escala Técnica Superior de Investigación (perfil bioinformática).

Este Rectorado, haciendo uso de las competencias que le atribuye el artículo 20, en relación con el 2.2 de la Ley Orgánica 6/2001, de 21 de diciembre de Universidades, modificada por la Ley 4/2007, de 12 de abril, la Ley 7/2007, de 12 de abril del Estatuto Básico del Empleado Público y de acuerdo con lo que establece el artículo 190 de los Estatutos de la Universitat de València, acuerda convocar pruebas selectivas de acceso al grupo A, subgrupo A1, por el turno libre, sector de administración especial, escala técnica superior de investigación (perfil bioinformática) de la Universitat de València, de conformidad con la Oferta de Empleo Público UVEG 2011 (publicada en el DOCV de fecha 8-08-2011) y con las siguientes
...
1.4 De acuerdo con lo que prevé el artículo 75.2 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, esta convocatoria se publicará en el D*iari Oficial de la Comunitat Valenciana (DOCV)* y en el B*oletín Oficial del Estado (BOE)*. Esta última publicación es la que se tomará como referencia a efectos del cómputo de plazos para la presentación de solicitudes. El resto de resoluciones administrativas derivadas de esta convocatoria se publicarán únicamente en el D*iari Oficial de la Comunitat Valenciana* *(DOCV)*.
...
2.1.4 Poseer el certificado acreditativo de conocimientos de valenciano del nivel C1, expedido por la Junta Qualificadora de Coneixements del Valencià (JQCV) de la Generalitat Valenciana o por el Servei de Política Lingüística de la Universitat de València, o bien el certificado de homologación emitido por este Servicio, sin perjuicio de lo que establece la base 1.3 y el anexo I de esta convocatoria.
...
3.1 Las personas interesadas dispondrán de un formulario para formalizar la solicitud en soporte informático. Este formulario se encontrará en la página web del Servei de Recursos Humans (PAS) de esta Universidad, que tiene la siguiente dirección: http://www.uv.es/pas.
...
3.2 Independientemente de la opción elegida para formalizar la solicitud, ésta se presentará por triplicado: Una copia para la entidad bancaria, una para la Universitat de València y una para la persona interesada. Las solicitudes se han de dirigir al Rectorado de la Universitat de València.

Las distintas opciones de presentación de solicitudes se explican en la base 3.4 de esta convocatoria.

3.3 El plazo de presentación de solicitudes será de 20 días hábiles contados a partir del día siguiente a la publicación de esta convocatoria en el B*oletín Oficial del Estado (BOE)*. Los sábados se considerarán hábiles a efectos del cómputo de plazos. La publicación de la convocatoria en el D*iari Oficial de la Comunitat Valenciana (DOCV)* tendrá sólo carácter informativo.
...
3.7.1 Las personas con una discapacidad igual o superior al 33 por 100. Estas personas deberán presentar los certificados correspondientes que acrediten la condición de personas con discapacidad mediante fotocopia del certificado de la Consellería de Bienestar Social u órgano competente.
...
3.7.3 Disfrutarán de una bonificación del 50 por 100 de estas tasas los miembros de familias numerosas de categoría general. Estas personas deberán presentar fotocopia de la documentación oficial en vigor que acredite la condición citada.
...
6.3 Una vez finalizado el proceso selectivo se publicará en el D*iari Oficial de la Comunitat Valenciana* *(DOCV),*por resolución del Rectorado la lista definitiva con el nombre de la persona aprobada.

## Séptima. Presentación de documentos.

7.1 En el plazo de 20 días hábiles, contados desde el día siguiente de la publicación en el D*iari Oficial de la Comunitat Valenciana* *(DOCV)* de la lista con el nombre de la persona aprobada, ésta deberá presentar en el Servei de Recursos Humans (PAS) de esta Universitat la documentación siguiente:
...
Una vez transcurrido el plazo de presentación de la documentación especificada en la base séptima de esta convocatoria, y después de haberse verificado el cumplimiento de los requisitos exigidos, el Rector dictará una resolución que se publicará en el D*iari Oficial de la Comunitat Valenciana* *(DOCV)*, mediante la cual la persona que haya superado estas pruebas selectivas será nombrada funcionario o funcionaria de carrera.
...
Los recursos contenciosos administrativos que se interpongan contra esta resolución serán anunciados en el D*iari Oficial de la Comunitat Valenciana* *(DOCV)*, como emplazamiento a las posibles personas interesadas.

Valencia, 23 de julio de 2013.–El Rector, P.D. (Resolución de 21 de julio de 2012), el Gerente, Joan Oltra i Vidal.
...
Ambas partes se realizarán en una única sesión. La valoración total del ejercicio será de 25 puntos. La primera parte se valorará en un 25 por 100 del total y la segunda parte en un 75 por 100 del total. La valoración del ejercicio será la suma de la puntuación de ambas partes.
...
13. Soluciones de almacenamiento. Tipos de discos. RAID, características y niveles. Arquitecturas DAS, NAS y SAN.

14. Linux. Características. Debian: tipos de versiones, instalación del sistema, paquetes y actualizaciones. Introducción a la informática y al SO Unix/Linux. Gestión Básica del Sistema Operativo Linux. Gestión de procesos. Sistema de Fichero. Ordenes avanzadas. Intérprete de órdenes y configuración del usuario

15. Virtualización. Tipos, caracterísitcas y ventajas. Planificación. VMware vSphere. ESXi y su instalación. vCenter Server. Update Manager. vSphere Client.

16. Supercomputación en la Universitat de València a nivel de usuario. Recursos disponibles, Lluisvives, Multivac y Tirant. Uso de colas. Políticas de uso. Red Española de Supercomputación.

17. Clasificación de redes, LAN, WAN, Internet. Características básicas de las arquitecturas. Servicios, protocolos, medios y dispositivos. OSI y TCP/IP.

18. La capa de aplicación del modelo TCP/IP y sus capas equivalentes en OSI. El modelo cliente-servidor. Redes entre pares y aplicaciones punto a punto. Protocolos y servicios: DNS, HTTP, SMTP/POP, FTP, DHCP, SMB, Telnet.

19. La capa de transporte en OSI y TCT/IP. Direccionamiento del puerto. Segmentación y reensamblaje. Los protocolos TCP y UDP.

20. La capa de red OSI. Protocolo de Internet IPv4. Encabezado de paquete. Direccionamiento. Enrutamiento.

21. Capas OSI física y enlace de datos. Tramas. Técnicas de control de acceso al medio. Topologías. Direccionamiento. Tipos de medios físicos. Ancho de banda, rendimiento y capacidad de transferencia útil.

22. Ethernet. La capa MAC. Las tramas. La dirección MAC. Unicast, multicast y broadcast. Tipos de Ethernet. Switches y su funcionamiento. El protocolo ARP.

23. Planificación de Sistemas de Información en Métrica 3. Descripción y objetivos. Actividades y participantes.

24. Diseño del Sistema de Información en Métrica 3. Descripción y objetivos. Actividades y participantes.

25. Aseguramiento de la Calidad de Métrica 3. Descripción y objetivos. Actividades y participantes.

26. Expresiones regulares. Metacarácteres unitarios y de repetición. Representación de caracteres. Operaciones y opciones en Perl. 2.1 Introducción a Perl. Identificación de patrones en Perl. Aspectos avanzados de Perl. Conceptos generales de bases de datos relacionales.

27. Tipos de datos estructurados en C. Vectores, Matrices, Arrays multidimensionales, Punteros, Estructuras, Listas enlazadas, Pilas y Colas.

28. Programación estructurada. Tipos de datos básicos, identificadores, operadores, variables, Constantes, estructuras de control, funciones y recursividad.

29. Programación Orientada a Objetos. Objetos, Mensajes, Relaciones, Propiedades, Métodos, Clases, Constructores, Herencia, Polimorfismo. Pasos en el diseño orientado a objetos.

30. Algoritmos de ordenación y búsqueda. Método de la burbuja, de selección directa, de inserción directa. Métodos avanzados Shell y Quicksort.

31. Modelo de datos relacionales, principales características. Reglas de CODD. Tablas, claves y restricciones. Base de datos relacional, características, elementos y estructura.

32. MySQL. Características. Administración de cuentas de usuario. Tipos de datos. Creación de bases de datos y tablas, carga de datos, consultas.

33. Plataforma Java. JCP y JSR. JVM, JRE, JDK y NetBeans. Java SE y EE. JNLP y Java Web Start. Servlets, JSP y Tomcat.

34. Diseño web, usabilidad y wireframes. HTTP y sus etiquetas. CSS, selectores, modelo de cajas, posicionamiento y visualización. Javascript, variables, operadores y estructuras de control de flujo.

35. Perl: características, tipos de variable, operadores, control de flujo, gestión de ficheros, subrutinas y opciones de línea de comandos.

36. Java: Tipos de datos, variables, operadores, control de flujo, excepciones. Manejo de clases, métodos y objetos. La palabra clave «this». Creación de paquetes. Ficheros. Clases predefinidas. Swing. JDBC.

37. Editores web y sus características. Dreamweaver: espacio de trabajo, utilización de sitios, administración de activos, bibliotecas y plantillas, uso de CSS y de comportamientos JavaScript.

38. PHP: características, variables y tipos de datos, operadores, estructuras de control, funciones, excepciones, clases y objetos.

39. Shell scripting: características, funciones, variables, arrays, parámetros, comandos predefinidos, estructuras de control, interfaz con el usuario, uso de ficheros, cron redirecciones y tuberías.

40. Edición de webs de la UVEG. Arquitectura de las webs corporativas y micro-sites. Nomenclatura Content Server. Gestor de contenidos y elementos. Fck editor. Edición de imágenes. Comunicación corporativa de la Universitat. Protección de datos en los entornos webs.

41. Proteínas: Aminoácidos. Enlace peptídico. Estructura: niveles de estructura. Propiedades.

42. Estructura de Proteínas. Comparación sistemática de estructura de proteínas. Predicción de estructura secundaria de proteínas. Predicción de estructura por homología de secuencia. Predicción de estructura por «threading». Simulación y dinámica molecular. Métodos ab initio.

43. Análisis de proteínas y sus motivos. Herramientas de caracterización de proteínas. Bases de datos de proteínas y su uso. Datos de secuencias de proteínas en UniProt. PRIDE - The Proteomics Identification Database. Perfiles, modelos de Markov y bases de datos. Uso de motivos.

44. Interacciones de proteínas y su importancia. Métodos de identificación. Tipos de bases de datos. IntAct.

45. Identificación mediante huella peptídica. Motores de búsqueda de MS para la identificación de proteínas mediante huella peptídica: MOWSE, Mascot, MS-Fit, PeptIdent, ProFound, Aldente.

46. Análisis de secuencias de péptidos. Herramientas informáticas para análisis de secuencias peptídicas e identificación de proteínas a partir de datos de MS/MS. «de novo» versus mapas de fragmentación de péptidos (PFF). Algoritmos y software: Sequest y Mascot.

47. Mining de proteomas. Proteómica comparativa: con geles 2D y con LC-MS y marcaje isotópico. Determinación de niveles de confianza en las identificaciones de péptidos y proteínas. «False discovery rate (FDRs)» y otras estrategias.

48. Proteómica cuantitativa. Aproximaciones SRM/MRM. Técnicas de análisis estadístico.

49. Datos proteómicos y servicios de integración: Estandarización de datos proteómicos, Herramientas adicionales para el manejo y validación de datos proteómicos: «trans-proteomics pipeline».

50. Subdivisión en áreas de estudio de la Bioinformática. Clasificación de las bases de datos y herramientas.

51. Expresión génica. Genes, transcripción y maduración. Traducción, síntesis, procesamiento y regulación de la expresión génica. Modificaciones postraduccionales.

52. Arrays. Introducción a Microarrays. Clustering y anotación de Microarrays. Anotación funcional. Análisis de datos de microarrays. Pre-procesado, normalización y filtrado de la señal. Detección de genes diferencialmente expresados. Análisis de clusters.

53. NGS. Plataformas de secuenciación masiva. Infraestructuras computacionales para análisis de datos de NGS. Formatos de ficheros y control de calidad en NGS. Alineadores de secuencias cortas. Determinación de variantes en NGS. Predicción de consecuencias de variación

54. Conceptos básicos de Bioestadística. Estadística descriptiva. Probabilidad y distribuciones. Tipos de distribuciones de muestreo. Estimación y pruebas de hipótesis. Análisis de la varianza.

55. Minimum Information Standards. MIxS, MIAME, MIAPE y MIAMET.

56. Integración de datos y servicios. Necesidades y metas. Análisis de soluciones actuales. Web Services en EMBL-EBI.

57. Sistemas de gestión de flujo de trabajo (WMS). Características. Soluciones y arquitecturas. Softwares disponibles. Taverna.

58. Sistemas de gestión de información de laboratorio (LIMS). Metas, funciones y características. Planificación. Arquitecturas. Softwares disponibles.

59. Alineamiento de secuencias: sentido biológico, matrices de identidad y de sustitución, algoritmos globales, locales y heurísticos, métodos, programación dinámica, gaps.

60. BLAST: Algoritmo, programas de la familia, tipos de ejecución, parámetros e interpretación de resultados.

61. Ontologías y anotaciones. Gene Ontology. GO slims. QuickGO. AmiGO. UniProt-Gene Ontology Annotation. Ontology Lookup Service.

62. Minería de datos (KDD). Conceptos, metas, fases y técnicas. Aplicaciones en la bioinformática. Herramientas.

63. PRIDE. Características. Consultas y envío de datos. PRIDE Inspector. PRIDE Converter 2.

64. UniProt. Su contenido. Características de sus bases de datos. Consultas e interpretación de resultados.

65. The International Nucleotide Sequence Databases. European Nucleotide Archive y Sequence Read Archive del EMBL-EBI. Consultas, envío de datos y formatos.

66. Bases de datos de genomas NCBI, UCSC, Ensembl. Características y consultas.

67. Familias de proteínas. InterPro, PROSITE, Pfam: características, consultas e interpretación de resultados.

68. Reactome y KEGG. Características, consultas, herramientas e interpretación de resultados.

69. Las E-utilities de Entrez. Consultas básicas vía URL. Las 8 funciones E-utilities. Uso con perl.

70. Predicción de genes. Métodos ab initio, comparativos de predicción y por homología. Anotación automática de genomas.

71. Evolución y sistemática. Análisis filogenéticos. Base teórica. Árbol evolutivo. Matriz de distancias. Métodos de reconstrucción de árboles. Clasificación filogenética.

72. Gestión de la Calidad en un servicio de Bioinformática. Registros. Indicadores de procesos. Plan de mejora continua.

Nota: La normativa legal que ampara el contenido de estos temas será la que se encuentre publicada en el momento de la publicación de la convocatoria en el B*oletín Oficial del Estado (BOE).*
...
Solicitud de admisión a las pruebas selectivas de acceso al grupo A, subgrupo A1, turno libre, sector de administración especial, escala técnica superior de investigación (perfil bioinformática) de esta Universitat.
...
Datos que ha de recoger la solicitud de admisión a las pruebas selectivas de acceso al grupo a subgrupo A1, por el turno libre, sector de Administración Especial, Escala Técnica Superior de Investigación (perfil bioinformática)
...
Si tiene exención de tasas o la bonificación del 50 por 100.
