---
identificador: "BOE-A-2013-8609"
titulo: "Resolución de 19 de julio de 2013, de la Universidad de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, por el turno libre, sector de administración especial, Escala Técnica Superior de Investigación (perfil espectrometría de masas)."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 56988
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2013-8609"
url_pdf: "https://www.boe.es/boe/dias/2013/08/05/pdfs/BOE-A-2013-8609.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2013-8609"
url_eli: ""
fetched_at: "2026-05-04T19:46:15Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 19 de julio de 2013, de la Universidad de Valencia, por la que se convocan pruebas selectivas de acceso al Grupo A, Subgrupo A1, por el turno libre, sector de administración especial, Escala Técnica Superior de Investigación (perfil espectrometría de masas).

Este Rectorado, haciendo uso de las competencias que le atribuye el artículo 20, en relación con el 2.2 de la Ley Orgánica 6/2001, de 21 de diciembre, de Universidades, modificada por la Ley 4/2007, de 12 de abril; la Ley 7/2007, de 12 de abril, del Estatuto Básico del Empleado Público, y de acuerdo con lo que establece el artículo 190 de los Estatutos de la Universitat de València, acuerda convocar pruebas selectivas de acceso al grupo A, subgrupo A1, por el turno libre, sector de administración especial, escala técnica superior de investigación (perfil espectrometría de masas) de la Universitat de València, de conformidad con la *Oferta de Empleo Público UVEG 2011 (publicada en el DOCV de fecha 8-08-2011)* y con las siguientes

Bases de la convocatoria

## Primera. Normas generales.

1.1 Esta convocatoria tiene por objeto la selección de personal para cubrir 1 puesto vacante del grupo A, subgrupo A1, por el turno libre, sector de administración especial, escala técnica superior de investigación (perfil espectrometría de masas), mediante el sistema de concurso-oposición.
...
7.1 Las personas que superen las pruebas selectivas deberán acreditar el conocimiento de valenciano de nivel elemental (B1), con certificados, diplomas o títulos expedidos por la Junta Qualificadora de Coneixements del Valencià o por el Servei de Política Lingüística de la Universitat de València, o bien el certificado de homologación emitido por este Servicio.
...
8.1.1 Certificado de nacimiento expedido por el registro civil correspondiente o fotocopia del DNI o NIE.
...
11.2 El fichero quedará bajo la responsabilidad de la Secretaría General de la UVEG, Av. Blasco Ibáñez, 13, 46010 de Valencia.
...
b.2) Conocimientos de valenciano: La valoración máxima por este concepto será de 3 puntos. En este apartado sólo se valorará el nivel de conocimientos de valenciano superior al exigido en la convocatoria de acuerdo con la siguiente escala:
...
13. Fundamentos de la espectrometría de masas (I). Principios. Historia. Camino libre de iones. Diagrama de un espectrómetro de masas.

14. Fundamentos de la espectrometría de masas (II). Concepto de espectrometría de masas. Aspecto de un espectro de masas. Terminología: relación masa-carga, iones con cargas dobles, ion molecular, pico base, intensidad relativa, porcentaje total de iones, resolución y sensibilidad.

15. Métodos de ionización aplicados al análisis de moléculas orgánicas (I): ionización electrónica. Fundamentos de la técnica. Fuente de ionización. El espectro de masas EI. Mecanismos de fragmentación. Aplicaciones de la técnica. Requisitos esenciales para el funcionamiento.

16. Métodos de ionización aplicados al análisis de moléculas orgánicas (II): ionización química. Fundamentos. Descripción de la fuente. Reacciones implicadas en la ionización química positiva. Ionización química negativa. Aplicaciones analíticas de CI. Requisitos esenciales para el funcionamiento.

17. Métodos de ionización aplicados al análisis de moléculas orgánicas (III): FAB y LSIMS. Fundamentos de las técnicas de bombardeo con iones y átomos rápidos. Descripción de la fuente. Procesos de ionización. Propiedades de la matriz. Efectos de los aditivos. Efecto del co-solvente. Aspecto de un espectro de masas. Aplicaciones de la técnica.

18. Métodos de ionización aplicados al análisis de moléculas orgánicas (IV): MALDI. Fundamentos de la técnica. Características de la fuente de ionización. Tipos de láser. Propiedades de la matriz. Interpretación de datos y fragmentaciones. SELDI, SALDI y DIOS. Aplicaciones a la técnica.

19. Métodos de ionización aplicados al análisis de moléculas orgánicas (V): FD/FI. Fundamentos. Descripción de la fuente. Mecanismo de formación de los iones de campo. Emisores de iones. Espectros de masas en FD. Información estructural. Aplicaciones.

20. Métodos de ionización aplicados al análisis de moléculas orgánicas (VI-a): ESI. Fundamentos de la ionización por electrospray. Descripción de la interfase ESI. Modelos fuente API. Proceso de ionización. Aspecto de un espectro de masas por ESI e interpretación de resultados. Aplicaciones.

21. Métodos de ionización aplicados al análisis de moléculas orgánicas (VI-b): Optimización y operaciones ESI. Aguja y condiciones. *Tuning* y calibración. Composición del disolvente. Otros parámetros: conductividad líquida, efecto de supresión de la señal, concentración modificada, aditivos en la fase móvil, velocidad de flujo, temperatura.

22. Métodos de ionización aplicados al análisis de moléculas orgánicas (VII-a): APCI. Fundamentos de la ionización química a presión atmosférica. Descripción de la interfase. Procesos de ionización por APCI. Aspecto de un espectro de masas por APCI. Aplicaciones a la técnica.

23. Métodos de ionización aplicados al análisis de moléculas orgánicas (VII-b): APCI: Optimización y operaciones APCI. Ionización. Calibración. Nebulización. Variables químicas. Comparación principales características ESI-APCI.

24. Analizadores de masas (I): analizadores cuadrupolares. Descripción. Ecuación de movimiento. Diagrama de estabilidad. Resolución. Prefiltros y postfiltros. Características y aplicaciones. Limitaciones.

25. Analizadores de masas (II): analizadores magnéticos y electromagnéticos. Acción del campo magnético. Dispersión y resolución. Sector magnético de doble focalización. Geometrías especiales. Comparación sector magnético-cuadrupolos. Aplicaciones.

26. Analizadores de masas (III): analizadores de tiempo de vuelo. Descripción y principios de funcionamiento. Extracción pulsada retardada. Reflectron. MALDI-TOF aplicaciones y limitaciones. Detección de los iones TAD.

27. Analizadores de masas (IV): analizadores de trampa iónica 3D. Descripción y principios de funcionamiento. Control de la formación de iones y de su detección. Proceso de ionización química en una trampa de iones. Modificaciones para mejorar las prestaciones de un analizador de trampa iónica. Campos de aplicación.

28. Analizadores de masas (V): analizador de resonancia ciclotrónica de iones y de transformada de fourier. Principios generales. Resonancia ion ciclotrón. Espectrometría de masas de transformada de Fourier (FT-ICR MS). Características y campos de aplicación.

29. Analizadores de masas (VI): analizador orbitrap. Principios de funcionamiento. Geometría del orbitrap. Trayectoria del ion. Detección de la corriente de imagen. Características. Aplicaciones.

30. Sistemas de vacío para los espectrómetros de masas. Necesidad de alto vacío. El recorrido libre medio. Tipos de bombas de vacío. Tipos de medidores de vacío.

31. Sistemas de detección de iones. Consideraciones generales. Tipos de detectores comúnmente empleados en la espectrometría de masas. Adquisición y proceso de los datos por ordenador.

32. Sistemas de introducción de las muestras. Consideraciones preliminares. Sistemas de introducción para muestras gaseosas. Sistemas de introducción para muestras líquidas. Sistemas de introducción para muestras sólidas.

33. Adquisición y procesamiento de los datos (GC/MS). Registro analógico. Registro digital. Calibración del espectrómetro de masas. Presentación de datos. Procesamiento de datos. RTIC y TIC. Sustracción del ruido. Cromatograma de una masa. Sistemas de identificación automatizada.

34. Manipulación de las muestras. Almacenamiento de las muestras. Aislamiento y purificación. Formación de derivados. Incorporación de isótopos estables.

35. Fuentes de error e interferencias (GC/MS). Fuentes de error en espectrometría de masas. Contaminación. Fuentes de interferencias. Casos de difícil sustracción del espectro del ruido de fondo.

36. Resolución y Exactitud de masa. Resolución y exactitud de masa (baja y alta resolución). Masa nominal. Masa exacta. Sensibilidad. Límite de detección.

37. Información analítica (I). Estrategias para la interpretación de resultados. Ionización y fragmentación. Iones abundantes con número impar y par de electrones. Iones fragmento de masas bajas. Identificación de los fragmentos neutros. Número de anillos o insaturaciones. Abundancias isotópicas. *Patterns* para Cl/Br. Regla del nitrógeno.

38. Información analítica (II): datos cuantitativos. Especificidad de los datos. Proceso y técnicas de cuantificación. Método del patrón externo. Método del patrón interno. Normalización.

39. Espectrometría de masas en tándem (MS/MS) (I). Concepto. Definición. Disociación de iones: iones metaestables, CID o CAD, SID y PID. Aplicaciones.

40. Espectrometría de masas en tándem (II). Instrumentación para MS/MS: Espectrometría de masas en tándem en el espacio (TQMS, QTOF, TOFTOF, BEqQ, Instrumentos de doble enfoque: técnicas de desenfoque, barridos enlazados. Espectrometría de masas en tándem en el tiempo (QIT, FTMS).

41. Cromatografía de gases-espectrometría de masas (GC/MS) (I). Términos cromatográficos. Integración del área del pico. Teoría de platos. Parámetros de separación y resolución. Gas portador. Tipos principales de inyección de la muestra. Tipos principales de columnas. Horno.

42. Cromatografía de gases-espectrometría de masas (GC/MS) (II). Complementariedad y compatibilidad. Descripción del proceso. Modelo de un sistema de GC/MS. Variables de control de un GC. Interfase de acoplamiento con el espectrómetro de masas. Ruido y sangrado de columna.

43. Cromatografía de gases-espectrometría de masas (GC/MS) (III). Modos de adquisición de los datos cromatográficos. Velocidad de proceso de datos y de barrido. Registro y tratamiento de los datos cromatográficos. Aplicaciones de la técnica. Ventajas y limitaciones. Tipos de CG/MS.

44. Cromatografía líquida-espectrometría de masas (HPLC/MS) (I). Principios generales de un HPLC. Clasificación de métodos de cromatografía líquida, según el mecanismo de retención y según el método de operación. Conceptos básicos de HPLC: factor de capacidad, selectividad, resolución etc.

45. Cromatografía líquida-espectrometría de masas (HPLC/MS) (II). Modos de separación. Cromatografía en fase normal. Cromatografía en fase reversa. Cromatografía de intercambio iónico. Cromatografía de exclusión molecular. Cromatografía de afinidad.

46. Cromatografía líquida-espectrometría de masas (HPLC/MS) (III). Sistemas de reparto de disolvente. Optimización de la reproducibilidad del flujo. Desgasificación del disolvente. Sistemas de bombeo isocráticos/gradiente. Columnas. Cromatografía de líquidos con espectrometría de masas, «incompatibilidad».

47. Cromatografía líquida-espectrometría de masas (HPLC/MS) (IV): interfases de acoplamiento utilizadas. Similitudes y diferencias entre cada una de las interfases. Resumen: principales características. Calibrantes.

48. Ionización y fragmentación. Ionización electrónica y velocidad de fragmentación. Consideraciones energéticas en los procesos de fragmentación. Teorías QET y RRKM. Ionización y potenciales de aparición.

49. Mecanismos de fragmentación (I): Rupturas. Ruptura dirigida por el electrón desapareado. Ruptura dirigida por la carga. Ruptura de los enlaces sigma.

50. Mecanismos de fragmentación (II): Reordenamientos. Reordenamiento del hidrógeno gama. Reordenamiento de Retro *Diels-Alder*. Reordenamiento doble de hidrógeno. Reordenamiento de tipo ciclohexanona.

51. Mecanismos de fragmentación (III). Fragmentación de cationes con un número par de electrones. Fragmentación que obedece a la regla de paridad. Fragmentaciones que no obedece a la regla de paridad.

52. Mecanismos de fragmentación (IV). Fragmentación de iones negativos. Mecanismos de fragmentación de aniones con número par de electrones: fragmentación del anión diacetato de etilenglicol. Mecanismo de fragmentación de aniones radicales. CRF.

53. Fragmentaciones representativas de clases de compuestos (I). Fragmentación de alcoholes. Fragmentación de éteres. Fragmentación de fenoles. Fragmentación de aminas.

54. Fragmentaciones representativas de clases de compuestos (II). Fragmentación de compuestos carbonílicos. Fragmentación de aldehídos. Fragmentación de cetonas. Fragmentación de ésteres. Fragmentación de ácidos carboxílicos. Fragmentación de amidas.

55. Fragmentaciones representativas de clases de compuestos (III). Fragmentación de hidrocarburos. Fragmentación de compuestos halogenados. Fragmentación de nitrocompuestos.

56. Fragmentaciones representativas de clases de compuestos (IV). Fragmentación de compuestos heterocíclicos y de azufre. Fragmentación de tioles, tioéteres, ariléteres y tiofenoles.

57. Análisis de biomoléculas por espectrometría de masas (I): Proteínas y péptidos. Las biomoléculas y la espectrometría de masas. ESI y MALDI. Fragmentación de péptidos. Identificación de proteínas. Detección y caracterización de mutaciones. Verificación de la estructura y purificación. Identificación y localización de modificaciones post-traslacional.

58. Análisis de biomoléculas por espectrometría de masas (II): Oligosacáridos. Espectro de masas. Fragmentación. Degradación acoplada con espectrometría de masas.

59. Análisis de biomoléculas por espectrometría de masas (III): Lípidos. Ácidos grasos. Acilgliceroles. Ácidos biliares.

60. Análisis de metabolitos en microorganismos: HPLC y HPLC/MS. Introducción. Inactivación de metabolismos y extracción de metabolitos de células. Análisis de aminoácidos libres. Análisis de intermedios de ciclos de TCA. Análisis de la glucolisis y el fosfato de pentosa vía intermedios. Conclusiones.

61. Perfil metabolómico en orina humana por GC/MS. Información biológica. Perfil metabólico de ácidos orgánicos. Perfil metabolómico: preparación de la muestra, determinación de creatinina, derivatización. Evaluación de creatinina.

62. Perfil metabólico por espectrometría de masas por resonancia de ion ciclotrón transformada de Fourier (FT-ICR-MS) y espectrometría de masas cuadrupolo tiempo de vuelo ionización electrospray (ESI-Q-TOF-MS). Introducción. Procedimiento para el perfil metabólico utilizando FT-ICR-MS y ESI-Q-TOF-MS. Muestra *E. coli* K12: Preparación, tratamiento de la muestra. Instrumentación. Condiciones de las medidas de los metabolitos intracelulares. Perfil metabolómico por el método de infusión.

63. Prácticas de GC/MS: Análisis de los fluidos corporales de drogas de abuso. Introducción. Extracción. Derivatización. Separación cromatográfica. Métodos de ionización. Análisis de masas. Análisis de drogas de abuso comunes: cocaína y sus metabolitos; condiciones y rendimiento por GC/MS.

64. Uso de relaciones isotópicas en análisis forense. Introducción. Fraccionamiento isotópico. Unidades de medida. Óptica iónica. Medición de las variaciones de la abundancia de isótopos estables naturales. Uso de relaciones isotópicas para la autenticación y análisis forense. Conclusiones.

65. Prácticas de LC/MS: aplicaciones ambientales de LC/MS en pesticidas (ESI y APCI). Introducción. Carbamatos. Pesticidas organofosforados. Triazinas. Fenilureas. Sulfonilureas. Estrategias analíticas en análisis de aguas. Límites de detección de pesticidas.

66. Prácticas de LC/MS: aplicaciones a productos naturales (TS, Cf-FAB y ESI). Productos naturales en plantas: alcaloides, flavonas, flavonoides y otros glicosidos. Taxanos. Toxinas: micotoxina tricotocenos, fumonisina y biotoxinas marinas. Vitaminas y sacáridos.

67. Aplicaciones farmacéuticas de LC/MS. Introducción. Cambio de masa: metabolitos en fase I y II. Identificación de metabolitos en fase I, LC-ESI-MS: *screening*MS/MS, omeoprazol. Identificación de metabolitos en fase II, LC-ESI-MS: conjugados S12813. Estudios farmacocinéticos.

68. Análisis de datos metabólicos, guía básica. Introducción. Materiales. Métodos: análisis básicos, detección de valores atípicos, normalización y transformación de datos. Análisis exploratorio de datos metabólicos. *Clustering* de datos metabólicos.

69. Desarrollo de métodos de LC/MS. Eliminación de la incertidumbre. Protocolo y consideraciones paso a paso. Evaluación del «*target*», matriz y condiciones de separación.

70. Mantenimiento del sistema GC-MS y soluciones a los problemas. Mantenimiento en cromatografía de gases. Mantenimiento del espectrómetro de masas y diagnóstico de problemas.

71. Mantenimiento de un espectrómetro de masas: triplecuadrupolo y trampa de iones. Fuentes de ionización, lentes, bombas vacío, etc.

72. Contaminación y limpieza de sistemas LC-MS. Prevención. Solución de los problemas de contaminación. Contaminantes y sus fuentes. Posibles iones de fondo.
...
Solicitud de admisión a las pruebas selectivas de acceso al grupo A, subgrupo A1, turno libre, sector de administración especial, escala técnica superior de investigación (perfil espectrometría de masas) de esta Universitat.
...
Datos que ha de recoger la solicitud de admisión a las pruebas selectivas de acceso al Grupo A, Subgrupo A1, por el turno libre, sector de administración especial, Escala Técnica Superior de Investigación (perfil espectrometría de masas)
