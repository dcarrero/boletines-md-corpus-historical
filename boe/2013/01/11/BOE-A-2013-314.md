---
identificador: "BOE-A-2013-314"
titulo: "Resolución de 27 de diciembre de 2012, de la Universidad de Valencia, por la que se convocan pruebas selectivas de acceso al grupo A, subgrupo A1, por el turno libre, sector de administración especial, escala técnica superior de planificación, análisis y evaluación (perfil: calidad)."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 1387
pagina_final: 1399
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2013-314"
url_pdf: "https://www.boe.es/boe/dias/2013/01/11/pdfs/BOE-A-2013-314.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2013-314"
url_eli: ""
fetched_at: "2026-05-04T08:31:57Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 27 de diciembre de 2012, de la Universidad de Valencia, por la que se convocan pruebas selectivas de acceso al grupo A, subgrupo A1, por el turno libre, sector de administración especial, escala técnica superior de planificación, análisis y evaluación (perfil: calidad).

Este Rectorado, haciendo uso de las competencias que le atribuye el artículo 20, en relación con el 2.2 de la Ley Orgánica 6/2001, de 21 de diciembre de Universidades, modificada por la Ley 4/2007, de 12 de abril, Estatuto Básico del Empleado Público y de acuerdo con lo que establece el artículo 190 de los Estatutos de la Universitat de València, acuerda convocar pruebas selectivas de acceso al grupo A, subgrupo A1, por el turno libre, sector de administración especial, escala técnica superior de planificación, análisis y evaluación (perfil: calidad) de la Universitat de València, de conformidad con las siguientes

Bases de la convocatoria

## Primera. Normas generales.

1.1 Esta convocatoria tiene por objeto la selección de personal para cubrir 1 puesto vacante del grupo A, subgrupo A1, por el turno libre, sector de administración especial, escala técnica superior de planificación, análisis y evaluación (perfil: calidad), mediante el sistema de concurso-oposición.
...
7.1 En el plazo de veinte días hábiles, contados desde el día siguiente de la publicación en el «Diari Oficial de la Comunitat Valenciana» («DOCV») de la lista con el nombre de la persona aprobada, ésta deberá presentar en el Servei de Recursos Humans («PAS») de esta Universidad la documentación siguiente:
...
10.5 Las personas interesadas podrán ejercer sus derechos de acceso, rectificación, cancelación y oposición, en cumplimiento de lo que establece la LOPD, ante el Servei de Recursos Humans (PAS) de la Universitat de València, Avd. Blasco Ibáñez, núm. 13, nivel 1, 46010 de Valencia.
...
7. La Universitat de València. Sus Estatutos: Fines de la Universidad, estructura, órganos de gobierno colegiados y unipersonales.
...
1. La evaluación institucional como punto de partida de los Sistemas de Garantía Internos de Calidad (SGIC). Planes Nacionales de Evaluación de la Calidad.

2. Programa de Evaluación Institucional y su influencia en las universidades españolas.

3. Planes de Calidad propios de la Universitat de València. Plan de Evaluación y Mejora del Rendimiento Académico. Programa de Evaluación de las Prácticas en Empresa. Programa de Evaluación del Plan de acción tutorial.

4. Evaluación para la verificación de las enseñanzas oficiales.

5. Mención de Calidad de los Programas de Doctorado. Programa MENCIÓN.

6. Seguimiento de las titulaciones oficiales. Protocolo elaborado por la Comisión Universitaria para la Regulación del Seguimiento y la Acreditación (CURSA).

7. La calidad en el proceso de aprobación de los títulos oficiales de grado y máster.

8. La calidad en el proceso de aprobación de los títulos oficiales de doctorado.

9. Norma ISO 9001:2008. Capítulos y principios.

10. Formas principales de evaluación EFQM: Cuestionario y memoria. La matriz REDER.

11. Definición de los criterios agentes en el Modelo EFQM.

12. Definición de los criterios resultados en el Modelo EFQM.

13. Cuestionario de la Herramienta Perfil en el ámbito universitario y modelo EFQM.

14. Implantación de sistemas de indicadores. Norma UNE 66175:2003.

15. Sistema de garantía de calidad en las titulaciones de grado y máster.

16. Sistema de garantía de calidad de los programas de doctorado.

17. Política y objetivos de calidad en la implantación de un sistema de gestión de la calidad.

18. Evaluación de las prácticas externas en las titulaciones oficiales. Criterios e indicadores.

19. Evaluación de los programas de movilidad en las titulaciones oficiales.

20. Evaluación del rendimiento académico en las titulaciones oficiales. Principales indicadores.

21. Órganos y comisiones implicados en la calidad de los centros y titulaciones de la Universitat de València.

22. Manual de Calidad para la implantación de un SGIC.

23. Procedimientos y evaluación de la dimensión del programa formativo dentro de un SGIC de un centro universitario.

24. Procedimientos y evaluación de la dimensión del desarrollo de la enseñanza dentro de un SGIC de un centro universitario.

25. Procedimientos y evaluación de la organización de la enseñanza dentro de un SGIC de un centro universitario.

26. Procedimientos y evaluación de los recursos humanos dentro de un SGIC de un centro universitario.

27. Procedimientos y evaluación de los recursos materiales dentro de un SGIC de un centro universitario.

28. Procedimientos y evaluación de la dimensión calidad dentro de un SGIC de un centro universitario.

29. Guías docentes. Importancia en el seguimiento de las titulaciones.

30. Evaluación de los servicios universitarios. Mapa de procesos.
...
## ANEXO IV. Solicitud de admisión a las pruebas selectivas de acceso al grupo A, subgrupo A1, turno libre, sector de administración especial, Escala Técnica Superior de Planificación, Análisis y Evaluación (perfil: calidad) de esta Universidad
...
Datos que ha de recoger la solicitud de admisión a las pruebas selectivas de acceso al grupo A, subgrupo A1, turno libre, sector de administración especial, Escala Técnica Superior de Planificación, Análisis y Evaluación (perfil: calidad)
