...
pagina_final: 30769
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2013-4209"
url_pdf: "https://www.boe.es/boe/dias/2013/04/20/pdfs/BOE-A-2013-4209.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2013-4209"
url_eli: "https://www.boe.es/eli/es/rd/2013/04/19/285"
fetched_at: "2026-05-04T13:51:39Z"
...
[encabezado]NORMATIVA DEL PLAN HIDROLÓGICO DE LA PARTE ESPAÑOLA DE LA DEMARCACIÓN HIDROGRÁFICA DEL MIÑO-SIL
...
Anexo 14. Trabajos específicos a realizar durante la revisión del plan hidrológico del Miño-Sil.[fin indice]

### [encabezado]CAPÍTULO PRELIMINAR. Disposiciones generales
...
| --- | --- | --- |
| Unidad de demanda | Asignación (hm^3^/año) | Procedencia |
...
| Población abastecida por el sistema
 (municipio, área metropolitana, etc.) | Dotación bruta máxima
 (l/hab./día) |
| --- | --- |
| Menos de 2.000 | 180 |
...
| Tipo de ganado | Dotación bruta máxima
...
| Tipo de central | Rango de dotación anual en hm^3^ por cada 100 MW potencia eléctrica instalada |  |
| --- | --- | --- |
...
2. Se establece la dotación unitaria máxima bruta para la atención de polígonos industriales de 12.000 m^3^/ha/año. Este valor incluye todas las necesidades complementarias del polígono industrial, tales como zonas ajardinadas, servicios de limpieza y otras.
...
| Actividad extractiva | Dotación máx.
 en m^3^/año/explotación |
| --- | --- |
...
| Código de masa | Nombre | Categoría | Área
 (ha) | N.º | Tipo |
| --- | --- | --- | --- | --- | --- |
...
|  |  |  |  |  |
| Cobre total disuelto | (2) Dureza del agua (mg/LCaCO~3~) | VMA (4) |  |  |
| CaCO~3~ <= 10 | 5 |  |  |  |
| 10 < CaCO~3~ <=50 | 22 |  |  |  |
| 50 < CaCO~3~ <= 100 | 40 |  |  |  |
| 7440508 | CaCO~3~ > 100 | 120 |  |  |
| 7440473 | Cromo total disuelto | 50 |  |  |
| 7782492 | Selenio disuelto | 1 |  |  |
| 440666 | Zinc total | (2) Dureza del agua (mg/LCaCO~3~) | VMA |  |
| CaCO~3~ <= 10 | 30 |  |  |  |
| 10 < CaCO~3~ <=50 | 200 |  |  |  |
| 50< CaCO~3~<= 100 | 300 |  |  |  |
| CaCO~3~ > 100 | 500 |  |  |  |
...
| Nitrato (mg NO~3~11) | 18,4 | 20 |
| Amonio (mg NH~4~/1) | 0,46 | 0,5 |
| DBO~5~ | 4,6 | 5 |
| Fósforo Total (mg/1) | 0,36 | 0,4 |
| Ortofosfatos (mg PO~4~/1) | 0,64 | 0,7 |

(1) En el caso de los siguientes indicadores fisicoquímicos generales : temperatura, saturación de oxígeno, nitrato, amonio, DBO~5~, fósforo total y ortofosfatos, no se dispone de condiciones de referencia ni de una variación de los rangos correspondientes al buen estado por tipología.
...
| Fitoplancton | Biovolumen (mm^3^/L) | 0,36 | 1,9 (0,19) |  |  |
...
| Fitoplancton | Biovolumen (mm^3^/L) | 0,76 | 2,1 (0,19) |  |  |
...
| ELEMENTO
 DE CALIDAD | INDICADOR | CONDICIÓN
 DE REFERENCIA | VALORES LÍMITES /EGR) |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| LÍMITE MUY BUENO/BUENO | LÍMITE BUENO/ MODERADO | LÍMITE MODERADO/DEFICIENTE | LÍMITE DEFICIENTE/MALO |  |  |  |
...
| ELEMENTO
 DE CALIDAD | INDICADOR | CONDICIÓN DE REFERENCIA | VALORES LÍMITES /EGR) |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| LÍMITE MUY BUENO/BUENO | LÍMITE BUENO/ MODERADO | LÍMITE MODERADO/DEFICIENTE | LÍMITE DEFICIENTE/MALO |  |  |  |
...
| --- | --- |
| Nitratos | 50 mg/I |
| Sustancias activas de los plaguicidas, incluidos los metabolitos y los productos de degradación y reacción que sean pertinentes (1) | 0,1 μg/I (referido a cada sustancia). 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| XUTM (29) | YUTM (29) | Qmin. (m^3^/s) | Qmin. (m^3^/s) | Qmin. (m^3^/s) | Qmin. (m^3^/s) |  |  |
...
| MASA DE AGUA | CAUDAL GENERADOR (m^3^/s) | PERIODO RETORNO (AÑOS) | MES DE MÁXIMA FRECUENCIA |  |
| --- | --- | --- | --- | --- |
| CÓDIGO | DENOMINACIÓN |  |  |  |
...
| MASA DE AGUA | TASA DE CAMBIO ASCENDENTE (m^3/^día) | TASA DE CAMBIO DESCENDENTE (m^3/^día) | DURACIÓN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO (h) | VOLUMEN DEL HIDROGRAMA, SEGÚN TASA DE CAMBIO |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Volumen (hm^3^) | Volumen (% s/apor. natural) |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| CÓDIGO | DENOMINACIÓN | TC: 
 Perc. 70 | TC: 
 Perc. 90 | TC 
 Máxima | TC: 
 Perc. 70 | TC: 
...
| Servicios Prestados |  |  |
| Volumen captado, por período de facturación | m^3^ |  |
| Localización de la captación (adjuntar plano de situación y coordenadas UTM Huso 29 ETRS 89) | X:
 Y: |  |
| Volumen registrado, por período de facturación | m^3^ |  |
| Volumen facturado, por período de facturación | m^3^ |  |
...
| Punto de vertido de aguas residuales (adjuntar plano de situación y coordenadas UTM Huso 29 ETRS 89) | X:
 Y: |  |
...
| SISTEMA DE EXPLOTACIÓN | RESERVA AMBIENTAL (hm^3^/año) | RESERVA ABASTECIMIENTO (hm^3^/año) |
| --- | --- | --- |
...
[ignorar]ÍNDICE DE FRANQUEABILIDAD (IF).
...
[ignorar]ÍNDICE DE COMPARTIMENTACIÓN (IC).
...
[ignorar]ÍNDICE DE CONTINUIDAD LONGITUDINAL.
...
M~ov~ = Movilidad, capacidad de realizar migraciones.
...
V~n~ = Vulnerabilidad, En función de las categorías establecidas en la lista roja de la UICN.
...
[ignorar]ÍNDICE DE PRIORIDAD DE ACTUACIÓN (IPA).
...
L~t~  = Longitud total del río.

L~arriba~ = Longitud de las aguas libres por encima del azud.

L~abajo~ = Longitud de las aguas libres por debajo del azud.
...
Sk~i~= Suma de los coeficientes de prioridad de las especies (k~i~) presentes en el tramo del azud en cuestión.

Sk~T~ = Suma de los coeficientes de prioridad de las especies (k~i~) presentes en el río, tramo, masa de agua o cuenca donde se encuentra el azud.
...
P = F~Reserva Fluvial~+ F~LIC~ + F~ESPACIOS PROTEGIDOS~

Donde:

F~Reserva Fluvial~: 50 si el tramo en que está el azud es reserva fluvial.

0 si el tramo en que está el azud no es reserva fluvial.

F~LIC~: 25 si el tramo en que está el azud es LIC de ribera.

0 si el tramo en que está el azud no es LIC de ribera.

F~ESPACIOS PROTEGIDOS~: 25 si el tramo en que está el azud está en un espacio protegido (Parque Nacional, Regional, etc.).
