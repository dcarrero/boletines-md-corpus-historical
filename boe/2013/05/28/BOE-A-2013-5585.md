---
identificador: "BOE-A-2013-5585"
titulo: "Resolución de 10 de mayo de 2013, de la Universidad de Granada, por la que se convoca oposición libre para cubrir plaza de personal laboral con la categoría de Técnico Especialista de Laboratorio (Grupo III), vacante en el Instituto Universitario de Investigación \"Carlos I\"."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 40138
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2013-5585"
url_pdf: "https://www.boe.es/boe/dias/2013/05/28/pdfs/BOE-A-2013-5585.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2013-5585"
url_eli: ""
fetched_at: "2026-05-04T15:54:24Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 10 de mayo de 2013, de la Universidad de Granada, por la que se convoca oposición libre para cubrir plaza de personal laboral con la categoría de Técnico Especialista de Laboratorio (Grupo III), vacante en el Instituto Universitario de Investigación "Carlos I".
...
1.1 Se convoca 1 plaza de Personal Laboral con la categoría de Técnico/a Especialista de Laboratorio (Grupo III), vacante en el Instituto Universitario de Investigación «Carlos I» de Física Teórica y Computacional de esta Universidad, mediante el procedimiento de oposición libre.
...
1.10 El desempeño de las plazas convocadas quedará sometido a la Ley 53/1984, de 26 de diciembre, en materia de Incompatibilidades del Personal al Servicio de las Administraciones Públicas («BOE» n.º 4, de 4 de enero de 1985).
...
Granada, 10 de mayo de 2013.–El Rector, Francisco González Lodeiro.
...
4. Prevención de riesgos laborales en el Área de Mantenimiento Laboratorio.

5. Mantenimiento de cluster de computación masiva.

6. Gestión de discos redundantes.

7. UPS: control de los equipos conectados, apagado automático de ellos.

8. Conexión de redes locales, GigaEthernet, VLANs, Trucking.

9. Reparación y sustitución de equipos dañados.

10. Cluster de computación masiva: gestor de colas de trabajos, scripts para automatizar tareas, ejecución de órdenes en paralelo, backups, gestión de usuarios, imágenes de SO, monitorización, optimización del software para computación, checkpoints de los procesos de ejecución, tecnología GRID, Cloud Computing, software científico.

11. Conocimientos básicos de lenguajes de Programación C/C++, PHP, Perl, Bash, Java.

12. Gestión de bases de datos: MySQL, Access.

13. Conocimientos básicos programación web: HTML, CSS, CGI.

14. Administración de GNU/Linux. Instalación, configuración y resolución de problemas.

15. Gestión de cuentas y usuarios: LDAP, NIS.

16. Servidor de correo: Postfix, IMAP, POP3, cuotas, antispam y antivirus, webmail.

17. Servidor web: diferentes dominios, alojamiento locales para usuarios, SFTP, repositorios software, mirror de distribuciones, Moodle.

18. WIFI: despliegue de red WIFI, Bridges, restricciones de acceso.

19. Seguridad: backups, firewalls, filtrado de IPs, VPN.

20. Servidor de impresión, impresoras compartidas en red.
