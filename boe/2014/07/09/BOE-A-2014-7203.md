...
pagina_final: 53749
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2014-7203"
url_pdf: "https://www.boe.es/boe/dias/2014/07/09/pdfs/BOE-A-2014-7203.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2014-7203"
url_eli: ""
fetched_at: "2026-04-28T19:59:32Z"
parser_version: "boletines-md/0.1"
---

# Resolución 452/38071/2014, de 7 de julio, de la Subsecretaría, por la que se convoca el proceso de selección para el ingreso en los centros docentes militares de formación, mediante la forma de ingreso directo, sin titulación previa de Técnico Superior, para la incorporación como militar de carrera a las Escalas de Suboficiales de los Cuerpos Generales y del Cuerpo de Infantería de Marina.
...
Convocar el proceso de selección para el ingreso en los centros docentes militares de formación mediante la forma de ingreso directo, sin titulación previa de Técnico Superior, para la incorporación como militar de carrera a las escalas de suboficiales de los Cuerpos Generales y del Cuerpo de Infantería de Marina, y aprobar las bases que los regulan.
...
| Cuerpo | Especialidad fundamental | Título de Técnico Superior | Centro docente militar de formación | Código | Vía (a) | Vía (b) | Vía (c) | Total plazas |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| General | Infantería Ligera. | Asistencia a la Dirección. | ACINF | 450 | 3 | 1 | 1 | 5 |
| Infantería Acorazada/Mecanizada. | Asistencia a la Dirección. | 451 | 1 |  |  | 1 |  |  |
| Caballería. | Asistencia a la Dirección. | ACAB | 402 | 1 |  |  | 1 |  |
| Artillería de Campaña. | Mecatrónica Industrial. | ACAR | 453 | 1 |  |  | 1 |  |
| Artillería Antiaérea. | Administración de Sistemas Informáticos en Red. | 404 | 1 |  |  | 1 |  |  |
| Mecatrónica Industrial. | 454 | 1 |  |  | 1 |  |  |  |
| Ingenieros. | Proyectos de Obra Civil. | ACING | 405 | 1 | 1 |  | 2 |  |
| Transmisiones. | Sistemas de Telecomunicaciones e Informáticos. | 406 | 1 | 1 |  | 2 |  |  |
| Totales | 10 | 3 | 1 | 14 |  |  |  |  |
...
| Cuerpo | Especialidad fundamental | Título de Técnico Superior | Centro docente militar de formación | Código | Vía (a) | Vía (b) | Vía (c) | Total plazas |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| General | Maniobra y Navegación. | Transporte marítimo y pesca de altura. | Esengra. | 420 | 1 | 1 |  | 2 |
| Comunicaciones y Sistemas de Información. | Sistemas de Telecomunicaciones e Informáticos. | Escaño. | 418 | 3 |  |  | 3 |  |
| Infantería de Marina | Infantería de Marina. | Asistencia a la Dirección. | Eimgaf. | 422 | 1 | 1 |  | 2 |
| Totales | 5 | 2 |  | 7 |  |  |  |  |
...
| Cuerpo | Especialidad fundamental | Título de Técnico Superior | Centro docente militar de formación | Código | Vía (a) | Vía (b) | Vía (c) | Total plazas |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| General | Protección y Apoyo a la Fuerza | Sistemas de Telecomunicaciones e Informáticos | ABA | 424 | 1 | 1 |  | 2 |
| Mantenimiento Operativo | Mantenimiento Aeromecánico | 425 | 3 |  |  | 3 |  |  |
| Control Aéreo y Sistemas de Información y Telecomunicaciones | Sistemas de Telecomunicaciones e Informáticos | 426 | 1 | 1 |  | 2 |  |  |
| Totales | 5 | 2 |  | 7 |  |  |  |  |

2. Notas

2.1 Los aspirantes deberán optar por una de las tres vías de acceso, en función del nivel de estudios indicado en la solicitud de admisión (apéndice 1):
...
2.2 Las plazas ofertadas en función de las distintas vías de acceso –(a), (b) o (c)– siguen el criterio establecido en el artículo 47 del Real Decreto 1147/2011, de 29 de julio, con la siguiente preferencia:
...
Las plazas no cubiertas se acumularán siguiendo los criterios preferenciales expuestos a continuación:

1.º Mismo código de plaza. La vía de acceso será, tanto en este criterio como en los siguientes: la que corresponda según el apartado 2.2 de las notas de la disposición segunda.

2.º Misma especialidad fundamental, pero en el otro código de plaza (aplicable, en su caso, a las especialidades fundamentales de Artillería de Campaña y Antiaérea del Ejército de Tierra, únicas opciones en las que dentro de la misma especialidad se ofertan varios códigos de plazas).

3.º Mismo centro docente militar de formación, en el código de plaza que mayor prioridad tenga establecida según los criterios determinados por los Ejércitos en el siguiente apartado.

4.º En el código de plaza determinado por los Ejércitos según el siguiente orden de prioridad:

i. En el Ejército de Tierra: Las plazas que queden sin cubrir de cualquier especialidad fundamental se asignarán, una a una, por el orden que se ofertan en el apartado 1.1 de la disposición segunda.

ii. En la Armada: las plazas que queden sin cubrir de cualquier especialidad fundamental, del Cuerpo General de la Armada, se asignarán, una a una, por el orden que se ofertan en el apartado 1.2 de la disposición segunda.

iii. En el Ejército del Aire: las plazas que queden sin cubrir de cualquier especialidad fundamental se asignarán, una a una, por el orden que se cita a continuación: Mantenimiento Operativo, Control Aéreo y Sistemas de Información y Telecomunicaciones, Protección y Apoyo a la Fuerza.
...
1. Para ser admitidos en el proceso de selección, los aspirantes deberán reunir el día de finalización del plazo de presentación de solicitudes y mantener hasta el momento de la incorporación al centro docente militar de formación, los siguientes requisitos:
...
1.1.1 Solicitud de admisión al proceso de selección, por la forma de ingreso directo, sin titulación previa de Técnico Superior, para la incorporación como militar de carrera a las Escalas de Suboficiales de los Cuerpos Generales y del Cuerpo de Infantería de Marina. Apéndice 1.

Para ser admitidos al proceso de selección, los aspirantes deberán remitir la solicitud (apéndice 1), junto con el resto de documentación, mediante el procedimiento indicado en el apartado 2 de esta base.
...
1.1.6 Copia compulsada o legalizada del documento oficial y definitivo que acredite haber superado la prueba, el curso de formación o estar en posesión de la titulación que se indica en la base segunda.1.g), de acuerdo con las plazas solicitadas.
...
En el caso de estar en condiciones de poseer un determinado título, de acuerdo a lo especificado en la base segunda.1.g), se aportará documento que acredite haber cumplido los trámites legales para su expedición.

1.1.7 Además de lo anterior, en función de la procedencia o edad del personal que solicite la admisión, también se aportará lo siguiente:
...
1.3 Presentación antes del inicio de la primera prueba física: Certificado médico oficial según modelos apéndice 9.
...
Al día siguiente de la finalización del plazo de admisión de solicitudes, los Jefe de UCO de destino/dependencia remitirán, vía correo electrónico a la dirección cuerposgeneralesuboficiales@oc.mde.es, relación nominal de todos los aspirantes de su UCO que solicitan formar parte del proceso de selección de la presente convocatoria. En el caso de que la UCO no tenga acceso a SIPERDEF, en el mismo correo se indicará dicha circunstancia.
...
Para el desarrollo y resolución del proceso de selección, se constituye un órgano de selección con la composición que se establece en el apéndice 8.
...
b) Aptitud psicofísica. Constará de pruebas psicológicas, pruebas físicas y reconocimiento médico. Se realizarán en el citado orden.

Excepto el reconocimiento médico, que será la última prueba que se realice, el orden del resto de las pruebas podrá ser alterado por el Presidente del órgano de selección cuando por concurrencia o no con otros procesos de selección sea necesario optimizar el rendimiento del personal e instalaciones que intervenga en la realización del proceso.
...
La prueba de lengua inglesa y las pruebas psicológicas, se realizarán en tanda única. Las pruebas físicas y el reconocimiento médico, así como la prueba de aptitud para vuelo, por tandas.
...
Los calificados como «no apto» en las pruebas físicas o en el reconocimiento médico serán eliminados del proceso de selección.
...
Los aspirantes deberán finalizar las pruebas y superar las marcas de las pruebas físicas recogidas en el apéndice 10.
...
El requisito especificado en el apartado 1.m) de la base segunda, se deberá verificar durante el desarrollo del reconocimiento médico. Si se detectara la existencia de algún caso en el que no se cumple el requisito, se pondrá en conocimiento del Presidente del órgano de selección a fin de que el personal afectado sea excluido del proceso de selección.
...
La calificación final del proceso de selección coincidirá con la puntuación final del concurso obtenida conforme a lo indicado en la base octava. Las puntuaciones se ordenarán de mayor a menor.

En caso de concurrir aspirantes que opten al proceso de selección con los requisitos que se contemplan en el apartado 1.g): i, ii y iii, de la base segunda, se confeccionarán tres listas:

– Lista número 1. Para los aspirantes que acrediten el requisito académico que figura en la base segunda.1.g).i.

– Lista número 2. Para los aspirantes que acrediten el requisito de la base segunda.1.g).ii.

– Lista número 3. Para los aspirantes que acrediten el requisito de la base segunda.1.g).iii

En el supuesto de igualdad en la calificación final, se aplicará lo siguiente:

– Para la lista número 1: Tendrá prioridad el aspirante que haya cursado el Bachillerato en la modalidad de Ciencia y Tecnología. De persistir el empate el que tenga mejor nota media del Bachillerato. De persistir la igualdad, el que tenga mayor valoración en los méritos militares.

– Para la lista número 2: Tendrá prioridad el aspirante que tenga mejor nota media en el curso de formación específico. De persistir la igualdad, el que tenga mayor valoración en los méritos militares.

– Para la lista número 3: Tendrá prioridad el aspirante que tenga mejor nota media en la prueba de acceso a la formación profesional de grado superior. De persistir la igualdad, el que tenga mayor valoración en los méritos militares.
...
No más tarde del día 7 de septiembre, el órgano de selección expondrá en la página web www.reclutamiento.defensa.gob.es/convounica, y en el tablón de anuncios del Ministerio de Defensa (calle General Yagüe, número 1), la relación complementaria de aspirantes, ordenada de mayor a menor nota, que habiendo superado las pruebas no hubieran obtenido plaza.
...
a) Ejército de Tierra. Al centro docente militar de formación que se determine en la resolución de aspirantes propuestos como alumnos, el día 8 de septiembre antes de las 10:00 horas.

b) Armada. Escuela de Suboficiales de la Armada, San Fernando (Cádiz): El día 8 de septiembre antes de las 10:00 horas.

c) Ejército del Aire. Academia Básica del Aire, Virgen del Camino (León): El día 8 de septiembre antes de las 10:00 horas.
...
– Armada. Código de Operación NF 0011. Número CIS cargo cupo ALPER 850000/14.
...
a) El día 9 de septiembre se procederá a cubrir las plazas de los propuestos como alumnos que no hayan efectuado su presentación, sin causa justificada, en el centro docente militar de formación correspondiente.

b) Hasta las 24 horas del día 21 de septiembre se cubrirán, cuando se produzcan, las plazas correspondientes a las bajas producidas en la fase de acogida y periodo de adaptación a la vida militar, fecha en la que finaliza la citada fase.
