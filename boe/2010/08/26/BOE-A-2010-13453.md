...
pagina_final: 74382
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-13453"
url_pdf: "https://www.boe.es/boe/dias/2010/08/26/pdfs/BOE-A-2010-13453.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-13453"
url_eli: ""
fetched_at: "2026-05-14T18:48:29Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 17 de agosto de 2010, de la Secretaría General Técnica, por la que se publica el Convenio con la Comunitat Valenciana, por el que se acuerda ejecutar para el año 2010, un programa especifico que desarrolla determinadas estrategias de gestión para mejorar la prestación de incapacidad temporal y estudia el comportamiento de los procesos de corta duración.
...
Convenio entre la Comunidad Valenciana y el Ministerio de Trabajo e Inmigración (INSS) por el que se acuerda ejecutar, durante el año 2010, un programa específico que desarrolla determinadas estrategias de gestión para mejorar la prestación de incapacidad temporal y estudia el comportamiento de los procesos de corta duración
...
Y de otra parte, el Honorable Conseller de Sanidad, don Manuel Cervera Taulet, en virtud de las competencias que le atribuye al artículo 35 de la Ley 5/1983, de 30 de diciembre, del Consell, facultado por acuerdo de Consell de fecha 11 de junio de 2010.
...
Primera.–El presente Convenio tiene por objeto establecer la colaboración entre el INSS y la Comunidad Valenciana para el desarrollo del Programa Específico, que se acompaña como parte integrante del Convenio. Con él, se pone en marcha un programa de estudio y seguimiento en procesos de IT de corta duración. Asimismo se establece un seguimiento de las bajas de los empleados de la Administración de la Generalitat y de las Instituciones Sanitarias, la consolidación de los accesos y la comunicación telemática entre ambas administraciones y finalmente se pone en marcha un plan de concienciación e información dirigido a los profesionales sanitarios y a los ciudadanos sobre un uso adecuado de la prestación.

Segunda.–La Comunidad Valenciana, a través de la Consejería de Sanidad y de su Servicio Publico de Salud, se compromete a:
...
Llevar a cabo un seguimiento singularizado de cada uno de los procesos que atañen al colectivo de empleados de la Administración de la Generalitat y las Instituciones Sanitarias.

Consolidar el acceso de los Inspectores Médicos del INSS al sistema de Historias Clínicas (ABUCASIS) y ampliar la comunicación telemática haciendo posible la transferencia digital de los documentos.
...
Efectuar el abono de las cantidades estipuladas según lo establecido en el Programa, con cargo al crédito figurado en los Presupuestos del INSS, referido en el punto cuarto de este Convenio y hasta la cantidad de 3.080.663,85 euros destinada para el mismo.
...
Y en prueba de conformidad, firman el presente Convenio en duplicado ejemplar, quedándose uno en poder de cada parte, en el lugar y fecha arriba indicados.–Por el Mi misterio de Trabajo e Inmigración, el Secretario de Estado de la Seguridad Social, Octavio J. Granado, el Director General del INSS, Fidel Ferreras Alonso.–Por la Comunidad Valenciana, Manuel Cervera Taulet.
...
Este Programa plantea aprovechar la experiencia de los estudios realizados en los años anteriores por el Instituto Nacional de la Seguridad Social (INSS) y la Comunidad Autónoma Valenciana a través del Servicio Público de Salud.
...
El Programa desarrolla cuatro objetivos: con el primero, se pone en marcha un estudio sobre el comportamiento en esta Comunidad de los procesos de IT de corta duración; el segundo, establece un seguimiento pormenorizado de las bajas laborales de los profesionales de la Administración de la Generalitat y de las Instituciones Sanitarias, el tercero, consolida el acceso a ABUCASIS y la comunicación telemática entre el INSS y el Servicio Público de Salud y con el cuarto se pone en marcha un plan de concienciación e información dirigido a los profesionales sanitarios y a los ciudadanos sobre un uso adecuado de la prestación.

1. Estudio y seguimiento en procesos de IT de corta duración.–Del análisis de los procesos de IT generados en esta Comunidad se desprende que un número elevado de ellos corresponde a procesos de corta duración que provocan además una merma importante para la organización del sistema productivo. Por ello se establece este objetivo consistente en la puesta en marcha de un estudio que someta a un seguimiento más riguroso a los procesos de IT, durante el primer mes de vigencia de cada uno de ellos.
...
Ponderación en el programa: este objetivo tiene, en el total del crédito asignado, un peso del 40%. Con dicho crédito la Comunidad deberá hacer frente a los gastos que se deriven del establecimiento de los equipos que se constituyan en la ejecución de este estudio, así como de las actualizaciones y mejoras informáticas que sean necesarias y del coste de los proyectos de investigación y de cualquier otra actividad incluida en la ejecución del mismo.
...
2. Plan de seguimiento específico de los procesos de IT de los profesionales de la Administración de la Generalitat y de las Instituciones Sanitarias.–Mediante este objetivo, se pretende llevar a cabo un análisis en profundidad de los procesos de IT que genera el personal, tanto sanitario como no sanitario, destinado en los distintos centros de la Administración de la Generalitat y de las Instituciones Sanitarias.
...
3. Consolidación del acceso y la comunicación telemática entre las tres Direcciones Provinciales del INSS y el Servicio Público de Salud.–Con la consecución de este objetivo se pretende completar el acceso de los Inspectores Médicos del INSS de las tres Direcciones Provinciales, ya iniciado en el ejercicio anterior, al sistema de Historias Clínicas (ABUCASIS) y ampliar la remisión por vía telemática de la documentación digitalizada entre la Consejería de Sanidad y las tres Direcciones Provinciales del INSS, haciendo posible la recepción por dicha vía de los informes trimestrales de control de la IT y de las propuestas de invalidez.
