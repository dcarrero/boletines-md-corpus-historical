---
identificador: "BOE-A-2010-13452"
titulo: "Resolución de 17 de agosto de 2010, de la Secretaría General Técnica, por la que se publica el Convenio con la Comunidad Autónoma de Castilla-La Mancha, por el que se acuerda ejecutar para el año 2010, un programa especifico que desarrolla determinadas estrategias de gestión para mejorar la prestación de incapacidad temporal y estudia el comportamiento de los procesos de corta duración."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 74375
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-13452"
url_pdf: "https://www.boe.es/boe/dias/2010/08/26/pdfs/BOE-A-2010-13452.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-13452"
url_eli: ""
fetched_at: "2026-05-14T18:48:28Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 17 de agosto de 2010, de la Secretaría General Técnica, por la que se publica el Convenio con la Comunidad Autónoma de Castilla-La Mancha, por el que se acuerda ejecutar para el año 2010, un programa especifico que desarrolla determinadas estrategias de gestión para mejorar la prestación de incapacidad temporal y estudia el comportamiento de los procesos de corta duración.

Suscrito el Convenio entre el Ministerio de Trabajo e Inmigración (INSS) y la Comunidad Autónoma de Castilla-La Mancha por el que se acuerda ejecutar para el año 2010, un programa especifico que desarrolla determinadas estrategias de gestión para mejorar la prestación de incapacidad temporal y estudia el comportamiento de los procesos de corta duración, y en cumplimiento de lo dispuesto en el punto dos del artículo 8 de la Ley 30/1992, de 26 de noviembre, de Régimen Jurídico de las Administraciones Públicas y del Procedimiento Administrativo Común, procede la publicación en el «Boletín Oficial del Estado» del citado Convenio, que figura como anexo de esta Resolución.
...
Convenio entre la Comunidad de Castilla-La Mancha y el Ministerio de Trabajo e Inmigración (INSS) por el que se acuerda ejecutar, durante el año 2010, un programa específico que desarrolla determinadas estrategias de gestión para mejorar la prestación de incapacidad temporal y estudia el comportamiento de los procesos de corta duración
...
Y de otra parte, don Fernando Lamata Cotanda, Consejero de Salud y Bienestar Social, nombrado por Decreto 128/2008, de 31-08-2008 («DOCM» número 181, de 2 de septiembre), y don Ramón Gálvez Zaloña, Director Gerente del Servicio de Salud de Castilla-La Mancha, en adelante (SESCAM), en virtud de nombramiento efectuado por Decreto 149/2009, de 6 de octubre («DOCM» número 198, de 09-10-2009), cuya capacidad para la firma del presente Convenio se deriva de las funciones representativas y de carácter institucional que le corresponden en razón de su cargo, a tenor de la referencia general al respecto contenida en el artículo 73 de la Ley 8/2003, de 30 de noviembre, de Ordenación Sanitaria de Castilla-La Mancha, y, en ejercicio de las funciones que le atribuye el artículo 4 del Decreto 140/2008, de 9 de septiembre («DOCM» número 189, de 12-09-2008), de Estructura Orgánica y Funciones de los Servicios Centrales y Periféricos del SESCAM.
...
Primera. El presente Convenio tiene por objeto establecer la colaboración entre el INSS y la Comunidad Autónoma de Castilla-La Mancha para el desarrollo del Programa Específico, que se acompaña como parte integrante del Convenio. Con él, se pone en marcha un programa de estudio y seguimiento en procesos de IT de corta duración. Asimismo se aborda la evaluación de actuaciones de los médicos de atención primaria en orden a la emisión de partes médicos de baja, se establece un sistema de información al asegurado de la situación de su proceso de IT en relación con tiempos estandarizados y finalmente, se adoptan las medidas encaminadas a capacitar a los Inspectores Médicos del INSS para que accedan a la base de datos informatizada de las historias clínicas.

Segunda. La Comunidad de Castilla-La Mancha, a través de la Consejería de Salud y Bienestar Social y del SESCAM, se compromete a:
...
Realizar un plan encaminado a evaluar las actuaciones de los médicos de atención primaria en su emisión de partes médicos de baja y alta.

Establecer un sistema de comunicación al asegurado y al médico de atención primaria correspondiente, sobre la situación del proceso de IT en relación con el tiempo que marcan las tablas de duración estándar para su patología.

Llevar a cabo las actividades encaminadas a capacitar a los Inspectores Médicos del INSS para el acceso informatizado a las historias clínicas desde su puesto de trabajo.
...
Proporcionar cuanta información sea necesaria a la Consejería de Salud y Bienestar Social la documentación oportuna, a fin de poder llevar a cabo las actuaciones objeto del Convenio.

Efectuar el abono de las cantidades estipuladas según lo establecido en el Programa, con cargo al crédito figurado en los Presupuestos del INSS, referido en el punto cuarto de este Convenio y hasta la cantidad de 1.370.805,28 euros destinada para el mismo.
...
Los representantes del INSS serán designados por el Director General del mismo y los representantes de la Comunidad por su Consejero de Salud y Bienestar Social.
...
Tres representantes de la Comunidad Autónoma designados por la Consejería de Salud y Bienestar Social.
...
Séptima. Liquidación del crédito.–El crédito establecido para financiar el Programa será transferido a la Consejería de Salud y Bienestar Social de forma gradual. A tal fin se tendrán en consideración las siguientes premisas:

El crédito se abonará en función de los resultados obtenidos en la ejecución del Programa.

La Consejería de Salud y Bienestar Social debe disponer al inicio de la ejecución de este Convenio del crédito necesario para ponerlo en marcha, facilitado mediante anticipo por el INSS, en la cuantía establecida en el Programa.
...
Y en prueba de conformidad, firman el presente Convenio en duplicado ejemplar, quedándose uno en poder de cada parte, en el lugar y fecha arriba indicados.–Por el Ministerio de Trabajo e Inmigración, el Secretario de Estado de la Seguridad Social, Octavio J. Granado Martínez, el Director General del INSS, Fidel Ferreras Alonso.–Por la Comunidad Autónoma de Castilla-La Mancha, el Consejero de Salud y Bienestar Social, Fernando Lamata Cotanda.
...
Este Programa plantea aprovechar la experiencia de los estudios realizados en los años anteriores por el Instituto Nacional de la Seguridad Social (INSS) y la Comunidad Autónoma de Castilla-La Mancha a través del SESCAM.
...
El Programa desarrolla cuatro objetivos: con el primero, se pone en marcha un estudio sobre el comportamiento en esta Comunidad de los procesos de IT de corta duración; el segundo, establece la evaluación de la actividad desarrollada por aquellos médicos de atención primaria que destacan por la elevada frecuencia en la emisión de partes de baja; el tercero, se ocupa de informar al ciudadano sobre la situación de su proceso de IT en relación con la duración estándar y el cuarto; persigue el acceso de los Inspectores Médicos del INSS, a la base de datos informatizada de las historias clínicas.
...
2. Evaluación de la actuación de los médicos que destacan por la elevada frecuencia en la emisión de partes.
...
Ponderación en el programa: este objetivo tiene, en el total del crédito asignado, un peso del 15%.

3. Desarrollo de un sistema de información y cita a consulta al ciudadano que supere duraciones estándar de IT.

Con esta actuación se pretende hacer consciente tanto al trabajador como al facultativo de la situación de la IT, con el objetivo de ajustar las duraciones a los estándares establecidos para cada diagnóstico.

Para ello se enviaría a cada trabajador en situación de IT un SMS a su teléfono móvil, cuando haya superado los días de duración estándar de acuerdo con el diagnóstico que motivó la IT, y con la referencia de las tablas de duraciones del INSS, para que solicite consulta con su médico.

Ponderación en el programa: este objetivo tiene, en el total del crédito asignado, un peso del 20%.

4. Acceso de los Inspectores Médicos del INSS, desde su puesto de trabajo a la base de datos, informatizada de historias clínicas.

Con este objetivo, ambas administraciones firmantes se comprometen a desarrollar las actividades necesarias a fin de alcanzar, para los Inspectores Médicos del INSS en la Comunidad, la capacidad de acceder informáticamente, a la base de datos de historias clínicas (TURRIANO) correspondientes a los procesos de incapacidades laborales que se gestionen en su territorio.
...
Comunicación entre la Consejería de Salud y el INSS: La Comisión Mixta establecerá unos cauces específicos de comunicación entre el INSS y la Consejería de Salud y Bienestar Social (SESCAM), mediante los cuales fluya cuanta información, datos y documentos se consideren oportunos para el eficaz desarrollo de las experiencias que se ponen en común.
...
Con la periodicidad de, al menos una vez por mes, la Dirección Provincial del INSS recibirá del órgano de la Inspección Médica que designe la Consejería de Salud y Bienestar Social, los datos y documentación correspondiente a los resultados obtenidos en los procesos de control fijados y detalle de las actividades realizadas.
...
Para la ejecución del Programa se pondrán a disposición de la Consejería de Salud y Bienestar Social, mediante un anticipo a cuenta, los fondos necesarios para poner en marcha el citado Programa. En fechas posteriores, coincidiendo con las etapas marcadas, se irán efectuando liquidaciones ajustadas a los objetivos alcanzados en cada una de ellas.

Anticipos y liquidaciones: Al inicio del Programa, la Consejería de Salud y Bienestar Social recibe un anticipo del 25% del crédito. Esta cantidad se mantendrá anticipada a lo largo de la ejecución del Convenio y sólo será objeto de liquidación al final del mismo.
