...
pagina_final: 55319
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-9994"
url_pdf: "https://www.boe.es/boe/dias/2010/06/24/pdfs/BOE-A-2010-9994.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-9994"
url_eli: "https://www.boe.es/eli/es/rd/2010/06/04/750"
fetched_at: "2026-05-14T15:21:04Z"
...
[ignorar]Anexo Técnico sobre Homologación Nacional de Tipo de vehículos de la categoría L
...
### [encabezado]APÉNDICE 1. Generalidades
...
### [encabezado]APÉNDICE 3. Serie Corta Nacional
...
| 3.2.2 | Combustibles: Diesel/gasolina/mezcla/otros ^(1)^ : 
 (En caso de otro tipo de combustible se deberá determinar un procedimiento de ensayo) | X | X |
...
| 3.2.4.3.3 | Inyectores: Referencia o presión de apertura o diagrama 
 característico ^(2)^ | X | X |
...
| 5.2 | Neumáticos (categoría, dimensiones y carga máxima) y llantas 
 normalmente montados | X | X |
...
| 5.2.4 | Símbolo de la mínima categoría de velocidad compatible con la 
 velocidad máxima teóricas por construcción del vehículo | X | X |
...
| 6.1.2 | Breve descripción de los componentes eléctricos y electrónicos 
 utilizados en el sistema de dirección | X | X |
| 7 | **FRENOS** |  |  |
...
| 7.4 | Otros dispositivos (en su caso): diseño y descripción de los 
 componentes eléctricos y electrónicos utilizados en el sistema de frenos | X | X |
| 8 | **DISPOSITIVO DE ALUMBRADO Y DE SEÑALIZACIÓN LUMINOSA** |  |  |
| 8.1 | Lista de todos los dispositivos (citar número, marca(s), modelo(s), 
 marca(s) de homologación, intensidad máxima de las luces de carretera, color, luz-testigo correspondiente) | X | X |
...
| Epígrafe | Ficha de características. Categoría L | Completos /
...
| 9.3.2 | Fotografías y/o diseños que muestren la parte oficial de las 
 inscripciones (ejemplo completo con indicación de las dimensiones) | X | X |
...
| Epígrafe | Ficha de características 
 Ciclomotores de 2 ruedas y Motocicletas | Completos/
 Completados | Incompletos |
| --- | --- | --- | --- |
| 1 | **EQUIPOS** |  |  |
...
| Epígrafe | Ficha de características. 
 Ciclomotores de 3 ruedas, Vehículos de 3 ruedas y Cuadriciclos | Completos/
 Completados | Incompletos |
| --- | --- | --- | --- |
...
^(g)^ Calcule el valor (a partir de Π = 3,1416) y redondee al cm^3^ .
...
### [encabezado]APÉNDICE 4. Homologación Individual
...
### [encabezado]APÉNDICE 5. Lista de requisitos exigidos para la homologación de vehículos en series cortas nacionales y homologación individual y casos excepcionales asimilados a la categoría
...
[ignorar]Anexo Técnico sobre Homologación de Tipo Nacional de vehículos de las categorías M y N
...
### [encabezado]APÉNDICE 2. Homologación Nacional de Tipo (categorías M y N)
...
| Epígrafe | Ficha de características. Categoría M y N | Completos/
 Completados | Incompletos |
| --- | --- | --- | --- |
| 0. | GENERALIDADES |  |  |
...
| 0.2.0.2 | Carrocería/Vehículo completo/completado 
 (en caso de vehículo completado, indicar la fase de fabricación) : | X |  |
| 0.2.1. | Denominación o denominaciones comerciales (si están disponibles): | X | X |
| 0.2.2 | Descripción del vehículo incompleto/completo/completado 
 p.e. camión cisterna 4x2, furgón cerrado, camión capitoné, tractora 6x4 con 5º rueda, (según anexo 2 parte C de la Directiva 2007/46/CE) | X | X |
...
| 2.3.2. | Vía de los demás ejes (^g^^4^): | X | X |
...
| 3.2.2.2. | Vehículos pesados (MMTA > 2,5 t): gasóleo/gasolina/GLP/GN-H/GNL/GN-HL/etanol (^1^)(^6^): | X | X |
...
| 3.2.9.4 | Tipo y marca del silencioso o de los silenciosos de escape: 
 En su caso, para el ruido exterior, medidas adoptadas para la reducción del ruido en el compartimento del motor y en el propio motor | X | X |
...
| 3.5 | Emisiones de CO~2~ y consumo de combustible (^o^) |  |  |
| 3.5.0 | Nivel de emisiones de escape: Euro ........... | X | X |
| 3.5.0.1 | Nivel de ruido a vehículo parado: ....... dB(A) a .......min-1 | X | X |
| 3.5.1.3 | Emisiones de CO~2~ en masa (ciclo mixto): g/km | X | X |
...
| 13.3.1. | Total (N) (^z^): | X |  |
| 13.3.2. | Piso superior (N~a~)(^z^) (^1^): | X |  |
| 13.3.3. | Piso inferior (N~b~) (^z^) (^1^): | X |  |
| 13.4. | Número de pasajeros (sentados) | X |  |
| 13.4.1 | Total (A) (^z^): | X |  |
| 13.4.2. | Piso superior (A~a~) (^z^) (^1^): | X |  |
| 13.4.3 | Piso inferior (A~b~) (^z^) (^1^): | X |  |
...
(^m^) Calcule el valor (a partir de Π = 3,1416) y redondee al cm^3^.
...
| Emisión de CO~2~ (Ciclo mixto) g/km: | X | X | X |
| Potencia Fiscal (CVF) | X | X | X |
| Observaciones | X | X | X |
| Opciones incluidas en la homologación de tipo | X | X | X |
| Firma autorizada según el RFFR | X | X | X |
...
| VARIOS |  |  |  |
| Velocidad máxima | X | X | X |
| Emisión de CO~2~ (ciclo mixto) (en su caso) (sólo N1) | X | X | X |
| Nivel de ruido parado: dB(A) a min^-1^ | X | X | X |
| Nivel de emisiones: Euro... | X | X | X |
| Potencia Fiscal (CVF) | X | X | X |
...
| Número de pasajeros sentados (incluido el conductor).1.^er^piso y 2º piso. | X | X | X |
...
### [encabezado]APÉNDICE 3. Serie Corta Nacional (categorías M y N)
...
### [encabezado]APÉNDICE 5. Lista de requisitos exigidos para la homologación de vehículos en Serie Corta Nacional y Homologación Individual.
...
| 3 | Depósitos de combustible /dispositivos de protección trasera | 70/221/CEE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
...
| 7 | Avisador acústico | 70/388/CEE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
| 8 | Dispositivos de visión indirecta | 2003/97/CE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
| 9 | Frenado | 71/320/CEE | A | A | A |
| 10 | Supresión de parásitos radioléctricos | 72/245/CEE | A(1) 
 C(3) | A(6) | A(1) 
 C(3) |
...
| 20 | Instalación de dispositivos de alumbrado y señalización luminosa | 76/756/CEE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
...
| 31 | Cinturones de seguridad | 77/541/CEE | A(2) 
 B(4) | A(6) | A(2) 
 B(4) |
...
| 39 | Emisiones de CO~2~/Consumo de carburante | 80/1268/CEE | A | A | A |
...
| 45 | Vidrios de seguridad | 92/22/CEE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
| 46 | Neumáticos | 92/23/CEE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
...
| 60 | Sistema de protección delantera | 2005/66/CE | X(2) 
 A(4) | A(6) | X(2) 
 A(4) |
| 61 | Sistema de aire acondicionado | 2006/40/CE | X(2) 
 B(3) | B(6) | X(2) 
 B(3) |
...
| 3 | Depósitos de combustible/dispositivos de protección trasera | 70/221/CEE | X(2) A | A(6) | X(2) 
 A |
...
| 8 | Dispositivos de visión indirecta | 2003/97/CE | X(2) 
 ...
 B(4) |
| 9 | Frenado | 71/320/CEE | A | A | A |
| 10 | Supresión de parásitos radioléctricos | 72/245/CEE | A(1) C(3) | A(6) | A(1) 
 C(3) |
| 11 | Emisiones diesel | 72/306/CEE | A | A | A |
...
| 39 | Emisiones de CO~2~ / Consumo de carburante | 80/1268/CEE | NA | NA | NA |
| 40 | Potencia del motor | 80/1269/CEE | C | C | C |
...
| 46 | Neumáticos | 92/23/CEE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
| 47 | Limitadores de velocidad (sólo M3) | 92/24/CEE92/6/CEE | X(2) 
 A(4) | A(6) 
 A(4) | X(2) 
 A(4) |
| 48 | Masas y dimensiones (excepto vehículos: punto 44) | 97/27/CE | A | A | A |
| 49 | Salientes exteriores de las cabinas | 92/114/CEE | NA | NA | NA |
| 50 | Dispositivos de acoplamiento | 94/20/CE | X(2) 
 A(4) | A(6) | X(2) 
 A(4) |
| 51 | Inflamabilidad (Sólo M3) | 95/28/CE | X(2) 
 A(4) | A(6) | X(2) 
 A(4) |
...
### [encabezado]APÉNDICE 2. Homologación Nacional de Tipo.
...
| 9. | CARROCERÍA |  |  |  |
| 9.0.1. | Para homologación de vehículos completados será necesario 
 presentar un certificado de acuerdo de colaboración entre los 
 fabricantes de las distintas fases. (Anexo XVII Directiva Marco) |  | X |  |
...
| Superficie del suelo cubierta por el vehículo (sólo O2, O3 y O4): ..... m^2^ |  | X | X |
| Voladizo trasero |  | X | X |
| Masa del vehículo con carrocería en orden de marcha |  | X | X |
...
| Breve descripción del dispositivo de frenado | X | X | X |
| Tipo de carrocería (según parte C del anexo II de la Directiva 2007/46) |  | X | X |
| Capacidad del depósito (sólo vehículos cisterna): ..... m^3^ | X | X | X |
...
### [encabezado]APÉNDICE 3. Serie corta nacional (Categorías O1, O2, O3 y O4.)
...
### [encabezado]APÉNDICE 4. Homologación Individual (Categorías O1, O2, O3 y O4.)
...
| Categoría O1 y O2 |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| **Asunto** | **Número AR (*)** | Serie Corta 
 
 **Nacional (H)** | **Homologación Individual (H)** |  |  |
| **Completos** | **Completados y transformados** |  |  |  |  |
...
| 9 | Frenado | 71/320/CEE | A | A | A |
| 10 | Supresión de parásitos radioeléctricos | 72/245/CEE | A(1) 
 C(3) | A(6) | A(1) 
 C(3) |
| 11 | Humos diesel | 72/306/CEE | NA | NA | NA |
| 12 | Acondicionamiento 
 interior | 74/60/CEE | NA | NA | NA |
...
| 20 | Instalación de los dispositivos de alumbrado y señalización luminosa | 76/756/CEE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
| 21 | Catadióptricos | 76/757/CEE | X(2) | A(6) | X(2) |
...
| 17 | Velocímetro y marcha atrás | 75/443/CEE | NA | NA | NA |
| 18 | Placas 
 reglamentarias | 76/114/CEE | B | A | B |
| 19 | Anclajes de los cinturones de seguridad | 76/115/CEE | NA | NA | NA |
| 20 | Instalación de los dispositivos de alumbrado y señalización luminosa | 76/756/CEE | X(2) 
 B(4) | A(6) | X(2) 
 B(4) |
...
[ignorar]Anexo Técnico sobre Homologación de Tipo Nacional de vehículos de la categoría T
...
### [encabezado]APÉNDICE 2. Homologación Nacional de Tipo (categoría T5)
...
| 2.3 | Dimensiones máximas y mínimas del tractor 
...
| 2.4 | Masa del tractor en vacío en orden de marcha (16) incluida la estructura de protección contra el vuelco, sin accesorios opcionales, pero con liquido de refrigeración, lubricantes, combustible,herramientas y conductor (6) 
 – máxima: 
 – mínima: |  |  |  |  |
...
| 2.7 | Masa remolcable técnicamente admisible por el tractor en el caso de: 
...
| 3.1.1 | Motor representativo / Tipo de motor (1) (21) 
...
| 3.1.5 | Principio de funcionamiento: 
...
| 3.4 | Potencia nominal: ......... kW a ...... min^-1^ con ajuste de serie (de conformidad con la Directiva 2000/25/CE o alternativamente CEPE/ONU 120R) |  |  |  |  |
...
### [encabezado]APÉNDICE 3. Serie corta nacional (categoría T)
...
### [encabezado]APÉNDICE 5. Lista de requisitos exigidos para la homologación nacional de tipo, series cortas nacionales y homologación Individual del vehículo, sus partes y piezas
...
| Avisador Acústico | 74/151/CEE V | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
...
| Velocidad máxima | 74/152/CEE, 
 Anexo, 
 Apartado 1 | C | C | C | C | C |
| Plataforma de carga | 74/152/CEE, 
 Anexo, 
 Apartado 2 | C | C | C | C | C |
| Retrovisores | 74/346/CEE | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
...
| Parabrisas y otros vidrios | 89/173/CEE III | X (2) 
 B (4) | X (2) 
 B (4) | X(2) 
 B (4) | X (2) 
 B (4) | N/A |
| 92/22/CEE | N/A | N/A | N/A | N/A | X (2) 
 B (4) |  |
...
| Enganches mecánicos entre tractores y remolques y carga vertical sobre el punto de tracción | 89/173/CEE IV | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
 B (4) | X (2) 
...
| Neumáticos | Reglamento 
 CEPE/ONU 
 106R00 | (C) RGV | C (RGV) | C (RGV) | C (RGV) | C (RGV) |
...
[ignorar]Anexo Técnico sobre Homologación de Tipo Nacional de Máquinas automotrices de un eje
...
### [encabezado]APÉNDICE 5. Lista de requisitos exigidos para la homologación nacional de tipo y homologación individual del vehículo, sus partes y sus piezas
...
|  | Instalación de los dispositivos de alumbrado | 78/933/CEE | A(2) (6) 
 A(4) (6) | A(2) (6) 
 A(4) (6) |
|  | Avisador acústico | 74/151/CE (V) | X (2) 
 A (4) | A (6) |
|  | Retrovisores | 74/346/CE | X (2) 
 A (4) | A (6) |
|  | Placas traseras de matricula | 74/151 CEE (II) | C (RGV) | C (RGV) |
|  | Enganches mecánicos | 89/173/CE IV ó 94/20/CE | C (2)(6) 
 C (4)(6) | C (2)(6) 
 C (4)(6) |
...
[ignorar]Anexo Técnico sobre Homologación de Tipo Nacional de Máquinas automotrices
...
### [encabezado]APÉNDICE 5. Lista de requisitos exigidos para la homologación nacional de tipo y homologación individual del vehículo, sus partes y piezas
...
| A(4) |  |  |  |  |
|  | Parabrisas y otros vidrios | 89/173/CE (III) 
 92/22/CE | X(2) 
 B(4) | X(2) 
 B(4) |
...
|  | Instalación de los dispositivos de alumbrado | 78/933/CEE | C(2) (6) (RGV) | C(2) (6) (RGV) |
| C(4) (6) (RGV) | C(4) (6) (RGV) |  |  |  |
|  | Avisador Acústico | 70/388/CEE ó 
 R28 | X(2) | A (6) |
| A (4) |  |  |  |  |
...
|  | Limitador de velocidad | 92/24/CEE 
 92/6/CEE | A | A |
...
| B(4) | B(4) |  |  |  |  |
| 8 | Dispositivos de visión indirecta | 2003/97/CE | X(2) | A(6) | X(2) 
 B(4) |
| B(4) |  |  |  |  |  |
| 9 | Frenado | 71/320/CEE | A | A | A |
...
[ignorar]Anexo Técnico sobre Homologación de Tipo Nacional de Tractocarros
...
|  | Instalación de los dispositivos de alumbrado | 78/933/CEE | C (2) (6) (RGV) | C (2) (6) (RGV) |
| C(4) (6) (RGV) | C (4) (6) (RGV) |  |  |  |
|  | Avisador acústico | 74/151 /CE V ó | X(2) 
 A(4) | A(6) |
| 70/388/CE ó |  |  |  |  |
| R28 |  |  |  |  |
...
|  | Enganches mecánicos | 89/173/CE (IV) ó | C (2)(6) | C (2)(6) |
| 94/20/CE | C (4)(6) | C (4)(6) |  |  |
|  | Emplazamiento y forma de colocación de las placas e inscripciones reglamentarias | 89/173/CE (V) ó 
 76/114/CE | C (RGV) | C (RGV) |
...
[ignorar]Anexo Técnico sobre Homologación de Tipo Nacional de Remolques especiales
...
| **N.º** | **Asunto** | Número de Directiva 
 
 **(*)** | Homologación 
 
 **Nacional (H)** | Homologación 
...
[ignorar]Anexo Técnico sobre Homologación de Tipo Nacional de Máquinas remolcadas
...
|  | Frenado | 76/432/CEE 
 71/320/CEE 
 R13 | C (RGV) | C (RGV) |
|  | Instalación de dispositivos de alumbrado y señalización luminosa | 78/933/CEE | C (2) (6)(RGV) 
 C (4) (6) (RGV) | C (2) (6)(RGV) 
 C(4) (6) (RGV) |
|  | Dimensiones y masas remolcables | 89/173/CEE (1) 
 97/27/CEE | C | C |
|  | Acoplamientos mecánicos | 89/173/CEE (IV) | C (2)(6)(8) 
 C (4)(6) (8) | C (2)(6) 
 C (4)(6) |
|  | Placa de fabricante | 89/173/CEE (V) 
 76/114/CEE | C (7) | C |
|  | Acoplamiento de frenos para remolques | 89/173/CEE (VI) | C | C |
...
| Tipo de 
 certificado | Categorías de vehículos |
| --- | --- |
...
| AT | **Vehículos agrícolas y de obras y servicios completos-completados distintos de los remolques o máquinas remolcadas agrí**
 **colas o de obras y servicios.** |
...
| BR | **Remolques agrícolas o de obras y servicios/máquinas remolcadas agrícolas o de o**
 **bras y servicios.** |
...
| D | **Vehículos completados**
 **de las categorías M, N y O distintos de los agrícolas, de obras y servicios y los de categoría L.** |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Coef. 
 Posición. | 11 | 22 | 33 | 44 | 55 | 66 | 77 | 88 | 99 | 110 | 121 | 132 | 143 | 154 | 165 | 176 | 187 |
...
| C.I. | **Código ITV.**Si procede. 
 Codificación de acuerdo a la ORDEN CTE/3216/2002. | 11 | Alf | – | – | – | – | – | sp | sp | sp | sp | sp | sp | Sp | sp | Sp | sp | Sp | sp |
...
| G | **Masa en orden de marcha (MOM).** Masa del vehículo en circulación con carrocería y con dispositivo de acoplamiento en caso de ser un vehículo tractor distinto de categoría M1, es decir con su equipo fijo autorizado, con conductor y sin pasajeros ni carga, y con su dotación completa de fluido de refrigeración, combustible, lubricante, rueda de repuesto y herramientas (Tara + 75 kg). Según definición de la directiva 92/21/CE. 
 Respecto a los vehículos pertenecientes a la categoría M1, N1, O1, O2 o M2 con un peso inferior a 3,5 toneladas, la masa real podrá variar en un 5 % respecto a la masa que figura en esta entrada. La variación será del 3 % para las demás categorías de vehículos. | 6 | Alf | kg | X | X | X | – | X | X | X | – | X | X | X | – | X | X | X | – |
...
| J.3 | **Volumen de bodegas.** Este punto sólo debe anotarse en el caso de M2 y M3. | 3 | Alf | m^3^ | X | – | – | – | X | – | – | – | X | – | – | – | X | – | – | – |
...
| P.1 | **Cilindrada.** Se consignará la cilindrada total. | 6 | AIf | cm^3^ | X | X | – | X | X | X | – | X | X | X | – | X | X | X | – | X |
...
| U.1 | **Nivel sonoro en parado:**Se indicará el valor en dB(A), que deberá corresponder con lo indicado en la homologación de tipo del vehículo. | 5 | AIf | dB 
 (A) | X | X | – | X | X | X | – | X | X | X | – | X | X | X | – | X |
| U.2 | **Velocidad del motor a la que se mide el nivel sonoro a vehículo parado:** Se indicará el valor en min^–1^ a la que se mide el nivel sonoro en parado, que deberá corresponder con lo indicado en la homologación de tipo. | 7 | Alt | min^–1^ | X | X | – | X | X | X | – | X | X | X | – | X | X | X | – | X |
