...
pagina_final: 102409
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-19049"
url_pdf: "https://www.boe.es/boe/dias/2010/12/10/pdfs/BOE-A-2010-19049.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-19049"
url_eli: "https://www.boe.es/eli/es-ex/l/2010/11/16/12"
fetched_at: "2026-05-15T00:10:58Z"
...
| --- | --- | --- | --- |
| Anexo I. 
Vicepresidencia 1.ª | Tasa por actividades administrativas en materia de televisión terrenal digital. | 02003-6 | 1. Primera concesión. |
| 3. Inscripción en el registro (vinculada a la primera concesión): 
3.1 Por cada inscripción. |  |  |  |
| Tasa por la prestación de servicios administrativos en materia de radiodifusión. | 02004-5 | 1. Inscripción en el Registro de Empresas de Radiodifusión: 
1.1 Primera inscripción. |  |
| 3. Concesión definitiva (por kW de PRA). |  |  |  |
| Anexo II. 
Administración Pública y Hacienda. | Tasas por servicios administrativos inherentes al juego de la Comunidad Autónoma de Extremadura. | 100064 | 1. Inscripción de empresas: 
...
– Autorizaciones de funcionamiento y explotación. |  |  |  |
| Anexo III. 
Agricultura y Desarrollo Rural. | Tasas por prestación de servicios facultativos en materia de producción vegetal y animal. | 12003.2 | 3. Por la Inspección facultativa inicial de establecimientos comerciales destinados a la agricultura, por cada establecimiento. |
...
| Tasa por concesión del uso y control de las etiquetas y sellos de garantía de los productos agrarios. | 12015-4 | 1. Tasa por concesión de uso de la etiqueta ecológica para productos agroalimentarios. 
1.1 Por tramitación de la solicitud de concesión de etiqueta ecológica. |  |
...
| Anexo VI. 
Industria, Energía y Medio Ambiente. | Tasa por servicios prestados en materia de Industria, Energía y Minas. | 15022-0 | Sección 3.ª 
Resolución de expedientes de concesión, autorización e inscripción de actividades industriales y registro de establecimientos industriales. 
1. Nuevas instalaciones, ampliaciones y sustituciones de maquinaría y traslado de industrias. |
...
| Anexo VII. 
Fomento. | Tasa por ordenación de los transportes por carretera y otras actuaciones facultativas. | 16008-1 | 1. De las autorizaciones de transportes: 
1.1 Por el otorgamiento de autorización de transportes interior público discrecional y privado complementario. 
1.6 Por el otorgamiento o renovación de autorización de transportes públicos regula de viajeros de uso especial. 
1.7 Por el otorgamiento de autorizaciones de Agencias de Transportes de mercancías, de transitoria o de almacenista distribuidor. 
1.8 Por el otorgamiento de autorizaciones de establecimientos de sucursales de Agencias de Transportes de mercancías, de transitoria o de almacenista distribuidor. 
1.10 Por el otorgamiento de autorizaciones de arrendamiento de vehículos con conductor. |
| Anexo VIII. 
Cultura y Turismo. | Tasa por tramitación de declaración responsable. | – | Presentación de declaración responsable. |
...
– Sin desplazamiento de facultativo 
– Con toma de datos de campo, el primer día 
– Cada día más. |  |
| Anexo IX. 
Sanidad y Dependencia. | Tasa por prestación de Servicios Sanitarios. | 18006-5 | Sección 4.ª 
Otras actuaciones sanitarias 
48. Obtención/renovación de autorización administrativa de funcionamiento de centros, establecimientos y servicios sanitarios. 
48.1 Centros con internamiento-Hospitales. 
48.2 Proveedores de asistencia sanitaria sin internamiento. 
48.3 Establecimientos sanitarios. 
48.4 Oferta asistencial. |
| 18014-4 | Sección 7.ª 
Almacenes de distribución de productos sanitarios 
78. Autorización de almacenes de distribución de productos sanitarios. |  |  |
| 18015-3 | Sección 8.ª 
Establecimientos fabricantes de productos sanitarios a medida. 
81. Licencia de funcionamiento a los fabricantes de productos sanitarios a medida. |  |  |
|  | Tasa por tramitación y resolución de expedientes en materia planificación y ordenación farmacéutica. | 18011-0 | 1. Farmacia. 
1. Participación en Concurso Público de nueva adjudicación de Oficinas de Farmacia. 
2. Autorización de instalación y funcionamiento de oficinas de farmacia por concurso de nueva adjudicación. |
| 2. Botiquines. 
1. Autorización de instalación y funcionamiento de Botiquines. |  |  |  |
| 3. Servicios de farmacia privados. 
1. Autorización de instalación y funcionamiento de los servicios de farmacia hospitalaria. |  |  |  |
| 4. Depósitos de medicamentos. 
1. Autorización de instalación y funcionamiento de depósitos de medicamentos. |  |  |  |
...
| Capital: 
Empleo estimado: | Centro/s de trabajo con los que pretende contar: |
| El que suscribe opta por iniciar su actividad bajo la forma jurídica de: 
– Empresario individual (autónomo). 
– Comunidad de Bienes. 
– Agrupación de Interés Económico. 
– Otras personas jurídicas (indicar). |  |
| El que suscribe autoriza a la Administración para solicitar las autorizaciones y notificaciones preceptivas en su nombre para el inicio de la actividad y, en particular: 
– Solicitud de inscripción en el Registro General de Empresas y Actividades Turísticas. 
– Solicitud de inscripción en el Registro de Empresas Acreditadas como contratistas o subcontratistas en el Sector de la Construcción. 
