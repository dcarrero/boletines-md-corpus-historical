---
identificador: "BOE-A-2010-16200"
titulo: "Resolución de 11 de octubre de 2010, de la Universidad Miguel Hernández, por la que se convocan pruebas selectivas de acceso al Grupo C, Subgrupo C1, sector Administración Especial, Escala Técnica Especialista, Especialista Técnico, mediante concurso-oposición libre."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 89852
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-16200"
url_pdf: "https://www.boe.es/boe/dias/2010/10/23/pdfs/BOE-A-2010-16200.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-16200"
url_eli: ""
fetched_at: "2026-05-14T21:26:47Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 11 de octubre de 2010, de la Universidad Miguel Hernández, por la que se convocan pruebas selectivas de acceso al Grupo C, Subgrupo C1, sector Administración Especial, Escala Técnica Especialista, Especialista Técnico, mediante concurso-oposición libre.
...
Visto el Acuerdo del Consejo de Gobierno de fecha 5 de diciembre de 2007 y 13 de enero de 2010,
...
1.1 Se convocan pruebas selectivas para cubrir 2 plazas vacantes, de la Escala Técnica Especialista, con denominación Especialista Técnico, grupo C, subgrupo C1 por el sistema general de acceso libre.
...
2.1.3 Estar en posesión del título de Bachiller, Técnico de Formación Profesional o equivalente En el caso de titulaciones obtenidas en el extranjero deberá estarse en posesión de la credencial que acredite su homologación.
...
## ANEXO I. Plazas vacantes números 55284 y 55237
...
5. El lenguaje de programación C. Conceptos básicos.

6. Lenguaje HTML. Características básicas.

7. Protocolo de comunicación TCP/IP.

8. Administración de servidores con sistema operativo Windows.

9. Administración de servidores con sistema operativo Linux y UNIX.

10. Sistemas operativos: definición y conceptos generales. Tipos de sistemas operativos.

11. Instrumentación y elementos básicos en óptica: fuentes de luz, lentes, espejos, polarizadores.

12. Componentes fotónicos. Dispositivos emisores de luz. LED. Láser. Fibra óptica.

13. Elementos activos en infraestructuras ICT. Tipos de amplificadores.

14. Elementos de una red de distribución en infraestructuras ICT: derivadores y repartidores.

15. Fundamentos de electrotecnia. Leyes fundamentales: ley de Ohm, leyes de Kirchhoff. Resistencias, bobinas y condensadores: identificación, uso y verificación.

16. Circuitos trifásicos: fundamentos y características principales.

17. Aparamenta eléctrica de baja tensión. Dispositivos de protección: interruptores diferenciales y magnetotérmicos.

18. Motores de CC y CA. Motores Síncronos y Asíncronos.

19. Manejo del osciloscopio digital. Escalas, tipos y modos de disparo.

20. Fuentes de alimentación. Características principales.

21. Circuitos con diodos. El transistor: identificación, tipos y modos de funcionamiento.

22. Circuitos lógicos combinacionales. Puertas lógicas, tablas de verdad.

23. Conocimiento y uso de Autómatas programables (PLC). El lenguaje de contactos.

24. Componentes electromecánicos. Acelerómetros. Tacómetros. Relés. Contactores. Interruptores. Magnetotérmicos. Diferenciales.

25. Sensores electrónicos. Sensores de posición y velocidad. Sensores de presencia y proximidad. Sensores de caudal, presión y temperatura

26. Robots industriales. Morfología y tipos. Características básicas. Protección.

27. Robots móviles: elementos y características básicas.

28. Fabricación industrial: el torno, centros de mecanizado y fresadora. Características principales.

29. Técnicas de diseño gráfico: Acotación.
