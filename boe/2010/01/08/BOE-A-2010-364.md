---
identificador: "BOE-A-2010-364"
titulo: "Orden ARM/3625/2009, de 23 de diciembre, por la que se definen las explotaciones, animales y grupos asegurables, las condiciones técnicas mínimas de explotación, el ámbito de aplicación, el período de garantía y los precios y fechas de suscripción en relación con el seguro de explotación de ganado vacuno de cebo, comprendido en el Plan Anual 2010 de Seguros Agrarios Combinados."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 2234
pagina_final: 2244
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-364"
url_pdf: "https://www.boe.es/boe/dias/2010/01/08/pdfs/BOE-A-2010-364.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-364"
url_eli: ""
fetched_at: "2026-05-14T05:41:53Z"
...
3. A efectos del seguro, se diferencian varios tipos de explotación en función de que el 90 por ciento, o más, de los animales de la explotación cumplan o no las siguientes condiciones:
...
6. La clasificación del tipo de explotación se realizará teniendo en cuenta el destino y la permanencia de los animales en los últimos tres meses.

7. El asegurado escogerá el tipo que defina su explotación y asegurará todos los animales bajo este tipo, afectando a todos los animales asegurables de su explotación y caracterizará a efectos del seguro a la misma.
...
Teniendo en cuenta lo indicado en el Plan Anual de Seguros Agrarios para el ejercicio 2010, el período de suscripción del seguro de explotación de ganado vacuno de cebo se iniciará el 15 de enero de 2010 y finalizará el día 31 de diciembre de 2010.
...
2. La compensación en caso de inmovilización cautelar por Fiebre aftosa, será la que se establece en el anexo II. Esta indemnización será proporcional a la duración de la medida cautelar oficialmente establecida, calculada en semanas, siendo el periodo mínimo de inmovilización indemnizable de 20 días. Superado dicho periodo se indemnizará desde el inicio de la inmovilización hasta un máximo de 17 semanas por todo el período de vigencia del seguro.

3. A efectos de indemnizaciones, y según la naturaleza del siniestro, el valor límite de las mismas será el resultado de aplicar a cada animal, en función de su edad, conformación morfológica y valor unitario, los porcentajes que aparecen en las siguientes tablas:

a) Siniestros diferentes a la fiebre aftosa:

1. Para explotaciones tipo 1, 2, 3, y 4: los que aparecen en el anexo III.

2. Para explotaciones tipo 5 y 6: los que aparecen en el anexo IV.

b) Valor limite a efectos de indemnización por muerte o sacrificio por fiebre aftosa: los que aparecen en el anexo V.

4. El valor unitario será el menor entre el valor real y el valor declarado; y el porcentaje a aplicar sobre el valor unitario será el que corresponda a la edad real y tipo de conformación real del animal siniestrado.
...
## ANEXO III. Valor límite máximo a efectos de indemnización en caso de siniestros diferentes a la fiebre aftosa en explotaciones tipo 1, 2, 3 y 4

| Porcentaje sobre el valor unitario según edad y tipo de conformación |  |  |  |
| --- | --- | --- | --- |
| Edad de los animales en el momento del siniestro expresadas en semanas | Razas de aptitud cárnica conformación excelente 
– 
Porcentaje | Razas de aptitud cárnica conformación normal 
– 
Porcentaje | Razas de aptitud láctea 
– 
Porcentaje |
| ≥ 8 ≤ 9 | 52 | 50 | 42 |
| > 9 ≤ 10 | 53 | 53 | 43 |
...
## ANEXO IV. Valor límite máximo a efectos de indemnización en caso de siniestros diferentes a la fiebre aftosa en explotaciones tipo 5 y 6

| Porcentaje sobre el valor unitario según edad y tipo de conformación |  |
| --- | --- |
| Edad de los animales en el momento del siniestro, expresadas en semanas | Razas de aptitud cárnica de conformación excelente 
– 
Porcentaje |
| ≥ 8 ≤ 9 | 52 |
| > 9 ≤ 10 | 53 |
...
## ANEXO V. Valor límite máximo a efectos de indemnización por muerte o sacrificio obligatorio por fiebre aftosa
