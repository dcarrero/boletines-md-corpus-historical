---
identificador: "BOE-A-2010-16843"
titulo: "Resolución 3D0/38230/2010, de 19 de octubre, del Instituto Nacional de Técnica Aeroespacial \"Esteban Terradas\", por la que se convocan becas de colaboración en el Proyecto \"MEIGA - Mars Enviromental Instrumentation for Ground and Atmosphere\"."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 92261
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-16843"
url_pdf: "https://www.boe.es/boe/dias/2010/11/03/pdfs/BOE-A-2010-16843.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-16843"
url_eli: ""
fetched_at: "2026-05-14T22:03:45Z"
parser_version: "boletines-md/0.1"
---

# Resolución 3D0/38230/2010, de 19 de octubre, del Instituto Nacional de Técnica Aeroespacial "Esteban Terradas", por la que se convocan becas de colaboración en el Proyecto "MEIGA - Mars Enviromental Instrumentation for Ground and Atmosphere".
...
La presente convocatoria tiene por objeto la concesión de 2 becas de formación destinadas a personas que se encuentren en posesión del título de Licenciado o Ingeniero, siempre que hayan terminado sus estudios con posterioridad al 31 de diciembre de 2006.
...
La financiación de las becas convocadas por la presente Resolución, se efectuará con cargo al concepto presupuestario 14205464A640 del presupuesto de gastos del INTA por una cantidad máxima de 24.720 €.
...
a) El desarrollo de las becas tendrá lugar en las dependencias del INTA de Torrejón de Ardoz (Madrid) con una dedicación a jornada completa.
...
i) El INTA proporcionará a los becarios seleccionados un seguro de enfermedad y accidentes, cuyos detalles de cobertura estarán a disposición de los becarios en la Unidad de Formación del Instituto.
...
4) Nota media del expediente académico en escala 1-4. Si no figura en la certificación académica oficial se solicitará a la universidad o se hará una declaración responsable de nota media (los formatos y guía se pueden consultar en la página web del Ministerio de Educación)

5) Currículum vitae.

6) Cuantos documentos desee aportar el solicitante como méritos, entre los que puede incluir cartas de presentación o certificados expedidos por profesores de su Centro.
...
c) La Comisión de selección estará formada por el Secretario General del INTA o persona en quien delegue, el Investigador Principal del Proyecto MEIGA y el tutor correspondiente.
...
Torrejón de Ardoz, 19 de octubre de 2010.–El Director General del Instituto Nacional de Técnica Aeroespacial Esteban Terradas, Jaime Denis Zambrana.

## ANEXO I

| Código | Tema propuesto | Titulaciones | Conocimientos valorables |
| --- | --- | --- | --- |
| MEIGA 01/11 | Caracterización y calibración de sensores magnéticos. | Licenciado en Ciencias Físicas. 
Ingeniero Electrónico. 
Ingeniero Aeronáutico. | Conocimientos de magnetismo y electrónica, instrumentación, MATLAB, MATHEMATICA |
| MEIGA 02/11 | Desarrollo de software sobre sistemas empotrados, para aplicación espacial. | Ingeniero Informático. 
Ingeniero de Telecomunicación. 
Ingeniero Industrial. | Conocimientos en programación de FPGAs y microprocesadores. 
Conocimientos de Sistemas Operativos para sistemas empotrados. 
Programación C, C++, VHDL. 
