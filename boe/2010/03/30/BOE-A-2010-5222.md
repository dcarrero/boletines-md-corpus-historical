...
pagina_final: 29834
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-5222"
url_pdf: "https://www.boe.es/boe/dias/2010/03/30/pdfs/BOE-A-2010-5222.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-5222"
url_eli: "https://www.boe.es/eli/es/o/2010/03/25/def792"
fetched_at: "2026-05-14T10:23:31Z"
...
[encabezado]NORMAS POR LAS QUE HAN DE REGIRSE LOS PROCESOS DE SELECCIÓN PARA EL INGRESO EN LOS CENTROS DOCENTES MILITARES DE FORMACIÓN PARA ACCEDER A LAS ESCALAS DE OFICIALES DE LOS CUERPOS GENERALES Y DE INFANTERÍA DE MARINA

## [precepto]Primera. Formas de ingreso.
...
## [precepto]Tercera. Distribución de plazas para la forma de ingreso por promoción.
...
## [precepto]Cuarta. Sistema de selección.

El sistema de selección será el de concurso-oposición.

## [precepto]Quinta. Concurso.
...
## [precepto]Séptima. Aptitud psicofísica.
...
## [precepto]Octava. Pruebas físicas.
...
## [precepto]Novena. Pruebas psicológicas.
...
## [precepto]Décima. Reconocimiento médico.
...
## [precepto]Undécima. Prueba de lengua inglesa.
...
## [precepto]Duodécima. Selección previa al reconocimiento médico.
...
## [precepto]Decimotercera. Prueba de conocimientos científicos.
...
## [precepto]Decimocuarta. Prueba de conocimientos teóricos o teórico-prácticos.
...
## [precepto]Decimoquinta. Calificación final del proceso selectivo y criterios de ordenación. Acceso a militar de carrera.
...
## [precepto]Decimosexta. Calificación final del proceso selectivo y criterios de ordenación. Acceso a militar de complemento.
...
## [precepto]Decimoséptima. Asignación de las plazas.
...
## [precepto]Decimoctava. Desarrollo de las pruebas en caso de embarazo, parto o posparto.
...
| **b) Tiempo en operaciones en el extranjero y**
 **misiones para el mantenimiento de la paz.** | 0,50/mes | Se considerarán meses completos despreciando los días que no lleguen a constituir un mes en la fecha en que finalice el plazo de presentación de solicitudes. No podrá superar los 5 puntos. |
...
| **e) Informes personales de calificación.** |  | Se valorará la nota global de las calificaciones de los dos últimos años o, en su defecto, las dos últimas disponibles. La puntuación se obtendrá de su media aritmética. Si por razones justificadas solamente se dispusiera de una sola calificación, se tomará la nota global de ésta. 
 El resultado final se multiplicará por 2, no pudiendo superarse los 20 puntos. 
...
| f) Edad. 
 Se valorará el no haber alcanzado en el año de la convocatoria las siguientes edades máximas: 
 Para incorporarse como militar de carrera, cuando no se exija titulación universitaria: 27 años. 
 Para incorporarse como militar de carrera, cuando se exija titulación universitaria: 30 años. 
 Para adscribirse como militar de complemento: 27 años. | 2 |  |
...
| 1. En el idioma Inglés. 
 a) Sin titulación universitaria: 0,75 puntos por cada grado de conocimiento superior a 2 no pudiendo superar los 6 puntos. 
 b) Con titulación universitaria: 0,75 puntos por cada grado de conocimiento superior a 2. Al resultado final se le restará 1,5 puntos, no pudiendo superar los 6 puntos. |  |  |
| 2. En un segundo idioma de los declarados de interés para las Fuerzas Armadas. Sólo se valorará uno de los siguientes apartados: 
 Certificado oficial de nivel avanzado: 2 pts. 
 SLP 3.3.3.3 o superior: 2 pts. 
 Certificado oficial nivel intermedio: 1 pto. 
 SLP 2.2.2.2 o superior: 1 pto. |  |  |
| **b) Acceso a las enseñanzas universitarias.**
 
 
 **(Solamente se aplicará cuando no se exija para el ingreso titulación universitaria)** | Entre 1 y 2 | Se considerará la calificación obtenida dividida por 5 en: 
...
| **c) Títulos (solamente se aplicará cuando no se exija para el ingreso titulación universitaria).** | 2 | Los títulos deberán tener carácter oficial y validez en todo el territorio nacional. Sólo se valorará un título. 
...
| **1. Título de Licenciado, Arquitecto, Ingeniero o Grado universitario, de los exigidos para el ingreso.** | Entre 5 y 20 | La media del expediente académico será el resultado de la aplicación de la siguiente fórmula: suma de los créditos obtenidos multiplicados cada uno de ellos por el valor de las calificaciones que correspondan, y dividida por el número de créditos totales. 
 En planes de estudios no estructurados en créditos la valoración se calculará por la suma de las asignaturas, multiplicando cada una de ellas por el valor de la calificación obtenida, dividida por el número total de asignaturas. 
 Sólo se valorará un título. 
 Si el título pertenece a la rama de conocimiento de “Ingeniería y Arquitectura” o “Enseñanzas Técnicas”, la puntuación obtenida se multiplicará por 2, si pertenece a la rama de “Ciencias” o “Ciencias Experimentales” se multiplicará por 1,5 y, por 1 si lo es a la de Ciencias Sociales y Jurídicas. |
