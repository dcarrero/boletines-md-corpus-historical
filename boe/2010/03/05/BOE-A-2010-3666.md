---
identificador: "BOE-A-2010-3666"
titulo: "Resolución de 9 de febrero de 2010, del Instituto de Astrofísica de Canarias, por la que se publica la convocatoria de becas de verano para la formación en desarrollo tecnológico dirigidas a estudiantes universitarios de titulaciones superiores, que estén cursando los últimos cursos de la carrera o sean recién titulados."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 22641
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2010-3666"
url_pdf: "https://www.boe.es/boe/dias/2010/03/05/pdfs/BOE-A-2010-3666.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2010-3666"
url_eli: ""
fetched_at: "2026-05-14T09:07:54Z"
...
Esta Dirección General ha resuelto aprobar la convocatoria pública para la concesión de 4 nuevas becas de formación, enmarcadas en el programa de becas de verano del IAC, en la modalidad «Formación en desarrollo tecnológico en el marco de los proyectos de desarrollo instrumental del IAC» y con sujeción a las siguientes bases:

Primero. Objeto, finalidad y duración.

1. La presente Resolución tiene por objeto convocar, en régimen de publicidad, objetividad y concurrencia competitiva, 4 ayudas para la formación de recién licenciados (curso 2008-2009 o posterior) y estudiantes de los últimos cursos universitarios de titulaciones superiores. Su finalidad es la de formar a dichos estudiantes o recién licenciados en el desarrollo tecnológico asociado a la investigación astrofísica.

2. Se convocan, en consecuencia:

| N.º | Duración | Tipo de beca. Finalidad |
| --- | --- | --- |
| 4 | 1 de julio a 30 de septiembre. | Desarrollo tecnológico. Se realizan en el Área de Instrumentación del IAC. Los proyectos disponibles para que los becarios desarrollen su labor son los que se detallan en el Anexo IV. |
...
Están destinadas a estudiantes de últimos cursos universitarios de titulaciones universitarias de ciclo largo, o superior, o recién licenciados (curso 2008-2009 o posterior) preferentemente de Ingeniería (Industrial, Informática, Aeronáutica, Telecomunicaciones), o Licenciatura en Ciencias Físicas o titulación afín.
...
b) Ser estudiantes de últimos cursos universitarios de titulaciones universitarias de ciclo largo, o superior, o recién licenciados, (curso 2008-2009 o posterior) preferentemente de Ingeniería (Industrial, Informática, Aeronáutica, Telecomunicaciones), o Licenciatura en Ciencias Físicas o titulación afín.
...
e) La no concurrencia de las circunstancias previstas en el art. 13 de la Ley General de Subvenciones, Ley 38/2003, de 17 de noviembre.
...
a) El impreso de solicitud (anexo I) y el impreso de documentación adjunta a la solicitud (anexo II) debidamente cumplimentados y firmados. En él el candidato elegirá el proyecto que más se adecue a sus preferencias de formación y por el cual será evaluado. Consignará un segundo proyecto por el cual únicamente será evaluado en el caso de que no haya candidatos suficientes que lo hubieran solicitado como primera opción.
...
Para percibir la ayuda de gastos de viaje prevista en el punto Tercero.1, los candidatos seleccionados, no residentes en la isla de Tenerife, deberán presentar certificado de residencia.
...
La financiación de las becas convocadas por la presente Resolución, se efectuará con cargo al concepto presupuestario 21.201.467A.480 del presupuesto de gastos del IAC, aprobado por la Ley 26/2009, de 23 de diciembre, de Presupuestos Generales del Estado para 2010.
...
La Laguna, 9 de febrero de 2010.–El Director del Instituto de Astrofísica de Canarias, Francisco Sánchez Martínez.
...
## ANEXO IV. Características de las becas-proyectos disponibles para la realización de las becas de desarrollo tecnológico
...
| --- | --- | --- | --- |
| A | Soporte al desarrollo e implantación de una aplicación de gestión de requerimientos de proyectos para el proyecto European Solar Telescope. | European Solar Telescope (EST). | Informática/Bases de Datos/Desarrollo Web. |
| B | Caracterización del Simulador de Telescopios y Atmósferas del IAC (IACAT). | Equalized and Diffraction-limited Field Spectrograph Experiment (EDIFISE). | Física/Electrónica/ Telecomunicación. |
| C | Entorno de pruebas y simulación para los componentes software de los instrumentos. | Departamento de Software. | Informática/Metamodelado/ Generación de código. |
| D | Montaje, integración y verificación de prototipos de desarrollo y subsistemas mecánicos a temperatura ambiente y criogénicos. | Espectrógrafo Multiobjeto Infrarrojo para GTC (EMIR). | Mecánica. |

## ANEXO V. Composición de la Comisión de Evaluación

Tribunal Titular:

• Ángel Alonso Sánchez, Ingeniero del Departamento de Proyectos.

• Heidy Moreno Arce, Ingeniera del Departamento de Software.

• Elvio Hernández Suárez, Ingeniero del Departamento de Mecánica.

Tribunal Suplente:

• Jorge Sánchez-Capuchino Revuelta, Ingeniero del Departamento de Óptica.

• Esperanza Páez Mañá, Ingeniera del Departamento de Software.

• José M. Delgado Hernández, Ingeniero del Departamento de Electrónica.
