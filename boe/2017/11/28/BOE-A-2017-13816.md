---
identificador: "BOE-A-2017-13816"
titulo: "Resolución de 16 de noviembre de 2017, de la Subsecretaría, por la que se publica el Convenio entre la Secretaría General de Administración Digital y la Agencia Estatal de Investigación, para la utilización de la \"Gestión Integrada de Servicios de Registro\" como aplicación integral de registro."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 115243
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2017-13816"
url_pdf: "https://www.boe.es/boe/dias/2017/11/28/pdfs/BOE-A-2017-13816.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2017-13816"
url_eli: ""
fetched_at: "2026-04-22T10:26:07Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 16 de noviembre de 2017, de la Subsecretaría, por la que se publica el Convenio entre la Secretaría General de Administración Digital y la Agencia Estatal de Investigación, para la utilización de la "Gestión Integrada de Servicios de Registro" como aplicación integral de registro.

El Secretario General de Administración Digital y la Directora de la Agencia Estatal de Investigación, han suscrito, con fecha 25 de octubre de 2017, un Convenio para la utilización de la «Gestión Integrada de Servicios de Registro» (GEISER) como aplicación integral de registro.
...
## ANEJO. Convenio entre la Administración General del Estado (Secretaría General de Administración Digital) y la Agencia Estatal de Investigación para la utilización de la «Gestión Integrada de Servicios de Registro» (GEISER) como aplicación integral de registro
...
1. Para la SGAD, la puesta a disposición de la Agencia Estatal de Investigación de la aplicación informática denominada «GEISER», como solución tecnológica para la gestión de los libros de registro de entrada y salida de dicho organismo, así como para la interconexión electrónica de su registro con el Sistema de Interconexión de Registros y el Registro Electrónico.

2. Para la Agencia Estatal de Investigación el uso de la aplicación citada, con sus propios recursos, para contribuir a la racionalización del uso de las tecnologías de la información y las comunicaciones en las Administraciones y, adaptar sus sistemas de información a los requisitos mínimos exigidos por la SGAD para el uso de la citada plataforma que figuran en el manual de usuario proporcionado por la SGAD.

3. La SGAD, y la Agencia Estatal de Investigación se prestarán el soporte necesario para la solución de las incidencias técnicas, de carácter informático, de la aplicación, en los términos recogidos en la cláusula quinta de este Convenio.

## Segunda. Especificaciones de la aplicación.

1. La conexión de los usuarios de la Agencia Estatal de Investigación a la aplicación «GEISER» se hará a través de la Red SARA, gestionada por la SGAD, que adoptará las medidas de seguridad que garanticen la confidencialidad del tránsito de la información intercambiada.

2. La aplicación distinguirá entre el grupo de usuarios de la Agencia Estatal de Investigación y el de usuarios de la SGAD y otros organismos.
...
a) Adscribir al proyecto los medios humanos y técnicos necesarios para la adecuada adaptación e implantación inicial de la citada aplicación en la Agencia Estatal de Investigación.

b) Proporcionar, antes de la puesta en producción de la aplicación, material para la autoformación específica del personal de la Agencia Estatal de Investigación encargado de dar soporte funcional e informático a la misma.

c) Proponer una lista de indicadores de seguimiento a los efectos de obtener la información necesaria durante la puesta a disposición de la aplicación «GEISER» en relación a la prestación del servicio por la SGAD, a la Agencia Estatal de Investigación.

2. La Agencia Estatal de Investigación se compromete a:

a) Utilizar la aplicación GEISER para la gestión de su registro oficial de entrada/salida en sus oficinas de registro y unidades tramitadoras. En este sentido y, conforme a la experiencia registrada en el ejercicio inmediatamente anterior a la firma de este Convenio, la Agencia Estatal de Investigación estima una previsión de uso de 165.000 asientos registrales.
...
1. La SGAD, realizará las labores de adaptación para la implantación inicial de la aplicación en la Agencia Estatal de Investigación.

a) Configuración técnica de los parámetros de GEISER relacionados con la conexión a SIR de las oficinas de la Agencia Estatal de Investigación.

b) Configuración en GEISER de las unidades de la Agencia Estatal de Investigación no contenidas en el Directorio Común DIR3.

c) Configuración en GEISER de los gestores de los accesos a los distintos ámbitos de la Agencia Estatal de Investigación configurados en la aplicación.
...
2. Por otra parte, la documentación electrónica contenida en la aplicación GEISER correspondiente a los registros de la Agencia Estatal de Investigación estará disponible en la aplicación por un periodo máximo de 1 año desde su entrada en el sistema.
...
Por su parte, la Agencia Estatal de Investigación contribuirá al mantenimiento anual de la sostenibilidad funcional y técnica de la aplicación GEISER con una contraprestación económica que se determina en base al uso del servicio. El cálculo de la contribución económica se realizará conforme a los criterios establecidos en el anexo I de este Convenio.

En particular la Agencia Estatal de Investigación ha estimado, en el periodo de vigencia del Convenio, que el uso de la aplicación en 165.000 asientos registrales, según lo que certifica en el anexo II de este Convenio, por lo que el alcance de la contraprestación económica es de 12.500 euros.
...
En caso de resolución, ambas partes deberán adoptar, de acuerdo con lo previsto en el artículo 52.3 de la Ley 40/2015, de 1 de octubre, las medidas necesarias para asegurar, en todo caso, el mantenimiento del servicio público electrónico a los ciudadanos prestado por la Agencia Estatal de Investigación con las aplicaciones proporcionadas por la SGAD.
...
El Convenio de colaboración será administrado por una Comisión de Seguimiento, formada por dos representantes de la SGAD, nombrados por su Secretario General, de los cuales uno que asumirá la Presidencia y tendrá voto de calidad en caso de empate en las votaciones y, dos representantes de la Agencia Estatal de Investigación, nombrados por su Director.
...
En prueba de conformidad, y para que conste a los efectos oportunos, las partes firman el presente Convenio.–El Secretario General de Administración Digital, Domingo Molina Moscoso.–La Directora de la Agencia Estatal de Investigación, Marina Pilar Villegas Gracia.
...
Doña Marina Pilar Villegas Gracia, como Directora de la Agencia Estatal de Investigación, declara que durante el ejercicio 2016 el número aproximado^(1)^ de asientos registrales de entrada y salida que fueron realizados conjuntamente en las oficinas de registro que se incorporarán a la aplicación GEISER en las condiciones del presente Convenio/acuerdo, asciende a un total de 131.000 asientos registrales.

Para el periodo inicial de vigencia del Convenio, se estima un total de 165.000 asientos registrales.
...
Fdo.: Marina Pilar Villegas Gracia.

^(1)^La puesta en funcionamiento de la Agencia Estatal de Investigación se produjo el 20 de junio de 2016, por lo que la cifra reflejada contiene una estimación, hasta esa fecha, de los asientos de otros órganos, de los cuales la Agencia ha asumido competencias.
