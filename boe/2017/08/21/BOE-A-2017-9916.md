---
identificador: "BOE-A-2017-9916"
titulo: "Resolución de 8 de agosto de 2017, de la Subsecretaría, por la que se publica el Convenio entre la Secretaría General de Administración Digital y la Confederación Hidrográfica del Guadiana, para la utilización de la Gestión Integrada de Servicios de Registro como aplicación integral de registro."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 85099
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2017-9916"
url_pdf: "https://www.boe.es/boe/dias/2017/08/21/pdfs/BOE-A-2017-9916.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2017-9916"
url_eli: ""
fetched_at: "2026-04-22T03:05:19Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 8 de agosto de 2017, de la Subsecretaría, por la que se publica el Convenio entre la Secretaría General de Administración Digital y la Confederación Hidrográfica del Guadiana, para la utilización de la Gestión Integrada de Servicios de Registro como aplicación integral de registro.

El Secretario General de Administración Digital y el Presidente de la Confederación Hidrográfica del Guadiana, han suscrito, con fecha 30 de junio de 2017, un Convenio para la utilización de la «Gestión Integrada de Servicios de Registro» (GEISER) como aplicación integral de registro.
...
## ANEJO. Convenio entre la Administración General del Estado (Secretaría General de Administración Digital) y la Confederación Hidrográfica del Guadiana (CHG) para la utilización de la «Gestión Integrada de Servicios de Registro» (GEISER) como aplicación integral de registro
...
Que la Confederación Hidrográfica del Guadiana, en virtud de lo dispuesto en el Real Decreto Legislativo 1/2001, de 20 de julio, por el que se aprueba el texto refundido de la Ley de Aguas tiene atribuidas, entre otras, las funciones de:
...
1. Para la SEFP, a través de la SGAD, la puesta a disposición de la CHG de la aplicación informática denominada «GEISER», como solución tecnológica para la gestión de los libros de registro de entrada y salida de dicho organismo, así como para la interconexión electrónica de su registro con el Sistema de Interconexión de Registros y el Registro Electrónico.

2. Para la CHG el uso de la aplicación citada, con sus propios recursos, para la mejora de la Administración electrónica en su ámbito de competencias.

3. La SEFP, a través de la SGAD, y la CHG se prestarán el soporte necesario para la solución de las incidencias técnicas, de carácter informático, de la aplicación, en los términos recogidos en la cláusula quinta de este Convenio.
...
1. La conexión de los usuarios de la CHG a la aplicación «GEISER» se hará a través de la Red SARA, gestionada por la SEFP, que adoptará las medidas de seguridad que garanticen la confidencialidad del tránsito de la información intercambiada.

2. La aplicación distinguirá entre el grupo de usuarios de la CHG y el de usuarios de la SEFP y otros organismos.

3. Los usuarios de la aplicación tendrán responsabilidad sobre el buen uso y gestión, en su propio ámbito, del software y de las aplicaciones citadas anteriormente. En todo caso, la SEFP no responderá de ningún daño y perjuicio directo o indirecto que provenga del mal empleo de los componentes o de incidencias en el acceso y uso del servicio por causas ajenas a la infraestructura de la SGAD, debiendo los sistemas de información de la CHG cumplir los requisitos mínimos exigidos por el uso, que figuran en el Manual de Usuario de la aplicación proporcionado por la SGAD.
...
c) Proponer una lista de indicadores de seguimiento a los efectos de obtener la información necesaria durante la puesta a disposición de la aplicación «GEISER» en relación a la prestación del servicio por la SEFP, a través de la SGAD, a la CHG.

2. La CHG se compromete a:

a) Utilizar la aplicación GEISER para la gestión de su registro oficial de entrada/salida en sus oficinas de registro y unidades tramitadoras. En este sentido y, conforme a la experiencia registrada en el ejercicio inmediatamente anterior a la firma de este Convenio, la CHG estima una previsión de uso de 110.000 asientos registrales.
...
1. La SEFP, a través de la SGAD, realizará las labores de adaptación para la implantación inicial de la aplicación en la CHG.
...
c) Las incidencias fuera del ámbito de actuación de la CHG serán comunicadas por su unidad de informática a la unidad designada por la SEFP, quien proporcionará el soporte solicitado.
...
Estas incidencias deberán ser analizadas conjuntamente por la unidad designada por la SGAD y por la unidad designada por la CHG, siendo competencia de la SEFP, a través de la SGAD, asegurar, en concordancia con los requisitos y necesidades del resto de organismos usuarios de la aplicación, que en todo caso la aplicación evoluciona de acuerdo con una única línea de desarrollo que permita su extensión a otros Organismos o Entidades de la Administración General del Estado.
...
En particular, la CHG ha estimado, en el periodo de vigencia del Convenio, que el uso de la aplicación en 110.000 asientos registrales, según lo que certifica en el anexo II de este Convenio, por lo que el alcance de la contraprestación económica es de 12.500 Euros.

| Año | Total Registros | Contribución Económica |
| --- | --- | --- |
| 2017 | 74.000 | 8.333,33 € |
| 2018 | 37.000 | 4.166,67 € |
...
El Convenio de Colaboración será administrado por una Comisión de Seguimiento, formada por dos representantes de la SGAD, nombrados por su Secretario General, que asumirá la Presidencia y tendrá voto de calidad en caso de empate en las votaciones y, dos representantes de la CHG, nombrados por su Presidente.
...
En prueba de conformidad, y para que conste a los efectos oportunos, las partes firman el presente Convenio. El Secretario General de Administración Digital, Domingo Molina Moscoso. 30 de junio de 2017.–El Presidente de la Confederación Hidrográfica del Guadiana, José Díaz Mora. 29 de junio de 2017.
...
D. José Díaz Mora, como Presidente de la CHG, declara que durante el ejercicio 2016 el número de asientos registrales de entrada y salida que fueron realizados conjuntamente en las oficinas de registro que se incorporarán a la aplicación GEISER en las condiciones del presente convenio/acuerdo, asciende a un total de 0 asientos registrales.

Para el periodo inicial de vigencia del Convenio, se estima un total de 110.000 asientos registrales.
