...
pagina_final: 81077
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2017-9639"
url_pdf: "https://www.boe.es/boe/dias/2017/08/11/pdfs/BOE-A-2017-9639.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2017-9639"
url_eli: ""
fetched_at: "2026-04-22T02:47:31Z"
parser_version: "boletines-md/0.1"
---

# Orden APM/794/2017, de 28 de julio, por la que se definen los bienes y los rendimientos asegurables, las condiciones técnicas mínimas de cultivo, el ámbito de aplicación, los periodos de garantía, las fechas de suscripción y los precios unitarios del seguro de explotaciones olivareras, comprendido en el trigésimo octavo Plan de Seguros Agrarios Combinados.
...
En el seguro principal se cubren las cosechas 2018/2019 y 2019/2020.
...
En el seguro principal se cubre la cosecha 2018/2019.
...
2. Revisión a instancia del asegurado. Los agricultores que consideren que el rendimiento asignado a su explotación no se ajusta a la realidad productiva de la misma, podrán solicitar la revisión del rendimiento asegurable por alguna de las causas que se indican a continuación:
...
1. Revisión de la base de datos de oficio por ENESA. La comunicación de la resolución de las revisiones efectuadas de oficio por ENESA, se comunicarán al asegurado y a AGROSEGURO en los 90 días siguientes al inicio del expediente.

2. Revisión de la base de datos a instancia del asegurado o solicitud de asignación de rendimiento. Los agricultores que deseen solicitar la revisión de la base de datos o la asignación de rendimientos por no figurar en dicha base de datos podrán hacerlo en cualquier momento a lo largo del año.
...
Para que tenga aplicación en la cosecha amparada por la presente orden y posteriores cosechas, o hasta la actualización de la base de datos, se podrá solicitar desde la publicación de la presente orden hasta el día 30 de septiembre de 2017. Las recibidas con posterioridad, se estudiarán para la contratación del Plan siguiente.

AGROSEGURO podrá realizar visitas a la explotación en caso de que las considere necesarias.

Para las solicitudes presentadas hasta el 30 de septiembre de 2017, AGROSEGURO remitirá a ENESA, los datos aportados en la solicitud, así como los datos de campo de cada explotación, con una propuesta de rendimiento, antes del 15 de octubre de 2017.

La revisión de rendimiento solicitada, se realizará por ENESA, y será comunicada a AGROSEGURO a más tardar el 10 de noviembre de 2017.
...
4. Documentación. Los agricultores que se encuentren en alguna de las circunstancias mencionadas anteriormente, deberán solicitar la revisión de la base de datos o la asignación de rendimiento, aportando la siguiente documentación:
...
2. Seguro complementario. Su ámbito de aplicación comprenderá las mismas parcelas que hayan sido incluidas en el seguro principal en los módulos 1A, 1B, 2A, 2 B y P con cobertura de resto de adversidades climáticas para la garantía a la plantación.
...
Teniendo en cuenta los períodos de garantía, anteriormente indicados y lo establecido en el Trigésimo Octavo Plan de Seguros Agrarios Combinados, los períodos de suscripción del seguro serán los siguientes:
...
Inicio de suscripción: 15 de marzo de 2018.

Finalización del periodo de suscripción:

Comunidades Autónomas de Andalucía, Castilla-La Mancha, Extremadura, Región de Murcia y Comunidad Valenciana: 30 de junio de 2018.

Resto del ámbito: 15 de julio de 2018.

2. Seguro complementario:

a) Módulos 1A, 1B, 2A y 2B.

Inicio de la suscripción: 15 de marzo de 2018 para el primer año y el 15 de marzo de 2019 para el segundo año.

Finalización de la suscripción:

Comunidades Autónomas de Andalucía, Castilla-La Mancha, Extremadura, Región de Murcia y Comunidad Valenciana: 30 de junio de 2018 para el primer año y 30 de junio de 2019 para el segundo año.

Resto del ámbito: 15 de julio de 2018 para el primer año y 15 de julio de 2019 para el segundo año.

b) Módulo P con cobertura de resto de adversidades climáticas para la plantación.

Inicio de la suscripción: 15 de marzo de 2018.
...
| Tipo plantación | Garantía | Riesgos cubiertos | Cálculo indemnización | Garantizado y límite 
 de indemnización |
| --- | --- | --- | --- | --- |
...
(2) Elegible según lo que figure para cada productor en la base de datos del Ministerio de Agricultura y Pesca, Alimentación y Medio Ambiente.
...
3.1 Cálculo del rendimiento medio. El cálculo de los rendimientos medios se ha obtenido a partir de los datos procedentes de los distintos seguros de olivar de las cosechas 2005/2006 a 2013/2014.
...
3.2 Cálculo de rendimientos máximos asegurables. Una vez calculados los rendimientos medios obtenidos por oleicultor, se han agrupado en los siguientes estratos, para configurar los rendimientos máximos asegurables:
...
| Tipo plantación | Ámbito
 ...
 Autónoma) | Densidad
 –
 Olivos/ha | Número años desde el siniestro |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Número de años desde el siniestro

| Tipo plantación | Ámbito (Comunidad Autónoma) | Densidad 
 –
...
| --- | --- | --- | --- | --- | --- |
| Provincia | Comarca |  |  |  |  |
| Producción. | Calidad. | Manzanilla Fina, Manzanilla Carrasqueña, Manzanilla Serrana y Gordal. | Todas. | Todas. | 31 de octubre de 2018. |
| Resto variedades. | Todas. | Todas. | 30 de noviembre de 2018. |  |  |
| Cantidad. | Daños producidos a consecuencia de caída de frutos (1). | Todas. | Tarragona. | Bajo Ebro. | 15 octubre de 2018. |
| Teruel. | Bajo Aragón. |  |  |  |  |
| Castelló/Castellón. | Alto Maestrazgo, Bajo Maestrazgo y Litoral Norte. |  |  |  |  |
| Resto ámbito. | 15 de noviembre de 2018. |  |  |  |  |
| Resto de daños. | Todas. | Todas. | Todas. | 28 febrero de 2019. |  |
| Plantación. | Todos. | Todas. | Todas. | Todas. | 12 meses. |
| Instalaciones. | Todos. | Todas. | Todas. | Todas. | 12 meses. |

(1) En siniestros acaecidos con posterioridad al 15 de octubre de 2018 o al 15 de noviembre de 2018, según el ámbito indicado, estará cubierta la caída de aceitunas, por cualquiera de los riesgos cubiertos, hasta el 28 de febrero de 2019 siempre que quede imposibilitada la recolección de las mismas.
...
| Grupos | Variedades | Precio máximo 
 ...
 €/100 kg |
| --- | --- | --- | --- |
| I. Aceituna de almazara. | Arbequina, Arroniz, Cornicabra y Empeltre. | 44,00 | 29,00 |
...
| Grupos | Variedades | Precio máximo
 ...
 €/100 kg |
| --- | --- | --- | --- |
| I. Aceituna de Almazara. | Arbequina, Arroniz, Cornicabra y Empeltre. | 50,00 | 33,00 |
