...
pagina_final: 89620
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2017-10443"
url_pdf: "https://www.boe.es/boe/dias/2017/09/12/pdfs/BOE-A-2017-10443.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2017-10443"
url_eli: ""
fetched_at: "2026-04-22T04:06:54Z"
...
El Secretario General de Administración Digital y el Presidente del Instituto de Contabilidad y Auditoría de Cuentas, han suscrito, con fecha 11 de julio de 2017, un Convenio para la utilización de la «gestión integrada de servicios de registro» (GEISER) como aplicación integral de registro.
...
## ANEJO. Convenio entre la Administración General del Estado (Secretaria General de Administración Digital) y el Instituto de Contabilidad y Auditoría de Cuentas (ICAC) para la utilización de la «gestión integrada de servicios de registro» (GEISER) como aplicación integral de registro
...
De otra parte, el Sr. D. Enrique Rubio Herrera, Presidente del Instituto de Contabilidad y Auditoría de Cuentas, nombrado para este cargo por el Real Decreto 572/2016, de 25 de noviembre, actuando en nombre y representación del Instituto de Contabilidad y Auditoría de Cuentas (ICAC) adscrito a la Subsecretaría del Ministerio de Economía, Industria y Competitividad, en ejercicio de las competencias atribuidas.
...
Que el Presidente del Instituto de Contabilidad y Auditoría de Cuentas, de acuerdo con el artículo 4.dos del estatuto de dicho Organismo Autónomo, aprobado por Real Decreto 302/1989, de 17 de marzo, ostenta la representación legal del instituto y es el órgano de contratación del mismo.
...
1. Para la SEFP, a través de la SGAD, la puesta a disposición del Instituto de Contabilidad y Auditoría de Cuentas de la aplicación informática denominada «GEISER», como solución tecnológica para la gestión de los libros de registro de entrada y salida de dicho organismo, así como para la interconexión electrónica de su registro con el Sistema de Interconexión de Registros y el Registro Electrónico.

2. Para el Instituto de Contabilidad y Auditoría de Cuentas el uso de la aplicación citada, con sus propios recursos, para la mejora de la Administración electrónica en su ámbito de competencias.

3. La SEFP, a través de la SGAD, y el Instituto de Contabilidad y Auditoría de Cuentas] se prestarán el soporte necesario para la solución de las incidencias técnicas, de carácter informático, de la aplicación, en los términos recogidos en la cláusula quinta de este Convenio.
...
1. La conexión de los usuarios del Instituto de Contabilidad y Auditoría de Cuentas a la aplicación «GEISER» se hará a través de la Red SARA, gestionada por la SEFP, que adoptará las medidas de seguridad que garanticen la confidencialidad del tránsito de la información intercambiada.

2. La aplicación distinguirá entre el grupo de usuarios del Instituto de Contabilidad y Auditoría de Cuentas y el de usuarios de la SEFP y otros organismos.

3. Los usuarios de la aplicación tendrán responsabilidad sobre el buen uso y gestión, en su propio ámbito, del software y de las aplicaciones citadas anteriormente. En todo caso, la SEFP no responderá de ningún daño y perjuicio directo o indirecto que provenga del mal empleo de los componentes o de incidencias en el acceso y uso del servicio por causas ajenas a la infraestructura de la SGAD, debiendo los sistemas de información del el Instituto de Contabilidad y Auditoría de Cuentas cumplir los requisitos mínimos exigidos por el uso, que figuran en el Manual de Usuario de la aplicación proporcionado por la SGAD.

## Tercera. Obligaciones de las partes.

1. La SEFP, a través de la SGAD, se compromete a:

a) Adscribir al proyecto los medios humanos y técnicos necesarios para la adecuada adaptación e implantación inicial de la citada aplicación en el Instituto de Contabilidad y Auditoría de Cuentas.

b) Proporcionar, antes de la puesta en producción de la aplicación, material para la auto formación específica del personal del Instituto de Contabilidad y Auditoría de Cuentas encargado de dar soporte funcional e informático a la misma.

c) Proponer una lista de indicadores de seguimiento a los efectos de obtener la información necesaria durante la puesta a disposición de la aplicación «GEISER» en relación a la prestación del servicio por la SEFP, a través de la SGAD, al Instituto de Contabilidad y Auditoría de Cuentas.

2. El Instituto de Contabilidad y Auditoría de Cuentas se compromete a:

a) Utilizar la aplicación GEISER para la gestión de su registro oficial de entrada/salida en sus oficinas de registro y unidades tramitadoras. En este sentido y, conforme a la experiencia registrada en el ejercicio inmediatamente anterior a la firma de este Convenio, el Instituto de Contabilidad y Auditoría de Cuentas estima una previsión de uso de 5.000 asientos registrales.
...
1. La SEFP, a través de la SGAD, realizará las labores de adaptación para la implantación inicial de la aplicación en el Instituto de Contabilidad y Auditoría de Cuentas.

a) Configuración técnica de los parámetros de GEISER relacionados con la conexión a SIR de las oficinas del Instituto de Contabilidad y Auditoría de Cuentas.

b) Configuración en GEISER de las unidades del Instituto de Contabilidad y Auditoría de Cuentas no contenidas en el Directorio Común DIR3.

c) Configuración en GEISER de los gestores de los accesos a los distintos ámbitos del Instituto de Contabilidad y Auditoría de Cuentas configurados en la aplicación.
...
a) Corresponderá al Instituto de Contabilidad y Auditoría de Cuentas dar soporte a la solución de las mismas, siempre y cuando su causa se encuentre dentro de su propia red de comunicaciones, equipos, sistemas operativos o navegadores.

b) Corresponderá al Instituto de Contabilidad y Auditoría de Cuentas atender y dar un primer nivel de soporte a las incidencias que se produzcan en relación con el uso y funcionamiento de la aplicación. La SGAD no atenderá directamente a los usuarios del Instituto de Contabilidad y Auditoría de Cuentas.

c) Las incidencias fuera del ámbito de actuación del Instituto de Contabilidad y Auditoría de Cuentas serán comunicadas por su unidad de informática a la unidad designada por la SEFP, quien proporcionará el soporte solicitado.

1.2 Incidencias evolutivas: Que serán aquellas que se produzcan a partir de la implantación inicial de la aplicación en el Instituto de Contabilidad y Auditoría de Cuentas y, en concreto, toda petición de modificación o alteración sugerida o solicitada por parte de este, de naturaleza distinta a las incidencias correctivas establecidas en el apartado anterior.

Estas incidencias deberán ser analizadas conjuntamente por la unidad designada por la SGAD y por la unidad designada por el Instituto de Contabilidad y Auditoría de Cuentas, siendo competencia de la SEFP, a través de la SGAD, asegurar, en concordancia con los requisitos y necesidades del resto de organismos usuarios de la aplicación, que en todo caso la aplicación evoluciona de acuerdo con una única línea de desarrollo que permita su extensión a otros organismos o entidades de la Administración General del Estado.

2. Por otra parte, la documentación electrónica contenida en la aplicación GEISER correspondiente a los registros del Instituto de Contabilidad y Auditoría de Cuentas estará disponible en la aplicación por un periodo máximo de 1 año desde su entrada en el sistema.
...
Por su parte, el Instituto de Contabilidad y Auditoría de Cuentas contribuirá al mantenimiento anual de la sostenibilidad funcional y técnica de la aplicación GEISER con una contraprestación económica que se determina en base al uso del servicio. El cálculo de la contribución económica se realizará conforme a los criterios establecidos en el anexo I de este Convenio.

En particular el Instituto de Contabilidad y Auditoría de Cuentas ha estimado, en el periodo de vigencia del Convenio, que el uso de la aplicación en 8.500 asientos registrales, según lo que certifica en el anexo II de este Convenio, por lo que el alcance de la contraprestación económica es de 0 euros.
...
En caso de resolución, ambas partes deberán adoptar, de acuerdo con lo previsto en el artículo 52.3 de la Ley 40/2015, de 1 de octubre, las medidas necesarias para asegurar, en todo caso, el mantenimiento del servicio público electrónico a los ciudadanos, prestado por el Instituto de Contabilidad y Auditoría de Cuentas con las aplicaciones proporcionadas por la SGAD.
...
El Convenio de Colaboración será administrado por una Comisión de Seguimiento, formada por dos representantes de la SGAD, nombrados por su Secretario General, que asumirá la Presidencia y tendrá voto de calidad en caso de empate en las votaciones y, dos representantes del Instituto de Contabilidad y Auditoría de Cuentas, nombrados por su Presidente.
...
En prueba de conformidad, y para que conste a los efectos oportunos, las partes firman el presente Convenio.–El Secretario General de Administración Digital, Domingo Javier Molina Moscoso, 11 de julio de 2017.–El Presidente del Instituto de Contabilidad y Auditoría de Cuentas, Enrique Rubio Herrera, 5 de julio de 2017.
...
Don Alfredo Suaz González, como Secretario General, declara que durante el ejercicio 2016 el número de asientos registrales de entrada y salida que fueron realizados conjuntamente en las oficinas de registro que se incorporarán a la aplicación GEISER en las condiciones del presente convenio/acuerdo, asciende a un total de 9.436 asientos registrales.

Para el periodo inicial de vigencia del Convenio, se estima un total de 8.500 asientos registrales.

Asimismo, de conformidad con lo dispuesto en el apartado 5 de la Ley 40/2015, de 1 de octubre, declara tener capacidad para financiar durante la vigencia del convenio, los compromisos financieros asumidos.–Fdo.: Alfredo Suaz González.
